...
argument_list|)
decl_stmt|;
comment|// The input column can either be a string or a list of list of integer values.
name|List
argument_list|<
name|String
argument_list|>
...
comment|// The row consists of some string columns, some Array<Array<int>> columns.
name|List
argument_list|<
name|ObjectInspector
argument_list|>
...
block|{
comment|// Blindly add this as a non settable list of list of integers,
comment|// should be sufficient for the test case.
comment|// Use the standard list object inspector.
name|columnOIs
operator|.
name|add
argument_list|(
