...
name|append
argument_list|(
literal|"list_binary_field_for_repeat_test"
argument_list|,
name|getBinaryValue
argument_list|(
name|isDictionaryEncoding
...
specifier|public
name|void
name|testUnrepeatedStringWithoutNullListRead
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
name|testUnRepeateStringWithoutNullListRead
argument_list|()
expr_stmt|;
name|removeFile
argument_list|()
...
specifier|public
name|void
name|testVectorizedRowBatchSizeChange
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
name|testVectorizedRowBatchSizeChangeListRead
argument_list|()
expr_stmt|;
name|removeFile
argument_list|()
...
name|createTestParquetReader
argument_list|(
literal|"message hive_schema {repeated binary list_binary_field_for_repeat_test;}"
argument_list|,
name|conf
argument_list|)
decl_stmt|;
...
index|]
decl_stmt|;
comment|// When deal with big data, the VectorizedRowBatch will be used for the different file split
comment|// to cache the data. Here is the situation: the first split only have 100 rows,
comment|// and VectorizedRowBatch cache them, meanwhile, the size of VectorizedRowBatch will be
comment|// updated to 100. The following code is to simulate the size change, but there will be no
comment|// ArrayIndexOutOfBoundsException when process the next split which has more than 100 rows.
name|vector
operator|.
name|lengths
operator|=
