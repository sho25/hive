...
return|;
block|}
comment|// We assume there have been no reads/lookups before this call.
comment|// And, keys are *UNIQUE*.
specifier|public
name|void
...
name|fail
argument_list|(
literal|"NULL key found in expected keys"
argument_list|)
expr_stmt|;
block|}
name|long
...
name|fail
argument_list|(
literal|"non-matched key not found in expected keys"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|fail
argument_list|(
literal|"non-matched key not one of the expected non-matched keys"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|fail
argument_list|(
literal|"non-matched key already returned"
argument_list|)
expr_stmt|;
block|}
name|returnedNonMatched
...
name|fail
argument_list|(
literal|"non-matched key count mismatch"
argument_list|)
expr_stmt|;
block|}
block|}
