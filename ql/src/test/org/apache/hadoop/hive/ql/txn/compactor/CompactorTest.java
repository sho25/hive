...
expr_stmt|;
block|}
comment|// Set the table as transactional for compaction to work
if|if
condition|(
name|parameters
operator|==
...
condition|)
block|{
comment|// Sort columns are not allowed for full ACID table. So, change it to insert-only table
name|parameters
operator|.
name|put
argument_list|(
