...
literal|9999
decl_stmt|;
comment|//approximate, so we get some negative values:
specifier|private
specifier|static
specifier|final
name|int
name|SMALLEST_EPOCH_DAY
init|=
operator|-
literal|365
operator|*
...
parameter_list|)
block|{
comment|// get date in timestamp out, and change timestamp out to string out
name|VectorizedRowBatch
name|batch
init|=
name|getVectorizedRowBatchDateInTimestampOut
...
return|;
block|}
comment|// For testing CastDateToStringWithFormat with
comment|// TestVectorTypeCastsWithFormat#testCastDateToStringWithFormat
specifier|public
specifier|static
name|VectorizedRowBatch
...
literal|0
argument_list|,
name|getSqlTimestamp
argument_list|(
literal|"2019-12-31 19:20:21.999999999"
argument_list|)
argument_list|)
expr_stmt|;
name|timestampColumnV
