...
argument_list|)
expr_stmt|;
comment|/**      * this may look a bit odd.  Compactor is capped at min open write id which is 23 in this case      * so the minor compaction above only 1 dir as input, delta_21_22 and outputs      * delta_21_22_v28 (and matching delete_delta)  (HIVE-9995/HIVE-20901)      */
name|Assert
operator|.
name|assertEquals
argument_list|(
