...
specifier|public
name|void
name|testGetTimestampProlepticConverter
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGetInt64MillisTimestampConverter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"2018-07-15 15:12:20.112"
argument_list|)
decl_stmt|;
name|PrimitiveType
name|primitiveType
init|=
name|createInt64TimestampType
argument_list|(
literal|false
argument_list|,
name|TimeUnit
...
specifier|public
name|void
name|testGetInt64MillisTimestampProlepticConverter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"1572-07-15 15:12:20.112"
argument_list|)
decl_stmt|;
name|PrimitiveType
name|primitiveType
...
specifier|public
name|void
name|testGetInt64MicrosTimestampConverter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"2018-07-15 15:12:20.112233"
argument_list|)
decl_stmt|;
name|PrimitiveType
name|primitiveType
...
specifier|public
name|void
name|testGetInt64NanosTimestampConverter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"2018-07-15 15:12:20.11223344"
argument_list|)
decl_stmt|;
name|PrimitiveType
name|primitiveType
...
specifier|public
name|void
name|testGetInt64NanosAdjustedToUTCTimestampConverter
parameter_list|()
throws|throws
name|Exception
block|{
