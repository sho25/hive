...
literal|null
expr_stmt|;
comment|// The path for MiniDFSCluster has changed, so look in both 17 and 19
comment|// In hadoop 17, the path is org.apache.hadoop.dfs.MiniDFSCluster, whereas
comment|// it is org.apache.hadoop.hdfs.MiniDFSCluster in hadoop 19. Due to this anamonly,
comment|// use reflection to invoke the methods.
try|try
block|{
name|dfsClass
operator|=
...
name|forName
argument_list|(
literal|"org.apache.hadoop.dfs.MiniDFSCluster"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|forName
argument_list|(
literal|"org.apache.hadoop.hdfs.MiniDFSCluster"
argument_list|)
expr_stmt|;
block|}
name|Constructor
