...
argument_list|)
expr_stmt|;
comment|/*           XXX Ugly hack - uncomment this to test without DDLs.           Should be removed once DDL/metastore mt issues are resolved           synchronized (this.getClass()) {           qt.executeOne(fname);           }         */
name|qt
operator|.
name|executeClient
argument_list|(
