...
name|Exception
block|{
comment|/*     System.out.println(         "*DEBUG* typeInfo " + typeInfo1.toString() +         " typeInfo2 " + typeInfo2 +         " arithmeticTestMode ROW_MODE" +         " columnScalarMode " + columnScalarMode +         " exprDesc " + exprDesc.toString());     */
name|HiveConf
name|hiveConf
init|=
operator|new
