...
name|info
argument_list|(
literal|"Ready to run the query: "
operator|+
name|query
argument_list|)
expr_stmt|;
...
name|format
argument_list|(
literal|"insert into %s (a) values ("
operator|+
name|i
operator|+
literal|")"
...
expr_stmt|;
block|}
name|runParallelQueries
argument_list|(
name|queries
argument_list|)
expr_stmt|;
comment|// Verify stats are either invalid, or valid and correct.
name|stats
operator|=
name|getTxnTableStats
argument_list|(
name|msClient
argument_list|,
name|tableName
...
condition|)
block|{
comment|// Stats should still be invalid if they were invalid.
name|stats
operator|=
name|getTxnTableStats
argument_list|(
...
expr_stmt|;
block|}
comment|// Stats should be valid after analyze.
name|runStatementOnDriver
argument_list|(
name|String
operator|.
name|format
argument_list|(
literal|"analyze table %s compute statistics for columns"
argument_list|,
name|tableName
argument_list|)
argument_list|)
...
name|format
argument_list|(
literal|"create table %s (a int) stored as orc "
operator|+
literal|"TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')"
argument_list|,
name|tableName
...
argument_list|)
decl_stmt|;
comment|// Stats should be valid after serial inserts.
name|List
argument_list|<
name|ColumnStatisticsObj
argument_list|>
...
specifier|public
name|void
name|testParallelInsertAnalyzeStats
parameter_list|()
throws|throws
name|Exception
block|{
...
name|format
argument_list|(
literal|"insert into %s (a) values (999)"
argument_list|,
name|tableName
argument_list|)
block|,
...
name|format
argument_list|(
literal|"insert into %s (a) values (1000)"
argument_list|,
name|tableName
argument_list|)
argument_list|)
...
specifier|public
name|void
name|testParallelTruncateAnalyzeStats
parameter_list|()
throws|throws
name|Exception
block|{
...
name|format
argument_list|(
literal|"insert into %s (a) values (1)"
argument_list|,
name|tableName
argument_list|)
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// Even though the stats are valid in metastore, txn stats are disabled.
name|stats
operator|=
name|getTxnTableStats
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Now the stats are visible again.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
literal|", INPUT__FILE__NAME from "
operator|)
operator|+
name|Table
operator|.
