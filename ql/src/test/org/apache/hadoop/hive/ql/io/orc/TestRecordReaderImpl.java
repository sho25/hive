...
name|fail
argument_list|(
literal|"Exception should have been thrown when Record Reader was closed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
decl_stmt|;
name|MetadataReaderFactory
name|mockedMetadataReaderFactory
init|=
name|mock
argument_list|(
name|MetadataReaderFactory
...
argument_list|)
operator|.
name|withDataReaderFactory
argument_list|(
name|mockedDataReaderFactory
argument_list|)
operator|.
name|withMetadataReaderFactory
argument_list|(
name|mockedMetadataReaderFactory
argument_list|)
operator|.
