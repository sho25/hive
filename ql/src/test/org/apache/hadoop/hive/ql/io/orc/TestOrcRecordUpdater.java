...
expr_stmt|;
block|}
comment|/*     CharsetDecoder instances are not thread safe, so it can end up in an inconsistent state when reading multiple     buffers parallel.     E.g:     java.lang.IllegalStateException: Current state = FLUSHED, new state = CODING_END   */
annotation|@
name|Test
specifier|public
name|void
name|testConcurrentParseKeyIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
comment|// When
comment|// Hit OrcRecordUpdater.parseKeyIndex with large parallelism
specifier|final
name|int
name|parallelism
init|=
