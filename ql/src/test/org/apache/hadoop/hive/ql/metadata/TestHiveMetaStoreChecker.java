...
argument_list|)
expr_stmt|;
comment|// currently HiveMetastoreChecker uses a minimum pool size of 2*numOfProcs
comment|// no other easy way to set it deterministically for this test case
name|checker
operator|=
name|Mockito
operator|.
...
name|assertTrue
argument_list|(
literal|"Expected exception HiveException got "
operator|+
name|e
operator|.
name|getClass
