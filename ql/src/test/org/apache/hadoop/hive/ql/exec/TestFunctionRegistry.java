...
name|assertFalse
argument_list|(
literal|"Function not added as permanent yet"
argument_list|,
name|FunctionRegistry
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now register as permanent function
name|FunctionResource
index|[]
name|emptyResources
init|=
...
name|registerPermanentFunction
argument_list|(
literal|"default.perm_current_timestamp"
argument_list|,
name|GenericUDFCurrentTimestamp
operator|.
name|class
...
name|assertTrue
argument_list|(
literal|"Function should now be recognized as permanent function"
argument_list|,
name|FunctionRegistry
operator|.
name|isPermanentFunction
