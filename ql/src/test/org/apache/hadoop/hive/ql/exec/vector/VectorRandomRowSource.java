...
name|SAME_TYPE
block|,
name|OMIT_GENERATION
block|,
name|STRING_FAMILY
block|,
name|STRING_FAMILY_OTHER_TYPE_VALUE
block|,
...
specifier|public
name|StringGenerationOption
name|getStringGenerationOption
parameter_list|()
block|{
return|return
name|stringGenerationOption
...
specifier|static
name|GenerationSpec
name|createTimestampMilliseconds
parameter_list|(
name|TypeInfo
name|typeInfo
parameter_list|)
...
name|category
expr_stmt|;
comment|// Do not represent DECIMAL_64 to make ROW mode tests easier --
comment|// make the VECTOR mode tests convert into the VectorizedRowBatch.
name|ObjectInspector
name|objectInspector
init|=
name|getObjectInspector
...
name|RuntimeException
argument_list|(
literal|"Unexpected string family category "
operator|+
name|primitiveCategory
argument_list|)
throw|;
...
name|RuntimeException
argument_list|(
literal|"Unexpected generationKind "
operator|+
name|generationKind
argument_list|)
throw|;
...
specifier|static
name|Object
name|getNonWritablePrimitiveObject
parameter_list|(
name|Object
name|object
parameter_list|,
