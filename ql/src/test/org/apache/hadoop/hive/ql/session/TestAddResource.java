...
expr_stmt|;
block|}
comment|/**    * Tests adding jar with special chars in the path:    * - works if it's given in URL encoded format    * - fails if it's not encoded (user should have done it).    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testSpecialCharsInPath
parameter_list|()
throws|throws
name|Exception
block|{
...
name|TEST_JAR_DIR
operator|+
literal|"testjar-[specialchars].jar"
decl_stmt|;
name|String
name|filePathEncoded
init|=
name|TEST_JAR_DIR
operator|+
literal|"testjar-%5Bspecialchars%5D.jar"
decl_stmt|;
name|writeTestJarFile
argument_list|(
name|filePath
