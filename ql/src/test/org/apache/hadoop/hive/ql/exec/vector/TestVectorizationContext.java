...
specifier|public
name|void
name|testInBloomFilter
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Setup InBloomFilter() UDF
name|ExprNodeColumnDesc
name|colExpr
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Setup VectorizationContext
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// Create vectorized expr
name|VectorExpression
name|ve
init|=
name|vc
...
expr_stmt|;
name|VectorInBloomFilterColDynamicValue
name|vectorizedInBloomFilterExpr
init|=
operator|(
name|VectorInBloomFilterColDynamicValue
operator|)
...
argument_list|()
decl_stmt|;
comment|// VectorInBloomFilterColDynamicValue should have all of the necessary information to vectorize.
comment|// Should be no need for child vector expressions, which would imply casting/conversion.
name|Assert
operator|.
name|assertNull
argument_list|(
