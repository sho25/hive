...
argument_list|)
expr_stmt|;
comment|// Drop table will clean the table entry from the compaction queue and hence cleaner have no effect
name|ms
operator|.
name|dropTable
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Drop partition will clean the partition entry from the compaction queue and hence cleaner have no effect
name|ms
operator|.
name|dropPartition
argument_list|(
