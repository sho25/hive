...
name|executeQuery
argument_list|(
literal|"insert into simple_stats (i, s) values (2, 'test2')"
argument_list|)
expr_stmt|;
name|executeQuery
argument_list|(
literal|"insert into simple_stats (i, s) values (3, 'test3')"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
name|executeQuery
argument_list|(
literal|"insert into simple_stats (i, s) values (1, 'test12')"
argument_list|)
expr_stmt|;
name|executeQuery
argument_list|(
literal|"insert into simple_stats (i, s) values (2, 'test22')"
argument_list|)
expr_stmt|;
name|executeQuery
argument_list|(
literal|"insert into simple_stats (i, s) values (3, 'test32')"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
expr_stmt|;
block|}
comment|// A table which is target of replication should not be queued for stats update, and hence its
comment|// stats state should not change.
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testNoStatsUpdateForSimpleReplTable
parameter_list|()
throws|throws
name|Exception
block|{
name|testNoStatsUpdateForReplTable
argument_list|(
literal|"simple"
argument_list|,
literal|""
...
specifier|public
name|void
name|testNoStatsUpdateForTxnReplTable
parameter_list|()
throws|throws
name|Exception
block|{
...
name|tblNamePrefix
operator|+
literal|"_ptn_repl_trgt_nostats"
decl_stmt|;
name|String
name|ptnTblWithStats
init|=
name|tblNamePrefix
operator|+
literal|"_ptn_repl_trgt_stats"
decl_stmt|;
name|StatsUpdaterThread
name|su
init|=
...
name|tblWOStats
operator|+
literal|"(i int, s string) "
operator|+
name|txnProperty
argument_list|)
expr_stmt|;
comment|// Mark this table as being replicated into
name|setTableReplTargetProperty
argument_list|(
name|tblWOStats
argument_list|)
expr_stmt|;
...
name|ptnTblWOStats
operator|+
literal|"(s string) partitioned by (i int) "
operator|+
name|txnProperty
argument_list|)
expr_stmt|;
