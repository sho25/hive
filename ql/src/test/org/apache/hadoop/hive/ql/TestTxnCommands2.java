...
block|{
block|{
literal|"{\"writeid\":0,\"bucketid\":536936448,\"rowid\":2}\t0\t13"
block|,
literal|"bucket_00001"
block|}
block|,
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536936448,\"rowid\":0}\t0\t15"
block|,
literal|"bucket_00001"
block|}
block|,
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536936448,\"rowid\":5}\t1\t4"
block|,
literal|"bucket_00001"
block|}
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536936448,\"rowid\":4}\t1\t5"
block|,
literal|"bucket_00001"
block|}
block|,
...
block|,
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536936448,\"rowid\":1}\t1\t16"
block|,
literal|"bucket_00001"
block|}
block|}
...
expr_stmt|;
block|}
comment|/**    * Create a table with schema evolution, and verify that no data is lost during (MR major)    * compaction.    *    * @throws Exception if a query fails    */
annotation|@
name|Test
specifier|public
name|void
name|testSchemaEvolutionCompaction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|tblName
init|=
literal|"schemaevolutioncompaction"
decl_stmt|;
name|runStatementOnDriver
argument_list|(
literal|"drop table if exists "
...
literal|"(a INT) "
operator|+
literal|" PARTITIONED BY(part string)"
operator|+
literal|" STORED AS ORC TBLPROPERTIES ('transactional'='true')"
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" partition (part='aa') values (1)"
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" ADD COLUMNS(b int)"
argument_list|)
expr_stmt|;
comment|// Second INSERT round.
name|runStatementOnDriver
argument_list|(
literal|"insert into "
operator|+
name|tblName
operator|+
literal|" partition (part='aa') values (2, 2000)"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Verify successful compaction
name|List
argument_list|<
name|ShowCompactResponseElement
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Validate data after compaction
name|res
operator|=
name|runStatementOnDriver
argument_list|(
