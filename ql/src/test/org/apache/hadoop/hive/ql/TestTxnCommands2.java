...
expr_stmt|;
block|}
comment|/**    * https://www.linkedin.com/pulse/how-load-slowly-changing-dimension-type-2-using-oracle-padhy    */
annotation|@
name|Test
specifier|public
name|void
...
name|teeCurMatch
init|=
literal|"select curMatch.*, case when splitTable.op is null or splitTable.op = 0 then 0 else 1 end op from ("
operator|+
name|curMatch
operator|+
...
name|teeCurMatch
operator|+
literal|") s on t.key=s.key and t.cur=1 and s.op=1 "
operator|+
