...
expr_stmt|;
block|}
comment|//this should not schedule a new compaction due to prior failures
name|Initiator
name|init
init|=
operator|new
...
name|assertEquals
argument_list|(
literal|"Unexpected number of failed compactions"
argument_list|,
name|numFailedCompactions
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Unexpected total number of compactions"
argument_list|,
name|numFailedCompactions
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Number of failed compactions after History clean"
argument_list|,
name|numFailedCompactions
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Total number of compactions after History clean"
argument_list|,
name|numFailedCompactions
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Unexpected num failed1"
argument_list|,
name|numFailedCompactions
operator|+
literal|2
...
name|assertEquals
argument_list|(
literal|"Unexpected num failed2"
argument_list|,
name|hiveConf
operator|.
name|getIntVar
...
argument_list|)
expr_stmt|;
comment|//at this point "show compactions" should have (COMPACTOR_HISTORY_RETENTION_FAILED) failed + 1 initiated
name|cbs
operator|=
name|countCompacts
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Unexpected num failed3"
argument_list|,
name|hiveConf
operator|.
name|getIntVar
...
name|assertEquals
argument_list|(
literal|"Unexpected num initiated"
argument_list|,
literal|1
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Unexpected num failed4"
argument_list|,
name|hiveConf
operator|.
name|getIntVar
...
name|assertEquals
argument_list|(
literal|"Unexpected num ready to clean"
argument_list|,
literal|1
argument_list|,
name|cbs
...
name|assertEquals
argument_list|(
literal|"Unexpected num failed5"
argument_list|,
name|hiveConf
operator|.
name|getIntVar
...
name|assertEquals
argument_list|(
literal|"Unexpected num succeeded"
argument_list|,
literal|1
argument_list|,
name|cbs
