...
name|parse
argument_list|(
literal|"repl load  from '/some/location/in/hdfs/'"
argument_list|)
decl_stmt|;
...
name|parse
argument_list|(
literal|"repl load targetTestDbName from '/some/location/in/hdfs/'"
argument_list|)
decl_stmt|;
name|assertFromLocation
argument_list|(
