...
name|assertEquals
argument_list|(
literal|"count: 2 min: bye max: hi"
argument_list|,
name|stats
index|[
literal|9
...
expr_stmt|;
block|}
comment|/**    * We test union and timestamp separately since we need to make the    * object inspector manually. (The Hive reflection-based doesn't handle    * them properly.)    */
annotation|@
name|Test
specifier|public
name|void
