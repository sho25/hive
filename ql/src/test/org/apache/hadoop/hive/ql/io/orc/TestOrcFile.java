...
argument_list|)
decl_stmt|;
comment|// this is an invalid decimal value, getting HiveDecimal from it will return null
name|writer
operator|.
name|addRow
argument_list|(
...
specifier|public
name|void
name|testHiveDecimalIsNullReset
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// orc creates 1000 batch size to make memory check align with 5000 instead of 5120
for|for
control|(
name|int
name|i
...
control|)
block|{
comment|// since we are walking backwards, seek back a buffer width so that
comment|// we load the previous buffer of rows
if|if
condition|(
name|i
operator|%
...
argument_list|)
decl_stmt|;
comment|// set up 10 files that all request the full size.
name|MemoryManager
operator|.
name|Callback
name|ignore
...
specifier|public
name|void
name|testLlapAwareMemoryManager
parameter_list|()
throws|throws
name|IOException
block|{
