...
expr_stmt|;
block|}
comment|// 2. Perform a major compaction.
name|runStatementOnDriver
argument_list|(
literal|"alter table "
operator|+
...
argument_list|)
expr_stmt|;
comment|// There should be 2 delta dirs.
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 4. Perform a minor compaction. Nothing should change.
comment|// Both deltas and the base dir should have the same name.
