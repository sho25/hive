...
specifier|public
name|void
name|testParsePercentileContAsc
parameter_list|()
throws|throws
name|Exception
block|{
...
name|parseSelect
argument_list|(
literal|"SELECT percentile_cont(0.4) WITHIN GROUP (ORDER BY val ASC) FROM src"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
...
specifier|public
name|void
name|testParsePercentileContDesc
parameter_list|()
throws|throws
name|Exception
block|{
...
name|parseSelect
argument_list|(
literal|"SELECT percentile_cont(0.4) WITHIN GROUP (ORDER BY val DESC) FROM src"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
