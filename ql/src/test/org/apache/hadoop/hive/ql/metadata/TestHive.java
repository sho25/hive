...
expr_stmt|;
block|}
comment|// accessType set by HMS Transformer
if|if
condition|(
name|tbl
operator|.
...
argument_list|)
decl_stmt|;
comment|// TODO: threadlocals... Why is all this Hive client stuff like that?!!
specifier|final
name|AtomicReference
argument_list|<
name|Hive
...
argument_list|)
expr_stmt|;
comment|// We should not be able to modify the active plan.
name|WMPool
name|pool
init|=
operator|new
...
parameter_list|)
block|{     }
comment|// But we should still be able to modify the other plan.
name|pool
operator|.
name|unsetNs
argument_list|()
expr_stmt|;
comment|// The call to create sets the namespace.
name|hm2
operator|.
name|createWMPool
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Make the 2nd plan active in a different namespace.
name|changes
operator|.
name|unsetNs
argument_list|()
