...
literal|null
expr_stmt|;
comment|// setValue() should be able to handle null input
name|values
index|[
name|i
index|]
...
argument_list|()
expr_stmt|;
comment|// set the offset and length for the two elements
name|cv
operator|.
name|offsets
index|[
...
literal|3
expr_stmt|;
comment|// initialize the integer values
for|for
control|(
name|int
name|i
...
literal|3
expr_stmt|;
comment|// initialize the keys and values
for|for
control|(
name|int
name|i
...
specifier|public
name|void
name|testVectorExpressionWriterDecimal
parameter_list|()
throws|throws
name|HiveException
block|{
...
specifier|public
name|void
name|testVectorExpressionSetterDecimal
parameter_list|()
throws|throws
name|HiveException
block|{
...
specifier|public
name|void
name|testVectorExpressionListLong
parameter_list|()
throws|throws
name|HiveException
block|{
...
specifier|public
name|void
name|testVectorExpressionMapLong
parameter_list|()
throws|throws
name|HiveException
block|{
