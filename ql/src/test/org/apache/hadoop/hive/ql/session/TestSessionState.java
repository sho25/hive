...
block|}
block|}
comment|/**    * Unit test for SessionState.createPath().    */
annotation|@
name|Test
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// second time will complete silently
name|SessionState
operator|.
name|createPath
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Show we cannot create a child of a file
try|try
block|{
name|SessionState
operator|.
...
name|fail
argument_list|(
literal|"did not get expected exception creating a child of a file"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|// Show we cannot create a child of a null directory
try|try
block|{
...
name|fail
argument_list|(
literal|"did not get expected exception creating a Path from a null string"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|// Create a directory with no permissions
name|Path
name|noPermissions
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Show we cannot create a child of the directory with no permissions
try|try
block|{
name|SessionState
operator|.
...
name|fail
argument_list|(
literal|"did not get expected exception creating a child of a directory with no permissions"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|contains
argument_list|(
literal|"Failed to create directory noPermissions/child"
argument_list|)
argument_list|)
expr_stmt|;
block|}
