...
block|}
block|}
comment|/**    * Test for {@link Utilities#getInputPaths(JobConf, MapWork, Path, Context, boolean, ExecutorService)} with a single    * threaded {@link ExecutorService}.    */
annotation|@
name|Test
specifier|public
name|void
name|testGetInputPathsWithPool
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Run a test with an un-partitioned table with a single file as the input
name|List
argument_list|<
name|Path
argument_list|>
name|tableInputPaths
init|=
name|Utilities
operator|.
name|getInputPaths
...
argument_list|()
expr_stmt|;
comment|// Run a test with a partitioned table with a single partition and a single file as the input
name|List
argument_list|<
name|Path
argument_list|>
name|tablePartitionInputPaths
init|=
name|Utilities
operator|.
name|getInputPaths
