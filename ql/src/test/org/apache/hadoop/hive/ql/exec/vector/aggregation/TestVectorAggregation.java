...
literal|"avg"
case|:
comment|/*         if (typeInfo instanceof DecimalTypeInfo) {           // UNDONE: Row-mode GenericUDAFAverage does not call enforcePrecisionScale...           hasDifferentCompleteExpr = false;         } else {           hasDifferentCompleteExpr = true;         }         */
name|hasDifferentCompleteExpr
operator|=
literal|true
expr_stmt|;
