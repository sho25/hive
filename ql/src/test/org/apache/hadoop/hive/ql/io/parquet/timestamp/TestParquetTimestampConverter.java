...
specifier|public
class|class
name|TestParquetTimestampConverter
extends|extends
name|TestCase
block|{
specifier|public
...
argument_list|)
expr_stmt|;
comment|//check if 1464305 Julian Days between Jan 1, 2005 BC and Jan 31, 2005.
name|cal1
operator|=
name|Calendar
operator|.
...
parameter_list|()
block|{
comment|// Test with different timezone IDs strings
name|valueTest
argument_list|(
name|Calendar
operator|.
