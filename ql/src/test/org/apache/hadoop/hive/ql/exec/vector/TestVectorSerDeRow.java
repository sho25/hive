...
argument_list|()
decl_stmt|;
comment|// FUTURE: try NULLs and UNICODE.
name|source
operator|.
name|init
argument_list|(
...
block|{
return|return
literal|"Object is different"
return|;
block|}
block|}
return|return
literal|"Actual and expected row are the same"
return|;
block|}
specifier|private
name|String
name|getObjectDisplayString
parameter_list|(
name|Object
name|object
parameter_list|)
