...
name|assertEquals
argument_list|(
literal|"counter: VERTEX_TOTAL_TASKS limit: 10000"
argument_list|,
name|expression
operator|.
name|getCounterLimit
...
name|assertEquals
argument_list|(
literal|"counter: DAG_TOTAL_TASKS limit: 10000"
argument_list|,
name|expression
operator|.
name|getCounterLimit
...
name|assertEquals
argument_list|(
literal|"counter: HDFS_WRITE_OPS limit: 10000"
argument_list|,
name|expression
operator|.
name|getCounterLimit
...
name|fromString
argument_list|(
literal|" VERTEX_TOTAL_TASKS> 10000"
argument_list|)
expr_stmt|;
name|expected
operator|=
...
specifier|public
name|void
name|testActionFromMetastoreStr
parameter_list|()
block|{
name|assertEquals
argument_list|(
