...
expr_stmt|;
block|}
comment|/**    * Tests the number of calls to dropPartitions and the respective batch sizes when first call to    * dropPartitions throws MetastoreException. The batch size should be reduced once by the    * decayingFactor 2, iow after batch size is halved.    *    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Tests the retries exhausted case when Hive.DropPartitions method call always keep throwing    * MetastoreException. The batch sizes should exponentially decreased based on the decaying factor and    * ultimately give up when it reaches 0.    *    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
