...
name|valueOf
argument_list|(
literal|"2016-01-01 01:01:01"
argument_list|)
argument_list|)
argument_list|)
decl_stmt|;
comment|// Write record to Parquet format using CST timezone
name|writeParquetRecord
argument_list|(
name|fileSchema
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// Write record to Parquet format using PST timezone
name|writeParquetRecord
argument_list|(
name|fileSchema
argument_list|,
