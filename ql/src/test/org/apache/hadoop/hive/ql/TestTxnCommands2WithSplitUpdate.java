...
argument_list|)
decl_stmt|;
comment|// TODO: Setting split strategy as 'BI' is workaround for HIVE-14448 until it is resolved.
name|hiveConf
operator|.
name|set
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Restore the previous value for split strategy, or unset if not previously set.
if|if
condition|(
name|oldSplitStrategyValue
operator|.
