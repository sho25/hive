...
name|runStatementOnDriver
argument_list|(
literal|"create table TAcid (a int, b int) stored as orc"
argument_list|)
expr_stmt|;
name|runStatementOnDriver
argument_list|(
literal|"create table TAcidPart (a int, b int) partitioned by (p int) stored"
operator|+
literal|" as orc"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//this table needs to be converted to Acid
name|runStatementOnDriver
argument_list|(
