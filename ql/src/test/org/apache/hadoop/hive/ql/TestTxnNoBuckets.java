...
block|}
block|}
comment|/**    * The idea here is to create a non acid table that was written by multiple writers, i.e.    * unbucketed table that has 000000_0& 000001_0, for example.  Unfortunately this doesn't work    * due to 'merge' logic - see comments in the method    */
annotation|@
name|Ignore
annotation|@
name|Test
