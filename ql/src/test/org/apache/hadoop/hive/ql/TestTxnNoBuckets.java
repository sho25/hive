...
argument_list|()
expr_stmt|;
comment|//see TestTxnNoBucketsVectorized for vectorized version
name|hiveConf
operator|.
name|setBoolVar
argument_list|(
...
expr_stmt|;
block|}
comment|/* ├── base_0000002_v0000025 │   ├── bucket_00000 │   └── bucket_00001 ├── delete_delta_0000002_0000002_0000 │   └── bucket_00000 |   └── bucket_00001 ├── delta_0000001_0000001_0000 │   ├── bucket_00000 │   └── bucket_00001 └── delta_0000002_0000002_0000     └── bucket_00000     */
name|String
name|expected
index|[]
index|[]
...
name|expected
argument_list|,
literal|"select ROW__ID, c1, c2, c3"
operator|+
operator|(
name|shouldVectorize
argument_list|()
...
name|runStatementOnDriver
argument_list|(
literal|"create table tmp (c1 integer, c2 integer) partitioned by (c3 integer) stored as orc "
operator|+
...
specifier|public
name|void
name|testInsertOverwriteToAcidWithUnionRemove
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
literal|"insert overwrite table T select a, b from "
operator|+
name|TxnCommandsBaseForTests
operator|.
name|Table
...
name|contains
argument_list|(
literal|"not supported due to OVERWRITE and UNION ALL"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":1}\t9\t10"
block|,
literal|"warehouse/t/000000_0"
block|}
block|,
...
literal|"{\"writeid\":0,\"bucketid\":537001984,\"rowid\":0}\t1\t2"
block|,
literal|"warehouse/t/base_10000002_v0000029/bucket_00002"
block|}
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":537001984,\"rowid\":1}\t2\t4"
...
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":0}\t5\t6"
block|,
literal|"warehouse/t/base_10000002_v0000029/bucket_00000"
block|}
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":1}\t9\t10"
...
literal|"{\"writeid\":10000001,\"bucketid\":536936448,\"rowid\":0}\t60\t88"
block|,
literal|"warehouse/t/base_10000002_v0000029/bucket_00001"
block|}
block|,     }
decl_stmt|;
name|checkExpected
...
block|,
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536870912,\"rowid\":0}\t0\t15"
block|,
literal|"bucket_00000"
block|,
literal|"bucket_00000"
...
block|,
block|{
literal|"{\"writeid\":10000003,\"bucketid\":536870912,\"rowid\":0}\t0\t17"
block|,
literal|"bucket_00000"
block|,
literal|"bucket_00000"
...
block|,
block|{
literal|"{\"writeid\":10000002,\"bucketid\":536870912,\"rowid\":0}\t0\t120"
block|,
literal|"bucket_00000"
block|,
literal|"bucket_00000"
...
block|,
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536870912,\"rowid\":1}\t1\t16"
block|,
literal|"bucket_00000"
block|,
literal|"bucket_00000"
...
block|{
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536870912,\"rowid\":0}"
block|,
literal|"17"
block|}
block|,
...
block|{
literal|"{\"writeid\":10000001,\"bucketid\":536870912,\"rowid\":0}\t1\t17"
block|,
literal|"warehouse/t/base_10000001_v0000029/bucket_00000"
block|}
block|,
block|{
...
literal|"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t1\t2\t4\t2"
block|,
literal|"t/p=1/q=2/base_0000003_v0000020/bucket_00000"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t1\t2\t4\t4"
