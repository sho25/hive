...
name|contains
argument_list|(
literal|"\'file\' access is not allowed due to restriction set by the accessExternalDTD property"
argument_list|)
argument_list|)
expr_stmt|;
block|}
