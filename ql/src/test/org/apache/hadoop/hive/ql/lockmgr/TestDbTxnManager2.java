...
return|;
block|}
comment|/**    * @deprecated use {@link #getLocks(boolean)}    */
specifier|private
name|List
argument_list|<
name|ShowLocksResponseElement
...
return|;
block|}
comment|/**    * @deprecated use {@link #getLocks(HiveTxnManager, boolean)}    */
specifier|private
name|List
argument_list|<
name|ShowLocksResponseElement
...
return|;
block|}
comment|/**    * for some reason sort order of locks changes across different branches...    */
specifier|private
name|List
argument_list|<
name|ShowLocksResponseElement
...
return|;
block|}
comment|//sort is not important except that it's consistent
annotation|@
name|Override
specifier|public
name|int
...
return|;
block|}
comment|//we should never get here (given current code)
if|if
condition|(
name|p1
operator|.
...
name|Ignore
argument_list|(
literal|"for some reason this fails with NPE in setUp() when run as part of the suite, but not standalone.."
argument_list|)
specifier|public
name|void
name|testUpdateWithSubquery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|run
argument_list|(
literal|"create table source (a1 int, b1 int, p1 int, q1 int) clustered by (a1) into 2  buckets stored as orc TBLPROPERTIES ('transactional'='true')"
argument_list|)
argument_list|)
expr_stmt|;
name|checkCmdOnDriver
...
name|run
argument_list|(
literal|"update source set b1 = 1 where p1 in (select t.q from target t where t.p=2)"
argument_list|)
argument_list|)
expr_stmt|;
block|}
