...
expr_stmt|;
block|}
comment|/**    * Concurrent delte/detele of same partition - should pass    * This test doesn't work yet, because we don't yet pass in operation type    *     * todo: Concurrent insert/update of same partition - should pass    */
annotation|@
name|Ignore
argument_list|(
literal|"HIVE-13622"
...
argument_list|)
expr_stmt|;
comment|//todo: this currently fails since we don't yet set operation type properly
name|Assert
operator|.
name|assertEquals
argument_list|(
