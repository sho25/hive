...
expr_stmt|;
block|}
comment|/**    * Check to make sure we acquire proper locks for queries involving non-strict locking    */
annotation|@
name|Test
specifier|public
name|void
name|checkExpectedReadLocksForNonAcidTables
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Test non-acid read-locking mode - the read locks are only obtained for the ACID side
name|conf
operator|.
name|setBoolVar
argument_list|(
