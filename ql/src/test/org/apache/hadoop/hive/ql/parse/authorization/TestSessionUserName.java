...
expr_stmt|;
block|}
comment|/**    * Test that the groupNames are retrieved properly from UGI    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testSessionGetGroupNames
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test that the groupNames returned is null, when the user name is null. The user name is null    * in the case of embedded HS2 and we assert that we don't throw an NPE in that case.    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testSessionNullUser
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertNull
argument_list|(
literal|"getGroupNames when userName == null"
argument_list|,
name|ss
operator|.
name|getAuthenticator
