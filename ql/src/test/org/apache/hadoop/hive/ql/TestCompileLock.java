...
expr_stmt|;
block|}
comment|/**    * Test that checks that the queries above the quota are timed out, so the compilation quota maximum is honored.    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testParallelCompilationTimeoutWithMultipleQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
name|verifyThatTimedOutCompileOpsCount
argument_list|(
name|responseList
argument_list|,
literal|6
