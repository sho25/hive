...
expr_stmt|;
block|}
comment|// execution mode not set, null is returned
name|assertEquals
argument_list|(
name|defaultNoConditionalTaskSize
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// disable memory checking
name|hiveConf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// invalid inflation factor
name|hiveConf
operator|.
name|set
argument_list|(
...
specifier|public
name|void
name|testLlapMemoryOversubscriptionMaxExecutorsPerQueryCalculation
parameter_list|()
block|{
name|ConvertJoinMapJoin
name|convertJoinMapJoin
