...
specifier|public
name|void
name|testNoConditionalTaskSizeForLlap
parameter_list|()
block|{
name|ConvertJoinMapJoin
name|convertJoinMapJoin
...
argument_list|()
decl_stmt|;
comment|// execution mode not set, default is returned
name|long
name|gotSize
init|=
name|convertJoinMapJoin
...
argument_list|)
expr_stmt|;
comment|// default executors is 4, max slots is 3. so 3 * 20% of noconditional task size will be oversubscribed
name|hiveConf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// num executors is less than max executors per query (which is not expected case), default executors will be
comment|// chosen. 4 * 20% of noconditional task size will be oversubscribed
name|int
name|chosenSlots
init|=
name|hiveConf
...
argument_list|)
expr_stmt|;
comment|// 2 concurrent sessions, 4 executors. 2 * 20% of noconditional task size will be oversubscribed
name|hiveConf
operator|.
name|unset
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 4 concurrent sessions, 4 executors. 1 * 20% of noconditional task size will be oversubscribed
name|hiveConf
operator|.
name|unset
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 8 concurrent sessions, 4 executors. default noconditioanl task will be used (no oversubscription)
name|hiveConf
operator|.
name|unset
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 2 * 120% of noconditional task size will be oversubscribed
name|hiveConf
operator|.
name|unset
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 0 value for number of sessions
name|hiveConf
operator|.
name|set
argument_list|(
