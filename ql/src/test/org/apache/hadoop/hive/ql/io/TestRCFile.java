...
expr_stmt|;
block|}
comment|/**    * Tests {@link RCFile.Reader#getColumn(int, BytesRefArrayWritable) } method.    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
...
block|{
comment|// #getColumn(2) should return the instance passed in:
name|assertSame
argument_list|(
name|result2
argument_list|,
...
expr_stmt|;
block|}
comment|// each column has height of 2:
name|assertEquals
argument_list|(
literal|2
argument_list|,
...
name|format
argument_list|(
literal|"Sync at offset %d skipped sync block at location %d (returned %d instead)"
argument_list|,
name|i
operator|-
literal|1
