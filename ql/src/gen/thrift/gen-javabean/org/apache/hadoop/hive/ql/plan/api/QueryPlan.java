...
argument_list|,
operator|new
name|QueryPlanStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|QueryPlanTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field queries is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetQueries
parameter_list|()
