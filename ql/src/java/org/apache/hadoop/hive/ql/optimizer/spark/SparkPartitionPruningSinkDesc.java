...
expr_stmt|;
block|}
comment|// Return a combined column name with corresponding target map work ID.
specifier|public
specifier|static
name|String
name|colNameWithTargetId
parameter_list|(
name|MapWork
name|target
parameter_list|,
...
return|;
block|}
comment|// Return the column from a combined column name.
specifier|public
specifier|static
name|String
