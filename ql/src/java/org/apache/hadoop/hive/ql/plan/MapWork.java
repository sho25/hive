...
specifier|private
name|VectorizerReason
name|notEnabledInputFileFormatReason
decl_stmt|;
specifier|private
name|Set
argument_list|<
name|String
argument_list|>
name|vectorizationInputFileFormatClassNameSet
decl_stmt|;
specifier|private
name|List
argument_list|<
...
name|String
argument_list|>
name|vectorizationEnabledConditionsMet
decl_stmt|;
specifier|private
name|List
argument_list|<
name|String
argument_list|>
name|vectorizationEnabledConditionsNotMet
decl_stmt|;
...
specifier|public
name|void
name|setEventSourceColumnTypeMap
parameter_list|(
name|Map
argument_list|<
name|String
...
specifier|public
name|void
name|setNotEnabledInputFileFormatReason
parameter_list|(
name|VectorizerReason
name|notEnabledInputFileFormatReason
parameter_list|)
...
specifier|public
name|VectorizerReason
name|getNotEnabledInputFileFormatReason
parameter_list|()
block|{
return|return
name|notEnabledInputFileFormatReason
...
name|VectorPartitionDesc
argument_list|>
name|getVectorPartitionDescList
parameter_list|()
block|{
return|return
name|vectorPartitionDescList
...
return|;
block|}
comment|/*     // Too many Q out file changes for the moment...     @Explain(vectorization = Vectorization.DETAIL, displayName = "vectorPartitionDescs", explainLevels = { Level.DEFAULT, Level.EXTENDED })     public String vectorPartitionDescs() {       return mapWork.getVectorPartitionDescList().toString();     }     */
annotation|@
name|Explain
argument_list|(
name|vectorization
...
name|displayName
operator|=
literal|"inputFormatFeatureSupport"
argument_list|,
name|explainLevels
operator|=
block|{
...
specifier|public
name|String
name|getVectorizationSupportInUse
parameter_list|()
block|{
name|Set
argument_list|<
...
name|displayName
operator|=
literal|"vectorizationSupportRemovedReasons"
argument_list|,
name|explainLevels
operator|=
block|{
