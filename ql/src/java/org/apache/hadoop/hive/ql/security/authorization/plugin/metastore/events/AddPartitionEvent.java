...
begin_comment
comment|/*  Authorizable Event for HiveMetaStore operation  AddPartition  */
end_comment
...
name|COMMAND_STR
init|=
literal|"alter table %s add partition %s"
decl_stmt|;
specifier|public
name|AddPartitionEvent
parameter_list|(
...
name|debug
argument_list|(
literal|"==> AddPartitionEvent.getOutputHObjs()"
argument_list|)
expr_stmt|;
block|}
name|List
...
name|debug
argument_list|(
literal|"<== AddPartitionEvent.getOutputHObjs(): ret="
operator|+
name|ret
argument_list|)
expr_stmt|;
