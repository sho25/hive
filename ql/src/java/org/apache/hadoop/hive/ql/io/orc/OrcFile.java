...
argument_list|)
expr_stmt|;
name|convertToProlepticGregorian
argument_list|(
literal|true
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Using LLAP memory manager for orc writer. memPerExecutor: {} maxLoad: {} totalMemPool: {}"
argument_list|,
name|LlapUtil
operator|.
...
name|MemoryManager
argument_list|>
name|threadLocalOrcLlapMemoryManager
init|=
literal|null
decl_stmt|;
specifier|private
...
name|MemoryManager
name|getThreadLocalOrcLlapMemoryManager
parameter_list|(
specifier|final
name|Configuration
name|conf
