...
name|Path
argument_list|>
name|encryptedTargetTablePaths
decl_stmt|;
...
block|}
name|void
name|addEncryptedTargetTablePath
parameter_list|(
name|Path
name|p
parameter_list|)
...
expr_stmt|;
block|}
comment|/**    * List of dbName.tblName of encrypted target tables of insert statement    * Used to support Insert ... values(...)    */
name|List
argument_list|<
name|Path
argument_list|>
name|getEncryptedTargetTablePaths
parameter_list|()
block|{
if|if
condition|(
