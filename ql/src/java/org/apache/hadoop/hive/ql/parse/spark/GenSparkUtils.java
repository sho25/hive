...
return|;
block|}
comment|// Create a MapWork for a temporary TableScanOperator
comment|// Basically a thin wrapper on GenMapRedUtils.setTaskPlan.
specifier|public
name|MapWork
name|createMapWork
parameter_list|(
...
argument_list|)
argument_list|,
literal|"AssertionError: the fileSink "
operator|+
name|fileSink
operator|.
name|getName
argument_list|()
operator|+
literal|" should be in the context"
argument_list|)
expr_stmt|;
name|SparkTask
name|currentTask
