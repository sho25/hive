...
argument_list|)
decl_stmt|;
comment|/**    * Parse the input {@link String} command and generate an operator tree.    * @param conf    * @param command    * @throws SemanticException    */
specifier|public
specifier|static
name|Operator
argument_list|<
...
return|;
block|}
comment|/**    * For the input ASTNode tree, perform a semantic analysis and check metadata    * Generate a operator tree and return it.    *    * @param ctx    * @param sem    * @param ast    * @return    * @throws SemanticException    */
specifier|private
specifier|static
name|Operator
argument_list|<
