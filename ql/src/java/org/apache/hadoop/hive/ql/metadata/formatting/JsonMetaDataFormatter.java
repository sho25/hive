...
condition|)
block|{
comment|// End the triggers array.
name|generator
operator|.
name|writeEndArray
argument_list|()
expr_stmt|;
comment|// End the pool object.
name|generator
operator|.
name|writeEndObject
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// triggers array and pool object left to be ended.
block|}
annotation|@
name|Override
specifier|public
...
condition|)
block|{
comment|// end the triggers within pool object.
name|generator
operator|.
name|writeEndArray
argument_list|()
expr_stmt|;
comment|// End the last pool object.
name|generator
operator|.
name|writeEndObject
argument_list|()
