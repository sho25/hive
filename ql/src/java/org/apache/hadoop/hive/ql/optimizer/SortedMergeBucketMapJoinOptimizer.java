...
condition|)
block|{
comment|// currently, a file from a big table can be joined with only 1 file from a small table
for|for
control|(
name|List
argument_list|<
...
return|;
block|}
comment|// require all sort columns are asc, right now only support asc
name|List
argument_list|<
name|String
argument_list|>
