...
block|{
comment|// TODO: colNamesFailedStats is designed to be used for both non
comment|// partitioned& partitioned cols; currently only used for non
comment|// partitioned cols.
name|colNamesFailedStats
operator|.
name|addAll
argument_list|(
...
comment|// TODO: Fix this as part of Partition Pruning
if|if
condition|(
operator|!
name|partColNamesThatRqrStats
...
name|logMsg
init|=
literal|"Could not get stats, number of Partitions for "
operator|+
name|m_hiveTblMetadata
operator|.
name|getCompleteName
