...
decl_stmt|;
comment|/**    * {@link org.apache.hadoop.hive.ql.optimizer.SortedDynPartitionOptimizer}    */
specifier|private
specifier|transient
name|int
name|buckColIdxInKeyForSdpo
init|=
operator|-
literal|1
decl_stmt|;
...
literal|true
expr_stmt|;
comment|// acidOp flag has to be checked to use JAVA hash which works like
comment|// identity function for integers, necessary to read RecordIdentifier
comment|// incase of ACID updates/deletes.
name|boolean
name|acidOp
init|=
name|conf
...
return|;
block|}
comment|/**    * For Acid Update/Delete case, we expect a single partitionEval of the form    * UDFToInteger(ROW__ID) and buckNum == -1 so that the result of this method    * is to return the bucketId extracted from ROW__ID unless it optimized by    * {@link org.apache.hadoop.hive.ql.optimizer.SortedDynPartitionOptimizer}     */
specifier|private
name|int
name|computeHashCode
parameter_list|(
...
condition|)
block|{
comment|// If no partition cols, just distribute the data uniformly
