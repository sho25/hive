...
block|}
block|}
comment|/**    * we don't expect multiple thread to call this method concurrently but {@link #lockMgr} will    * be read by a different threads that one writing it, thus it's {@code volatile}    */
annotation|@
name|Override
specifier|public
