...
argument_list|)
block|;
comment|// do not wait for downstream tasks
specifier|private
specifier|final
name|int
name|trait
...
return|;
block|}
comment|/**    * Returns the null order in the key columns.    *    * @return null, which means default for all key columns, or a String    *         of the same length as key columns, that consists of only "a"    *         (null first) and "z" (null last).    */
annotation|@
name|Explain
argument_list|(
name|displayName
...
name|String
argument_list|>
name|vectorizableReduceSinkNativeEngines
init|=
operator|new
name|LinkedHashSet
argument_list|<
...
specifier|public
class|class
name|ReduceSinkOperatorExplainVectorization
extends|extends
...
parameter_list|)
block|{
comment|// VectorReduceSinkOperator is not native vectorized.
name|super
argument_list|(
name|vectorReduceSinkDesc
argument_list|,
...
condition|)
block|{
comment|// Suppress empty column map.
return|return
literal|null
return|;
block|}
...
argument_list|()
argument_list|,
literal|"BinarySortableSerDe for keys"
argument_list|)
block|,
operator|new
name|VectorizationCondition
...
argument_list|()
argument_list|,
literal|"LazyBinarySerDe for values"
argument_list|)
block|}
decl_stmt|;
if|if
...
literal|false
argument_list|,
literal|"NOT UnexpectedCondition"
argument_list|)
expr_stmt|;
name|conditions
operator|=
...
name|displayName
operator|=
literal|"Reduce Sink Vectorization"
argument_list|,
name|explainLevels
operator|=
block|{
...
specifier|public
name|ReduceSinkOperatorExplainVectorization
name|getReduceSinkVectorization
parameter_list|()
block|{
name|VectorReduceSinkDesc
name|vectorReduceSinkDesc
