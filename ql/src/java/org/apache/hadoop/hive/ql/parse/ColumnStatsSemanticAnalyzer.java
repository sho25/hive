...
condition|)
block|{
comment|//TABLE(VALUES(cast(null as int),cast(null as string))) AS tablename(col1,col2)
name|rewrittenQueryBuilder
operator|.
name|append
argument_list|(
...
block|}
block|}
comment|/**    * @param ast    *          is the original analyze ast    * @param context    *          the column stats auto gather context    * @return    * @throws SemanticException    */
specifier|public
name|ASTNode
name|rewriteAST
parameter_list|(
