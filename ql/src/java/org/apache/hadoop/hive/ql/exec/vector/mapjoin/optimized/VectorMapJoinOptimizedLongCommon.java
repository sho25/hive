...
comment|// LOG.info("VectorMapJoinOptimizedLongCommon serialize key " + key + " hashTableKeyType " + hashTableKeyType.name() + " hex " + Hex.encodeHexString(bytes));
name|serializedBytes
operator|.
name|bytes
operator|=
...
name|hashTableKeyType
expr_stmt|;
comment|// PrimitiveTypeInfo[] primitiveTypeInfos = { TypeInfoFactory.longTypeInfo };
