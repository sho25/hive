...
condition|)
block|{
comment|//Set the number of rows written in case of insert queries, to print in the client(beeline).
name|SparkCounters
name|counters
init|=
name|sparkJobStatus
...
name|format
argument_list|(
literal|"Spark Job[%d] Metrics: "
argument_list|,
name|sparkJobID
argument_list|)
decl_stmt|;
comment|// Task Duration Time
if|if
condition|(
name|sparkStatisticGroup
operator|.
...
expr_stmt|;
block|}
comment|// Bytes Read / Records Read
if|if
condition|(
name|sparkStatisticGroup
operator|.
...
expr_stmt|;
block|}
comment|// Shuffle Read Bytes / Shuffle Read Records
if|if
condition|(
name|sparkStatisticGroup
operator|.
...
expr_stmt|;
block|}
comment|// Shuffle Write Bytes / Shuffle Write Records
if|if
condition|(
name|sparkStatisticGroup
operator|.
