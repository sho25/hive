...
block|}
block|}
comment|// Otherwise, handle like a normal generic UDF.
return|return
name|handleDeterministicUdf
argument_list|(
name|ctx
argument_list|,
name|fd
...
condition|)
block|{
comment|// Handle structs composed of partition columns,
for|for
control|(
name|Object
name|child
...
name|has_part_col
init|=
name|checkForPartColsAndUnknown
argument_list|(
name|fd
argument_list|,
name|nodeOutputs
