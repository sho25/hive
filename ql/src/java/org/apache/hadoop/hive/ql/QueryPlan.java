...
return|;
block|}
comment|/**    * TODO each Task should define a getType() method which will return the values    * instead of this method    * @param task    * @return    */
specifier|private
name|int
name|getStageType
parameter_list|(
...
return|;
block|}
comment|/**    * TODO remove this method. add a getType() method for each operator    * @param op    * @return    */
specifier|private
name|int
