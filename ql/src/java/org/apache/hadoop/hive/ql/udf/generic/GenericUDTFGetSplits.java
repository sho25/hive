...
argument_list|)
decl_stmt|;
comment|// 1. Generate the vertex/submit information.
if|if
condition|(
name|i
operator|==
...
argument_list|)
decl_stmt|;
comment|// 2. Generate input event.
name|SignedMessage
name|eventBytes
init|=
name|makeEventBytes
...
name|IOException
block|{
comment|// We put the query user, not LLAP user, in the message (and the token later?)
name|String
name|user
init|=
name|SessionState
