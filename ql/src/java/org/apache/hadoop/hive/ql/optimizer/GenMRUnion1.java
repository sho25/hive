...
expr_stmt|;
block|}
comment|/**    * Union Operator encountered. A map-only query is encountered at the given    * position. However, atleast of the sub-qeuries is a map-reduce job. Copy the    * information from the current top operator to the union context.    *     * @param ctx    * @param uCtxTask    * @param union    * @param stack    * @throws SemanticException    */
specifier|private
name|void
...
specifier|private
name|void
name|processSubQueryUnionMapJoin
parameter_list|(
name|GenMRProcContext
name|ctx
parameter_list|)
