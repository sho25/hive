...
return|;
block|}
comment|/**    * TODO: Handle 1) cast 2), Windowing Agg Call    */
annotation|@
name|Override
comment|/*    * Handles expr like struct(key,value).key    * Follows same rules as TypeCheckProcFactory::getXpathOrFuncExprNodeDesc()    * which is equivalent version of parsing such an expression from AST    */
specifier|public
name|ExprNodeDesc
...
block|}
block|}
comment|// Try to fold if it is a constant expression
if|if
condition|(
name|foldExpr
operator|&&
...
name|RuntimeException
argument_list|(
literal|"varchar/string/char values must use HiveNlsString for correctness"
argument_list|)
throw|;
block|}
case|case
