...
return|;
block|}
comment|/**    * Get a list of non-hidden column names    * @param max the maximum number of columns to return    * @return a list of non-hidden column names no greater in size than max    */
specifier|public
name|List
argument_list|<
name|String
