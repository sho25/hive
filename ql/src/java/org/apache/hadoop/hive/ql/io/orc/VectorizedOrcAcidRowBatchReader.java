...
block|}
block|}
comment|// Note: totalDeleteEventCount can actually be higher than real value.
comment|//       We assume here it won't be lower. Maybe we should just read and not guess...
if|if
condition|(
name|totalDeleteEventCount
operator|>
