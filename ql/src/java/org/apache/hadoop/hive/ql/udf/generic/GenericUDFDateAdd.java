...
begin_comment
comment|/**  * UDFDateAdd.  *  * Add a number of days to the date. The time part of the string will be  * ignored.  *  * NOTE: This is a subset of what MySQL offers as:  * http://dev.mysql.com/doc/refman  * /5.1/en/date-and-time-functions.html#function_date-add  *  */
end_comment
...
literal|1
decl_stmt|;
comment|// 1 for addition, -1 for subtraction
annotation|@
name|Override
specifier|public
name|ObjectInspector
...
name|UDFArgumentLengthException
argument_list|(
literal|"date_add() requires 2 argument, got "
operator|+
name|arguments
operator|.
name|length
...
name|UDFArgumentException
argument_list|(
literal|" DATE_ADD() only takes STRING/TIMESTAMP/DATEWRITABLE types as first argument, got "
operator|+
name|inputType1
argument_list|)
throw|;
...
name|UDFArgumentException
argument_list|(
literal|" DATE_ADD() only takes TINYINT/SMALLINT/INT types as second argument, got "
operator|+
name|inputType2
argument_list|)
throw|;
...
name|UDFArgumentException
argument_list|(
literal|"DATE_ADD() only takes STRING/TIMESTAMP/DATEWRITABLE types, got "
operator|+
name|inputType1
argument_list|)
throw|;
