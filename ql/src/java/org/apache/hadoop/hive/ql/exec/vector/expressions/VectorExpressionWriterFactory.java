...
name|HiveException
block|{
comment|// We should never reach this, the compile validation should guard us
throw|throw
operator|new
name|HiveException
argument_list|(
literal|"DECIMAL primitive type not supported in vectorization."
argument_list|)
throw|;
block|}
specifier|private
...
name|HiveException
argument_list|(
literal|"DATE primitive type not supported in vectorization."
argument_list|)
throw|;
block|}
specifier|private
