...
parameter_list|()
block|{   }
comment|/**    * Used to create a virtual view descriptor.    * @param viewName    * @param schema    * @param comment    * @param tblProps    * @param partColNames    * @param ifNotExists    * @param orReplace    * @param isAlterViewAs    */
specifier|public
name|CreateViewDesc
parameter_list|(
name|String
...
expr_stmt|;
block|}
comment|/**    * Used to create a materialized view descriptor    * @param viewName    * @param schema    * @param comment    * @param tblProps    * @param partColNames    * @param ifNotExists    * @param orReplace    * @param isAlterViewAs    * @param inputFormat    * @param outputFormat    * @param serde    */
specifier|public
name|CreateViewDesc
parameter_list|(
name|String
