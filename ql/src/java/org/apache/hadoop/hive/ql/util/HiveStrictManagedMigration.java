...
name|withDescription
argument_list|(
literal|"Whether tables living in the old warehouse path should have their data moved to the"
operator|+
literal|" default external location. Applicable only if migrationOption = external"
argument_list|)
operator|.
name|create
argument_list|()
...
argument_list|(
literal|"Please select external as migration option, it is required for "
operator|+
literal|"shouldMoveExternal option."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Options shouldModifyManagedTableLocation and "
operator|+
literal|"shouldMoveExternal cannot be used at the same time. Migration with move option on "
operator|+
literal|" managed tables either ends up with them remaining managed or converted to external, but can't be both."
argument_list|)
throw|;
block|}
name|boolean
...
name|info
argument_list|(
literal|"External warehouse path not specified/empty. Disabling shouldMoveExternal"
argument_list|)
expr_stmt|;
name|shouldMoveExternal
operator|=
...
name|info
argument_list|(
literal|"oldWarehouseRoot is not specified. Disabling shouldModifyManagedTableLocation and "
operator|+
literal|"shouldMoveExternal"
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"oldWarehouseRoot is the same as the target path {}."
operator|+
literal|" Disabling shouldModifyManagedTableLocation and shouldMoveExternal"
argument_list|,
name|runOptions
operator|.
name|oldWarehouseRoot
...
name|info
argument_list|(
literal|"oldWarehouseRoot {} has a different FS than the target path {}."
operator|+
literal|" Disabling shouldModifyManagedTableLocation and shouldMoveExternal"
argument_list|,
name|runOptions
...
name|info
argument_list|(
literal|"Warehouse is using non-HDFS FileSystem {}. Disabling shouldModifyManagedTableLocation and"
operator|+
literal|"shouldMoveExternal"
argument_list|,
name|oldWhRootFs
...
name|info
argument_list|(
literal|"oldWarehouseRoot {} and target path {} have different encryption zones."
operator|+
literal|" Disabling shouldModifyManagedTableLocation and shouldMoveExternal"
argument_list|,
name|oldWhRootPath
...
condition|(
operator|!
name|hasEquivalentErasureCodingPolicy
argument_list|(
name|ecShim
argument_list|,
name|oldWhRootPath
...
name|info
argument_list|(
literal|"oldWarehouseRoot {} and target path {} have different erasure coding policies."
operator|+
literal|" Disabling shouldModifyManagedTableLocation and shouldMoveExternal"
argument_list|,
name|oldWhRootPath
...
init|=
name|getDefaultDbPathManagedOrExternal
argument_list|(
name|dbName
argument_list|)
decl_stmt|;
...
name|info
argument_list|(
literal|"{} and {} have different EC policies. Will not change database location for {}"
argument_list|,
name|oldDefaultDbLocation
argument_list|,
name|targetPath
...
name|info
argument_list|(
literal|"{} and {} have different EC policies. Will not change table location for {}"
argument_list|,
name|oldDefaultTableLocation
argument_list|,
name|targetPath
...
condition|)
block|{
comment|// No need to check encryption zone and EC policy. Data was moved already along with the whole table.
return|return
literal|true
return|;
block|}
