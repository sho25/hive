...
condition|)
block|{
comment|// Make sure all the partitions have same bucket count.
name|PrunedPartitionList
name|prunedPartList
init|=
name|PartitionPruner
...
argument_list|)
decl_stmt|;
comment|// Fetch the bucketing version from table scan operator
name|int
...
parameter_list|)
block|{
comment|// This is a bit hackish to fix mismatch between SARG and Hive types
comment|// for Timestamp and Date. TODO: Move those types to storage-api.
if|if
condition|(
name|o
operator|instanceof
