...
argument_list|)
expr_stmt|;
name|checkPartitionDirsSingleThreaded
argument_list|(
name|basePaths
argument_list|,
name|allDirs
...
argument_list|)
expr_stmt|;
name|checkPartitionDirsInParallel
argument_list|(
operator|(
name|ThreadPoolExecutor
operator|)
...
block|}
block|}
comment|/*    * Original recursive implementation works well for single threaded use-case but has limitations    * if we attempt to parallelize this directly    */
specifier|private
name|void
name|checkPartitionDirsSingleThreaded
parameter_list|(
