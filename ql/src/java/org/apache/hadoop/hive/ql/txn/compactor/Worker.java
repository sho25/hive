...
argument_list|)
expr_stmt|;
comment|// Don't start compaction or cleaning if not necessary
name|AcidUtils
operator|.
name|Directory
name|dir
...
name|error
argument_list|(
literal|"Caught an exception while trying to mark compaction {} as failed: {}"
argument_list|,
name|ci
argument_list|,
name|e
...
name|error
argument_list|(
literal|"Caught an exception while committing compaction in worker "
operator|+
name|workerName
operator|+
literal|", "
