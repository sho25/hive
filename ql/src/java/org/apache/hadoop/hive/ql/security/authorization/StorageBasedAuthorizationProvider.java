...
name|info
argument_list|(
literal|"user {} has host proxy privilege."
argument_list|,
name|user
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// if can not decide on the proxy privilege status, then proceed with authorization check.
name|LOG
operator|.
name|warn
argument_list|(
literal|"Cannot obtain username to check for host proxy privilege"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Path authorization is skipped for path {}."
argument_list|,
name|path
argument_list|)
expr_stmt|;
