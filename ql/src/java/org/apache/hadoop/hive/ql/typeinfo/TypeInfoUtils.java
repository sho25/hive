...
specifier|static
name|String
name|getFieldSchemaTypeFromTypeInfo
parameter_list|(
name|TypeInfo
name|typeInfo
parameter_list|)
...
name|RuntimeException
argument_list|(
literal|"Complex struct type not supported!"
argument_list|)
throw|;
block|}
default|default:
...
return|;
block|}
comment|/**    * The mapping from type name in DDL to the Java class.     */
specifier|public
specifier|static
specifier|final
name|Map
...
argument_list|)
expr_stmt|;
comment|// These types are not supported yet.
comment|// TypeNameToClass.put(Constants.DATETIME_TYPE_NAME);
comment|// TypeNameToClass.put(Constants.TIMESTAMP_TYPE_NAME);
block|}
comment|/**    * Return the primitive type corresponding to the field schema    * @param field The field schema    * @return The TypeInfo object, or null if the field is not a primitive type.    */
specifier|public
specifier|static
name|TypeInfo
name|getPrimitiveTypeInfoFromFieldSchema
parameter_list|(
name|FieldSchema
name|field
parameter_list|)
