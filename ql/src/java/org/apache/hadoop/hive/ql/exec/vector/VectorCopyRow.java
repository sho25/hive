...
parameter_list|)
block|{
comment|// FUTURE: Figure out how to avoid this runtime checking by working out
comment|// DECIMAL_64 to DECIMAL and DECIMAL_64 to DECIMAL_64 up front...
name|ColumnVector
name|inColVectorBase
init|=
name|inBatch
operator|.
name|cols
