...
parameter_list|,
name|int
name|sourceColumnNum
parameter_list|,
name|VectorizedRowBatch
name|targetBatch
parameter_list|,
name|int
name|targetColumnNum
parameter_list|,
name|int
name|size
parameter_list|)
...
condition|)
block|{
comment|// No isNull copying necessary.
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|// Clear out isNull array.
name|targetColVector
operator|.
name|reset
argument_list|()
...
expr_stmt|;
block|}
comment|// Primitive column types ignore nulls and just copy all values.
switch|switch
condition|(
name|sourceColVector
operator|.
...
name|isNull
decl_stmt|;
comment|// Target isNull was copied at beginning of method.
for|for
control|(
name|int
name|i
...
block|{
name|IntervalDayTimeColumnVector
name|sourceIntervalDayTimeColVector
init|=
operator|(
operator|(
name|IntervalDayTimeColumnVector
...
decl_stmt|;
name|IntervalDayTimeColumnVector
name|targetIntervalDayTimeColVector
init|=
operator|(
operator|(
name|IntervalDayTimeColumnVector
