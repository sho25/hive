...
specifier|final
name|int
name|DEFAULT_TINYINT_PRECISION
init|=
literal|3
decl_stmt|;
specifier|private
...
specifier|final
name|int
name|DEFAULT_SMALLINT_PRECISION
init|=
literal|5
decl_stmt|;
specifier|private
...
specifier|final
name|int
name|DEFAULT_INTEGER_PRECISION
init|=
literal|10
decl_stmt|;
specifier|private
...
name|DECIMAL
case|:
comment|// In Hive, SUM aggregate on decimal column will add 10 to compute
comment|// the output precision; see
comment|// GenericUDAFSum.GenericUDAFSumHiveDecimal#getOutputDecimalTypeInfoForSum
return|return
name|typeFactory
operator|.
name|createSqlType
