...
return|;
block|}
comment|/**    * Get fully qualified column name from output key column names and column expression map    * @param keyExprs    *          - output key names    * @param map    *          - column expression map    * @return list of fully qualified names    */
specifier|public
specifier|static
name|List
argument_list|<
...
argument_list|)
decl_stmt|;
comment|// if we couldn't get expression try prepending "KEY." prefix to reducer key column names
if|if
condition|(
name|end
operator|==
