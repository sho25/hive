...
block|}
block|}
comment|// if basic stats are not available then return
if|if
condition|(
name|nr
operator|<=
...
return|;
block|}
comment|// if any basic stats is missing, mark it as partial stats
if|if
condition|(
name|nr
operator|<=
...
expr_stmt|;
block|}
comment|// if both are available then we have complete basic stats
if|if
condition|(
name|nr
operator|>
