...
argument_list|()
decl_stmt|;
comment|/**    * Common initialization code for RecordProcessors    * @param jconf    * @param processorContext the {@link TezProcessorContext}    * @param mrReporter    * @param inputs map of Input names to {@link LogicalInput}s    * @param outputs map of Output names to {@link LogicalOutput}s    * @throws Exception    */
name|void
name|init
parameter_list|(
name|JobConf
