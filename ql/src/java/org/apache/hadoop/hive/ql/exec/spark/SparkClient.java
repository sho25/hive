...
argument_list|)
decl_stmt|;
comment|// An action may trigger multi jobs in Spark, we only monitor the latest job here
comment|// until we found that Hive does trigger multi jobs.
name|List
argument_list|<
name|Integer
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// jobIds size is always bigger than or equal with 1.
name|int
name|jobId
init|=
name|jobIds
