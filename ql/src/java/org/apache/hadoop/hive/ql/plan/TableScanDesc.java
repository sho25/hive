...
name|String
argument_list|>
name|getOpPropsWithStorageHandlerProps
parameter_list|()
block|{
name|HiveStorageHandler
name|storageHandler
...
name|displayName
operator|=
literal|"vectorizationSchemaColumns"
argument_list|,
name|explainLevels
operator|=
block|{
...
argument_list|()
decl_stmt|;
comment|// We currently include all data, partition, and any vectorization available
comment|// virtual columns in the VRB.
specifier|final
name|int
name|size
init|=
...
name|DataTypePhysicalVariation
index|[]
name|projectedColumnDataTypePhysicalVariations
init|=
name|vectorTableScanDesc
operator|.
