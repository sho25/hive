...
name|foldedFromCol
decl_stmt|;
comment|// If this constant was created while doing constant folding, foldedFromTab holds the name of
comment|// the original tabAlias from which it was folded.
specifier|private
specifier|transient
name|String
name|foldedFromTab
...
annotation|@
name|Override
comment|/**    * Return string representation of constant expression    * Beside ExplainPlan task Default constraint also make use it to deserialize constant expression    * to store it in metastore, which is later reparsed to generate appropriate constant expression    * Therefore it is necessary for this method to qualify the intervals with appropriate qualifiers    */
specifier|public
name|String
name|getExprString
parameter_list|()
