...
return|;
block|}
comment|/**    * Get top level select starting from root. Assumption here is root can only    * be SortRel& ProjectRel. Also the top project should be at most 2 levels    * below Sortrel; i.e SortRel(Limit)-SortRel(OB)-Select    *    * @param rootRel    * @return    */
specifier|public
specifier|static
name|Pair
argument_list|<
