...
specifier|transient
name|StructObjectInspector
name|tblRowObjectInspector
decl_stmt|;
comment|// convert from partition to table schema
specifier|private
specifier|transient
name|Converter
...
specifier|public
name|StructObjectInspector
name|getTblRawRowObjectInspector
parameter_list|()
block|{
return|return
name|tblRawRowObjectInspector
...
return|;
block|}
comment|/**      * @return the rowWithPartAndVC      */
specifier|public
name|Object
index|[]
name|getRowWithPartAndVC
parameter_list|()
block|{
return|return
name|rowWithPartAndVC
...
specifier|public
name|Converter
name|getPartTblObjectInspectorConverter
parameter_list|()
block|{
return|return
name|partTblObjectInspectorConverter
...
return|;
block|}
comment|/**    * Set the inspectors given a input. Since a mapper can span multiple partitions, the inspectors    * need to be changed if the input changes    **/
specifier|private
name|void
name|setInspectorInput
parameter_list|(
name|MapInputPath
name|inp
parameter_list|)
...
comment|// In that case, it will be a Select, but the rowOI need not be ammended
if|if
condition|(
name|op
operator|instanceof
...
argument_list|()
decl_stmt|;
comment|// If the partition does not exist, use table properties
name|Properties
name|partProps
init|=
operator|(
...
block|}
block|}
comment|// Change the serializer etc. since it is a new file, and split can span
comment|// multiple files/partitions.
annotation|@
name|Override
specifier|public
name|void
