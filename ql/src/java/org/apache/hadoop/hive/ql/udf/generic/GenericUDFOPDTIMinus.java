...
name|OperationType
block|{
name|INTERVALYM_MINUS_INTERVALYM
block|,
name|DATE_MINUS_INTERVALYM
block|,
name|TIMESTAMP_MINUS_INTERVALYM
block|,
name|INTERVALDT_MINUS_INTERVALDT
block|,
name|TIMESTAMP_MINUS_INTERVALDT
block|,
name|TIMESTAMP_MINUS_TIMESTAMP
block|,
name|DATE_MINUS_INT
block|}
empty_stmt|;
...
comment|// Date - IntervalYearMonth = Date (operands not reversible)
comment|// Timestamp - IntervalYearMonth = Timestamp (operands not reversible)
comment|// IntervalDayTime - IntervalDayTime = IntervalDayTime
comment|// Date - IntervalYearMonth = Timestamp (operands not reversible)
comment|// Timestamp - IntervalYearMonth = Timestamp (operands not reversible)
comment|// Timestamp - Timestamp = IntervalDayTime
comment|// Date - Date = IntervalDayTime
comment|// Timestamp - Date = IntervalDayTime (operands reversible)
...
condition|)
block|{
comment|// Operands converted to timestamp, result as interval day-time
name|minusOpType
operator|=
name|OperationType
operator|.
