...
return|;
block|}
comment|// TODO support only non nested case
specifier|private
name|PrimitiveType
name|getElementType
parameter_list|(
...
name|RuntimeException
argument_list|(
literal|"Current Parquet Vectorization reader doesn't support nested type"
argument_list|)
throw|;
block|}
return|return
...
block|{
comment|// Support for schema evolution
return|return
operator|new
