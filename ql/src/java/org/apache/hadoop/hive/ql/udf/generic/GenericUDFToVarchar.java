...
name|converter
decl_stmt|;
comment|// The varchar type parameters need to be set prior to initialization,
...
name|warn
argument_list|(
literal|"Type converter already initialized, setting type params now will not be useful"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|UDFArgumentException
argument_list|(
literal|"Was expecting VarcharTypeParams, instead got "
operator|+
name|typeParams
operator|.
name|getClass
