...
decl_stmt|;
comment|// remember the event operators we've seen
specifier|public
specifier|final
name|Set
argument_list|<
...
decl_stmt|;
comment|// remember the event operators we've abandoned.
specifier|public
specifier|final
name|Set
argument_list|<
...
decl_stmt|;
comment|// remember the connections between ts and event
specifier|public
specifier|final
name|Map
argument_list|<
