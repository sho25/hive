...
return|;
block|}
comment|/**    * Test if the storage handler allows the push-down of join filter predicate to prune further the splits.    *    * @param syntheticFilterPredicate Join filter predicate.    * @return true if supports dynamic split pruning for the given predicate.    */
specifier|default
name|boolean
name|addDynamicSplitPruningEdge
parameter_list|(
name|ExprNodeDesc
name|syntheticFilterPredicate
parameter_list|)
block|{
return|return
literal|false
return|;
block|}
comment|/**    * Used to add additional operator specific information from storage handler during DESCRIBE EXTENDED statement.    *    * @param operatorDesc operatorDesc    * @param initialProps Map containing initial operator properties    * @return Map<String, String> containing additional operator specific information from storage handler    * OR `initialProps` if the storage handler choose to not provide any such information.    */
specifier|default
name|Map
argument_list|<
name|String
...
name|String
argument_list|>
name|getOperatorDescProperties
parameter_list|(
name|OperatorDesc
name|operatorDesc
parameter_list|,
