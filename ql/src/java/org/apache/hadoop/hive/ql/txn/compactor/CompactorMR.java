...
argument_list|()
decl_stmt|;
comment|// For non-bucketed tables we might not have a 00000x_0 in all the delta dirs e.g. after
comment|// multiple ingestions of various sizes.
name|Path
index|[]
name|deltasForSplit
init|=
...
name|getDeltaDirsFromBucketTracker
argument_list|(
name|bt
argument_list|)
decl_stmt|;
