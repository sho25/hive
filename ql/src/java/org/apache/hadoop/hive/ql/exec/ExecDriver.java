...
name|info
argument_list|(
literal|"=========Adding files to distributed cache================"
argument_list|)
expr_stmt|;
name|FileStatus
index|[]
name|jdbmRemoteFiles
init|=
name|hdfs
operator|.
name|listStatus
...
name|info
argument_list|(
literal|"add 1 jdbm file to distributed cache: "
operator|+
name|path
operator|.
name|toUri
...
name|info
argument_list|(
literal|"===========Finishing adding files to distributed cache=========="
argument_list|)
expr_stmt|;
block|}
block|}
