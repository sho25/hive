...
name|p
decl_stmt|;
comment|/**    * This is derived from t and p, but we need to serialize this field to make sure    * ReadEntity.hashCode() does not need to recursively read into t and p.     */
specifier|private
name|String
name|name
decl_stmt|;
