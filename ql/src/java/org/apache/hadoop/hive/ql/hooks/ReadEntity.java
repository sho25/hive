...
argument_list|()
decl_stmt|;
comment|// The accessed columns of query
specifier|private
specifier|final
name|List
argument_list|<
...
expr_stmt|;
block|}
comment|/**    * Constructor for objects represented as String. Currently applicable only    * for function names.    *    * @param db    * @param objName    * @param className    * @param type    */
specifier|public
name|ReadEntity
parameter_list|(
name|Database
