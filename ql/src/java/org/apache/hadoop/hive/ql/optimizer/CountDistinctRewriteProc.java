...
literal|1
decl_stmt|;
comment|// Check if we can process it or not
specifier|protected
name|boolean
...
operator|)
decl_stmt|;
comment|// VC is still here and it will be pruned by column pruner
comment|// boolean noVCneeded = (desc == null) || (desc.getVirtualCols() == null)
comment|// || (desc.getVirtualCols().isEmpty());
name|boolean
name|isSkipHF
init|=
name|desc
...
argument_list|)
expr_stmt|;
comment|// KEY._col0:0._col0 => KEY._col0
for|for
control|(
name|int
name|i
