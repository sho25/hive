...
argument_list|()
decl_stmt|;
comment|// Data structure to control whether a certain reference is present in every operand
name|Set
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|// If we did not add any factor or there are no common factors, we can bail out
if|if
condition|(
name|refsInAllOperands
operator|.
