...
try|try
block|{
comment|// TODO try to make this still work after integration with remote spark context, so that we
comment|// don't break test, we should implement automatic calculate reduce number for remote spark
comment|// client and refactor code later, track it with HIVE-8855.
name|HiveSparkClient
name|sparkClient
init|=
name|HiveSparkClientFactory
