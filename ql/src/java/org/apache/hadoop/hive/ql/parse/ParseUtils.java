...
literal|null
decl_stmt|;
comment|// If TypeInfo is parameterized, provide the params to the UDF factory method.
name|typeParams
operator|=
name|tableFieldTypeInfo
operator|.
...
name|VARCHAR
case|:
comment|// Nothing to do here - the parameter will be passed to the UDF factory method below
break|break;
default|default:
throw|throw
operator|new
...
argument_list|()
operator|+
literal|" does not take type parameters"
argument_list|)
throw|;
block|}
block|}
