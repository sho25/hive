...
block|}
block|}
comment|/**    * Append list of partition columns to Insert statement, i.e. the 2nd set of partCol1,partCol2    * INSERT INTO T PARTITION(partCol1,partCol2...) SELECT col1, ... partCol1,partCol2...    * @param targetName simple target table name (i.e. name or alias)    */
specifier|private
name|void
...
condition|)
block|{
comment|//todo: there are bugs here: https://issues.apache.org/jira/browse/HIVE-15048
...
literal|1
operator|:
literal|"expected 1 WriteEntity. Got "
operator|+
name|outputs
assert|;
comment|//this asserts comment above
name|WriteEntity
name|original
init|=
literal|null
...
return|;
block|}
comment|//todo: see SubQueryDiagnostic for some ideas on turning ASTNode into SQL
comment|//todo: should we add MERGE to AcidUtils.Operation instead?  that will be a lot of code clean up
specifier|private
enum|enum
name|Operation
block|{
...
block|{
comment|//todo: is this the right way to get<table>.<colum> for target?
name|rewrittenQueryStr
operator|.
name|append
argument_list|(
