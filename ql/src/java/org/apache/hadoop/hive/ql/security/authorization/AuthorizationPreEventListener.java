...
case|:
name|authorizeAuthorizationAPICall
argument_list|()
expr_stmt|;
default|default:
break|break;
...
specifier|private
name|void
name|authorizeDropMultiPartition
parameter_list|(
...
name|error
argument_list|(
literal|"Could not construct partition-object for: "
operator|+
name|partition
argument_list|,
name|exception
...
condition|)
block|{
comment|// Authorize all dropped-partitions in one shot.
name|authorizeDropMultiPartition
argument_list|(
operator|(
name|HiveMultiPartitionAuthorizationProviderBase
...
block|{
comment|// Authorize individually.
name|TableWrapper
name|table
init|=
operator|new
