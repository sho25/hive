...
condition|)
block|{
comment|// FIXME: I don't think there is a need for this right now...calcite have already done the flattening/etc
comment|// removing this case clause will not miss the OR below AND
case|case
name|AND
case|:
name|ImmutableList
