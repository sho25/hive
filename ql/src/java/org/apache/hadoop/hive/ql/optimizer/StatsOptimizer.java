...
block|}
block|}
comment|// cselOpTocgbyOp may be 0 to 1, where the 0th position of cgbyOp is '1' and 1st position of cgbyOp is count('1')
comment|// Thus, we need to adjust it to the correct position.
name|List
argument_list|<
name|Entry
argument_list|<
