...
begin_comment
comment|/*  * Specialized class for doing a vectorized map join that is an inner join on a Single-Column Long  * using a hash map.  */
end_comment
...
block|}
comment|//---------------------------------------------------------------------------
comment|// Process Single-Column Long Inner Join on a vectorized row batch.
comment|//
annotation|@
name|Override
specifier|public
