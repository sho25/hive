...
decl_stmt|;
block|}
comment|/**    * Returns the UDAFInfo struct for the aggregation    * @param aggName  The name of the UDAF.    * @param mode     The mode of the aggregation. This affects the evaluate method.    * @param aggClasses  The classes of the parameters to the UDAF.     * @param aggParameters  The actual exprNodeDesc of the parameters.    * @param aggTree   The ASTNode node of the UDAF in the query.    * @return UDAFInfo    * @throws SemanticException when the UDAF is not found or has problems.    */
name|UDAFInfo
name|getUDAFInfo
parameter_list|(
name|String
...
name|aggName
operator|+
literal|"\" does not have evaluate()/evaluatePartial() methods."
decl_stmt|;
throw|throw
operator|new
name|SemanticException
...
name|add
argument_list|(
name|genExprNodeDescFromColRef
argument_list|(
name|cl
argument_list|,
name|inputRR
...
argument_list|)
expr_stmt|;
comment|// reduce sink does not have any kids
...
return|;
block|}
comment|/**    * Generates expression node from a TOK_COLREF AST Node    * @param expr Antrl node    * @param input row resolver for this col reference    * @return exprNodeDesc or null if ASTNode is not a TOK_COLREF    * @throws SemanticException    */
specifier|private
name|exprNodeDesc
name|genExprNodeDescFromColRef
parameter_list|(
