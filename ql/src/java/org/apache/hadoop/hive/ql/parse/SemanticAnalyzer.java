...
specifier|final
name|String
name|GROUPING_SET_KEY
init|=
literal|"GROUPING_SET_KEY"
decl_stmt|;
specifier|private
specifier|static
class|class
...
argument_list|)
decl_stmt|;
comment|// Nothing special needs to be done for grouping sets.
comment|// This is the final group by operator, so multiple rows corresponding to the
...
return|;
block|}
comment|/**    * Handle skewed values in DDL.    *    * It can be used by both skewed by ... on () and set skewed location ().    *    * @param skewedValues    * @param vNode    * @throws SemanticException    */
specifier|private
name|void
name|analyzeDDLSkewedValues
parameter_list|(
