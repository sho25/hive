...
return|;
block|}
comment|/**    * Write formatted information about the given columns, including partition    * columns to a string    * @param cols - list of columns    * @param partCols - list of partition columns    * @param printHeader - if header should be included    * @param isOutputPadded - make it more human readable by setting indentation    *        with spaces. Turned off for use by HiveServer2    * @param showParColsSep - show partition column separator    * @return string with formatted column information    */
specifier|public
specifier|static
name|String
name|getAllColumnsInformation
