...
argument_list|()
decl_stmt|;
comment|// this might bad in a skewed case; consider:
comment|// 1 row with 1000 long string
comment|// 99 rows with 0 length
comment|// orig avg is 10
comment|// new avg is 5 (if substr(5)) ; but in reality it will stay ~10
name|Optional
argument_list|<
name|Double
argument_list|>
