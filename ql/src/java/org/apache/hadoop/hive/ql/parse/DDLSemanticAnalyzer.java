...
argument_list|)
expr_stmt|;
comment|// This special handling is because we cannot generate write ID for full ACID conversion,
comment|// it will break the weird 10000001-write-ID logic that is currently in use. However, we do
comment|// want to generate a write ID for prop changes for existing txn tables, or MM conversion.
name|boolean
