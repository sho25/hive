...
name|SemanticException
argument_list|(
literal|"Invalid token in CREATE RESOURCE PLAN statement"
argument_list|)
throw|;
block|}
name|CreateResourcePlanDesc
...
name|SemanticException
argument_list|(
literal|"Invalid ALTER ACTIVATE command"
argument_list|)
throw|;
block|}
break|break;
...
name|SemanticException
argument_list|(
literal|"Invalid ALTER ENABLE command"
argument_list|)
throw|;
block|}
break|break;
...
name|SemanticException
argument_list|(
literal|"Invalid ALTER DISABLE command"
argument_list|)
throw|;
block|}
name|desc
...
name|SemanticException
argument_list|(
literal|"Expected number for query parallelism in alter resource plan statment"
argument_list|)
throw|;
block|}
name|int
...
name|SemanticException
argument_list|(
literal|"Expected new name for rename in alter resource plan statment"
argument_list|)
throw|;
block|}
name|String
...
try|try
block|{
comment|// To make sure host/port pair is valid, the status of the location
...
parameter_list|)
block|{
comment|// Only check host/port pair is valid, wheter the file exist or not does not matter
block|}
catch|catch
parameter_list|(
name|Exception
...
throw|;
block|}
comment|// transactional tables are compacted and no longer needs to be bucketed, so not safe for merge/concatenation
name|boolean
name|isAcid
init|=
name|AcidUtils
