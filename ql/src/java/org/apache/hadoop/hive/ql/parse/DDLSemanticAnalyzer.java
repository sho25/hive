...
block|{
comment|// tab is not a View or Link.
if|if
condition|(
name|expectView
operator|||
...
return|;
block|}
comment|/**    * Get the fully qualified name in the ast by concatenating the nodes of the binary tree    * in an inorder traversal order. e.g. the ast of the form ^(DOT    * ^(AT a b) c) will generate a name of the form a@b.c    *    * @param ast    *          The root node of the binary tree    * @return String    */
specifier|private
name|String
