...
condition|)
block|{
name|analyzeAlterTableAlterPartsProtectMode
argument_list|(
name|ast
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Alter protect mode of a table or partition    *    * @param ast    *          The parsed command tree.    * @throws SemanticException    *           Parsin failed    */
specifier|private
name|void
name|analyzeAlterTableAlterPartsProtectMode
parameter_list|(
