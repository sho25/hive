...
return|;
block|}
comment|/**    * Get the partition specs from the tree. This stores the full specification    * with the comparator operator into the output list.    *    * @param ast    *          Tree to extract partitions from.    * @throws SemanticException    */
specifier|private
name|void
name|getFullPartitionSpecs
parameter_list|(
