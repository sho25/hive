...
name|info
argument_list|(
literal|"Repl Dump: Completed analyzing Repl Dump for DB: {} and created {} COPY tasks to dump "
operator|+
literal|"metadata and data"
argument_list|,
name|dbName
argument_list|,
name|rootTasks
...
name|info
argument_list|(
literal|"Repl Dump: Analyzed dump for table/view: {}.{} and created copy tasks to dump metadata "
operator|+
literal|"and data to path {}"
argument_list|,
name|dbName
argument_list|,
name|tblName
...
return|;
block|}
comment|// Use for replication states focused on event only, where the obj state will be the event state
specifier|private
name|ReplicationSpec
name|getNewEventOnlyReplicationSpec
parameter_list|(
