...
block|}
block|}
comment|/**    * The reader who reads from the underlying decimal value which is stored in an INT32 physical type.    *    * The data is read as INT32 from the reader treated as a decimal, then validated, converted    * and returned as per the type defined in HMS.    */
specifier|public
specifier|static
class|class
name|TypesFromInt32DecimalPageReader
extends|extends
name|DefaultParquetDataColumnReader
block|{
specifier|private
...
block|}
block|}
comment|/**    * The reader who reads from the underlying decimal value which is stored in an INT64 physical type.    *    * The data is read as INT64 from the reader treated as a decimal, then validated, converted    * and returned as per the type defined in HMS.    */
specifier|public
specifier|static
class|class
name|TypesFromInt64DecimalPageReader
extends|extends
name|DefaultParquetDataColumnReader
block|{
specifier|private
