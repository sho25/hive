...
literal|null
decl_stmt|;
comment|/**    * When {@link #setCurrentTxn(long)} is set to this or {@link #getCurrentTxn()}} returns this it    * indicates that there is not a current transaction in this session.   */
specifier|public
specifier|static
specifier|final
name|long
...
literal|1L
decl_stmt|;
comment|/**    * Transaction currently open    */
specifier|private
name|long
name|currentTxn
init|=
...
argument_list|,
literal|"org.apache.hadoop.hive.ql.security.authorization.plugin.AuthorizationMetaStoreFilterHook"
argument_list|)
expr_stmt|;
name|authorizerV2
operator|.
...
return|;
block|}
comment|/**    * If authorization mode is v2, then pass it through authorizer so that it can apply    * any security configuration changes.    * @throws MetaException    */
specifier|public
name|void
