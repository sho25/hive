...
specifier|final
name|String
name|QUERY_EXEC_SUMMARY_HEADER
init|=
...
specifier|final
name|String
name|FS_COUNTERS_SUMMARY_HEADER
init|=
...
init|=
literal|"%10s %14s %13s %12s %14s %15s"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
argument_list|)
decl_stmt|;
comment|// used when I/O redirection is used
specifier|private
specifier|static
specifier|final
name|String
name|FILE_HEADER_FORMAT
init|=
...
argument_list|)
decl_stmt|;
comment|// FileSystem counters
specifier|private
specifier|static
specifier|final
name|String
name|FS_COUNTERS_HEADER_FORMAT
init|=
...
block|}
block|}
comment|/**    * monitorExecution handles status printing, failures during execution and final status retrieval.    *    * @param dagClient client that was used to kick off the job    * @param conf configuration file for this operation    * @return int 0 - success, 1 - killed, 2 - failed    */
specifier|public
name|int
...
argument_list|)
expr_stmt|;
name|printQueryExecutionBreakDown
argument_list|()
expr_stmt|;
name|console
operator|.
