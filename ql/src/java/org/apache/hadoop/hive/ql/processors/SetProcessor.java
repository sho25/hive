...
specifier|final
name|Pattern
name|TIME_ZONE_PATTERN
init|=
name|Pattern
operator|.
name|compile
argument_list|(
literal|"^time(\\s)+zone\\s"
argument_list|,
name|Pattern
operator|.
...
block|}
block|}
comment|/*    * Checks if the value contains any of the PASSWORD_STRINGS and if yes    * return true    */
specifier|private
name|boolean
name|isHidden
parameter_list|(
...
return|;
block|}
comment|// Special handling for time-zone
name|Matcher
name|matcher
init|=
name|TIME_ZONE_PATTERN
