...
name|parentTasks
decl_stmt|;
comment|/**    * this can be set by the Task, to provide more info about the failure in TaskResult    * where the Driver can find it.  This is checked if {@link Task#execute(org.apache.hadoop.hive.ql.TaskQueue)}    * returns non-0 code.    */
specifier|private
name|Throwable
name|exception
decl_stmt|;
...
name|debug
argument_list|(
literal|"Task getting executed using mapred tag : "
operator|+
name|conf
operator|.
name|get
