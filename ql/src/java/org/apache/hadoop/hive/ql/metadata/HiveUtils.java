...
name|plugin
operator|.
name|DefaultHiveAuthorizerFactory
import|;
end_import
...
return|;
block|}
comment|/**    * Create a new instance of HiveAuthorizationProvider    * @param conf    * @param authorizationProviderConfKey    * @param authenticator    * @param nullIfOtherClass - return null if configuration    *  does not point to a HiveAuthorizationProvider subclass    * @return new instance of HiveAuthorizationProvider    * @throws HiveException    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
