...
block|{
comment|/**      * @param op         consists of EQUALS, NULL_SAFE_EQUALS, LESS_THAN, LESS_THAN_EQUALS, IS_NULL      * @param literal      * @param columnName      * @param columnType      * @return      */
annotation|@
name|Override
specifier|public
name|FilterPredicate
...
name|Exception
block|{
comment|// For CHAR types, the trailing spaces should be removed before adding the
comment|// value to the predicate. This change is needed because for CHAR types,
comment|// Hive passes a padded value to the predicate, but since the value
comment|// is stored in Parquet without padding, no result would be returned.
comment|// For more details about this issue, please refer to HIVE-21407.
name|String
name|value
init|=
literal|null
