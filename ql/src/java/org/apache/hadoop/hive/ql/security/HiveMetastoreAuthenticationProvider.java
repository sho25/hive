...
block|{
comment|/**    * Allows invoker of HiveMetastoreAuthenticationProvider to send in a    * hive metastore handler that can be used to provide data for any    * authentication that needs to be done.    * @param handler    */
name|void
