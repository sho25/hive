...
name|debug
argument_list|(
literal|"unable to find the table owner in the cache for table "
operator|+
name|fullTableName
operator|+
literal|" "
operator|+
literal|"will determine user based on table location"
argument_list|)
expr_stmt|;
name|runAs
operator|=
...
name|error
argument_list|(
literal|"Caught Exception while checking compactiton eligibility "
operator|+
name|StringUtils
operator|.
name|stringifyException
