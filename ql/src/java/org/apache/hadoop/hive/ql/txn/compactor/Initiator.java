...
continue|continue;
block|}
comment|// Compaction doesn't work under a transaction and hence pass null for validTxnList
...
return|;
block|}
comment|// If it is for insert-only transactional table, return null.
if|if
condition|(
name|AcidUtils
operator|.
