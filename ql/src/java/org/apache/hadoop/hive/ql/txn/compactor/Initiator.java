...
argument_list|)
decl_stmt|;
comment|/* checkForCompaction includes many file metadata checks and may be expensive.                * Therefore, using a thread pool here and running checkForCompactions in parallel */
name|compactionList
operator|.
name|add
argument_list|(
...
parameter_list|()
lambda|->
name|scheduleCompactionIfRequired
argument_list|(
name|ci
argument_list|,
name|t
