...
begin_comment
comment|/** * VectorUDAFVarSampTimestamp. Vectorized implementation for VARIANCE aggregates. */
end_comment
...
specifier|public
class|class
name|VectorUDAFVarSampTimestamp
extends|extends
name|VectorAggregateExpression
block|{
specifier|private
...
name|variance
decl_stmt|;
comment|/**       * Value is explicitly (re)initialized in reset() (despite the init() bellow...)       */
specifier|transient
specifier|private
name|boolean
name|isNull
