...
block|}
block|}
comment|/**    * Get the primary keys from the AST and populate the pkInfos with the required    * information.    * @param child  The node with primary key token    * @param pkInfos Primary Key information structure    * @throws SemanticException    */
specifier|private
specifier|static
name|void
name|processPrimaryKeyInfos
parameter_list|(
name|ASTNode
name|child
parameter_list|,
...
name|HiveParser
operator|.
name|TOK_REBUILD_MATERIALIZED_VIEW
operator|)
assert|;
name|int
name|childIndex
