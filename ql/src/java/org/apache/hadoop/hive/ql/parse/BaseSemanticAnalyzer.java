...
block|}
block|}
comment|/**    * Process the foreign keys from the AST and populate the foreign keys in the SQLForeignKey list    * @param child Foreign Key token node    * @param foreignKeys SQLForeignKey list    * @throws SemanticException    */
specifier|protected
specifier|static
name|void
