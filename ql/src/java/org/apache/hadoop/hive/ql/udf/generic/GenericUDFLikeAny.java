...
name|value
operator|=
literal|"test _FUNC_(pattern1, pattern2...) - returns true if test matches any patterns patternN."
operator|+
...
name|UDFArgumentLengthException
argument_list|(
literal|"The like any operator requires at least one pattern for matching, got "
operator|+
operator|(
name|arguments
operator|.
...
index|]
expr_stmt|;
comment|/**expects string and null arguments */
for|for
control|(
name|int
name|idx
