...
block|}
block|}
comment|/**    * NOTE: This method ignores the subtype numbers in the TypeDescription rebuilds the subtype    * numbers based on the length of the result list being appended.    *    * @param result    * @param typeInfo    */
specifier|public
specifier|static
name|void
...
block|}
block|}
comment|/**    * NOTE: This method ignores the subtype numbers in the OrcProto.Type rebuilds the subtype    * numbers based on the length of the result list being appended.    *    * @param result    * @param typeInfo    */
specifier|public
specifier|static
name|int
name|appendOrcTypesRebuildSubtypes
