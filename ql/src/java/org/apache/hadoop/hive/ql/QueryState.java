...
literal|0
decl_stmt|;
comment|// Holds the tag supplied by user to uniquely identify the query. Can be used to kill the query if the query
comment|// id cannot be queried for some reason like hive server restart.
specifier|private
name|String
name|queryTag
init|=
