...
return|return;
block|}
comment|/**    * Check the partitions used by the table scan to make sure they also exist in the    * index table    * @param pctx    * @param operator    * @return partitions used by query.  null if they do not exist in index table    */
specifier|private
name|Set
argument_list|<
name|Partition
...
return|;
block|}
comment|/**    * return index tables associated with a given base table    */
specifier|private
name|List
argument_list|<
name|Table
...
return|;
block|}
comment|/**    * return index tables associated with the base table of the partition    */
specifier|private
name|List
argument_list|<
name|Table
...
return|;
block|}
comment|/**    * Check the index partitions on a parttioned table exist and are fresh    */
specifier|private
name|boolean
name|isIndexPartitionFresh
parameter_list|(
...
return|;
block|}
comment|/**    * Check that the indexes on the unpartioned table exist and are fresh    */
specifier|private
name|boolean
name|isIndexTableFresh
parameter_list|(
