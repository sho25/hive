...
throw|;
block|}
comment|// Other file formats should do similar check to make sure file formats match
comment|// when doing LOAD DATA .. INTO TABLE
if|if
condition|(
name|OrcInputFormat
operator|.
...
literal|"Destination"
operator|+
literal|" table is stored as ORC but the file being loaded is not a valid ORC file."
argument_list|)
argument_list|)
throw|;
block|}
