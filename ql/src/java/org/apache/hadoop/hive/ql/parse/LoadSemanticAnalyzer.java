...
name|bucketId
operator|+
literal|". Only 1 file per bucket allowed in single load command. To load "
operator|+
literal|"multiple files for same bucket, use multiple statements for table "
operator|+
name|table
operator|.
name|getFullyQualifiedName
...
block|{
comment|/**          * for loading into un-bucketed acid table, files can be named arbitrarily but they will          * be renamed during load.          * {@link Hive#mvFile(HiveConf, FileSystem, Path, FileSystem, Path, boolean, boolean,          * boolean, int)}          * and          * {@link Hive#copyFiles(HiveConf, FileSystem, FileStatus[], FileSystem, Path, boolean,          * boolean, List, boolean)}          */
block|}
block|}
catch|catch
parameter_list|(
