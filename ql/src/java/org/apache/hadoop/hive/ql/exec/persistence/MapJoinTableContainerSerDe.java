...
block|}
block|}
comment|/**    * Loads the table container from a folder. Only used on Spark path.    * @param fs FileSystem of the folder.    * @param folder The folder to load table container.    * @return Loaded table.    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
