...
name|info
argument_list|(
literal|"Multi MR Input for work {} is null. Skipping read."
argument_list|,
name|mergeMapWork
operator|.
name|getName
...
decl_stmt|;
comment|// On LLAP dynamic value registry might already be cached.
specifier|final
name|DynamicValueRegistryTez
name|registryTez
init|=
...
name|debug
argument_list|(
literal|"There are {} key-value readers for input {}"
argument_list|,
name|kvReaders
operator|.
name|size
