...
parameter_list|()
block|{
comment|// compute locally and assign
name|int
name|hash
init|=
name|Arrays
...
name|that
decl_stmt|;
comment|// not comparing hashCtx - irrelevant
return|return
name|hashcode
operator|==
name|keyThat
...
parameter_list|)
block|{
comment|// Do not assign the input value object to the timestampValues array element.
comment|// Always copy value using set* methods.
name|timestampValues
index|[
name|index
index|]
...
index|]
decl_stmt|;
comment|// FUTURE: Add INTERVAL_YEAR_MONTH, etc, as desired.
switch|switch
condition|(
name|primitiveTypeInfo
operator|.
