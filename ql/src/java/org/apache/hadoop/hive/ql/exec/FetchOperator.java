...
name|HiveException
block|{
name|ensureCorrectSchemaEvolutionConfigs
argument_list|(
name|job
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|// if fetch is not being done from table and file sink has provided a list
comment|// of files to fetch from then there is no need to query FS to check the existence
comment|// of currpath
if|if
condition|(
operator|!
...
decl_stmt|;
name|boolean
name|isForcePositionalEvolution
init|=
name|HiveConf
operator|.
name|getBoolVar
...
name|warn
argument_list|(
literal|"invalid schema evolution ({}) and force positional evolution ({}) pair, falling back to disabling both"
argument_list|,
name|isSchemaEvolution
argument_list|,
name|isForcePositionalEvolution
...
condition|)
block|{
comment|// input format could be cached, in which case we need to reset the list of files to fetch
operator|(
operator|(
name|HiveSequenceFileInputFormat
operator|)
...
name|debug
argument_list|(
literal|"No valid directories for "
operator|+
name|currPath
argument_list|)
expr_stmt|;
...
name|trace
argument_list|(
literal|"Setting originals fetch inputs to {}"
argument_list|,
name|inputs
argument_list|)
expr_stmt|;
...
argument_list|,
operator|new
name|FetchInputFormatSplitComparator
argument_list|()
argument_list|)
expr_stmt|;
block|}
