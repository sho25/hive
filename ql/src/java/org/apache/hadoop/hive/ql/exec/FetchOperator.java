...
block|}
block|}
comment|/**    * Set context for this fetch operator in to the jobconf.    * This helps InputFormats make decisions based on the scope of the complete    * operation.    * @param conf the configuration to modify    * @param partDirs the list of partition directories    */
specifier|static
name|void
name|setFetchOperatorContext
parameter_list|(
