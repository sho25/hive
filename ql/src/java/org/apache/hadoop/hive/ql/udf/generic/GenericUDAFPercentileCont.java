...
condition|)
block|{
comment|// column ref, expression (0<= percentile<= 1)
return|return
...
condition|)
block|{
comment|// expression (0<= percentile<= 1), order by column ref, order direction, null ordering
return|return
name|getGenericUDAFEvaluator
argument_list|(
name|parameters
...
literal|1
argument_list|,
literal|"Only 1 argument and a single order column "
operator|+
literal|"reference expected."
argument_list|)
throw|;
block|}
block|}
...
expr_stmt|;
block|}
comment|// ...for real input data, no order direction
specifier|protected
name|void
name|initInspectors
parameter_list|(
name|PrimitiveObjectInspector
name|orderByColumnOI
parameter_list|)
block|{
name|inputOI
operator|=
...
expr_stmt|;
block|}
comment|// ...for real input data, with order direction
specifier|protected
name|void
name|initInspectors
parameter_list|(
...
name|converter
operator|.
name|convertPercentileParameter
argument_list|(
name|percentiles
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * The evaluator for percentile computation based on array of longs.    */
specifier|public
specifier|static
class|class
name|PercentileContLongArrayEvaluator
...
block|}
block|}
comment|/**    * The evaluator for percentile computation based on array of doubles.    */
specifier|public
specifier|static
class|class
name|PercentileContDoubleArrayEvaluator
