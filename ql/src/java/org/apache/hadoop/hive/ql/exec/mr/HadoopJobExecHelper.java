...
specifier|transient
name|int
name|lastMapProgress
decl_stmt|;
specifier|protected
specifier|transient
name|int
name|lastReduceProgress
decl_stmt|;
specifier|public
specifier|transient
name|JobID
...
argument_list|)
decl_stmt|;
name|updateMapRedTaskWebUIStatistics
argument_list|(
name|mapRedStats
argument_list|,
name|rj
...
condition|)
block|{
comment|//Set the number of table rows affected in mapRedStats to display number of rows inserted.
if|if
condition|(
name|ctrs
operator|!=
...
argument_list|)
expr_stmt|;
comment|// Computes the skew for all the MapReduce irrespective
comment|// of Success or Failure
if|if
condition|(
name|this
operator|.
...
condition|)
block|{
name|computeReducerTimeStatsPerJob
argument_list|(
name|rj
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// Compute the reducers run time statistics for the job
name|ReducerTimeStatsPerJob
name|reducerTimeStatsPerJob
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Adding the reducers run time statistics for the job in the QueryPlan
name|this
operator|.
name|task
operator|.
