...
parameter_list|()
block|{   }
comment|/**    * This constructor is used for partitioned CTAS. Basically we pass the name of    * partitioned columns, which will all be dynamic partitions since the binding    * is done after executing the query in the CTAS.    */
specifier|public
name|DynamicPartitionCtx
parameter_list|(
name|List
