...
name|prunedColLists
decl_stmt|;
comment|/**    * This map stores the pruned nested column path for each operator    */
specifier|private
specifier|final
name|Map
argument_list|<
...
return|;
block|}
comment|/**    * Get the path to the root column for the nested column attribute    *    * @param curOp current operator    * @return the nested column paths for current operator and its child operator    */
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|genNestedColPaths
parameter_list|(
name|Operator
argument_list|<
name|?
...
return|;
block|}
comment|/**    * Creates the list of internal group paths for select * expressions.    *    * @param op        The select operator.    * @param paths The list of nested column paths returned by the children of the    *                  select operator.    * @return List<String> of the nested column path from leaf to the root.    */
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|getSelectNestedColPathsFromChildren
parameter_list|(
name|SelectOperator
name|op
parameter_list|,
