...
argument_list|()
decl_stmt|;
comment|// shallow copy aliasToOpInfo, we won't want to clone the operator tree here
name|cloned
operator|.
name|setAliasToOpInfo
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// clone filterMap
name|int
index|[]
index|[]
name|clonedFilterMap
init|=
name|filterMap
operator|==
literal|null
...
block|{
return|return
literal|"QBJoinTree [leftAlias="
operator|+
name|leftAlias
operator|+
literal|", rightAliases="
operator|+
name|Arrays
operator|.
name|toString
