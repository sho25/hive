...
parameter_list|)
block|{
comment|// PARQUET_INT96_WRITE_ZONE_PROPERTY is a table property used to detect what timezone
comment|// conversion to use when writing Parquet timestamps.
name|String
name|timeZoneID
init|=
name|tableProperties
...
return|;
block|}
comment|// If no timezone is defined in table properties, then adjust timestamps using
comment|// PARQUET_INT96_NO_ADJUSTMENT_ZONE timezone
return|return
name|TimeZone
operator|.
name|getTimeZone
