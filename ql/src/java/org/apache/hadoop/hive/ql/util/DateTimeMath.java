...
return|;
block|}
comment|/**    * Perform date + int operation .    * @param dt the date    * @param interval the int (days)    * @return the resulting date    */
specifier|public
name|Date
name|add
parameter_list|(
...
return|;
block|}
comment|/**    * TODO - this is a temporary fix for handling Julian calendar dates.    * Returns a Gregorian calendar that can be used from year 0+ instead of default 1582.10.15.    * This is desirable for some UDFs that work on dates which normally would use Julian calendar.    * @return the calendar    */
specifier|public
specifier|static
name|Calendar
