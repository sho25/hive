...
return|;
block|}
comment|/**    * Reduces all calls to SUM0, AVG, STDDEV_POP, STDDEV_SAMP, VAR_POP, VAR_SAMP in    * the aggregates list to.    *    *<p>It handles newly generated common subexpressions since this was done    * at the sql2rel stage.    */
specifier|private
name|void
name|reduceAggs
parameter_list|(
...
name|SUM0
case|:
comment|// replace original SUM0(x) with COALESCE(SUM(x), 0)
return|return
name|reduceSum0
argument_list|(
name|oldAggRel
