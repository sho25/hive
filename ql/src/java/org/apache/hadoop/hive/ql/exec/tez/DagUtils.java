...
name|conf
operator|.
name|OrderedPartitionedKVEdgeConfigurer
import|;
end_import
...
name|conf
operator|.
name|UnorderedPartitionedKVEdgeConfigurer
import|;
end_import
...
name|conf
operator|.
name|UnorderedUnpartitionedKVEdgeConfigurer
import|;
end_import
...
return|;
block|}
comment|/**    * @param numContainers number of containers to pre-warm    * @param localResources additional resources to pre-warm with    * @return prewarm context object    */
specifier|public
name|PreWarmContext
