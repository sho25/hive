...
name|TezConfiguration
operator|.
name|TEZ_AM_VERTEX_TASK_SCHEDULER_NAME
argument_list|,
name|serviceName
argument_list|)
operator|.
...
name|TezConfiguration
operator|.
name|TEZ_AM_VERTEX_CONTAINER_LAUNCHER_NAME
argument_list|,
name|serviceName
argument_list|)
operator|.
...
name|TezConfiguration
operator|.
name|TEZ_AM_VERTEX_TASK_COMMUNICATOR_NAME
argument_list|,
name|serviceName
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * @param src path to the source for the resource    * @param dest path in hdfs for the resource    * @param type local resource type (File/Archive)    * @param conf    * @return localresource from tez localization.    * @throws IOException when any file system related calls fails.    */
specifier|public
name|LocalResource
name|localizeResource
parameter_list|(
