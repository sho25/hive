...
return|;
block|}
comment|/**    * Given a Vertex group and a vertex createEdge will create an    * Edge between them.    *    * @param group The parent VertexGroup    * @param wConf The job conf of the child vertex    * @param w The child vertex    * @param edgeType the type of connection between the two    * endpoints.    */
specifier|public
name|GroupInputEdge
name|createEdge
parameter_list|(
