...
block|}
specifier|protected
name|GenericUDAFFirstValueEvaluator
name|createEvaluator
parameter_list|()
block|{
return|return
...
return|return
operator|new
name|FirstValStreamingFixedWindow
argument_list|(
name|this
argument_list|,
name|start
...
condition|)
block|{
comment|/*          * add value to chain if it is not null or if skipNulls is false.          */
if|if
condition|(
operator|!
name|fb
