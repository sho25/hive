...
block|}
name|boolean
name|genPredOnLeftSide
init|=
literal|false
decl_stmt|,
name|genPredOnRightSide
init|=
literal|false
decl_stmt|;
switch|switch
...
argument_list|)
decl_stmt|;
comment|// generate predicate on left side
name|Set
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|// generate predicate on right side
name|Set
argument_list|<
name|String
argument_list|>
...
block|}
name|boolean
name|isNewLeftPredicateAlwaysTrue
init|=
name|newLeftPredicate
operator|.
name|isAlwaysTrue
