...
argument_list|()
decl_stmt|;
comment|// This variable must be initialized only once to keep good read performance while doing conversion of timestamps values.
specifier|final
name|Calendar
name|calendar
decl_stmt|;
...
condition|)
block|{
comment|// Local time should be used if timezone is not available.
name|calendar
operator|=
name|Calendar
operator|.
