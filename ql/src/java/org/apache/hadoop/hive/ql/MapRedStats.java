...
condition|)
block|{
comment|// Erasure Coding stats - added in HADOOP-15507, expected in Hadoop 3.2.0
name|Counter
name|hdfsReadEcCntr
init|=
name|counters
...
literal|"FileSystemCounters"
argument_list|,
literal|"HDFS_BYTES_READ_EC"
argument_list|)
decl_stmt|;
comment|// FileSystemCounter.BYTES_READ_EC
if|if
condition|(
name|hdfsReadEcCntr
operator|!=
...
return|;
block|}
comment|/**    * Get the Erasure Coding Shim.    * @return a HdfsErasureCodingShim    */
specifier|private
name|HadoopShims
operator|.
name|HdfsErasureCodingShim
...
name|warn
argument_list|(
literal|"Could not get Erasure Coding shim for reason: "
operator|+
name|e
operator|.
name|getMessage
