...
comment|// 1.1 Create TableScanDesc
name|String
name|tableAlias
init|=
name|ht
...
argument_list|)
decl_stmt|;
comment|// 1.2. Set Partition cols in TSDesc
name|List
argument_list|<
name|ColumnInfo
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// 1.3. Set needed cols in TSDesc
name|List
argument_list|<
name|Integer
argument_list|>
...
literal|null
decl_stmt|;
comment|// 2.1 Construct ordered colInfo list for TS RowSchema& update vcolMap
name|ArrayList
argument_list|<
name|ColumnInfo
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// 4. For each input, we generate the corresponding ReduceSink child
name|List
argument_list|<
name|Operator
argument_list|<
...
control|)
block|{
comment|// Generate a ReduceSink operator for each join child
name|ReduceSinkOperator
name|child
init|=
name|genReduceSink
...
expr_stmt|;
block|}
comment|// 5. Generate Join operator
name|JoinOperator
name|joinOp
init|=
name|genJoin
...
argument_list|)
decl_stmt|;
comment|// 6. TODO: Extract condition for non-equi join elements (if any) and add it
comment|// 7. Virtual columns
name|Map
argument_list|<
name|Integer
argument_list|,
...
literal|1
decl_stmt|;
comment|// 1.b. Generate reduce sink
name|resultOp
operator|=
name|genReduceSink
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1.c. Generate project operator
name|Map
argument_list|<
name|String
argument_list|,
