...
begin_comment
comment|/** * VectorUDAFSumTimestamp. Vectorized implementation for SUM aggregates. */
end_comment
...
name|value
operator|=
literal|"_FUNC_(expr) - Returns the sum value of expr (vectorized, type:<ValueType>)"
argument_list|)
specifier|public
class|class
...
parameter_list|)
block|{
comment|/*      * Sum input TIMESTAMP and output DOUBLE.      *      * Just modes (PARTIAL1, COMPLETE).      */
return|return
name|name
operator|.
name|equals
