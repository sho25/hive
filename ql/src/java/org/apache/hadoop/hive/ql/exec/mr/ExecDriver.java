...
block|}
block|}
comment|/**    * Retrieve the resources from the current session and configuration for the given type.    * @return Comma-separated list of resources    */
specifier|protected
specifier|static
name|String
name|getResource
...
argument_list|()
decl_stmt|;
comment|// TODO: why is there a TezSession in MR ExecDriver?
if|if
condition|(
name|ss
operator|!=
...
expr_stmt|;
block|}
comment|// Initialize the resources from command line
if|if
condition|(
name|files
operator|!=
