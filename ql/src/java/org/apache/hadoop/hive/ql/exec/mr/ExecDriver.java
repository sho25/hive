...
block|{
comment|//fall back to non-vector mode
name|HiveConf
operator|.
name|setBoolVar
argument_list|(
...
return|;
block|}
comment|//verify the expressions contained in the operators
try|try
block|{
name|validateVectorOperator
argument_list|(
name|vectorOp
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|//set with HS2 in secure mode with doAs
name|hadoopAuthToken
operator|=
name|args
index|[
