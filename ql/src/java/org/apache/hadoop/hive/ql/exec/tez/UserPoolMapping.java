...
expr_stmt|;
block|}
comment|// TODO: move these into tests when there are fewer conflicting patches pending.
annotation|@
name|VisibleForTesting
specifier|public
name|MappingInput
...
return|;
block|}
comment|// For equal-priority rules, user rules come first because they are more specific (arbitrary).
name|Mapping
name|mapping
init|=
name|userMappings
