...
specifier|static
name|String
name|SKIP_COLUMN_IDS_CONF_STR
init|=
literal|"hive.io.rcfile.skipcolumn.ids"
decl_stmt|;
comment|/**    * Sets skip columns' ids(start from zero) for RCFile's Reader. Once a column    * is included in the list, RCFile's reader will just skip its value.    *     */
specifier|public
specifier|static
name|void
...
return|;
block|}
comment|/**    * Clears the skip column ids set in the conf.    */
specifier|public
specifier|static
name|void
