...
name|to_skip
decl_stmt|;
comment|// default value for skipping a column
if|if
condition|(
name|notSkipIDs
operator|.
...
condition|)
block|{
comment|// this is the case to get all columns
name|to_skip
operator|=
literal|false
expr_stmt|;
...
block|{
comment|// no column name is specified e.g, in select count(1) from tt; skip all columns
for|for
control|(
name|int
name|i
