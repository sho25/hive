...
name|mapWork
expr_stmt|;
comment|// in MR, ReduceWork is a terminal work, but that's not the case for spark, therefore for
comment|// big dir MapWork, we'll have to clone all dependent works in the original work graph
name|cloneWorkGraph
argument_list|(
name|currentWork
argument_list|,
