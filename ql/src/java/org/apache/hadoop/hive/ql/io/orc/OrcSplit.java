...
argument_list|)
expr_stmt|;
comment|// We could avoid serializing file ID and just replace the path with inode-based path.
comment|// However, that breaks bunch of stuff because Hive later looks up things by split path.
name|this
operator|.
name|fileId
operator|=
