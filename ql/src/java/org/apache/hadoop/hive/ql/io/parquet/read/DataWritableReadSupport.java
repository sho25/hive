...
return|;
block|}
comment|/**    * Get a valid zoneId from some metadata, otherwise return null.    */
specifier|public
specifier|static
name|ZoneId
...
return|;
block|}
comment|/**    * Get the proleptic from some metadata, otherwise return null.    */
specifier|public
specifier|static
name|Boolean
name|getWriterDateProleptic
parameter_list|(
name|Map
argument_list|<
name|String
...
name|tableSchema
init|=
name|getRequestedSchemaForIndexAccess
argument_list|(
name|indexAccess
argument_list|,
name|columnNamesList
...
block|}
block|}
comment|/**    * It's used for vectorized code path.    * @param indexAccess    * @param columnNamesList    * @param columnTypesList    * @param fileSchema    * @param configuration    * @return    */
specifier|public
specifier|static
name|MessageType
...
argument_list|)
decl_stmt|;
comment|//TODO Duplicated code for init method since vectorization reader path doesn't support Nested
comment|// column pruning so far. See HIVE-15156
if|if
condition|(
operator|!
name|ColumnProjectionUtils
...
name|IllegalStateException
argument_list|(
literal|"Metadata contains a writer time zone that does not match "
operator|+
literal|"file footer's writer time zone."
argument_list|)
throw|;
block|}
name|String
...
name|IllegalStateException
argument_list|(
literal|"Metadata contains a writer proleptic property value that does not match "
operator|+
literal|"file footer's value."
argument_list|)
throw|;
block|}
name|String
name|prolepticDefault
init|=
name|ConfVars
operator|.
