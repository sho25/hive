...
argument_list|)
decl_stmt|;
comment|// Adds the PARQUET_INT96_WRITE_ZONE_PROPERTY value to the metadata object so that it passes the timezone
comment|// to the Parquet readers. PARQUET_INT96_WRITE_ZONE_PROPERTY is set on ParquetRecordReaderWrapper.
name|contextMetadata
operator|.
name|put
argument_list|(
