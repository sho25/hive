...
argument_list|()
decl_stmt|;
comment|// TODO: Replace with direct call to ProgressHelper, when reliably available.
specifier|private
specifier|static
class|class
name|ReflectiveProgressHelper
block|{
name|Configuration
name|conf
decl_stmt|;
...
name|getClassByName
argument_list|(
literal|"org.apache.tez.common.ProgressHelper"
argument_list|)
expr_stmt|;
name|progressHelper
operator|=
...
name|debug
argument_list|(
literal|"ProgressHelper initialized!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|warn
argument_list|(
literal|"Could not find ProgressHelper. "
operator|+
name|ex
argument_list|)
expr_stmt|;
...
block|}
name|void
name|scheduleProgressTaskService
parameter_list|(
name|long
name|delay
parameter_list|,
...
name|warn
argument_list|(
literal|"ProgressHelper uninitialized. Bailing on scheduleProgressTaskService()"
argument_list|)
expr_stmt|;
return|return;
block|}
...
argument_list|(
literal|"scheduleProgressTaskService"
argument_list|,
name|long
operator|.
name|class
...
name|debug
argument_list|(
literal|"scheduleProgressTaskService() called!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|warn
argument_list|(
literal|"Could not scheduleProgressTaskService."
argument_list|,
name|exception
argument_list|)
expr_stmt|;
...
block|}
name|void
name|shutDownProgressTaskService
parameter_list|()
block|{
if|if
condition|(
...
name|getDeclaredMethod
argument_list|(
literal|"shutDownProgressTaskService"
argument_list|)
operator|.
name|invoke
argument_list|(
...
name|debug
argument_list|(
literal|"shutDownProgressTaskService() called!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|warn
argument_list|(
literal|"Could not shutDownProgressTaskService."
argument_list|,
name|exception
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// As of now only used for Bucket MapJoin, there is exactly one event in the list.
assert|assert
name|arg0
operator|.
name|size
...
argument_list|()
decl_stmt|;
comment|// Get int view of the buffer
name|IntBuffer
name|intBuffer
init|=
name|buffer
...
return|return;
block|}
comment|// leverage TEZ-3437: Improve synchronization and the progress report behavior.
name|progressHelper
operator|=
operator|new
name|ReflectiveProgressHelper
