...
begin_comment
comment|/**  * This operation is handled as a special case because Hive  * long%long division returns needs special handling to avoid  * for divide by zero exception  */
end_comment
...
condition|)
block|{
comment|// Denominator is zero, convert the batch to nulls
name|outputColVector
operator|.
name|noNulls
operator|=
