...
name|MetaException
argument_list|(
literal|"The partition values must be not null or empty."
argument_list|)
throw|;
block|}
name|assertTempTablePartitioned
...
decl_stmt|;
return|return
name|appendPartitionToTempTable
argument_list|(
name|table
argument_list|,
name|partition
...
name|MetaException
argument_list|(
literal|"The partition must be not null or empty."
argument_list|)
throw|;
block|}
name|assertTempTablePartitioned
...
name|MetaException
argument_list|(
literal|"Cannot obtain list of partition by filter:\""
operator|+
name|request
operator|.
name|getFilter
