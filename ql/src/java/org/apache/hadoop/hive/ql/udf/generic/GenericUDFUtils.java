...
name|commonTypeInfo
operator|=
name|updateCommonTypeForDecimal
argument_list|(
name|commonTypeInfo
argument_list|,
name|oiTypeInfo
...
parameter_list|)
block|{
comment|/**      * TODO: Hack fix until HIVE-5848 is addressed. non-exact type shouldn't be promoted      * to exact type, as FunctionRegistry.getCommonClass() might do. This corrects      * that.      */
if|if
condition|(
name|commonTypeInfo
operator|instanceof
