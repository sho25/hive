...
name|value
operator|=
literal|"_FUNC_(AVG) - Returns the average value of expr (vectorized, type: decimal)"
argument_list|)
specifier|public
class|class
...
block|{
comment|// Note that if sum is out of range, mutateAdd will ignore the call.
comment|// At the end, sum.isSet() can be checked for null.
name|sum
operator|.
name|mutateAdd
argument_list|(
...
name|soi
decl_stmt|;
comment|/**      * The scale of the SUM in the partial output      */
specifier|private
name|short
name|sumScale
decl_stmt|;
comment|/**      * The precision of the SUM in the partial output      */
specifier|private
name|short
name|sumPrecision
decl_stmt|;
comment|/**      * the scale of the input expression      */
specifier|private
name|short
name|inputScale
decl_stmt|;
comment|/**      * the precision of the input expression      */
specifier|private
name|short
name|inputPrecision
decl_stmt|;
...
parameter_list|()
block|{
comment|// the output type of the vectorized partial aggregate must match the
comment|// expected type for the row-mode aggregation
comment|// For decimal, the type is "same number of integer digits and 4 more decimal digits"
name|DecimalTypeInfo
name|dtiSum
init|=
name|GenericUDAFAverage
...
name|agg
decl_stmt|;
comment|// !isSet checks for overflow.
if|if
condition|(
name|myagg
operator|.
