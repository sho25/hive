...
name|info
argument_list|(
literal|"Looking for hashtable file with suffix: "
operator|+
name|suffix
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"\tInitializing the hashtable by cached file:"
operator|+
name|path
operator|.
name|toString
...
name|info
argument_list|(
literal|"\tLoad back 1 hashtable file from distributed cache:"
operator|+
name|path
operator|.
name|toString
