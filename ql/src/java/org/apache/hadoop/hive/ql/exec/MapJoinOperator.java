...
decl_stmt|;
name|ObjectInspector
name|deserObjInspector
decl_stmt|;
comment|/**      * @param serObjInspector      * @param serializer      * @param deserializer      * @param deserObjInspector      */
specifier|public
name|MapJoinObjectCtx
parameter_list|(
name|ObjectInspector
...
expr_stmt|;
block|}
comment|/**      * @return the objInspector      */
specifier|public
name|ObjectInspector
name|getSerObjInspector
parameter_list|()
block|{
return|return
name|serObjInspector
...
argument_list|)
expr_stmt|;
comment|// initialize the join output object inspectors
name|ArrayList
argument_list|<
name|ObjectInspector
argument_list|>
...
expr_stmt|;
comment|// compute keys and values
name|ArrayList
argument_list|<
name|Object
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// Until there is one representation for the keys, convert explicitly
name|int
name|keyPos
init|=
literal|0
decl_stmt|;
comment|// TODO: use keyPos instead
for|for
control|(
name|Object
name|keyElem
...
argument_list|)
expr_stmt|;
comment|// TODO: put some warning if the size of res exceeds a given threshold
if|if
condition|(
name|metadataValueTag
index|[
...
argument_list|()
decl_stmt|;
comment|// currently, key is always byteswritable and value is text - TODO: generalize this
name|keyObj
operator|.
name|setMetadataTag
argument_list|(
