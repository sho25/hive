...
name|HiveException
block|{
comment|//should this close updaters[]?
for|for
control|(
name|int
name|idx
...
comment|// for MM tables, the final destination partition directory is created by the tasks themselves
try|try
block|{
if|if
condition|(
