...
block|{
comment|// TODO# wrong! special case #N bucketing
name|finalPaths
index|[
name|filesIdx
index|]
...
name|warn
argument_list|(
literal|"Unknown file found - neither a manifest nor directory: "
operator|+
name|path
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// TODO# dp will break - removeTempOrDuplicateFiles assumes dirs in results. Why? We recurse...
name|List
argument_list|<
name|Path
argument_list|>
