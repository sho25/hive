...
condition|)
block|{
comment|// if multiple KILL happens, only first kill will be chosen
name|LOG
operator|.
name|warn
argument_list|(
literal|"Conflicting KILL triggers ({} and {}). Choosing the first KILL trigger: {}"
argument_list|,
name|existingTrigger
argument_list|,
name|currentTrigger
