...
name|tableName
decl_stmt|;
comment|/**    * table name for the result of showcreatetable.    */
specifier|private
specifier|static
specifier|final
name|String
name|table
init|=
literal|"show_create_table"
decl_stmt|;
comment|/**    * thrift ddl for the result of showcreatetable.    */
specifier|private
specifier|static
specifier|final
name|String
...
parameter_list|()
block|{   }
comment|/**    * @param resFile    * @param tableName    *          name of table to show    */
specifier|public
name|ShowCreateTableDesc
parameter_list|(
name|String
