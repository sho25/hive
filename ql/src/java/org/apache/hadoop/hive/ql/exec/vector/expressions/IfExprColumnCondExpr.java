...
begin_comment
comment|/**  * Do regular execution of the THEN vector expression (a column or scalar) and conditional execution  * of the ELSE vector expression of a SQL IF statement.  */
end_comment
...
comment|// The THEN expression is either IdentityExpression (a column) or a ConstantVectorExpression
