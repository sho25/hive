...
expr_stmt|;
block|}
comment|// TODO: remove and let the thread handle it via normal ways?
specifier|private
name|int
name|applyInitialResourcePlan
parameter_list|(
...
condition|)
block|{
comment|// Looks like some pools were removed; insert queued queries into the front of get reqs.
for|for
control|(
name|PoolState
name|oldPool
