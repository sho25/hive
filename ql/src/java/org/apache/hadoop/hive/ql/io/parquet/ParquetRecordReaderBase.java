...
argument_list|)
expr_stmt|;
comment|// TODO enable MetadataFilter
specifier|final
name|ParquetMetadata
name|parquetMetadata
init|=
...
expr_stmt|;
block|}
comment|// rowGroupOffsets need to be set to null otherwise filter will not be applied
comment|// in ParquetRecordReader#initializeInternalReader
return|return
operator|new
name|ParquetInputSplit
argument_list|(
