...
begin_comment
comment|/**  * Wrapper around {@link org.apache.hadoop.hive.ql.exec.persistence.RowContainer}  *  * This class is thread safe.  */
end_comment
...
name|BINARY_TYPE_NAME
decl_stmt|;
comment|// Used to cache rows added while container is iterated.
specifier|private
name|RowContainer
