...
return|;
block|}
comment|/** getFinalDirName that takes into account MM, but not DP, LB or buckets. */
specifier|public
name|Path
...
block|}
block|}
comment|/**    * @return true, if the table is used during compaction    */
specifier|public
name|boolean
name|isCompactionTable
parameter_list|()
block|{
return|return
name|getTable
...
name|displayName
operator|=
literal|"Dp Sort State"
argument_list|)
specifier|public
name|String
name|getDpSortStateString
parameter_list|()
block|{
return|return
name|getDpSortState
...
return|;
block|}
comment|/**    * Whether this is CREATE TABLE SELECT or CREATE MATERIALIZED VIEW statemet    * Set by semantic analyzer this is required because CTAS/CM requires some special logic    * in mvFileToFinalPath    */
specifier|public
name|boolean
name|isCTASorCM
parameter_list|()
...
name|displayName
operator|=
literal|"File Sink Vectorization"
argument_list|,
name|explainLevels
operator|=
block|{
