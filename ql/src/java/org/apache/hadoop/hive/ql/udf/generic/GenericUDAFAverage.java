...
block|}
block|}
comment|/**    * The result type has the same number of integer digits and 4 more decimal digits    * This is exposed as static so that the vectorized AVG operator use the same logic    * @param scale    * @param precision    * @return    */
specifier|public
specifier|static
name|DecimalTypeInfo
name|deriveSumTypeInfo
