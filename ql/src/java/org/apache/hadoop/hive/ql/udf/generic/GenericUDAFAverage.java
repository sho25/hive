...
name|class
block|,
name|VectorUDAFAvgLongComplete
operator|.
name|class
block|,
...
name|class
block|,
name|VectorUDAFAvgDoubleComplete
operator|.
name|class
block|,
...
name|class
block|,
name|VectorUDAFAvgTimestampComplete
operator|.
name|class
block|,
name|VectorUDAFAvgPartial2
operator|.
name|class
block|,
name|VectorUDAFAvgFinal
operator|.
name|class
block|}
argument_list|)
...
argument_list|(
block|{
name|VectorUDAFAvgDecimal
operator|.
name|class
block|,
name|VectorUDAFAvgDecimalComplete
operator|.
name|class
block|,
name|VectorUDAFAvgDecimal64ToDecimal
operator|.
name|class
block|,
name|VectorUDAFAvgDecimal64ToDecimalComplete
operator|.
name|class
block|,
name|VectorUDAFAvgDecimalPartial2
operator|.
name|class
block|,
name|VectorUDAFAvgDecimalFinal
operator|.
name|class
block|}
argument_list|)
...
name|HiveException
block|{
comment|// Intercept result ObjectInspector so we can extract the DECIMAL precision and scale.
name|ObjectInspector
name|resultOI
init|=
name|super
