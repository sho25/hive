...
parameter_list|()
block|{   }
comment|/**    * File Sink Operator encountered     * @param op the file sink operator encountered    * @param opProcCtx context    */
specifier|public
name|void
name|process
parameter_list|(
...
block|}
block|}
comment|/**    * @param op the operator encountered    * @param opProcCtx context    */
specifier|public
name|void
name|process
parameter_list|(
