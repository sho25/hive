...
condition|)
block|{
comment|// it's a table alias, and also a column
name|ctx
operator|.
name|setError
argument_list|(
...
return|;
block|}
comment|/**      * Get the exprNodeDesc      * @param name      * @param children      * @return The expression node descriptor      * @throws UDFArgumentTypeException       */
specifier|public
specifier|static
name|exprNodeDesc
...
return|;
block|}
comment|// TODO: extract as a function
...
literal|null
return|;
comment|// Convert the parameters if the type of parameters do not exactly match.
name|ArrayList
argument_list|<
name|exprNodeDesc
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// The return type of a function can be of either Java Primitive Type/Class or Writable Class.
name|TypeInfo
name|resultTypeInfo
init|=
literal|null
