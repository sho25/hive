...
try|try
block|{
comment|// todo replace below with joda-time, which supports timezone
if|if
condition|(
name|expr
operator|.
...
return|;
block|}
comment|// TODO : Char and string comparison happens in char. But, varchar and string comparison happens in String.
comment|// if column type is char and constant type is string, then convert the constant to char
comment|// type with padded spaces.
name|String
