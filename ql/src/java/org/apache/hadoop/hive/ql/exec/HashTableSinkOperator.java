...
literal|1
decl_stmt|;
comment|// one of the tables that is not
comment|// in memory
specifier|protected
specifier|transient
name|int
...
literal|1
decl_stmt|;
comment|// one of the tables that is
...
index|]
expr_stmt|;
comment|// initialize some variables, which used to be initialized in
comment|// CommonJoinOperator
name|numAliases
operator|=
name|conf
operator|.
