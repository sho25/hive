...
expr_stmt|;
block|}
comment|/**      * Setup for reading the key of an entry with the equalKey method.      * @param hashMapStore      * @param refWord      */
specifier|public
name|void
name|setKey
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Setup for a match outright.      * @param hashMapStore      * @param refWord      */
specifier|public
name|void
name|set
parameter_list|(
...
condition|)
block|{
comment|// Read big key length we wrote with the key.
name|keyLength
operator|=
name|writeBuffers
operator|.
