...
name|IOException
argument_list|(
literal|"ORCFileMerge failed because the input files are not compatible."
operator|+
literal|" Column counts does not match."
argument_list|)
throw|;
block|}
if|if
...
literal|"ORCFileMerge failed because the input files are not compatible."
operator|+
literal|" Compression codec does not match."
argument_list|)
throw|;
block|}
if|if
...
literal|"ORCFileMerge failed because the input files are not compatible."
operator|+
literal|" Compression buffer size does not match."
argument_list|)
throw|;
block|}
if|if
...
literal|"ORCFileMerge failed because the input files are not compatible."
operator|+
literal|" Row index stride does not match."
argument_list|)
throw|;
block|}
