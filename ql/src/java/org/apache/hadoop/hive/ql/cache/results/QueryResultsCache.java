...
block|{
comment|// No actual result directory, no need to move anything.
name|cachedResultsPath
operator|=
name|zeroRowsPath
expr_stmt|;
...
name|warn
argument_list|(
literal|"ResultsCache: no entry for {}"
argument_list|,
name|queryString
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"ResultsCache: Attempted to remove entry but it was not in the cache: {}"
argument_list|,
name|entry
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// Only entries marked as valid should have results that can be removed.
continue|continue;
block|}
