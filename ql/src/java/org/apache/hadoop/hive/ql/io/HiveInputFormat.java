...
name|info
argument_list|(
literal|"Resetting VectorMapOperatorReadType from "
operator|+
name|old
operator|+
...
return|return;
block|}
comment|// Tez require the use of recursive input dirs for union processing, so we have to look into the
comment|// directory to find out
name|LinkedList
argument_list|<
name|Path
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// add itself as a starting point
while|while
condition|(
operator|!
name|subdirs
...
literal|false
decl_stmt|;
comment|// whether getAcidState has been called for currDir
for|for
control|(
name|FileStatus
name|file
...
name|warn
argument_list|(
literal|"Ignoring a file not in MM directory "
operator|+
name|path
argument_list|)
expr_stmt|;
