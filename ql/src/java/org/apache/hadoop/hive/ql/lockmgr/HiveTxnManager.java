...
name|LockException
function_decl|;
comment|/**   * Open a new transaction.   * @param ctx Context for this query   * @param user Hive user who is opening this transaction.   * @param txnType transaction type.   * @return The new transaction id   * @throws LockException if a transaction is already open.   */
name|long
name|openTxn
parameter_list|(
name|Context
