...
literal|1
argument_list|,
literal|"Requested to generate single "
operator|+
literal|"split. Paths and fileStatuses are expected to be 1. Got paths: "
operator|+
name|paths
operator|.
name|size
...
argument_list|)
expr_stmt|;
comment|// increment/set input counters
name|InputInitializerContext
name|inputInitializerContext
init|=
name|getContext
...
argument_list|()
decl_stmt|;
comment|// The assumption here is the path is a file. Only case this is different is ACID deltas.
comment|// The isFile check is avoided here for performance reasons.
specifier|final
name|String
name|fileStr
init|=
...
name|debug
argument_list|(
literal|"Published tez counters: "
operator|+
name|tezCounters
argument_list|)
expr_stmt|;
