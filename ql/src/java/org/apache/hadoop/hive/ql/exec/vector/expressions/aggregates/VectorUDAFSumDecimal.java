...
begin_comment
comment|/** * VectorUDAFSumDecimal. Vectorized implementation for SUM aggregates. */
end_comment
...
name|value
operator|=
literal|"_FUNC_(expr) - Returns the sum value of expr (vectorized, type: decimal)"
argument_list|)
specifier|public
class|class
...
parameter_list|)
block|{
comment|/*      * Sum input and output are DECIMAL.      *      * Any mode (PARTIAL1, PARTIAL2, FINAL, COMPLETE).      */
return|return
name|name
operator|.
name|equals
