...
expr_stmt|;
block|}
comment|// Calls getPosition on the row output stream if dictionary encoding is used, and the direct
comment|// output stream if direct encoding is used
specifier|private
name|void
name|recordOutputPosition
parameter_list|(
name|OrcProto
operator|.
name|RowIndexEntry
