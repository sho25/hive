...
name|streamFactory
decl_stmt|;
comment|/**      * Create a tree writer.      * @param columnId the column id of the column to write      * @param inspector the object inspector to use      * @param schema the row schema      * @param streamFactory limited access to the Writer's data.      * @param nullable can the value be null?      * @throws IOException      */
name|TreeWriter
parameter_list|(
name|int
name|columnId
...
return|;
block|}
comment|/**      * Add a new value to the column.      * @param obj the object to write      * @throws IOException      */
name|void
name|write
parameter_list|(
name|Object
