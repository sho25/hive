...
name|allColumns
operator|=
name|getColumnNamesFromInspector
argument_list|(
name|inspector
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Get the current column id. After creating all tree writers this count should tell how many      * columns (including columns within nested complex objects) are created in total.      * @return current column id      */
specifier|public
name|int
name|getCurrentColumnId
parameter_list|()
block|{
return|return
name|columnCount
...
condition|)
block|{
comment|// integers are converted to longs in column statistics and during SARG evaluation
name|bloomFilter
operator|.
name|addLong
argument_list|(
...
condition|)
block|{
comment|// floats are converted to doubles in column statistics and during SARG evaluation
name|bloomFilter
operator|.
name|addDouble
argument_list|(
