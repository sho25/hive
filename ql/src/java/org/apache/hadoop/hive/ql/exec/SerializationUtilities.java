...
block|}
block|}
comment|/**    * Supports sublists created via {@link ArrayList#subList(int, int)} since java7 (oracle jdk,    * represented by<code>java.util.ArrayList$SubList</code>).    * This is from kryo-serializers package.    */
specifier|private
specifier|static
class|class
name|ArrayListSubListSerializer
