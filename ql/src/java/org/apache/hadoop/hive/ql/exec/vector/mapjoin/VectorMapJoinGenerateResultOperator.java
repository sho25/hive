...
name|PrimitiveTypeInfo
index|[]
name|bigTablePrimitiveTypeInfos
decl_stmt|;
specifier|private
specifier|transient
name|VectorSerializeRow
...
name|SerDeException
block|{
comment|// The super method will reload a hash table partition and
comment|// put a single MapJoinBytesTableContainer into the currentSmallTable member.
name|super
operator|.
name|reloadHashTable
argument_list|(
