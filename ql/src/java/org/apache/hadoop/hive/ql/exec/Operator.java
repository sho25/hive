...
return|;
block|}
comment|/**    * Computes and retrieves the stats for this operator. Default implementation assumes same    * input/output size for operator.    *    * @return Statistics for this operator    */
specifier|public
name|Statistics
name|getStatistics
parameter_list|(
