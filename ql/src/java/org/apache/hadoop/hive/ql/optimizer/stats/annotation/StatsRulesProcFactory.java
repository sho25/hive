...
name|aspCtx
operator|.
name|isUniformWithinRange
argument_list|()
condition|)
block|{
comment|// Assuming uniform distribution, we can use the range to calculate
comment|// new estimate for the number of rows
return|return
name|Math
operator|.
name|round
...
condition|)
block|{
comment|// if the foreign key is filtered by some condition we may not re-scale it
name|newrows
operator|=
name|parentStats
operator|.
