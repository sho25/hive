...
argument_list|)
expr_stmt|;
comment|// reason we compute interim row count, where join type isn't considered, is because later
comment|// it will be used to estimate num nulls
name|long
...
condition|)
block|{
comment|// interim row count can not be less due to containment
comment|// assumption in join cardinality computation
assert|assert
operator|(
name|newNumRows
operator|>
...
comment|// interim row count can not be less due to containment
comment|// assumption in join cardinality computation
comment|// interimNumRows represent number of matches for join keys on two sides.
comment|// newNumRows-interimNumRows represent number of non-matches.
assert|assert
operator|(
name|newNumRows
operator|>
