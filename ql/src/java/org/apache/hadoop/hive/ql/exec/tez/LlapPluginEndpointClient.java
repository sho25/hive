...
block|{
comment|// Note: this could be made more generic; it may be a common problem for the endpoints that
comment|//       can move around dynamically. For now we only handle this for the update.
specifier|public
specifier|static
interface|interface
