...
expr_stmt|;
block|}
comment|/**    * Initializes the VectorizedRowBatch context based on an scratch column type map and    * object inspector.    * @param columnTypeMap    * @param rowOI    *          Object inspector that shapes the column types    */
specifier|public
name|void
name|init
parameter_list|(
