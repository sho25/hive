...
begin_comment
comment|/**  * ProcessAnalyzeTable sets up work for the several variants of analyze table  * (normal, no scan.) The plan at this point will be a single  * table scan operator.  */
end_comment
