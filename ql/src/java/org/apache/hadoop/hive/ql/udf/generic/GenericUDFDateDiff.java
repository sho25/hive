...
name|UDFArgumentException
argument_list|(
literal|"TO_DATE() only takes STRING/TIMESTAMP/TIMESTAMPLOCALTZ types, got "
operator|+
name|inputType
argument_list|)
throw|;
...
name|UDFArgumentException
argument_list|(
literal|" DATEDIFF() only takes STRING/TIMESTAMP/DATEWRITABLE/TIMESTAMPLOCALTZ types as "
operator|+
operator|(
name|i
operator|+
