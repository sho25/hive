...
decl_stmt|;
comment|/** Constraint related objects */
specifier|private
specifier|transient
name|PrimaryKeyInfo
name|pki
...
name|cc
decl_stmt|;
comment|/** Constraint related flags    *  This is to track if constraints are retrieved from metastore or not    */
specifier|private
specifier|transient
name|boolean
name|isPKFetched
...
expr_stmt|;
block|}
comment|/** This api is used by getMetaData which require deep copy of metastore.api.table    * and constraints copy    */
specifier|public
name|Table
name|makeCopy
parameter_list|()
block|{
comment|// make deep copy of metastore.api.table
name|Table
name|newTab
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// copy constraints
name|newTab
operator|.
name|copyConstraints
argument_list|(
name|this
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * @return The owner type of the table.    * @see org.apache.hadoop.hive.metastore.api.Table#getOwnerType()    */
specifier|public
name|PrincipalType
name|getOwnerType
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * @param ownerType    * @see org.apache.hadoop.hive.metastore.api.Table#setOwnerType(org.apache.hadoop.hive.metastore.api.PrincipalType)    */
specifier|public
name|void
name|setOwnerType
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * @return the creation metadata (only for materialized views)    */
specifier|public
name|CreationMetadata
...
return|;
block|}
comment|/**    * @param creationMetadata    *          the creation metadata (only for materialized views)    */
specifier|public
name|void
...
return|;
block|}
comment|/**    * Setup the table level stats as if the table is new. Used when setting up Table for a new    * table or during replication.    */
specifier|public
name|void
...
block|}
block|}
comment|/** Constraints related methods    *  Note that set apis are used by DESCRIBE only, although get apis return RELY or ENABLE    *  constraints DESCRIBE could set all type of constraints    * */
comment|/* This only return PK which are created with RELY */
specifier|public
name|PrimaryKeyInfo
...
name|warn
argument_list|(
literal|"Cannot retrieve PK info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/* This only return FK constraints which are created with RELY */
specifier|public
name|ForeignKeyInfo
...
name|warn
argument_list|(
literal|"Cannot retrieve FK info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/* This only return UNIQUE constraint defined with RELY */
specifier|public
name|UniqueConstraint
...
name|warn
argument_list|(
literal|"Cannot retrieve Unique Key info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/* This only return NOT NULL constraint defined with RELY */
specifier|public
name|NotNullConstraint
...
name|warn
argument_list|(
literal|"Cannot retrieve Not Null constraint info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/* This only return DEFAULT constraint defined with ENABLE */
specifier|public
name|DefaultConstraint
...
name|warn
argument_list|(
literal|"Cannot retrieve Default constraint info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/* This only return CHECK constraint defined with ENABLE */
specifier|public
name|CheckConstraint
...
name|warn
argument_list|(
literal|"Cannot retrieve Check constraint info for table : "
operator|+
name|this
operator|.
name|getTableName
...
expr_stmt|;
block|}
comment|/** This shouldn't use get apis because those api call metastore    * to fetch constraints.    * getMetaData only need to make a copy of existing constraints, even if those are not fetched    */
specifier|public
name|void
name|copyConstraints
parameter_list|(
