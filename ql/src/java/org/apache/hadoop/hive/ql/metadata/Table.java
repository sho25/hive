...
expr_stmt|;
block|}
comment|/**    * @param outputFormatClass the outputFormatClass to set    */
specifier|public
name|void
name|setOutputFormatClass
parameter_list|(
...
block|{
comment|// This is an empty partition
if|if
condition|(
operator|!
name|partPaths
...
name|HiveException
argument_list|(
literal|"Data in hdfs is messed up. Table "
operator|+
name|getName
argument_list|()
operator|+
literal|" has a partition "
operator|+
name|partPath
operator|+
literal|" that is not a directory"
argument_list|)
throw|;
block|}
name|ret
