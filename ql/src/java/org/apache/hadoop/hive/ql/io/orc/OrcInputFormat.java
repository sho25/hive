...
block|}
block|}
comment|/**    * The full ACID directory information needed for splits; no more calls to HDFS needed.    * We could just live with AcidUtils.Directory but...    * 1) That doesn't contain have base files.    * 2) We save fs for convenience to avoid getting it twice.    */
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
