...
condition|)
block|{
comment|// Also, we currently do not use predicate evaluation when the schema has data type
comment|// conversion.
if|if
condition|(
name|evolution
...
name|debug
argument_list|(
literal|"Skipping split elimination for {} since the schema has data type conversion"
argument_list|,
name|file
operator|.
name|getPath
