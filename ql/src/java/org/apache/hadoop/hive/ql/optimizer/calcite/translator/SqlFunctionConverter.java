...
condition|)
block|{
comment|// Calcite native - has broken inference for return type, so we override it with explicit return type
comment|// e.g. timestamp - timestamp is inferred as timestamp, where it really should be interval.
name|calciteOp
operator|=
operator|new
name|SqlMonotonicBinaryOperator
