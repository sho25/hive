...
begin_comment
comment|/*  Authorizable Event for HiveMetaStore operation  AlterPartition  */
end_comment
...
name|COMMAND_STR
init|=
literal|"alter table %s partition %s"
decl_stmt|;
specifier|public
name|AlterPartitionEvent
parameter_list|(
...
name|debug
argument_list|(
literal|"==> AlterPartitionEvent.getInputHObjs()"
argument_list|)
expr_stmt|;
block|}
name|List
...
name|debug
argument_list|(
literal|"==> AlterPartitionEvent.getOutputHObjs()"
argument_list|)
expr_stmt|;
block|}
name|List
