...
argument_list|)
expr_stmt|;
comment|// Read/set include and exclude tables list.
name|int
name|idx
init|=
name|readReplScopeTablesList
argument_list|(
name|lineContents
argument_list|,
literal|1
...
name|IOException
block|{
comment|// If the list doesn't exist, then return.
if|if
condition|(
name|startIdx
operator|>=
...
return|;
block|}
comment|// Each tables list should start with "{" and ends with "}"
if|if
condition|(
operator|!
literal|"{"
...
name|IOException
argument_list|(
literal|"Invalid repl tables list data in dump metadata file. Missing \"{\"."
argument_list|)
throw|;
block|}
name|List
...
name|info
argument_list|(
literal|"Read ReplScope: Set Include Table Names: {}."
argument_list|,
name|tableNames
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Read ReplScope: Set Exclude Table Names: {}."
argument_list|,
name|tableNames
argument_list|)
expr_stmt|;
