...
return|;
block|}
comment|/**    * @param aggr: the original aggregate    * @param argList: the original argList in aggregate    * @param cleanArgList: the new argList without duplicates    * @param map: the mapping from the original argList to the new argList    * @param newGroupSet: the sorted positions of groupset    * @return    * @throws CalciteSemanticException    */
specifier|private
name|RelNode
name|createCount
parameter_list|(
...
block|}
block|}
comment|/**    * @param aggregate: the original aggregate    * @param argList: the original argList in aggregate    * @param cleanArgList: the new argList without duplicates    * @param map: the mapping from the original argList to the new argList    * @param groupSet: new group set    * @return    */
specifier|private
name|Aggregate
name|createGroupingSets
parameter_list|(
