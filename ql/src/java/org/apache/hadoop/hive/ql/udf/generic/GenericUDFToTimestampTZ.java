...
begin_comment
comment|/**  * Convert from string to TIMESTAMP WITH TIME ZONE.  */
end_comment
...
name|value
operator|=
literal|"CAST(STRING as TIMESTAMP WITH TIME ZONE) - returns the"
operator|+
literal|"timestamp with time zone represented by string."
argument_list|,
name|extended
operator|=
...
name|UDFArgumentLengthException
argument_list|(
literal|"The function CAST as TIMESTAMP WITH TIME ZONE requires at least one argument, got "
operator|+
name|arguments
operator|.
name|length
...
name|UDFArgumentException
argument_list|(
literal|"CAST as TIMESTAMP WITH TIME ZONE only allows"
operator|+
...
name|UDFArgumentException
argument_list|(
literal|"The function CAST as TIMESTAMP WITH TIME ZONE takes only primitive types"
argument_list|)
throw|;
block|}
name|converter
...
index|]
operator|+
literal|" AS TIMESTAMP WITH TIME ZONE)"
return|;
block|}
block|}
end_class
