...
name|SemanticException
argument_list|(
literal|"Each SMBMapJoin should be associated only with one Mapwork"
argument_list|)
throw|;
block|}
name|context
...
expr_stmt|;
block|}
comment|//If its a FileSink to bucketed files, also use MR-style shuffle to get compatible taskId for bucket-name
name|FileSinkOperator
name|fso
init|=
name|GenSparkUtils
