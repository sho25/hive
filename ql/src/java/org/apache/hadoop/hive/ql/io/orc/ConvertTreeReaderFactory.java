...
specifier|protected
name|Writable
name|getStringGroupResultFromString
parameter_list|(
name|Object
name|previous
parameter_list|,
...
specifier|protected
name|String
name|stringFromStringGroupTreeReader
parameter_list|(
name|TreeReader
...
name|RuntimeException
argument_list|(
literal|"Call read() and getLong instead"
argument_list|)
throw|;
block|}
specifier|protected
...
name|IOException
block|{
comment|// The DoubleColumnVector produced by FloatTreeReader is what we want.
name|floatTreeReader
operator|.
name|nextVector
argument_list|(
...
block|{
name|TimestampWritable
name|readTimestampWritableResult
init|=
operator|(
name|TimestampWritable
operator|)
...
name|IOException
block|{
comment|// UNDONE: Binary to StringGroup conversion?
name|byte
index|[]
name|bytes
init|=
...
name|DECIMAL
case|:
comment|// UNDONE: Decimal to Decimal conversion????
comment|// Not currently supported conversion(s):
case|case
name|BINARY
case|:
