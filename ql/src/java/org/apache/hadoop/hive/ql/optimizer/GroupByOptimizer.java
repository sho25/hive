...
condition|)
block|{
comment|// Lets see if this constant was folded because of optimization.
name|String
name|origCol
init|=
operator|(
...
expr_stmt|;
block|}
comment|// add selectOp to match the schema
comment|// after that, inputOp is the parent of selOp.
for|for
control|(
name|Operator
argument_list|<
...
name|selOp
init|=
name|genOutputSelectForGroupBy
argument_list|(
name|inputOp
argument_list|,
name|currOp
argument_list|)
decl_stmt|;
comment|// update the childOp of selectOp
name|selOp
operator|.
