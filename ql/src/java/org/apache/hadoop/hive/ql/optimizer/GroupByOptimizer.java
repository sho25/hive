...
block|}
block|}
comment|/**      * Given the group by keys, sort columns, this method      * determines if we can use sorted group by or not.      * We can use map-side sort group by group by columns match the sorted columns      * in exactly the same order.      *      * @param groupByCols      * @param sortCols      * @return      * @throws SemanticException      */
specifier|private
name|GroupByOptimizerSortMatch
name|matchSortColumns
parameter_list|(
