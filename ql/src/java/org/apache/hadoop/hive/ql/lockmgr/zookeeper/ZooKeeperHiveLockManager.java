...
return|;
block|}
comment|/**    * @param  name     The name of the zookeeper child    * @param  data     The data for the zookeeper child    * @param  mode     The mode in which the child needs to be created    * @param  numRetries  number of retries if the child cannot be created    * @param  sleepTime   sleep time between retries    **/
specifier|private
name|String
name|createChild
parameter_list|(
...
literal|null
return|;
comment|// nothing to do if the node already exists
block|}
catch|catch
parameter_list|(
name|Exception
