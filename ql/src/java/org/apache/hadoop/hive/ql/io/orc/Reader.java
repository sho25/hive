...
name|IOException
function_decl|;
comment|/**    * Create a RecordReader that reads everything with the given options.    * @param options the options to use    * @param conf conf object    * @return a new RecordReader    * @throws IOException    */
name|RecordReader
name|rowsOptions
parameter_list|(
name|Options
