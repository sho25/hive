...
return|;
block|}
comment|/**    * Alters a materialized view.    *    * @param db    *          Database that the materialized view belongs to.    * @param alterMVDesc    *          Descriptor of the changes.    * @return Returns 0 when execution succeeds and above 0 if it fails.    * @throws HiveException    * @throws InvalidOperationException    */
specifier|private
name|int
name|alterMaterializedView
parameter_list|(
...
name|AssertionError
argument_list|(
literal|"Unsupported alter materialized view type! : "
operator|+
name|alterMVDesc
operator|.
name|getOp
...
argument_list|)
expr_stmt|;
comment|// This is a replace/rebuild, so we need an exclusive lock
name|addIfAbsentByName
argument_list|(
operator|new
name|WriteEntity
...
control|)
block|{
comment|// Add to creation metadata
name|String
index|[]
name|names
init|=
...
argument_list|()
operator|.
name|getLastCompletedTransactionForTables
argument_list|(
name|dbNames
argument_list|,
name|tableNames
