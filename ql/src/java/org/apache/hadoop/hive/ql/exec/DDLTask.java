...
expr_stmt|;
block|}
comment|/**      * If the user didn't specify a SerDe, and any of the columns are not of type String,       * we will have to use DynamicSerDe instead.      */
if|if
condition|(
name|crtTbl
operator|.
...
name|info
argument_list|(
literal|"Default to DynamicSerDe for table "
operator|+
name|crtTbl
operator|.
name|getTableName
