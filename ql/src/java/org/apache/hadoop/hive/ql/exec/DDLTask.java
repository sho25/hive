...
block|}
block|}
comment|// reset owner and creation time
name|int
name|rc
init|=
name|setGenericTableAttributes
...
condition|)
block|{
comment|// if we are changing partition columns, check that partitions don't exist
if|if
condition|(
operator|!
name|oldview
...
name|HiveException
argument_list|(
literal|"Cannot add or drop partition columns with CREATE OR REPLACE VIEW if partitions currently exist"
argument_list|)
throw|;
block|}
block|}
