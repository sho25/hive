...
argument_list|()
operator|+
literal|" second argument only takes numeric type"
argument_list|)
throw|;
block|}
block|}
...
argument_list|()
operator|+
literal|" scale argument for "
operator|+
literal|"decimal must be constant"
argument_list|)
throw|;
block|}
break|break;
...
case|:
block|{
comment|// The getPrimitiveWritableObject method returns a new writable.
name|HiveDecimalWritable
...
argument_list|)
decl_stmt|;
comment|// Call the different round flavor.
return|return
name|round
argument_list|(
name|decimalWritable
