...
condition|)
block|{
comment|// ParseUtils.processSetColsNode() can change type of TOK_SETCOLREF nodes later
return|return
operator|new
name|CommonToken
argument_list|(
...
parameter_list|)
block|{
comment|// Overriden to copy start index / end index, that is needed through optimization,
comment|// e.g., for masking/filtering
name|ASTNode
name|astNode
init|=
operator|(
...
return|;
block|}
comment|/*    * Parse a string as a query hint.    */
specifier|public
name|ASTNode
name|parseHint
parameter_list|(
...
argument_list|)
expr_stmt|;
name|HiveParser_ResourcePlanParser
operator|.
name|triggerExpressionStandalone_return
name|r
init|=
literal|null
decl_stmt|;
...
name|parser
operator|.
name|gResourcePlanParser
operator|.
name|triggerExpressionStandalone
argument_list|()
expr_stmt|;
block|}
catch|catch
...
name|HiveParser_ResourcePlanParser
operator|.
name|triggerActionExpressionStandalone_return
name|r
init|=
literal|null
decl_stmt|;
...
name|gResourcePlanParser
operator|.
name|triggerActionExpressionStandalone
argument_list|()
expr_stmt|;
block|}
catch|catch
