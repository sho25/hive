...
argument_list|()
operator|+
literal|"(CompilationOpContext, OperatorDesc, VectorizationContext, VectorDesc) not found"
argument_list|,
name|e
argument_list|)
throw|;
...
name|HiveException
argument_list|(
literal|"Error encountered calling constructor "
operator|+
name|opClass
operator|.
name|getSimpleName
argument_list|()
operator|+
literal|"(CompilationOpContext, OperatorDesc, VectorizationContext, VectorDesc)"
argument_list|,
name|e
argument_list|)
throw|;
