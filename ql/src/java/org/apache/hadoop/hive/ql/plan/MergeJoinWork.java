...
expr_stmt|;
block|}
comment|/**    * For now, this class just says in EXPLAIN VECTORIZATION we don't support vectorization of the    * Merge Join vertex instead of being silent about it.    */
specifier|public
class|class
name|MergeJoinExplainVectorization
extends|extends
name|BaseExplainVectorization
block|{
specifier|private
...
index|[]
name|mergeWorkVectorizationConditions
decl_stmt|;
specifier|public
name|MergeJoinExplainVectorization
parameter_list|(
...
name|VectorizationCondition
index|[]
name|createMergeWorkExplainVectorizationConditions
parameter_list|()
block|{
name|boolean
name|enabled
...
name|enabled
argument_list|,
literal|"Vectorizing MergeJoin Supported"
argument_list|)
block|}
decl_stmt|;
return|return
...
name|displayName
operator|=
literal|"MergeJoin Vectorization"
argument_list|,
name|explainLevels
operator|=
block|{
