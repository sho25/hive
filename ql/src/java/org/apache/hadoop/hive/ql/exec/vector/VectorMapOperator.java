...
block|{
comment|// transfer the row-mode children to the vectorized op parent
name|List
argument_list|<
name|Operator
argument_list|<
...
name|HiveException
argument_list|(
literal|"Hive Runtime Error while processing "
argument_list|,
name|e
argument_list|)
throw|;
