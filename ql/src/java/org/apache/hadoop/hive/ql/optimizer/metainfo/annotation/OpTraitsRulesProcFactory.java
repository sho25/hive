...
control|)
block|{
comment|// Make sure this entry is in key columns.
name|boolean
name|isKey
init|=
literal|false
...
block|}
block|}
comment|/*    * PTFOperator re-orders the keys just like Group By Operator does.    */
specifier|public
specifier|static
class|class
name|PTFRule
...
condition|)
block|{
comment|// Go through each expression in PTF window function.
comment|// All the expressions must be on columns, else we put empty list.
for|for
control|(
name|PTFExpressionDef
name|expression
...
condition|)
block|{
comment|// clear out the list and bail out
name|partitionKeys
operator|.
name|clear
argument_list|()
