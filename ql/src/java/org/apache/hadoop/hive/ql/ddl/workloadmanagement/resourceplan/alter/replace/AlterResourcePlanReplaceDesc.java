...
begin_comment
comment|/**  * DDL task description for REPLACE [ACTIVE] RESOURCE PLAN ... commands.  */
end_comment
...
specifier|final
name|String
name|destinationResourcePlanName
decl_stmt|;
specifier|public
name|AlterResourcePlanReplaceDesc
parameter_list|(
...
name|displayName
operator|=
literal|"Destination Resource plan name"
argument_list|,
name|explainLevels
operator|=
block|{
