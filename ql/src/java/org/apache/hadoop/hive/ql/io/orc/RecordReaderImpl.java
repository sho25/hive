...
name|loc
decl_stmt|;
comment|// column statistics for char/varchar columns are stored as strings, so convert char/varchar
comment|// type predicates to string
name|Object
name|predObj
init|=
name|predicate
...
condition|)
block|{
comment|// primitive type of char/varchar is Text (i.e trailing white spaces trimmed string)
return|return
name|StringUtils
operator|.
name|stripEnd
