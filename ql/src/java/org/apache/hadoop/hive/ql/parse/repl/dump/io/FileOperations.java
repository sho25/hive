...
condition|)
block|{
comment|// This is only called for replication that handles MM tables; no need for mmCtx.
try|try
init|(
name|BufferedWriter
name|writer
...
name|info
argument_list|(
literal|" sleep for {} milliseconds for retry num {} "
argument_list|,
name|sleepTime
argument_list|,
name|repeat
...
name|info
argument_list|(
literal|"thread sleep interrupted"
argument_list|,
name|timerEx
operator|.
name|getMessage
...
expr_stmt|;
block|}
comment|// in case of io error, reset the file system object
name|FileSystem
operator|.
name|closeAllForUGI
argument_list|(
