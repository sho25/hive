...
condition|)
block|{
comment|/*          * in the case of count(or sum) distinct if we are not able to map          * a parameter column references back to the ReduceSink value columns          * we give up and assume all columns are needed.          */
name|boolean
