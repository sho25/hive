...
begin_comment
comment|/**  * Planner rule that removes UDF sq_count_check from a  * plan if group by keys in a subquery are constant  * and there is no windowing or grouping sets  */
end_comment
