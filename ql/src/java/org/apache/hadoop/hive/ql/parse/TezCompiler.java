...
argument_list|()
decl_stmt|;
comment|// We check whether we can find semijoin predicates
for|for
control|(
name|SemijoinOperatorInfo
name|roi
...
argument_list|)
decl_stmt|;
comment|// First rest of predicates
name|newAndArgs
operator|.
name|addAll
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Then sorted between predicates
name|newAndArgs
operator|.
name|addAll
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Finally, sorted in bloom predicates
name|ExprNodeDesc
name|andExpr
init|=
name|ExprNodeGenericFuncDesc
...
condition|)
block|{
comment|// tsExpr might actually be a ExprNodeFieldDesc and we need to extract the column expression
if|if
condition|(
name|tsExpr
operator|instanceof
...
name|info
argument_list|(
literal|"Unwrapped column expression from ExprNodeFieldDesc"
argument_list|)
expr_stmt|;
name|tsExpr
operator|=
