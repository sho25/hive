...
name|SemanticException
argument_list|(
literal|"Unions not yet supported on Tez."
operator|+
literal|" Please use MR for this query"
argument_list|)
throw|;
block|}
block|}
...
name|RuleRegExp
argument_list|(
literal|"Handle Forward opertor"
argument_list|,
name|ForwardOperator
operator|.
name|getOperatorName
