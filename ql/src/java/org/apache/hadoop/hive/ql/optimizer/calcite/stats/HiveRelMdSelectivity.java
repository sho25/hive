...
condition|)
block|{
comment|// Distinct row count could not be determined,
comment|// return default selectivity
return|return
literal|1.0
return|;
block|}
...
name|ndvEstimate
operator|=
name|maxNdvForCorrelatedColumns
argument_list|(
name|peLst
argument_list|,
name|colStatMap
