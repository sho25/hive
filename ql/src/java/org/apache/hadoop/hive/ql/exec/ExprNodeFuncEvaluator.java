...
name|ObjectInspector
index|[]
name|paramInspectors
decl_stmt|;
specifier|transient
name|boolean
index|[]
name|paramIsPrimitiveWritable
decl_stmt|;
specifier|transient
name|Object
index|[]
...
expr_stmt|;
block|}
comment|// The return type of a function can be either Java Primitive or Writable.
if|if
condition|(
name|PrimitiveObjectInspectorUtils
operator|.
...
comment|// We should convert UDFSize and UDFIsNull to ExprNodeEvaluator.
switch|switch
condition|(
name|c
condition|)
