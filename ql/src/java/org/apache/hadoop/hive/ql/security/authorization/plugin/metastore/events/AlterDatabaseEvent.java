...
begin_comment
comment|/*  Authorizable Event for HiveMetaStore operation  AlterDatabase  */
end_comment
...
name|debug
argument_list|(
literal|"==> AlterDatabaseEvent.getOutputHObjs()"
argument_list|)
expr_stmt|;
block|}
name|List
...
name|debug
argument_list|(
literal|"<== AlterDatabaseEvent.getOutputHObjs(): ret="
operator|+
name|ret
argument_list|)
expr_stmt|;
