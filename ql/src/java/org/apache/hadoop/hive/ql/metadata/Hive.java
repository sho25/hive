...
comment|// removed source file staging.. it's more confusing when faild.
for|for
control|(
name|int
name|counter
...
condition|)
block|{
comment|//need to find last existing path, and apply its permission on entire subtree.
name|Path
name|path
init|=
name|destf
...
expr_stmt|;
block|}
comment|//at the end of this loop, path is the last existing path (the real parent).
name|fs
operator|.
name|mkdirs
argument_list|(
...
name|info
argument_list|(
literal|"setting permission of parent folder: "
operator|+
name|path
operator|.
name|toString
...
block|{
comment|//simply make the directory.
name|fs
operator|.
name|mkdirs
argument_list|(
