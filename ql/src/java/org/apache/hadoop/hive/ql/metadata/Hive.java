...
condition|)
block|{
name|setTableSnapshotForTransactionalTable
argument_list|(
name|environmentContext
argument_list|,
name|conf
...
condition|)
block|{
name|setTableSnapshotForTransactionalPartition
argument_list|(
name|environmentContext
argument_list|,
name|conf
...
condition|)
block|{
comment|// Can be null for create table case; we don't need to verify txn stats.
name|ec
operator|.
name|putToProperties
argument_list|(
...
name|warn
argument_list|(
literal|"Table snapshot has null write IDs for "
operator|+
name|newTbl
argument_list|)
expr_stmt|;
