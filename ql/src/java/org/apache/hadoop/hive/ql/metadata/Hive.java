...
return|;
block|}
comment|/**    * Returns metadata for the table named tableName in the current database.    * @param tableName the name of the table    * @return    * @throws HiveException if there's an internal error or if the    * table doesn't exist    */
specifier|public
name|Table
name|getTable
parameter_list|(
...
condition|)
block|{
comment|// Partition does not exist currently. The partition name is
comment|// extrapolated from
...
argument_list|)
expr_stmt|;
comment|// create the parent directory otherwise rename can fail if the parent
