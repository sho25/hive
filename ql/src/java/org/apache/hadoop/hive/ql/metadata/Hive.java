...
literal|null
decl_stmt|;
comment|/**    * get    *    * @param c    * @return    * @exception    *    */
specifier|public
specifier|static
name|Hive
name|get
...
condition|)
block|{
comment|// TODO - this doesn't work if the user switches to a different metadb server
comment|// during the same session. revisit.
name|c
operator|.
name|set
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//msc = new HiveMetaStoreClient(this.conf);
block|}
catch|catch
parameter_list|(
name|MetaException
...
name|HiveException
argument_list|(
literal|"Unable to open connection to metastore"
argument_list|,
name|e
argument_list|)
throw|;
...
name|info
argument_list|(
literal|"Closing current connection to Hive Metastore."
argument_list|)
expr_stmt|;
if|if
condition|(
...
block|}
block|}
comment|/**    * Drops table along with the data in it. If the table doesn't exist then it is a no-op    * @param tableName    * @throws HiveException    */
specifier|public
name|void
name|dropTable
parameter_list|(
...
return|;
block|}
comment|/**    * Returns metadata of the table.     * @param tableName the name of the table    * @return the table    * @exception HiveException if there's an internal error or if the table doesn't exist     */
specifier|public
name|Table
name|getTable
parameter_list|(
...
return|;
block|}
comment|/**    * Returns metadata of the table    * @param tableName    * @param throwException controls whether an exception is thrown or a returns a null    * @return    * @throws HiveException    */
specifier|public
name|Table
name|getTable
parameter_list|(
