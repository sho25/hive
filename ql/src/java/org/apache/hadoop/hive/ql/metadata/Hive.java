...
argument_list|()
operator|+
literal|" ignored for rewriting as it contains non-transactional tables"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
condition|)
block|{
comment|// We will not try partial rewriting either because the config specification, this
comment|// is a rebuild over some non-transactional table, or there were update/delete
comment|// operations in the source tables (not supported yet)
name|LOG
operator|.
name|debug
argument_list|(
