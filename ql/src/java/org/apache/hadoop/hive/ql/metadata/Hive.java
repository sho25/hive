...
expr_stmt|;
block|}
comment|/**    * Updates the existing table metadata with the new metadata.    *    * @param fullyQlfdTblName    *          name of the existing table    * @param newTbl    *          new name of the table. could be the old name    * @throws InvalidOperationException    *           if the changes in metadata is not acceptable    * @throws TException    */
specifier|public
name|void
name|alterTable
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Creates the table with the given objects. It takes additional arguments for    * primary keys and foreign keys associated with the table.    *    * @param tbl    *          a table object    * @param ifNotExists    *          if true, ignore AlreadyExistsException    * @param primaryKeys    *          primary key columns associated with the table    * @param foreignKeys    *          foreign key columns associated with the table    * @param uniqueConstraints    *          UNIQUE constraints associated with the table    * @param notNullConstraints    *          NOT NULL constraints associated with the table    * @param defaultConstraints    *          DEFAULT constraints associated with the table    * @throws HiveException    */
specifier|public
name|void
name|createTable
parameter_list|(
...
argument_list|()
operator|+
literal|" ignored for rewriting as there was no information loaded in the invalidation cache"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
argument_list|()
decl_stmt|;
comment|// If the limit is not met, we do not add the materialized view.
comment|// If we are doing a rebuild, we do not consider outdated materialized views either.
if|if
condition|(
name|diff
operator|==
...
condition|)
block|{
comment|// If parameter is zero, materialized view cannot be outdated at all
name|LOG
operator|.
name|debug
argument_list|(
