...
name|DATE
case|:
comment|// The Calcite literal is in GMT, this will be converted back to JVM locale
comment|// by ASTBuilder.literal during Calcite->Hive plan conversion
specifier|final
name|Calendar
name|cal
init|=
...
comment|// Calcite cannot represent TIMESTAMP literals with precision higher than 3
if|if
condition|(
name|ts
operator|.
...
name|CalciteSemanticException
argument_list|(
literal|"High Precision Timestamp: "
operator|+
name|String
operator|.
name|valueOf
