...
function_decl|;
block|}
comment|/**    * Evaluate current value against this expression. Return true if expression evaluates to true (current> limit)    * else false otherwise    *    * @param current - current value against which expression will be evaluated    * @return    */
name|boolean
name|evaluate
parameter_list|(
specifier|final
