...
name|cnfThrowable
init|=
name|findClassNotFoundException
argument_list|(
name|ke
argument_list|)
decl_stmt|;
...
argument_list|()
operator|+
literal|"\". If this is a UDF and you "
operator|+
literal|"are running LLAP, you may need to regenerate the llap startup script and restart "
operator|+
literal|"llap with jars for your udf."
argument_list|,
name|cnfThrowable
argument_list|)
expr_stmt|;
...
literal|"\" You may"
operator|+
literal|" need to regenerate the LLAP startup script and restart llap daemons."
argument_list|,
name|cnfThrowable
argument_list|)
throw|;
...
return|;
block|}
comment|/**      * get the jar files from specified directory or get jar files by several jar names sperated by comma      * @param path      * @return      */
specifier|public
specifier|static
name|Set
argument_list|<
...
condition|)
block|{
comment|// add all jar files under the reloadable auxiliary jar paths
name|Set
argument_list|<
name|File
argument_list|>
