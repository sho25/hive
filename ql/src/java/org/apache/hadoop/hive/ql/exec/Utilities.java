...
expr_stmt|;
block|}
comment|/**    * Deserializes the plan.    * @param in The stream to read from.    * @return The plan, such as QueryPlan, MapredWork, etc.    */
specifier|public
specifier|static
parameter_list|<
name|T
...
parameter_list|)
block|{
comment|// TODO: need proper clone. Meanwhiel, let's at least keep this horror in one place
name|PerfLogger
name|perfLogger
init|=
name|PerfLogger
