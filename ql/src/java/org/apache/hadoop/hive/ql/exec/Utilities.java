...
argument_list|)
expr_stmt|;
comment|//this loader is closed, remove it from cached registry loaders to avoid remove it again.
name|Registry
name|reg
init|=
name|SessionState
...
return|;
block|}
comment|/**    * Strips Hive password details from configuration    */
specifier|public
specifier|static
name|void
...
parameter_list|)
block|{
comment|// Strip out all Hive related password information from the JobConf
if|if
condition|(
name|HiveConf
operator|.
