...
argument_list|)
decl_stmt|;
comment|// This is just a backup case. We would like Hive to always have jobnames.
if|if
condition|(
name|s
operator|==
...
condition|)
block|{
comment|// There is no job name => we set one
name|s
operator|=
literal|"JOB"
operator|+
...
return|;
block|}
comment|/**    * Returns a unique ID for the job.    */
specifier|public
specifier|static
name|int
name|sanitizedJobId
...
argument_list|)
decl_stmt|;
comment|/**    * Local job name looks like "job_local_1_map_0000", where 1 is job ID and 0000 is task ID.    */
specifier|private
specifier|static
name|Pattern
name|fileNameLocalTaskIdRegex
init|=
name|Pattern
operator|.
name|compile
...
return|;
block|}
comment|/**    * Replace the task id from the filename. E.g., replace "000000" out of    * "24931_r_000000_0" or "24931_r_000000_0.gz" by 33 to    * "24931_r_000033_0" or "24931_r_000033_0.gz"    */
specifier|public
specifier|static
name|String
