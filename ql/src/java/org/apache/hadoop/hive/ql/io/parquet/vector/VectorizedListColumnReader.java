...
begin_comment
comment|/**  * It's column level Parquet reader which is used to read a batch of records for a list column.  * TODO Currently List type only support non nested case.  */
end_comment
...
expr_stmt|;
block|}
comment|// Need to be in consistent with that VectorizedPrimitiveColumnReader#readBatchHelper
comment|// TODO Reduce the duplicated code
specifier|private
name|Object
name|readPrimitiveTypedRow
parameter_list|(
