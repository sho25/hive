...
condition|)
block|{
comment|// Empty partition, single reducer -> constant hashCode
name|hashCode
operator|=
literal|0
expr_stmt|;
...
block|{
comment|// Empty partition, multiple reducers -> random hashCode
name|hashCode
operator|=
name|nonPartitionRandom
operator|.
...
block|{
comment|// Compute hashCode from partitions
name|partitionVectorExtractRow
operator|.
name|extractRow
argument_list|(
...
expr_stmt|;
block|}
comment|// Compute hashCode from buckets
if|if
condition|(
operator|!
name|isEmptyBuckets
