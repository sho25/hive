...
begin_comment
comment|/**  * UDFDateFloorSecond.  *  * Converts a timestamp to a timestamp with second granularity.  */
end_comment
...
name|value
operator|=
literal|"_FUNC_(param) - Returns the timestamp at a second granularity"
argument_list|,
name|extended
operator|=
