...
expr_stmt|;
block|}
comment|/**    * Return a list of partitions matching the filter.    * @param filter filter string, must be not null.    * @return list of partitions, always not-null.    * @throws MetaException    */
name|List
argument_list|<
name|Partition
argument_list|>
...
name|error
argument_list|(
literal|"JavaScript script engine is not found, therefore partition filtering "
operator|+
literal|"for temporary tables is disabled."
argument_list|)
expr_stmt|;
return|return
name|result
...
name|MetaException
argument_list|(
literal|"Incorrect partition filter"
argument_list|)
throw|;
block|}
block|}
