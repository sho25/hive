...
decl_stmt|;
comment|// Is the table for which we are updating stats going
comment|// to be migrated during replication.
specifier|private
name|long
name|writeId
decl_stmt|;
...
literal|true
return|;
comment|// Checked at setup time; if this is called, the table is transactional.
block|}
block|}
end_class
