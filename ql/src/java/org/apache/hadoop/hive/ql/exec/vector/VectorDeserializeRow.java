...
block|{
comment|// Pass true for canRetainByteRef since we will be keeping byte references to the input
comment|// bytes with the BytesColumnVector.setRef method.
name|deserializeRowColumn
argument_list|(
name|batch
