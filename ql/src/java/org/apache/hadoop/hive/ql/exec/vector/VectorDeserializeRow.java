...
name|UNION
case|:
comment|// The only aspect of conversion to Struct / Union themselves is add fields as NULL on the end
comment|// (no removal from end? which would mean skipping fields...)
comment|// UNDONE
break|break;
case|case
name|LIST
...
name|MAP
case|:
comment|// Conversion only happens below to List elements or Map key and/or values and not to the
comment|// List or Map itself.
default|default:
throw|throw
operator|new
name|RuntimeException
