...
literal|null
return|;
comment|// TODO: when txn stats are implemented, use writeIds to determine stats accuracy
annotation|@
...
comment|//       to retrieve partsToUpdate in a single query; no checking partition params in java.
name|List
argument_list|<
name|String
argument_list|>
