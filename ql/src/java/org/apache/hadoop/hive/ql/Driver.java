...
block|}
block|}
comment|//restore state after we're done executing a specific query
return|return
literal|0
return|;
block|}
...
return|;
block|}
comment|/**    * Returns a set of hooks specified in a configuration variable.    *    * See getHooks(HiveConf.ConfVars hookConfVar, Class<T> clazz)    * @param hookConfVar    * @return    * @throws Exception    */
specifier|private
name|List
argument_list|<
name|Hook
...
name|warn
argument_list|(
literal|"Exception in closing hive lock manager. "
operator|+
name|org
operator|.
name|apache
