...
expr_stmt|;
block|}
comment|/**    * Launches a new task    *    * @param tsk    *          task being launched    * @param queryId    *          Id of the query containing the task    * @param noName    *          whether the task has a name set    * @param jobname    *          name of the task, if it is a map-reduce job    * @param jobs    *          number of map-reduce jobs    * @param taskQueue    *          the task queue    */
specifier|private
name|TaskRunner
name|launchTask
parameter_list|(
