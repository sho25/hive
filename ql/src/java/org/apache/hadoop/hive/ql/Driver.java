...
condition|)
block|{
comment|//this may be true for conditional task, but we will not inc the counter
name|jobs
operator|++
expr_stmt|;
block|}
...
return|;
block|}
comment|/**    * Encapsulates the basic response info returned by the Driver. Typically    *<code>errorMessage</code> and<code>SQLState</code> will only be set if    * the<code>responseCode</code> is not 0.    */
specifier|public
class|class
name|DriverResponse
block|{
