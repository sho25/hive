...
comment|// NOTE: only used from index related classes
specifier|public
name|Driver
parameter_list|(
name|HiveConf
...
literal|null
decl_stmt|;
comment|// convert to List as above Set was created using Sets.union (for reasons
comment|// explained there)
comment|// but that Set is immutable
name|List
argument_list|<
name|ReadEntity
argument_list|>
...
argument_list|)
decl_stmt|;
comment|// add permanent UDFs being used
name|inputList
operator|.
name|addAll
argument_list|(
name|getPermanentFunctionEntities
argument_list|(
name|ss
argument_list|)
argument_list|)
...
condition|)
block|{
comment|// Only permanent functions need to be authorized.
comment|// Built-in function access is allowed to all users.
comment|// If user can create a temp function, they should be able to use it
comment|// without additional authorization.
continue|continue;
block|}
name|functionEntities
operator|.
