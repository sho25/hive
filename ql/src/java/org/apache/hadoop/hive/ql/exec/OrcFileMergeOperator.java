...
name|warn
argument_list|(
literal|"Incompatible ORC file merge! Schema mismatch for "
operator|+
name|k
operator|.
name|getInputPath
...
name|warn
argument_list|(
literal|"Incompatible ORC file merge! File version mismatch for "
operator|+
name|k
operator|.
name|getInputPath
...
name|warn
argument_list|(
literal|"Incompatible ORC file merge! Writer version mismatch for "
operator|+
name|k
operator|.
name|getInputPath
