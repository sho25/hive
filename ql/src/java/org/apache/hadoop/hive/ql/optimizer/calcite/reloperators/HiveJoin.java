...
argument_list|()
expr_stmt|;
comment|// 2. Get possible algorithms
name|Set
argument_list|<
name|JoinAlgorithm
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// 3. For each possible algorithm, calculate cost, and select best
name|RelOptCost
name|selfCost
init|=
literal|null
...
argument_list|()
decl_stmt|;
comment|// TODO: Check whether inputs are already sorted; currently we assume
comment|//       we need to sort all of them
specifier|final
name|double
name|cpuCost
init|=
