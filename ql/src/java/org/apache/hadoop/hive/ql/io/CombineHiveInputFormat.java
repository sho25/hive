...
comment|// Hadoop does not handle non-splitable files correctly for CombineFileInputFormat,
...
try|try
block|{
comment|// Take only the path part of the URI.
...
name|info
argument_list|(
literal|"getPartitionDescFromPath "
argument_list|,
name|e2
argument_list|)
expr_stmt|;
