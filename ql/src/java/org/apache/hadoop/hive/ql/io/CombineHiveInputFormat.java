...
try|try
block|{
comment|//if path does not have scheme, use the scheme from filterPath
...
comment|//if it happens it can lead to incorrect splits being generated
comment|// and files that should not be combined could end up being combied
throw|throw
operator|new
