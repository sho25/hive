...
argument_list|()
operator|+
literal|" only takes INTERVAL_YEAR_MONTH and STRING_GROUP types, got "
operator|+
name|inputTypes
index|[
name|i
...
argument_list|()
operator|+
literal|" only takes INTERVAL_DAY_TIME and STRING_GROUP types, got "
operator|+
name|inputTypes
index|[
name|i
...
argument_list|()
operator|+
literal|" only takes BOOLEAN types as "
operator|+
name|getArgOrder
argument_list|(
name|i
