...
name|info
argument_list|(
literal|"ACID tables con only be vectorized for the input file format -- "
operator|+
literal|"i.e. when Hive Configuration option "
operator|+
name|HiveConf
operator|.
name|ConfVars
...
return|;
block|}
comment|// Today, ACID tables are only ORC and that format is vectorizable.  Verify this
comment|// assumption.
name|Preconditions
operator|.
name|checkState
...
literal|"=false and "
operator|+
literal|" ACID table is "
operator|+
name|isAcidTable
operator|+
literal|" and "
operator|+
literal|" given the Hive Configuration options "
operator|+
name|getHiveOptionsString
argument_list|()
argument_list|)
