...
argument_list|()
operator|+
literal|" with vectorization context key="
operator|+
name|vContext
operator|.
name|getFileKey
...
argument_list|()
operator|+
literal|" added new vectorization context key="
operator|+
name|vOutContext
operator|.
name|getFileKey
...
name|debug
argument_list|(
literal|"Vectorized ReduceWork reduce shuffle vectorization context key="
operator|+
name|vContext
operator|.
name|getFileKey
