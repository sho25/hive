...
condition|)
block|{
comment|// For now, VectorGroupByOperator ProcessingModeReduceMergePartial cannot handle key
comment|// expressions.
for|for
control|(
name|ExprNodeDesc
...
literal|"Key"
argument_list|,
literal|"Non-column key expressions not supported for MERGEPARTIAL"
argument_list|)
expr_stmt|;
return|return
literal|false
...
return|;
block|}
comment|/*     if (aggDesc.getDistinct()) {       setExpressionIssue("Aggregation Function", "DISTINCT not supported");       return new Pair<Boolean,Boolean>(false, false);     }     */
if|if
condition|(
name|aggDesc
operator|.
...
expr_stmt|;
name|boolean
name|hasEmptyBuckets
init|=
literal|false
decl_stmt|;
name|boolean
name|hasNoPartitions
init|=
literal|false
decl_stmt|;
if|if
...
condition|)
block|{
comment|// Check for unexpected conditions...
name|hasEmptyBuckets
operator|=
operator|(
name|desc
...
name|info
argument_list|(
literal|"Unexpected condition: UNIFORM hash and empty buckets"
argument_list|)
expr_stmt|;
name|isUnexpectedCondition
operator|=
...
name|info
argument_list|(
literal|"Unexpected condition: UNIFORM hash and no partitions"
argument_list|)
expr_stmt|;
name|isUnexpectedCondition
operator|=
