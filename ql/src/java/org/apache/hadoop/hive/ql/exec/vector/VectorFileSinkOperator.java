...
literal|"Number of dynamic partitions exceeded hive.exec.max.dynamic.partitions"
operator|+
literal|".pernode."
block|}
decl_stmt|;
...
literal|null
decl_stmt|;
comment|//lbDirName = (lbCtx == null) ? null : generateListBucketingDirName(row);
name|FSPaths
name|fpaths
decl_stmt|;
if|if
