...
name|inputFormatClass
operator|=
name|getInputFormatClassFromSplit
argument_list|(
name|s
argument_list|,
name|work
...
argument_list|()
operator|+
literal|" implements SplitSizeEstimator"
argument_list|)
expr_stmt|;
name|splitSizeEstimatorMap
operator|.
...
argument_list|()
operator|+
literal|" does not implement SplitSizeEstimator"
argument_list|)
expr_stmt|;
name|splitSizeEstimatorMap
operator|.
