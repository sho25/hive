...
return|;
block|}
comment|/**    * Create task location hints from a set of input splits    * @param splits the actual splits    * @return taskLocationHints - 1 per input split specified    * @throws IOException    */
specifier|public
name|List
argument_list|<
name|TaskLocationHint
