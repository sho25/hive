...
begin_comment
comment|/**  * This class evaluates double first_value() for a PTF group.  *  * We capture the last value from the last batch.  It can be NULL.  * It becomes the group value.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// Last row of last batch determines isGroupResultNull and double lastValue.
