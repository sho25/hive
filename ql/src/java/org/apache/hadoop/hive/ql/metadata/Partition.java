...
return|;
block|}
comment|/**    * We already have methods that clone stuff using XML or Kryo.    * And now for something completely different - let's clone SD using Thrift!    * Refactored into a method.    */
specifier|public
specifier|static
name|StorageDescriptor
name|cloneSd
...
return|;
block|}
comment|// What is the point of this?  Why not just use the copy constructor in StorageDescriptor?
name|StorageDescriptor
name|sd
init|=
operator|new
...
condition|)
block|{
comment|// sd can be null for views
name|String
name|clsName
init|=
name|tPartition
