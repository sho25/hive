...
block|}
block|}
comment|/**      * Creates a partition name -> value spec map object      * @param tbl Use the information from this table.      * @param tp Use the information from this partition.      * @return Partition name to value mapping.      */
specifier|private
name|LinkedHashMap
argument_list|<
name|String
