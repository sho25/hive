...
block|{
comment|/**        * Table location string need to be constructed as URI first to decode        * the http encoded characters in the location path (because location is        * stored as URI in org.apache.hadoop.hive.ql.metadata.Table before saved        * to metastore database). This is not necessary for partition location.        */
try|try
block|{
return|return
operator|new
