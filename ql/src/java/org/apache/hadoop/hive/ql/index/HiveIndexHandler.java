...
name|HiveException
function_decl|;
comment|/**    * Requests that the handler generate a plan for building the index; the plan    * should read the base table and write out the index representation.    *     * @param baseTable    *          the definition of the table being indexed    *     * @param index    *          the definition of the index    *     * @param indexTblPartitions    *          list of index partitions    *     * @param baseTblPartitions    *          list of base table partitions with each element mirrors to the    *          corresponding one in indexTblPartitions    *     * @param indexTable    *          the definition of the index table, or null if usesIndexTable()    *          returns null    *     * @param db    *     * @return list of tasks to be executed in parallel for building the index    *     * @throw HiveException if plan generation fails    */
name|List
argument_list|<
name|Task
argument_list|<
