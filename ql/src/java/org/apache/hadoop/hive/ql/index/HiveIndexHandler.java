...
name|HiveException
function_decl|;
comment|/**    * Generate the list of tasks required to run an index sub-query for the    * given predicate, using the given index    * @param index    * @param predicate    * @param parseContext    * @param queryContext contains results, such as query tasks and input configuration    */
name|void
