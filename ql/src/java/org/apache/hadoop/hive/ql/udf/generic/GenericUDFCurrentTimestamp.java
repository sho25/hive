...
name|value
operator|=
literal|"_FUNC_() - Returns the current timestamp at the start of query evaluation."
operator|+
...
name|UDFArgumentLengthException
argument_list|(
literal|"The function CURRENT_TIMESTAMP does not take any arguments, but found "
operator|+
name|arguments
operator|.
name|length
...
argument_list|)
expr_stmt|;
comment|// Need to preserve currentTimestamp
name|GenericUDFCurrentTimestamp
name|other
init|=
operator|(
