...
name|value
operator|=
literal|"CAST(<string> AS INTERVAL YEAR TO MONTH) - Returns the year-month interval represented by the string"
argument_list|)
specifier|public
class|class
...
name|UDFArgumentLengthException
argument_list|(
literal|"The function INTERVAL_YEAR_MONTH requires at least one argument, got "
operator|+
name|arguments
operator|.
name|length
...
name|UDFArgumentException
argument_list|(
literal|"The function INTERVAL_YEAR_MONTH takes only primitive types"
argument_list|)
throw|;
block|}
name|tc
...
name|append
argument_list|(
literal|" AS INTERVAL YEAR TO MONTH)"
argument_list|)
expr_stmt|;
return|return
name|sb
