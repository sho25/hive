...
begin_comment
comment|/*  * Specialized class for doing a vectorized map join that is an inner join on a Single-Column Long  * and only big table columns appear in the join result so a hash multi-set is used.  */
end_comment
...
block|}
comment|//---------------------------------------------------------------------------
comment|// Process Single-Column Long Inner Big-Only Join on a vectorized row batch.
comment|//
annotation|@
name|Override
specifier|public
...
comment|/*          * Get our Single-Column Long hash multi-set information for this specialized class.          */
name|hashMultiSet
operator|=
operator|(
name|VectorMapJoinLongHashMultiSet
