...
name|displayName
operator|=
literal|"DynamicPartitionHashJoin"
argument_list|,
name|explainLevels
operator|=
block|{
...
specifier|public
name|String
name|getDebugOuterFilterMapString
parameter_list|()
block|{
if|if
condition|(
...
condition|)
block|{
comment|// Only add this condition when false to avoid mega-Q file update.
name|conditionList
operator|.
name|add
argument_list|(
...
name|displayName
operator|=
literal|"hashTableImplementationType"
argument_list|,
name|explainLevels
operator|=
block|{
...
name|displayName
operator|=
literal|"bigTableFilterExpressions"
argument_list|,
name|explainLevels
operator|=
block|{
...
name|displayName
operator|=
literal|"bigTableRetainColumnNums"
argument_list|,
name|explainLevels
operator|=
block|{
...
specifier|public
name|String
name|getBigTableRetainedColumnNums
parameter_list|()
block|{
if|if
condition|(
...
name|displayName
operator|=
literal|"nonOuterSmallTableKeyMapping"
argument_list|,
name|explainLevels
operator|=
block|{
...
specifier|public
name|String
name|getNonOuterSmallTableKeyMapping
parameter_list|()
block|{
if|if
condition|(
