...
argument_list|(
literal|"Clone with vectorization desc not supported"
argument_list|)
throw|;
block|}
name|this
...
decl_stmt|;
name|boolean
name|whenFastHashTableThenNoHybrid
init|=
operator|(
operator|!
name|isFastHashTableEnabled
...
name|whenFastHashTableThenNoHybrid
argument_list|,
literal|"When Fast Hash Table, then requires no Hybrid Hash Join"
argument_list|)
block|,
operator|new
name|VectorizationCondition
