...
parameter_list|()
block|{   }
comment|/**    * @param conf    *          hive configuration    * @param opTaskMap    *          reducer to task mapping    * @param parseCtx    *          current parse context    * @param rootTasks    *          root tasks for the plan    * @param mvTask    *          the final move task    * @param mapCurrCtx    *          operator to task mappings    * @param inputs    *          the set of input tables/partitions generated by the walk    * @param outputs    *          the set of destinations generated by the walk    */
specifier|public
name|GenMRProcContext
parameter_list|(
name|HiveConf
