...
argument_list|,
operator|new
name|VectorGroupByOperatorComparator
argument_list|()
argument_list|)
expr_stmt|;
name|comparatorMapping
...
argument_list|,
operator|new
name|CommonMergeJoinOperatorComparator
argument_list|()
argument_list|)
expr_stmt|;
name|comparatorMapping
...
argument_list|,
operator|new
name|VectorSelectOperatorComparator
argument_list|()
argument_list|)
expr_stmt|;
name|comparatorMapping
...
argument_list|,
operator|new
name|AppMasterEventOperatorComparator
argument_list|()
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|". Default to always false comparator."
argument_list|)
expr_stmt|;
return|return
name|AlwaysFalseOperatorComparator
...
argument_list|>
block|{
comment|// the outer class is responsible for maintaining the comparator singleton
specifier|private
name|AlwaysFalseOperatorComparator
parameter_list|()
block|{     }
