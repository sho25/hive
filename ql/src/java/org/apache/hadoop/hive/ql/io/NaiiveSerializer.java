...
begin_comment
comment|/**  * Serializes and deserializes Hive Objects as a delimited strings.  **/
end_comment
...
argument_list|(
literal|"UTF-8 should be supported"
argument_list|,
name|e
argument_list|)
throw|;
...
expr_stmt|;
block|}
comment|// Will make this configurable when DDL (CREATE TABLE) supports customized null string.
name|String
name|nullString
init|=
literal|null
