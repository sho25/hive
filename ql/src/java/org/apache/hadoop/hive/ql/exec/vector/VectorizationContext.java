...
return|;
block|}
comment|/**    * Returns a vector expression for a given expression    * description.    * @param exprDesc, Expression description    * @return {@link VectorExpression}    */
specifier|public
name|VectorExpression
name|getVectorExpression
parameter_list|(
...
name|println
argument_list|(
literal|"In the context, Input column 1: "
operator|+
name|inputCol1
operator|+
literal|", column 2: "
