...
condition|)
block|{
comment|// Special case handling for Multi-OR and Multi-AND FILTER and PROJECTION.
name|Class
argument_list|<
name|?
argument_list|>
...
block|{
return|return
name|createVectorMultiAndOrProjectionExpr
argument_list|(
name|vclass
argument_list|,
name|childExpr
...
specifier|private
name|void
name|determineChildrenVectorExprAndArguments
parameter_list|(
name|Class
argument_list|<
name|?
...
argument_list|)
expr_stmt|;
comment|// For Multi-AND/OR, transform the arguments -- column indices into an array of int.
name|int
index|[]
name|colNums
init|=
