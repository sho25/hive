...
block|}
block|}
comment|/* Return true if we are running in the planner, and false if we    * are running in a task.    */
comment|/*   private boolean isPlanner() {      // This relies on the behavior that columnMap is null in the planner.     return columnMap == null;   }   */
specifier|private
class|class
name|OutputColumnManager
block|{
...
block|{
comment|// TODO? add code to handle constant argument case
throw|throw
operator|new
name|HiveException
argument_list|(
