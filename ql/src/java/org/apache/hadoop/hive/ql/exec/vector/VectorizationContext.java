...
return|;
block|}
comment|// We need to differentiate DECIMAL columns by their precision and scale...
name|String
...
name|HiveException
argument_list|(
literal|"No vector type for type name "
operator|+
name|returnType
argument_list|)
throw|;
...
name|HiveException
argument_list|(
literal|"Unable to use the VectorUDFAdaptor. Encountered unsupported expr desc : "
operator|+
name|child
argument_list|)
throw|;
...
name|CHAR
case|:
comment|//Return the CHAR type as is, it includes maximum length
return|return
name|hiveTypeName
return|;
case|case
name|VARCHAR
case|:
comment|//Return the VARCHAR type as is, it includes maximum length.
return|return
name|hiveTypeName
return|;
case|case
...
argument_list|)
expr_stmt|;
comment|// We haven't had a chance to examine the VAR* and STD* area and expand it beyond PARTIAL1.
name|add
argument_list|(
operator|new
name|AggregateDefinition
...
literal|"bigint"
expr_stmt|;
comment|// Convert our synonym to a real Hive type name.
block|}
name|result
index|[
name|i
