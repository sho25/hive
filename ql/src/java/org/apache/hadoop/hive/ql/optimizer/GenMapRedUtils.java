...
name|info
argument_list|(
literal|"OrcFile format - Using stripe level merge"
argument_list|)
expr_stmt|;
block|}
else|else
...
return|;
block|}
comment|/**    * Create a block level merge task for RCFiles or stripe level merge task for    * ORCFiles    *    * @param fsInputDesc    * @param finalName    * @return MergeWork if table is stored as RCFile or ORCFile,    *         null otherwise    */
specifier|public
specifier|static
name|MapWork
name|createMergeTask
