...
argument_list|()
decl_stmt|;
comment|// The mapjoin has already been encountered. Some context must be stored
comment|// about that
if|if
condition|(
name|readInputMapJoin
...
argument_list|)
decl_stmt|;
comment|// In case of map-join followed by map-join, the file needs to be
comment|// obtained from the old map join
name|AbstractMapJoinOperator
argument_list|<
name|?
extends|extends
