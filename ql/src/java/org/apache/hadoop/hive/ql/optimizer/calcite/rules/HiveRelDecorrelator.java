...
condition|)
block|{
comment|// TODO: for now only EQUAL and NOT EQUAL corr predicates are optimized
comment|//optimize rest of the predicates
case|case
name|NOT_EQUALS
case|:
if|if
...
condition|)
block|{
comment|// we will need value generator
break|break;
block|}
case|case
name|EQUALS
