...
argument_list|)
decl_stmt|;
comment|// this should only be called when we are creating filter (decorrelate filter)
comment|// since in that case null/unknown is treated as false we don't care about
comment|// nullability of operands and will always rewrite op=op to op is not null
if|if
condition|(
name|RexUtil
operator|.
