...
expr_stmt|;
block|}
comment|// If someone is trying to read a table with transactional=true they must be using the
comment|// right TxnManager.  We do not look at SessionState.get().getTxnMgr().supportsAcid().
specifier|public
specifier|static
name|boolean
name|isAcidTable
