...
argument_list|)
decl_stmt|;
comment|/**    * This does not need to use ORIGINAL_PATTERN_COPY because it's used to read    * a "delta" dir written by a real Acid write - cannot have any copies    */
specifier|public
specifier|static
specifier|final
name|PathFilter
...
name|COMPACTED_BASE
block|,
comment|// a regular base file generated through major compaction
name|ORIGINAL_BASE
block|,
comment|// a non-acid schema file for tables that got converted to acid
name|INSERT_DELTA
block|;
comment|// a delta file with only insert events that can be treated as base for split-update
block|}
