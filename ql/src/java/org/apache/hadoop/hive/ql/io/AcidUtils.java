...
return|;
block|}
comment|/**    * Checks if a table is an ACID table that only supports INSERT, but not UPDATE/DELETE    * @param table table    * @return true if table is an INSERT_ONLY table, false otherwise    */
specifier|public
specifier|static
name|boolean
