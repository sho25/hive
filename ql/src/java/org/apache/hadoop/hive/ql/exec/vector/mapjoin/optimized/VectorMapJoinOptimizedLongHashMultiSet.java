...
begin_comment
comment|/*  * An single long value hash map based on the BytesBytesMultiHashMultiSet.  *  * We serialize the long key into BinarySortable format into an output buffer accepted by  * BytesBytesMultiHashMultiSet.  */
end_comment
