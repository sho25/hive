...
specifier|final
name|String
name|LLAP_OF_SH_CLASS
init|=
literal|"org.apache.hadoop.hive.llap.LlapStorageHandler"
decl_stmt|;
specifier|public
specifier|static
...
name|ret
decl_stmt|;
comment|// Resolve storage handler (if any)
try|try
block|{
name|HiveStorageHandler
name|storageHandler
...
name|RuntimeException
argument_list|(
literal|"Error loading storage handler in getTableDesc: "
operator|+
name|e
operator|.
name|getMessage
...
return|;
block|}
comment|/**    * Generate a table descriptor from a createViewDesc.    */
specifier|public
specifier|static
name|TableDesc
name|getTableDesc
...
name|info
argument_list|(
literal|"configureInputJobSecrets not found"
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
block|}
comment|// same idea, only set for non-native tables
if|if
condition|(
operator|!
name|jobSecrets
...
block|}
block|}
comment|/**    * Check if the table is the temporary table created by VALUES() syntax    * @param tableName table name    * @return    */
specifier|public
specifier|static
name|boolean
...
control|)
block|{
comment|// Don't add the partition or table created during the execution as the input source
if|if
condition|(
name|isValuesTempTable
argument_list|(
...
return|;
block|}
comment|/**    * Returns the default SerDe for table and materialized view creation    * if none is specified.    */
specifier|public
specifier|static
name|Class
argument_list|<
...
return|;
block|}
comment|/**    * Get a Map of table or partition properties to be used in explain extended output.    * Do some filtering to make output readable and/or concise.    */
specifier|static
name|Map
...
condition|)
block|{
comment|// should copy properties first
name|clone
operator|=
operator|new
name|HashMap
