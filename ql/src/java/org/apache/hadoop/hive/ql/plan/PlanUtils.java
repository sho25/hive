...
expr_stmt|;
comment|// set other table properties
comment|/*       TODO - I don't think I need any of this       Properties properties = ret.getProperties();        if (crtTblDesc.getTableName() != null&& crtTblDesc.getDatabaseName() != null) {         properties.setProperty(org.apache.hadoop.hive.metastore.api.hive_metastoreConstants.META_TABLE_NAME,             crtTblDesc.getTableName());       }        if (crtTblDesc.getTblProps() != null) {         properties.putAll(crtTblDesc.getTblProps());       }        */
comment|// replace the default input& output file format with those found in
comment|// crtTblDesc
name|Class
argument_list|<
