...
name|maxSize
operator|=
name|getNoConditionalTaskSizeForLlap
argument_list|(
name|maxSize
argument_list|,
name|context
...
name|info
argument_list|(
literal|"No conditional task size adjusted for LLAP. executorsPerNode: {}, numSessions: {}, "
operator|+
literal|"availableSlotsPerQuery: {}, overSubscriptionFactor: {}, maxSlotsPerQuery: {}, slotsPerQuery: {}, "
operator|+
literal|"noconditionalTaskSize: {}, adjustedNoconditionalTaskSize: {}"
argument_list|,
name|executorsPerNode
argument_list|,
name|numSessions
...
name|varname
operator|+
literal|" returned value {}. Returning {}"
operator|+
literal|" as no conditional task size for LLAP."
argument_list|,
name|numSessions
argument_list|,
name|maxSize
