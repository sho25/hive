...
name|parentOp
decl_stmt|;
comment|// If the chosen big table has less number of buckets than any of the
comment|// small tables, then those buckets will have no mapping to any of the
comment|// big table buckets resulting in wrong results.
if|if
condition|(
name|numBuckets
operator|>
...
name|info
argument_list|(
literal|"Small table has more buckets than big table."
argument_list|)
expr_stmt|;
return|return
literal|false
