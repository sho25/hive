...
literal|1
decl_stmt|;
comment|// number of costly ops (Join, GB, PTF/Windowing, TF) below the big input
name|int
name|bigInputNumberCostlyOps
init|=
operator|-
literal|1
decl_stmt|;
...
block|}
name|int
name|currentInputNumberCostlyOps
init|=
name|foundInputNotFittingInMemory
condition|?
operator|-
...
comment|// 3) the number of costly operators for this input is higher, or
comment|// 4) the number of costly operators is equal, but the size is bigger,
name|boolean
...
literal|0
decl_stmt|;
comment|// it doesn't matter which position we use in this case.
name|LOG
operator|.
name|info
argument_list|(
