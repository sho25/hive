...
condition|)
block|{
comment|// Redo create-table/view analysis, because it's not part of
comment|// doPhase1.
...
name|OPTIMIZER
argument_list|,
literal|"Calcite: Prejoin ordering transformation, Merge Project-Project, Merge Sort-Sort"
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Generate OB RelNode and input Select RelNode that should be used to      * introduce top constraining Project. If Input select RelNode is not      * present then don't introduce top constraining select.      *      * @param qb      * @param srcRel      * @param outermostOB      * @return RelNode OB RelNode      * @throws SemanticException      */
specifier|private
name|RelNode
