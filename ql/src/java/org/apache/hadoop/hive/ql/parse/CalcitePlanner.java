...
expr_stmt|;
block|}
comment|// 4.1. Run other optimizations that do not need stats
name|perfLogger
operator|.
name|PerfLogBegin
argument_list|(
...
expr_stmt|;
block|}
comment|// 4.2. Run other optimizations that do not need stats
name|perfLogger
operator|.
name|PerfLogBegin
argument_list|(
...
name|OPTIMIZER
argument_list|,
literal|"Calcite: Optimizations without stats 2"
argument_list|)
expr_stmt|;
