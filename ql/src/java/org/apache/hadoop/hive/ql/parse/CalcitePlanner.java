...
argument_list|)
decl_stmt|;
comment|// 0. for GSets, Cube, Rollup, bail from Calcite path.
if|if
condition|(
operator|!
name|qbp
...
name|format
argument_list|(
literal|"Encountered Grouping Set/Cube/Rollup%s"
operator|+
literal|" Currently we don't support Grouping Set/Cube/Rollup"
operator|+
literal|" clauses in CBO,"
operator|+
...
block|}
block|}
comment|// 4. Construct aggregation function Info
name|ArrayList
argument_list|<
name|AggInfo
argument_list|>
...
control|)
block|{
comment|// 4.1 Determine type of UDAF
