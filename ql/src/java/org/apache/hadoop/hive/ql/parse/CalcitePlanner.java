...
expr_stmt|;
block|}
comment|// 10. Sort predicates in filter expressions
if|if
condition|(
name|conf
operator|.
...
name|warn
argument_list|(
literal|"Missing column stats (see previous messages), "
operator|+
literal|"skipping sort predicates in filter expressions in CBO"
argument_list|)
expr_stmt|;
name|noColsMissingStats
operator|.
...
name|OPTIMIZER
argument_list|,
literal|"Calcite: Sort predicates within filter operators"
argument_list|)
expr_stmt|;
block|}
comment|// 11. Apply Druid and JDBC transformation rules
name|perfLogger
operator|.
name|PerfLogBegin
argument_list|(
...
name|OPTIMIZER
argument_list|,
literal|"Calcite: JDBC transformation rules"
argument_list|)
expr_stmt|;
block|}
...
name|OPTIMIZER
argument_list|,
literal|"Calcite: Trying to remove Limit and Order by"
argument_list|)
expr_stmt|;
