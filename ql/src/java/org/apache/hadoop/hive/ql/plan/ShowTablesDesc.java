...
expr_stmt|;
block|}
comment|/**    * @param type    *          type of the tables to show    */
specifier|public
name|ShowTablesDesc
parameter_list|(
name|Path
...
expr_stmt|;
block|}
comment|/**    * @return the table type to be fetched    */
annotation|@
name|Explain
argument_list|(
name|displayName
...
return|;
block|}
comment|/**    * @param type    *          the table type to set    */
specifier|public
name|void
name|setType
parameter_list|(
...
return|;
block|}
comment|/**    * @param isExtended    *          whether extended modifier is enabled    */
specifier|public
name|void
name|setIsExtended
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * @return table type filter, null if it is not filtered    */
annotation|@
name|Explain
argument_list|(
name|displayName
...
return|;
block|}
comment|/**    * @param typeFilter    *          table type filter for show statement    */
specifier|public
name|void
name|setTypeFilter
parameter_list|(
