...
begin_comment
comment|/*  * Specialized class for doing a vectorized map join that is an left semi join on a Single-Column Long  * using a hash set.  */
end_comment
...
block|}
comment|//---------------------------------------------------------------------------
comment|// Process Single-Column Long Left-Semi Join on a vectorized row batch.
comment|//
annotation|@
name|Override
specifier|public
