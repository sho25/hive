...
return|;
block|}
comment|/**    * Verify if a table should be exported or not    */
specifier|public
specifier|static
name|Boolean
...
return|;
block|}
comment|/**    * Verify if a table should be exported or not by talking to metastore to fetch table info.    * Return true when running into errors with metastore call.     */
specifier|public
specifier|static
name|Boolean
...
name|error
argument_list|(
literal|"Failed to validate if the table should be exported or not"
argument_list|,
name|e
argument_list|)
expr_stmt|;
