...
parameter_list|)
block|{
comment|// The checksum is set as the fragment portion of the file uri
return|return
name|fileURIStr
operator|+
name|URI_FRAGMENT_SEPARATOR
...
specifier|static
name|FileChecksum
name|getCMDecodedChecksum
parameter_list|(
name|String
name|encodedFileURIStr
parameter_list|)
block|{
comment|// TODO: Implement this as part of HIVE-15490
return|return
literal|null
return|;
block|}
