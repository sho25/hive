...
begin_comment
comment|/*  Authorizable Event for HiveMetaStore operation CreateDatabase  */
end_comment
...
name|debug
argument_list|(
literal|"==> CreateDatabaseEvent.getOutputHObjs()"
argument_list|)
expr_stmt|;
block|}
name|List
...
name|debug
argument_list|(
literal|"<== CreateDatabaseEvent.getOutputHObjs(): ret="
operator|+
name|ret
argument_list|)
expr_stmt|;
