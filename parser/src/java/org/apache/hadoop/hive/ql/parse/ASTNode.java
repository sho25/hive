...
parameter_list|()
block|{   }
comment|/**    * @param t Token for the CommonTree Node    */
specifier|public
name|ASTNode
parameter_list|(
name|Token
...
specifier|protected
name|List
name|createChildrenList
parameter_list|()
block|{
comment|// Measurements show that in most situations the number of children is small.
comment|// Avoid wasting memory by creating ArrayList with the default capacity of 10.
return|return
operator|new
name|ArrayList
argument_list|(
