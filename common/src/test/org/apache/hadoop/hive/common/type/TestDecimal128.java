...
argument_list|)
expr_stmt|;
comment|// Compare long value with HiveDecimal#longValue
name|d
operator|.
name|update
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The trailing zeros from a double value are trimmed automatically
comment|// by the double data type
name|Decimal128
name|d12
init|=
operator|new
