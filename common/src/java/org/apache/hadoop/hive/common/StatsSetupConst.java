...
name|debug
argument_list|(
literal|"In StatsSetupConst, JsonParser can not parse "
operator|+
name|BASIC_STATS
operator|+
literal|"."
argument_list|)
expr_stmt|;
comment|// We try to parse it as TRUE or FALSE
if|if
condition|(
name|statsAcc
operator|.
...
argument_list|)
decl_stmt|;
comment|// duplicate key is not possible
try|try
block|{
name|stats
operator|.
...
block|{
comment|// getJSONObject(COLUMN_STATS) should be found.
name|JSONObject
name|allColumnStats
init|=
name|stats
