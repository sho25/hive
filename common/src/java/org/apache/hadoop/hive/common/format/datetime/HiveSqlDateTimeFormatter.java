...
block|}
block|}
comment|// next non-numeric character is a delimiter. Don't worry about AM/PM since we've already
comment|// handled that case.
if|if
condition|(
operator|(
name|token
