...
return|;
block|}
comment|/**    * Trashes or deletes all files under a directory. Leaves the directory as is.    * @param fs FileSystem to use    * @param f path of directory    * @param conf hive configuration    * @return true if deletion successful    * @throws FileNotFoundException    * @throws IOException    */
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**    * Move a particular file or directory to the trash. If for a certain reason the trashing fails    * it will force deletes the file or directory    * @param fs FileSystem to use    * @param f path of file or directory to move to trash.    * @param conf    * @return true if move successful    * @throws IOException    */
specifier|public
specifier|static
name|boolean
name|moveToTrash
...
return|;
block|}
comment|/**    * Move a particular file or directory to the trash.    * @param fs FileSystem to use    * @param f path of file or directory to move to trash.    * @param conf    * @param forceDelete whether force delete the file or directory if trashing fails    * @return true if move successful    * @throws IOException    */
specifier|public
specifier|static
name|boolean
name|moveToTrash
