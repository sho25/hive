...
name|info
argument_list|(
literal|"Setting permission of parent directory: "
operator|+
name|path
operator|.
name|toString
...
return|;
block|}
comment|/**    * Deletes all files under a directory, sending them to the trash.  Leaves the directory as is.    * @param fs FileSystem to use    * @param f path of directory    * @param conf hive configuration    * @return true if deletion successful    * @throws FileNotFoundException    * @throws IOException    */
specifier|public
specifier|static
name|boolean
