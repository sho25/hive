...
block|}
block|}
comment|/**    * default directory will have the same depth as number of skewed columns    * this will make future operation easy like DML merge, concatenate merge    * @param skewedCols    * @param hconf    * @return    */
specifier|public
specifier|static
name|String
