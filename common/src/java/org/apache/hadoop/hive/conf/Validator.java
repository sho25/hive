...
name|format
argument_list|(
literal|"Path '%s' provided could not be located."
argument_list|,
name|value
argument_list|)
return|;
...
name|format
argument_list|(
literal|"Path '%s' provided is not a directory."
argument_list|,
name|value
argument_list|)
return|;
...
name|format
argument_list|(
literal|"Path '%s' provided is not writable."
argument_list|,
name|value
argument_list|)
return|;
...
block|{
return|return
literal|"Expects a writable directory on the local filesystem"
return|;
block|}
block|}
block|}
