...
block|}
block|}
comment|/**    * Writes the default ConfVars out to a temporary File and returns    * a URL pointing to the temporary file.    * We need this in order to initialize the ConfVar properties    * in the underling Configuration object using the addResource()    * method.    */
specifier|private
specifier|static
...
argument_list|()
expr_stmt|;
comment|// Overlay the default ConfVars
name|addResource
argument_list|(
name|getConfVarURL
argument_list|()
...
expr_stmt|;
block|}
comment|// Overlay system properties
...
name|warn
argument_list|(
literal|"Unable to set default configuration value for "
operator|+
name|var
operator|.
name|varname
