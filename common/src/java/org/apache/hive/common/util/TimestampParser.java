...
parameter_list|)
block|{
comment|// 1970-01-01 00:00:00 did not exist in some zones. In these zones, we need to take different,
comment|// less optimal parsing route.
return|return
literal|null
return|;
block|}
