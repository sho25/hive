...
argument_list|)
expr_stmt|;
comment|// Initialize materializations invalidation cache (only for local metastore)
...
argument_list|)
expr_stmt|;
comment|// TODO: this is ugly... account for ability to pass via EC for the old API.
if|if
condition|(
name|environmentContext
operator|!=
