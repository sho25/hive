...
operator|.
name|TField
name|GET_COLUMN_STATS_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|GetTableRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|GetTableRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
specifier|final
name|int
name|__GETCOLUMNSTATS_ISSET_ID
init|=
literal|0
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/** Returns true if field getColumnStats is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetGetColumnStats
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|}
name|boolean
name|this_present_getColumnStats
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_getColumnStats
init|=
literal|true
operator|&&
name|that
...
block|{
specifier|public
name|GetTableRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|GetTableRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
