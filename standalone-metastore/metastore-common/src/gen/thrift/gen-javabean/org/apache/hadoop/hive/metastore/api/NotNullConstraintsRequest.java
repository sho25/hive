...
name|TStruct
argument_list|(
literal|"NotNullConstraintsRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|NotNullConstraintsRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|NotNullConstraintsRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|NotNullConstraintsRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|NotNullConstraintsRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
