...
specifier|public
class|class
name|WMDropResourcePlanResponse
...
name|TStruct
argument_list|(
literal|"WMDropResourcePlanResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMDropResourcePlanResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMDropResourcePlanResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMDropResourcePlanResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMDropResourcePlanResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
