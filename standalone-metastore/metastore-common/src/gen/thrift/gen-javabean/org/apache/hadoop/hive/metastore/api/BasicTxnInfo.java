...
argument_list|,
operator|new
name|BasicTxnInfoStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|BasicTxnInfoTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field isnull is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetIsnull
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field time is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTime
parameter_list|()
...
return|;
name|boolean
name|this_present_isnull
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_isnull
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'isnull' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|BasicTxnInfoStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
