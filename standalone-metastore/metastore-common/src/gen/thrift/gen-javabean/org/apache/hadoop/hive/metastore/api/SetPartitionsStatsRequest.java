...
name|TStruct
argument_list|(
literal|"SetPartitionsStatsRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|SetPartitionsStatsRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|SetPartitionsStatsRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field colStats is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetColStats
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field needMerge is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetNeedMerge
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'colStats' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|SetPartitionsStatsRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|SetPartitionsStatsRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
