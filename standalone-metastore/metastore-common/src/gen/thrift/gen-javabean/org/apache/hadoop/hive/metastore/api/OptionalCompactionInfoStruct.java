...
name|TStruct
argument_list|(
literal|"OptionalCompactionInfoStruct"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|OptionalCompactionInfoStructStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|OptionalCompactionInfoStructTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field ci is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetCi
parameter_list|()
...
block|{
specifier|public
name|OptionalCompactionInfoStructStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|OptionalCompactionInfoStructTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
