...
name|TStruct
argument_list|(
literal|"SchemaVersionDescriptor"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|SchemaVersionDescriptorStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|SchemaVersionDescriptorTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|SchemaVersionDescriptorStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|SchemaVersionDescriptorTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
