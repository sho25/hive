...
operator|.
name|TField
name|REWRITE_ENABLED_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
operator|.
name|TField
name|CREATION_METADATA_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
operator|.
name|TField
name|REQUIRED_READ_CAPABILITIES_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
name|TField
argument_list|(
literal|"requiredReadCapabilities"
argument_list|,
name|org
operator|.
name|apache
...
operator|.
name|TField
name|REQUIRED_WRITE_CAPABILITIES_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
name|TField
argument_list|(
literal|"requiredWriteCapabilities"
argument_list|,
name|org
operator|.
name|apache
...
argument_list|,
operator|new
name|TableStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
name|String
argument_list|>
name|requiredWriteCapabilities
decl_stmt|;
comment|// optional
...
argument_list|)
block|,
name|REQUIRED_READ_CAPABILITIES
argument_list|(
operator|(
name|short
operator|)
...
argument_list|)
block|,
name|REQUIRED_WRITE_CAPABILITIES
argument_list|(
operator|(
name|short
operator|)
...
literal|24
case|:
comment|// REQUIRED_READ_CAPABILITIES
return|return
name|REQUIRED_READ_CAPABILITIES
return|;
case|case
literal|25
case|:
comment|// REQUIRED_WRITE_CAPABILITIES
return|return
name|REQUIRED_WRITE_CAPABILITIES
return|;
default|default:
...
specifier|final
name|int
name|__REWRITEENABLED_ISSET_ID
init|=
literal|5
decl_stmt|;
specifier|private
...
name|other
operator|.
name|isSetRequiredReadCapabilities
argument_list|()
condition|)
block|{
name|List
...
name|String
argument_list|>
name|__this__requiredReadCapabilities
init|=
operator|new
name|ArrayList
argument_list|<
...
name|other
operator|.
name|isSetRequiredWriteCapabilities
argument_list|()
condition|)
block|{
name|List
...
name|String
argument_list|>
name|__this__requiredWriteCapabilities
init|=
operator|new
name|ArrayList
argument_list|<
...
expr_stmt|;
block|}
comment|/** Returns true if field temporary is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTemporary
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field rewriteEnabled is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetRewriteEnabled
parameter_list|()
block|{
return|return
name|EncodingUtils
...
expr_stmt|;
block|}
comment|/** Returns true if field creationMetadata is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetCreationMetadata
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field accessType is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetAccessType
parameter_list|()
block|{
return|return
name|EncodingUtils
...
specifier|public
name|int
name|getRequiredReadCapabilitiesSize
parameter_list|()
block|{
return|return
operator|(
...
name|String
argument_list|>
name|getRequiredReadCapabilitiesIterator
parameter_list|()
block|{
return|return
operator|(
...
specifier|public
name|void
name|addToRequiredReadCapabilities
parameter_list|(
name|String
name|elem
parameter_list|)
...
specifier|public
name|void
name|unsetRequiredReadCapabilities
parameter_list|()
block|{
name|this
operator|.
...
expr_stmt|;
block|}
comment|/** Returns true if field requiredReadCapabilities is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetRequiredReadCapabilities
parameter_list|()
...
specifier|public
name|void
name|setRequiredReadCapabilitiesIsSet
parameter_list|(
name|boolean
name|value
parameter_list|)
...
specifier|public
name|int
name|getRequiredWriteCapabilitiesSize
parameter_list|()
block|{
return|return
operator|(
...
name|String
argument_list|>
name|getRequiredWriteCapabilitiesIterator
parameter_list|()
block|{
return|return
operator|(
...
specifier|public
name|void
name|addToRequiredWriteCapabilities
parameter_list|(
name|String
name|elem
parameter_list|)
...
specifier|public
name|void
name|unsetRequiredWriteCapabilities
parameter_list|()
block|{
name|this
operator|.
...
expr_stmt|;
block|}
comment|/** Returns true if field requiredWriteCapabilities is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetRequiredWriteCapabilities
parameter_list|()
...
specifier|public
name|void
name|setRequiredWriteCapabilitiesIsSet
parameter_list|(
name|boolean
name|value
parameter_list|)
...
block|}
name|boolean
name|this_present_rewriteEnabled
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_rewriteEnabled
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_creationMetadata
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_creationMetadata
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_requiredReadCapabilities
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_requiredReadCapabilities
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_requiredWriteCapabilities
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_requiredWriteCapabilities
init|=
literal|true
operator|&&
name|that
...
expr_stmt|;
name|boolean
name|present_requiredReadCapabilities
init|=
literal|true
operator|&&
operator|(
...
expr_stmt|;
name|boolean
name|present_requiredWriteCapabilities
init|=
literal|true
operator|&&
operator|(
