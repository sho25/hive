...
specifier|public
class|class
name|NotNullConstraintsResponse
...
name|TStruct
argument_list|(
literal|"NotNullConstraintsResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|NotNullConstraintsResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|NotNullConstraintsResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'notNullConstraints' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|NotNullConstraintsResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|NotNullConstraintsResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
