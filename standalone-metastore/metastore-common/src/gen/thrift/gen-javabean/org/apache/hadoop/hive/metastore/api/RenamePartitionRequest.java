...
name|TStruct
argument_list|(
literal|"RenamePartitionRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|RenamePartitionRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|RenamePartitionRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field partVals is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetPartVals
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field newPart is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetNewPart
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'partVals' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'newPart' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|RenamePartitionRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|RenamePartitionRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
