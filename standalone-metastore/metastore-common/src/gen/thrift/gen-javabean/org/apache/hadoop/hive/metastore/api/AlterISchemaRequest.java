...
argument_list|,
operator|new
name|AlterISchemaRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|AlterISchemaRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field newSchema is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetNewSchema
parameter_list|()
...
block|{
specifier|public
name|AlterISchemaRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|AlterISchemaRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
