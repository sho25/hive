...
specifier|public
class|class
name|SetPartitionsStatsResponse
...
name|TStruct
argument_list|(
literal|"SetPartitionsStatsResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|SetPartitionsStatsResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|SetPartitionsStatsResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field result is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetResult
parameter_list|()
...
return|;
name|boolean
name|this_present_result
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_result
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'result' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|SetPartitionsStatsResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|SetPartitionsStatsResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
