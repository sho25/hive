...
name|TStruct
argument_list|(
literal|"WMGetAllResourcePlanRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMGetAllResourcePlanRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMGetAllResourcePlanRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMGetAllResourcePlanRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMGetAllResourcePlanRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
