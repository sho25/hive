...
argument_list|,
operator|new
name|CommitTxnKeyValueStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|CommitTxnKeyValueTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field tableId is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTableId
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field key is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetKey
parameter_list|()
...
return|;
name|boolean
name|this_present_tableId
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_tableId
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'tableId' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'key' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'value' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|CommitTxnKeyValueStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|CommitTxnKeyValueTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
