...
argument_list|,
operator|new
name|PartitionsStatsResultStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|PartitionsStatsResultTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
decl_stmt|;
name|String
name|__this__partStats_copy_key
init|=
name|other_element_key
decl_stmt|;
name|List
...
name|ColumnStatisticsObj
argument_list|>
name|__this__partStats_copy_value
init|=
operator|new
name|ArrayList
argument_list|<
...
expr_stmt|;
block|}
comment|/** Returns true if field partStats is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetPartStats
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'partStats' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|PartitionsStatsResultStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|PartitionsStatsResultTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
