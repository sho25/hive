...
name|TStruct
argument_list|(
literal|"ScheduledQueryMaintenanceRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
operator|.
name|TField
name|SCHEDULED_QUERY_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|ScheduledQueryMaintenanceRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|ScheduledQueryMaintenanceRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TFieldIdEnum
block|{
comment|/**      *       * @see ScheduledQueryMaintenanceRequestType      */
name|TYPE
argument_list|(
operator|(
name|short
...
expr_stmt|;
block|}
comment|/** Returns true if field scheduledQuery is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetScheduledQuery
parameter_list|()
...
block|}
name|boolean
name|this_present_scheduledQuery
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_scheduledQuery
init|=
literal|true
operator|&&
name|that
...
name|TProtocolException
argument_list|(
literal|"Required field 'scheduledQuery' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|ScheduledQueryMaintenanceRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|ScheduledQueryMaintenanceRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
