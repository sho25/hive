...
operator|.
name|TField
name|SECONDS_SINCE_EPOCH_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|TimestampStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TimestampTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
specifier|final
name|int
name|__SECONDSSINCEEPOCH_ISSET_ID
init|=
literal|0
decl_stmt|;
specifier|private
...
name|secondsSinceEpoch
expr_stmt|;
name|setSecondsSinceEpochIsSet
argument_list|(
literal|true
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/** Returns true if field secondsSinceEpoch is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetSecondsSinceEpoch
parameter_list|()
block|{
return|return
name|EncodingUtils
...
return|;
name|boolean
name|this_present_secondsSinceEpoch
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_secondsSinceEpoch
init|=
literal|true
decl_stmt|;
if|if
...
decl_stmt|;
name|boolean
name|present_secondsSinceEpoch
init|=
literal|true
decl_stmt|;
name|list
...
name|TProtocolException
argument_list|(
literal|"Required field 'secondsSinceEpoch' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
