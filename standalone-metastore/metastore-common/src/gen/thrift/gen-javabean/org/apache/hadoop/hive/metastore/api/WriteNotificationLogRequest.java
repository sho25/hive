...
name|TStruct
argument_list|(
literal|"WriteNotificationLogRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WriteNotificationLogRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WriteNotificationLogRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field db is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetDb
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field fileInfo is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetFileInfo
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'db' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'fileInfo' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|WriteNotificationLogRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WriteNotificationLogRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
