...
argument_list|,
operator|new
name|AggrStatsStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|AggrStatsTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
specifier|final
name|int
name|__ISSTATSCOMPLIANT_ISSET_ID
init|=
literal|1
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/** Returns true if field partsFound is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetPartsFound
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|}
name|boolean
name|this_present_partsFound
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_partsFound
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'partsFound' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
