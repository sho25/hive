...
argument_list|,
operator|new
name|PartitionValuesRowStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|PartitionValuesRowTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'row' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|PartitionValuesRowStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|PartitionValuesRowTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
