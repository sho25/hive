...
argument_list|,
operator|new
name|AlterCatalogRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|AlterCatalogRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field newCat is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetNewCat
parameter_list|()
...
block|{
specifier|public
name|AlterCatalogRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|AlterCatalogRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
