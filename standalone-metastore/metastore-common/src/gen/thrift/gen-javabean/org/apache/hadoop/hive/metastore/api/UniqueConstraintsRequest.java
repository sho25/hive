...
name|TStruct
argument_list|(
literal|"UniqueConstraintsRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|UniqueConstraintsRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|UniqueConstraintsRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|UniqueConstraintsRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|UniqueConstraintsRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
