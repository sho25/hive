...
specifier|public
class|class
name|WriteNotificationLogResponse
...
name|TStruct
argument_list|(
literal|"WriteNotificationLogResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WriteNotificationLogResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WriteNotificationLogResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WriteNotificationLogResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WriteNotificationLogResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
