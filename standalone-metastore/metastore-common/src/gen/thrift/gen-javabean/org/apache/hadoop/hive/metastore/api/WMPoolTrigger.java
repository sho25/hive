...
argument_list|,
operator|new
name|WMPoolTriggerStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMPoolTriggerTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field trigger is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTrigger
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'pool' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'trigger' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|WMPoolTriggerStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
