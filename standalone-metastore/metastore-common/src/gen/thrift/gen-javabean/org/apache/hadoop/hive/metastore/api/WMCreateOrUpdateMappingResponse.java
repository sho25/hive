...
name|TStruct
argument_list|(
literal|"WMCreateOrUpdateMappingResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMCreateOrUpdateMappingResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMCreateOrUpdateMappingResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMCreateOrUpdateMappingResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMCreateOrUpdateMappingResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
