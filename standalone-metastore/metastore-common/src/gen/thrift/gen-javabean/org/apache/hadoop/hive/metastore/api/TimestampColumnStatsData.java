...
name|TStruct
argument_list|(
literal|"TimestampColumnStatsData"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TimestampColumnStatsDataStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TimestampColumnStatsDataTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TimestampColumnStatsDataStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TimestampColumnStatsDataTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
