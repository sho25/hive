...
name|TStruct
argument_list|(
literal|"SetSchemaVersionStateRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|SetSchemaVersionStateRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|SetSchemaVersionStateRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|SetSchemaVersionStateRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|SetSchemaVersionStateRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
