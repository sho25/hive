...
name|MetaException
function_decl|;
comment|/**    * @param tbl    * @throws AlreadyExistsException    * @throws InvalidObjectException    * @throws MetaException    * @throws NoSuchObjectException    * @throws TException    * @see org.apache.hadoop.hive.metastore.api.ThriftHiveMetastore.Iface#create_table(org.apache.hadoop.hive.metastore.api.CreateTableRequest)    */
name|void
name|createTable
parameter_list|(
name|Table
...
name|TException
function_decl|;
comment|/**    * @param request CreateTableRequest    * @throws AlreadyExistsException    * @throws InvalidObjectException    * @throws MetaException    * @throws NoSuchObjectException    * @throws TException    */
name|void
name|createTable
parameter_list|(
...
name|TException
function_decl|;
comment|/**    * Initiate a transaction with given type.    * @param user User who is opening this transaction.    * @param txnType Type of needed transaction.    * @return transaction identifier    * @throws TException    */
name|long
name|openTxn
parameter_list|(
name|String
...
name|TException
function_decl|;
comment|/**    * Like commitTxn but it will atomically store as well a key and a value. This    * can be useful for example to know if the transaction corresponding to    * txnid has been committed by later querying with DESCRIBE EXTENDED TABLE.    * TABLE_PARAMS from the metastore must already have a row with the TBL_ID    * corresponding to the table in the parameters and PARAM_KEY the same as key    * in the parameters. The way to update this table is with an ALTER command    * to overwrite/create the table properties.    * @param txnid id of transaction to be committed.    * @param tableId id of the table to associate the key/value with    * @param key key to be committed. It must start with "_meta". The reason    *            for this is to prevent important keys being updated, like owner.    * @param value value to be committed.    * @throws NoSuchTxnException if the requested transaction does not exist.    * This can result fro the transaction having timed out and been deleted by    * the compactor.    * @throws TxnAbortedException if the requested transaction has been    * aborted.  This can result from the transaction timing out.    * @throws IllegalStateException if not exactly one row corresponding to    * tableId and key are found in TABLE_PARAMS while updating.    * @throws TException    */
name|void
...
name|TException
function_decl|;
comment|/**    * Get the next compaction job to do.    * @param workerId id of the worker requesting.    * @return next compaction job encapsulated in a {@link CompactionInfoStruct}.    * @throws MetaException    * @throws TException    */
...
name|TException
function_decl|;
comment|/**    * Set the compaction highest write id.    * @param cr compaction job being done.    * @param txnId transaction id.    * @throws TException    */
name|void
...
name|TException
function_decl|;
comment|/**    * Get columns.    * @param cr compaction job.    * @return    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
name|TException
function_decl|;
comment|/**    * Mark a finished compaction as cleaned.    * @param cr compaction job.    * @throws MetaException    * @throws TException    */
name|void
name|markCleaned
parameter_list|(
name|CompactionInfoStruct
...
name|TException
function_decl|;
comment|/**    * Mark a finished compaction as compacted.    * @param cr compaction job.    * @throws MetaException    * @throws TException    */
name|void
name|markCompacted
parameter_list|(
name|CompactionInfoStruct
...
name|TException
function_decl|;
comment|/**    * Mark a finished compaction as failed.    * @param cr compaction job.    * @throws MetaException    * @throws TException    */
name|void
name|markFailed
parameter_list|(
name|CompactionInfoStruct
...
name|TException
function_decl|;
comment|/**    * Set the hadoop id for a compaction.    * @param jobId mapreduce job id that will do the compaction.    * @param cqId compaction id.    * @throws MetaException    * @throws TException    */
name|void
name|setHadoopJobid
parameter_list|(
name|String
