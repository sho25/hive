...
begin_comment
comment|// This file is copied from PlainSaslServer.java from hive.auth and modified. Need to see how can
end_comment

begin_comment
comment|// we deduplicate the code.
end_comment
...
begin_comment
comment|// This is a copy of org.apache.hive.service.auth.PlainSaslServer modified for HMS. See whether
end_comment
...
name|super
argument_list|(
literal|"HiveMetaStoreSaslPlain"
argument_list|,
literal|1.0
argument_list|,
literal|"Hive MetaStore Plain SASL provider"
argument_list|)
expr_stmt|;
name|put
argument_list|(
