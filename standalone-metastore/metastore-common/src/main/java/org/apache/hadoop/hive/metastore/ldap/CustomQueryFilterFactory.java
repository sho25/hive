...
begin_comment
comment|/**  * A factory for a {@link Filter} based on a custom query.  *<br>  * The produced filter object filters out all users that are not found in the search result  * of the query provided in Hive configuration.  * @see MetastoreConf.ConfVars#METASTORE_PLAIN_LDAP_CUSTOMLDAPQUERY  */
end_comment
