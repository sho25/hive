...
name|String
argument_list|>
name|encryptionZoneToCmrootMapping
init|=
operator|new
name|HashMap
argument_list|<>
...
specifier|final
name|String
name|TXN_WRITE_EVENT_FILE_SEPARATOR
init|=
literal|"]"
decl_stmt|;
specifier|static
...
specifier|static
name|String
name|encryptedCmRootDir
decl_stmt|;
specifier|private
specifier|static
name|String
name|fallbackNonEncryptedCmRootDir
decl_stmt|;
specifier|public
enum|enum
name|RecycleType
...
argument_list|)
expr_stmt|;
comment|//validate cmRootEncrypted is absolute
name|Path
...
argument_list|()
operator|+
literal|" should be a relative path"
argument_list|)
throw|;
block|}
comment|//Create default cm root
name|Path
name|cmroot
init|=
operator|new
...
condition|)
block|{
comment|//If cm root is encrypted we keep using it for the encryption zone
name|String
name|encryptionZonePath
init|=
name|cmRootFs
operator|.
name|getUri
...
literal|null
decl_stmt|;
comment|//Default path if hive.repl.cm dir is encrypted
name|String
name|cmrootDir
init|=
name|fallbackNonEncryptedCmRootDir
...
argument_list|()
expr_stmt|;
comment|//For encryption zone, create cm at the relative path specified by hive.repl.cm.encryptionzone.rootdir
comment|//at the root of the encryption zone
name|cmrootDir
operator|=
name|encryptionZonePath
operator|+
