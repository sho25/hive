...
block|}
block|}
comment|/**    * @param params table/partition parameters    * @return the list of column names for which the stats are available.    */
specifier|public
specifier|static
name|List
argument_list|<
...
condition|)
block|{
comment|// No table/partition params, no statistics available
return|return
literal|null
return|;
block|}
...
return|;
block|}
comment|// TODO: should this also check that the basic flag is valid?
name|ColumnStatsAccurate
name|stats
init|=
name|parseStatsAcc
