...
name|warn
argument_list|(
literal|"RetryingMetaStoreClient unable to determine current user UGI."
argument_list|)
expr_stmt|;
block|}
name|this
...
name|info
argument_list|(
literal|"RetryingMetaStoreClient proxy="
operator|+
name|msClientClass
operator|+
literal|" ugi="
...
return|;
block|}
comment|/**    * This constructor is meant for Hive internal use only.    * Please use getProxy(HiveConf conf, HiveMetaHookLoader hookLoader) for external purpose.    */
specifier|public
specifier|static
name|IMetaStoreClient
name|getProxy
...
condition|)
block|{
comment|// Perform reconnect with the proper user context
try|try
block|{
name|LOG
operator|.
name|info
argument_list|(
literal|"RetryingMetaStoreClient trying reconnect as "
operator|+
name|this
operator|.
name|ugi
...
name|warn
argument_list|(
literal|"RetryingMetaStoreClient unable to reconnect. No UGI information."
argument_list|)
expr_stmt|;
throw|throw
operator|new
name|MetaException
argument_list|(
literal|"UGI information unavailable. Will not attempt a reconnect."
argument_list|)
throw|;
block|}
block|}
...
return|;
block|}
comment|/**    * Returns the UGI for the current user.    * @return the UGI for the current user.    */
specifier|private
name|UserGroupInformation
name|getUGI
parameter_list|()
...
parameter_list|)
block|{
comment|// Swallow the exception and let the call determine what to do.
block|}
return|return
name|ugi
return|;
