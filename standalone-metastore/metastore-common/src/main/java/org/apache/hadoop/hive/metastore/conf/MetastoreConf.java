...
specifier|final
name|String
name|DEFAULT_STORAGE_SCHEMA_READER_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.DefaultStorageSchemaReader"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|HIVE_ALTER_HANDLE_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.HiveAlterHandler"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
...
init|=
literal|"org.apache.hadoop.hive.metastore.MaterializationsRebuildLockCleanerTask"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|METASTORE_TASK_THREAD_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.MetastoreTaskThread"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|RUNTIME_STATS_CLEANER_TASK_CLASS
init|=
...
specifier|final
name|String
name|EVENT_CLEANER_TASK_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.events.EventCleanerTask"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|METASTORE_DELEGATION_MANAGER_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.security.MetastoreDelegationTokenManager"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|ACID_COMPACTION_HISTORY_SERVICE_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.txn.AcidCompactionHistoryService"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|ACID_HOUSE_KEEPER_SERVICE_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.txn.AcidHouseKeeperService"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
specifier|final
name|String
name|ACID_OPEN_TXNS_COUNTER_SERVICE_CLASS
init|=
literal|"org.apache.hadoop.hive.metastore.txn.AcidOpenTxnsCounterService"
decl_stmt|;
annotation|@
name|VisibleForTesting
specifier|static
...
operator|+
literal|"metastore.dbaccess.ssl.use.SSL must be set to true for this property to take effect. \n"
operator|+
literal|"This directly maps to the javax.net.ssl.trustStorePassword Java system property. Defaults to jssecacerts, if it exists, otherwise uses cacerts. \n"
operator|+
literal|"It is recommended to specify the password using a credential provider so as to not expose it to discovery by other users. \n"
operator|+
literal|"One way to do this is by using the Hadoop CredentialProvider API and provisioning credentials for this property. Refer to the Hadoop CredentialProvider API Guide for more details."
argument_list|)
block|,
...
literal|"metastore.dbaccess.ssl.use.SSL must be set to true for this property to take effect. \n"
operator|+
literal|"This directly maps to the javax.net.ssl.trustStore Java system property. Defaults to the default Java truststore file. \n"
argument_list|)
block|,
...
operator|+
literal|"Types jceks, jks, dks, pkcs11, and pkcs12 can be read from Java 8 and beyond. Defaults to jks."
argument_list|)
block|,
...
argument_list|(
literal|"metastore.notification.parameters.exclude.patterns"
argument_list|,
literal|"hive.metastore.notification.parameters.exclude.patterns"
argument_list|,
literal|""
argument_list|,
literal|"List of comma-separated regexes that are used to reduced the size of HMS Notification messages."
operator|+
literal|" The regexes are matched against each key of parameters map in Table or Partition object"
operator|+
literal|"present in HMS Notification. Any key-value pair whose key is matched with any regex will"
operator|+
literal|" be removed from Parameters map during Serialization of Table/Partition object."
argument_list|)
block|,
...
name|SECONDS
argument_list|,
literal|"If a scheduled query is not making progress for this amount of time it will be considered TIMED_OUT"
argument_list|)
block|,
...
name|SECONDS
argument_list|,
literal|"Interval of scheduled query maintenance task. Which removes executions above max age;"
operator|+
literal|"and marks executions as timed out if the condition is met"
argument_list|)
block|,
...
name|SECONDS
argument_list|,
literal|"Maximal age of a scheduled query execution entry before it is removed."
argument_list|)
block|,
...
literal|","
operator|+
literal|"org.apache.hadoop.hive.metastore.ScheduledQueryExecutionsMaintTask"
argument_list|,
...
begin_comment
comment|/**    * Get values from comma-separated config, to an array after extracting individual values.    * @param conf Configuration to retrieve it from    * @param var variable to retrieve    * @return Array of String, containing each value from the comma-separated config,    *  or default value if value not in config file    */
end_comment
