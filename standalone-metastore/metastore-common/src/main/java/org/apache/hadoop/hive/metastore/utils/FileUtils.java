...
return|;
block|}
comment|/**    * Get all file status from a root path and recursively go deep into certain levels.    *    * @param base    *          the root path    * @param fs    *          the file system    * @return array of FileStatus    * @throws IOException    */
specifier|public
specifier|static
name|List
argument_list|<
...
argument_list|>
block|{
comment|/**      * This works with {@link RemoteIterator} which (potentially) produces all files recursively      * so looking for hidden folders must look at whole path, not just the the last part of it as      * would be appropriate w/o recursive listing.      */
specifier|public
specifier|static
specifier|final
name|PathFilter
...
block|}
block|}
comment|// No more matching files in the iterator
name|nextFile
operator|=
literal|null
expr_stmt|;
