...
block|}
block|}
comment|/**    * Filter the list of compactions if filtering is enabled. Otherwise, return original list    *    * @param isFilterEnabled true: filtering is enabled; false: filtering is disabled.    * @param filterHook      the object that does filtering    * @param compactions     the list of compactions    * @return the list of compactions that user has access or original list if filtering is disabled;    * @throws MetaException    */
specifier|public
specifier|static
name|List
argument_list|<
name|ShowCompactResponseElement
argument_list|>
name|filterCompactionsIfEnabled
parameter_list|(
name|boolean
name|isFilterEnabled
parameter_list|,
...
argument_list|)
decl_stmt|;
comment|// DBName -> List of TableNames map used for checking access rights for non partitioned tables
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|()
decl_stmt|;
comment|// DBName -> TableName -> List of PartitionNames map used for checking access rights for
...
block|}
block|}
comment|// Checking non partitioned table access rights
for|for
control|(
name|Map
operator|.
...
expr_stmt|;
block|}
comment|// Checking partitioned table access rights
for|for
control|(
name|Map
operator|.
...
block|}
block|}
comment|// Add the compactions to the response only we have access right
for|for
control|(
name|ShowCompactResponseElement
name|c
