...
name|trace
argument_list|(
literal|"doAllPartitionContainStats for column: {} is: {}"
argument_list|,
name|colName
argument_list|,
name|doAllPartitionContainStats
...
block|{
comment|// aggregateData already has the ndv of the max of all
block|}
name|columnStatisticsData
operator|.
name|setStringStats
