...
name|info
argument_list|(
literal|"HMS client filtering is "
operator|+
operator|(
name|isEnabled
condition|?
...
name|debug
argument_list|(
literal|"HMSC::open(): Creating plain authentication thrift connection."
argument_list|)
expr_stmt|;
name|String
name|userName
...
name|MetaException
argument_list|(
literal|"No user specified for plain transport."
argument_list|)
throw|;
block|}
comment|// The password is not directly provided. It should be obtained from a keystore pointed
comment|// by configuration "hadoop.security.credential.provider.path".
try|try
block|{
name|String
name|passwd
...
parameter_list|)
block|{
comment|// IOException covers SaslException
name|LOG
operator|.
name|error
argument_list|(
...
condition|)
block|{
comment|// Either tte or recentME should be set but protect from a bug which causes both of them to
comment|// be null. When MetaException wraps TTransportException, tte will be set so stringify that
comment|// directly.
name|String
...
expr_stmt|;
block|}
comment|/**    * @param tbl    * @throws MetaException    * @throws NoSuchObjectException    * @throws TException    * @see org.apache.hadoop.hive.metastore.api.ThriftHiveMetastore.Iface#create_table(org.apache.hadoop.hive.metastore.api.CreateTableRequest)    */
annotation|@
name|Override
specifier|public
name|void
...
block|}
block|}
comment|/**    * @param request    * @throws MetaException    * @throws NoSuchObjectException    * @throws TException    */
annotation|@
name|Override
specifier|public
name|void
...
name|TException
block|{
comment|// TODO should we add capabilities here as well as it returns Partition objects
return|return
name|listPartitions
argument_list|(
name|getDefaultCatalog
...
expr_stmt|;
block|}
comment|/**   * Builder for requiredFields bitmask to be sent via GetTablesExtRequest   */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/**    * Builder for building table capabilities to be includes in TBLPROPERTIES    * during createTable    */
specifier|public
specifier|static
class|class
name|TableCapabilityBuilder
block|{
specifier|private
name|String
