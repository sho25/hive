...
specifier|public
class|class
name|TestGetPartitionsUsingProjectionAndFilterSpecs
block|{
specifier|private
specifier|static
specifier|final
...
specifier|public
name|void
name|testGetPartitionsWithFilterExpr
parameter_list|()
throws|throws
name|TException
block|{
name|runGetPartitionsUsingExpr
argument_list|()
expr_stmt|;
block|}
annotation|@
...
specifier|public
name|void
name|testGetPartitionsUsingNames
parameter_list|()
throws|throws
name|Exception
block|{
name|runGetPartitionsUsingNames
argument_list|()
expr_stmt|;
block|}
annotation|@
...
specifier|public
name|void
name|testGetPartitionsUsingValues
parameter_list|()
throws|throws
name|Exception
block|{
name|runGetPartitionsUsingVals
argument_list|()
expr_stmt|;
block|}
annotation|@
...
specifier|public
name|void
name|testGetPartitionsUsingExprWithJDO
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGetPartitionsUsingValuesWithJDO
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGetPartitionsUsingNamesWithJDO
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInvalidFilterByNames
parameter_list|()
throws|throws
name|Exception
block|{
name|runWithInvalidFilterByNames
argument_list|()
expr_stmt|;
block|}
annotation|@
...
specifier|public
name|void
name|testInvalidFilterByNamesWithJDO
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInvalidProjectFieldNamesWithJDO
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|testInvalidProjectFieldNames2WithJDO
parameter_list|()
throws|throws
name|TException
block|{
...
argument_list|)
expr_stmt|;
comment|// filter mode is set but not filters are provided
name|client
operator|.
name|getPartitionsWithSpecs
argument_list|(
...
name|TException
block|{
comment|// test simple case first
name|getPartitionsWithExpr
argument_list|(
name|Arrays
operator|.
name|asList
...
name|asList
argument_list|(
literal|"state=\"CA\" AND city=\"PaloAlto\""
argument_list|)
argument_list|,
literal|1
argument_list|)
expr_stmt|;
comment|// empty result set
name|getPartitionsWithExpr
argument_list|(
name|Arrays
operator|.
name|asList
argument_list|(
literal|"state=\"CA\" AND city=\"Seattle\""
argument_list|)
argument_list|,
literal|0
argument_list|)
...
name|asList
argument_list|(
literal|"(state=\"CA\" AND city !=\"PaloAlto\") OR (state=\"WA\" AND city = \"Seattle\")"
argument_list|)
argument_list|,
literal|2
argument_list|)
...
name|asList
argument_list|(
literal|"state=\"CA\" OR state=\"WA\""
argument_list|,
literal|"city=\"PaloAlto\" OR city=\"Seattle\""
argument_list|)
argument_list|,
literal|2
argument_list|)
...
name|assertEquals
argument_list|(
literal|"Invalid number of partitions returned"
argument_list|,
name|expectedPartition
argument_list|,
name|partitionSpecWithSharedSD
...
name|assertTrue
argument_list|(
literal|"Partition spec should have been empty since filter doesn't match with any partitions"
argument_list|,
name|response
operator|.
name|getPartitionSpec
...
name|TException
block|{
comment|// get partitions from "trusted" API
name|List
argument_list|<
name|Partition
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// non-existing partition should return zero partitions
name|getPartitionsWithVals
argument_list|(
name|Arrays
operator|.
...
argument_list|)
decl_stmt|;
comment|// remove one to make sure that the test is really looking at 3 names
name|names
operator|.
name|remove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// filter mode is set. Empty filter names. So no partitions should be returned
name|getPartitionsWithNames
argument_list|(
name|Arrays
operator|.
...
name|assertNull
argument_list|(
literal|"values were not requested but are still set"
argument_list|,
name|partitionWithoutSDS
operator|.
name|get
...
name|assertNull
argument_list|(
literal|"Parameters were not requested but are still set"
argument_list|,
name|partitionWithoutSDS
operator|.
name|get
