...
name|assertTrue
argument_list|(
literal|"Create time of catalog should be set"
argument_list|,
name|cat
operator|.
...
name|assertTrue
argument_list|(
literal|"Create time of catalog should be non-zero"
argument_list|,
name|cat
operator|.
name|getCreateTime
...
name|newDescription
init|=
literal|"an even more descriptive description"
decl_stmt|;
name|newCat
operator|.
name|setDescription
...
name|description
init|=
literal|"I have a bad feeling about this"
decl_stmt|;
operator|new
name|CatalogBuilder
argument_list|()
