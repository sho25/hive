...
begin_comment
comment|/**  * Tests handling of scheduled queries related calls to the metastore.  *  * Checks whether expected state changes are being done to the HMS database.  */
end_comment
...
annotation|@
name|Test
comment|//(expected = MetaException.class)
specifier|public
name|void
name|testDisabledProgress
parameter_list|()
throws|throws
name|MetaException
throws|,
