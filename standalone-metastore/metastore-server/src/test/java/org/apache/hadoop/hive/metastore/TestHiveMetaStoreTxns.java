...
specifier|public
name|void
name|testOpenReadOnlyTxnExcluded
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAllocateTableWriteIdForReadOnlyTxn
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expectMessage
argument_list|(
literal|"Write ID allocation failed on db.tbl as not all input txns in open state or read-only"
argument_list|)
expr_stmt|;
name|long
name|txnId
