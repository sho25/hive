...
name|tableName
init|=
literal|"table_for_no_such_catalog"
decl_stmt|;
name|Table
name|table
init|=
...
argument_list|)
decl_stmt|;
comment|// Explicitly mis-set the catalog name
name|part
operator|.
name|setCatName
argument_list|(
...
specifier|public
name|void
name|testAddPartitionUpperCaseDBAndTableName
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Create partition with table name 'TEST_ADD_PART_TABLE' and db name 'TEST_PARTITION_DB'
name|Partition
name|partition
init|=
name|buildPartition
...
specifier|public
name|void
name|testAddPartitionNullValues
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAddPartitionsUpperCaseDBAndTableName
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Validate the partitions attributes
comment|// The db and table name should be all lower case: 'test_partition_db' and
comment|// 'test_add_part_table'
comment|// The location should be saved case-sensitive, it should be
comment|// warehouse dir + "TEST_ADD_PART_TABLE/year=2017" and
comment|// warehouse dir + "TEST_ADD_PART_TABLE/year=2018"
name|Partition
name|part
init|=
name|client
...
specifier|public
name|void
name|testAddPartitionsUpperCaseDBAndTableNameInOnePart
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Create two partitions with table name 'test_add_part_table' and db name 'test_partition_db'
comment|// Create one partition with table name 'TEST_ADD_PART_TABLE' and db name 'TEST_PARTITION_DB'
name|Partition
name|partition1
init|=
name|buildPartition
...
specifier|public
name|void
name|testAddPartitionsNullValues
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAddPartitionsInvalidLocation
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAddPartitionsMoreThanThreadCountsOneFails
parameter_list|()
throws|throws
name|Exception
block|{
