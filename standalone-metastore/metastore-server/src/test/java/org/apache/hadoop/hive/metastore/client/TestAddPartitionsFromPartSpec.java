...
specifier|public
name|void
name|testAddPartitionSpecWithSharedSDUpperCaseDBAndTableName
parameter_list|()
throws|throws
name|Exception
block|{
...
name|TABLE_NAME
operator|+
literal|"/sharedSDTest/partwithoutsd1"
argument_list|,
name|part
operator|.
name|getSd
...
specifier|public
name|void
name|testAddPartitionSpecUpperCaseDBAndTableName
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Create table 'test_partition_db.test_add_part_table'
name|String
name|tableName
init|=
literal|"test_add_part_table"
decl_stmt|;
name|String
name|tableLocation
init|=
...
argument_list|)
expr_stmt|;
comment|// Create partitions with table name 'TEST_ADD_PART_TABLE' and db name 'TEST_PARTITION_DB'
name|Partition
name|partition1
init|=
name|buildPartition
...
argument_list|)
expr_stmt|;
comment|// Validate the partition attributes
comment|// The db and table name should be all lower case: 'test_partition_db' and
comment|// 'test_add_part_table'
comment|// The location should be saved case-sensitive, it should be
comment|// warehouse dir + "TEST_ADD_PART_TABLE/year=2017"
name|Partition
name|part
init|=
name|client
