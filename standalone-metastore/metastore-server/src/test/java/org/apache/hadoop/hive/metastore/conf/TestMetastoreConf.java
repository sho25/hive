...
expr_stmt|;
block|}
comment|/**    * Test class names hardcoded in MetastoreConf.    * MetastoreConf uses several hard-coded class names. If one of these classes is renamed or    * moved to a different package we want to be able to catch this. So we compare expected    * class name with the actual one.    */
annotation|@
name|Test
specifier|public
name|void
