...
literal|"createUser"
argument_list|,
literal|"Create the Hive user, set hiveUser to the db"
operator|+
...
argument_list|)
decl_stmt|;
comment|/*     Option metaDbTypeOpt = OptionBuilder.withArgName("metaDatabaseType")         .hasArgs().withDescription("Used only if upgrading the system catalog for hive")         .create("metaDbType");         */
name|Option
name|urlOpt
init|=
name|OptionBuilder
...
argument_list|)
expr_stmt|;
comment|//options.addOption(metaDbTypeOpt);
name|options
operator|.
name|addOption
argument_list|(
