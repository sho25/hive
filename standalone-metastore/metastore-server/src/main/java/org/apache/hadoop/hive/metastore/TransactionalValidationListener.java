...
argument_list|)
operator|+
literal|" cannot be converted to external table as it is transactional table."
argument_list|)
throw|;
block|}
...
condition|)
block|{
comment|// Validate each partition directory
name|List
argument_list|<
name|Partition
argument_list|>
...
argument_list|)
decl_stmt|;
name|validateTableStructureForPath
argument_list|(
name|hmsHandler
argument_list|,
name|wh
...
block|{
comment|// Non-partitioned - only need to worry about the base table directory
name|Path
name|tablePath
init|=
name|getTablePath
...
name|msg
init|=
literal|"Error getting partitions for "
operator|+
name|Warehouse
operator|.
name|getQualifiedName
...
name|MetaException
argument_list|(
literal|"Error getting table path for "
operator|+
name|Warehouse
operator|.
name|getQualifiedName
