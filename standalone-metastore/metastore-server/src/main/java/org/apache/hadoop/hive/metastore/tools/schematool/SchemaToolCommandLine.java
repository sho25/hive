...
argument_list|,
literal|"Drop all Hive databases (with CASCADE). "
operator|+
literal|"This will remove all managed data!"
argument_list|)
decl_stmt|;
name|Option
name|yesOpt
...
literal|"yes"
argument_list|,
literal|"Don't ask for confirmation when using -dropAllDatabases."
argument_list|)
decl_stmt|;
name|Option
name|validateOpt
...
name|withDescription
argument_list|(
literal|"Merge databases from a catalog into other, Argument is the source catalog name "
operator|+
literal|"Requires --toCatalog to indicate the destination catalog"
argument_list|)
operator|.
name|create
argument_list|(
...
name|printAndExit
argument_list|(
literal|"mergeCatalog and toCatalog must be set for mergeCatalog"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|printAndExit
argument_list|(
literal|"dropAllDatabases can only be used with dbType=hive"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|printAndExit
argument_list|(
literal|"yes can only be used with dropAllDatabases"
argument_list|)
expr_stmt|;
block|}
block|}
