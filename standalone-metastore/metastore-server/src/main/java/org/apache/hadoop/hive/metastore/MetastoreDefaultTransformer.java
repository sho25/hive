...
name|MetaException
argument_list|(
literal|"An external table's location needs to be under the external warehouse root directory,"
operator|+
literal|"table:"
operator|+
name|table
...
name|debug
argument_list|(
literal|"Table is a EXTERNAL TABLE"
argument_list|)
expr_stmt|;
name|Path
name|tableLocation
...
name|tableLocation
operator|+
literal|",Hive external warehouse:"
operator|+
name|externalWHRootPath
argument_list|)
throw|;
