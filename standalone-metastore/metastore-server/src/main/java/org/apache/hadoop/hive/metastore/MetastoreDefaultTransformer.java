...
name|debug
argument_list|(
literal|"Table belongs to non-default catalog, skipping translation"
argument_list|)
expr_stmt|;
return|return
name|objects
...
name|debug
argument_list|(
literal|"Table belongs to non-default catalog, skipping"
argument_list|)
expr_stmt|;
return|return
name|table
...
name|MetaException
argument_list|(
literal|"An external table's location should not be located within managed warehouse root directory,"
operator|+
literal|"table:"
operator|+
name|table
...
name|tablePath
operator|+
literal|",Hive managed warehouse:"
operator|+
name|whRootPath
argument_list|)
throw|;
...
name|info
argument_list|(
literal|"Starting translation for Alter table for processor "
operator|+
name|processorId
operator|+
literal|" with "
...
name|MetaException
argument_list|(
literal|"A managed table's location needs to be under the hive warehouse root directory,"
operator|+
literal|"table:"
operator|+
name|table
...
name|debug
argument_list|(
literal|"Table is an EXTERNAL TABLE:tableLocation={}, whroot={}"
argument_list|,
name|tableLocation
argument_list|,
name|whRootPath
...
name|debug
argument_list|(
literal|"Table is an EXTERNAL TABLE:tableLocation=null"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|debug
argument_list|(
literal|"Database belongs to non-default catalog, skipping translation"
argument_list|)
expr_stmt|;
return|return
name|db
