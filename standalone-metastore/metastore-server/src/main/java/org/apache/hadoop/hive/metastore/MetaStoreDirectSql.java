...
block|}
block|}
comment|/**    * Helper method for preparing for "SOMETHING_ID in (...)" to use in future queries.    * @param objectIds the objectId collection    * @return The concatenated list    * @throws MetaException If the list contains wrong data    */
specifier|private
specifier|static
name|String
name|getIdListForIn
