...
name|InvalidOperationException
block|{
comment|// Get list of partition values
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|// Get existing partitions from store
name|List
argument_list|<
name|Partition
argument_list|>
...
argument_list|()
operator|+
literal|" not matching with old parts size "
operator|+
name|oldParts
operator|.
name|size
...
name|InvalidOperationException
argument_list|(
literal|"Table type cannot be changed from "
operator|+
name|oldTbl
operator|.
name|getTableType
...
argument_list|)
decl_stmt|;
comment|//if its not called from cahced store then update the table
name|boolean
name|doAlterTable
init|=
name|deletedCols
...
condition|)
block|{
comment|// for out para, this value is initialized by caller.
if|if
condition|(
name|deletedCols
operator|==
...
block|{
comment|// in case deletedCols is provided by caller, stats will be updated  by caller.
name|updateColumnStats
operator|=
literal|false
expr_stmt|;
