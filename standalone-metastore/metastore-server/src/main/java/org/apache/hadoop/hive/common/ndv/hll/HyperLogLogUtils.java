...
block|}
block|}
comment|/**    * Refer serializeHLL() for format of serialization. This function    * deserializes the serialized hyperloglogs    * @param in    *          - input stream    * @return deserialized hyperloglog    * @throws IOException    */
specifier|public
specifier|static
name|HyperLogLog
name|deserializeHLL
...
return|;
block|}
comment|/**    * This function deserializes the serialized hyperloglogs from a byte array.    * @param buf - to deserialize    * @return HyperLogLog    */
specifier|public
specifier|static
name|HyperLogLog
name|deserializeHLL
...
argument_list|)
decl_stmt|;
comment|// TODO: use faster non-sync inputstream
try|try
block|{
name|HyperLogLog
name|result
