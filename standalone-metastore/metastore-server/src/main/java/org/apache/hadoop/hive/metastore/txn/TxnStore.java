...
name|MetaException
function_decl|;
comment|/**    * Replicate Table Write Ids state to mark aborted write ids and writeid high water mark.    * @param rqst info on table/partitions and writeid snapshot to replicate.    * @throws MetaException in case of failure    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
...
name|MetaException
function_decl|;
comment|/**    * Get invalidation info for the materialization. Currently, the materialization information    * only contains information about whether there was update/delete operations on the source    * tables used by the materialization since it was created.    * @param cm creation metadata for the materialization    * @param validTxnList valid transaction list for snapshot taken for current query    * @throws MetaException    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
...
parameter_list|)
function_decl|;
comment|/**    * Add the ACID write event information to writeNotificationLog table.    * @param acidWriteEvent    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
