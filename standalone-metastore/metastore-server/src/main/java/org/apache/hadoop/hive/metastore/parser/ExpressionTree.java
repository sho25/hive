...
return|return;
block|}
comment|//get the value for a partition key form MPartition.values (PARTITION_KEY_VALUES)
name|String
name|valString
init|=
literal|"values.get("
...
return|;
block|}
comment|// There's no support for date cast in JDO. Let's convert it to string; the date
comment|// columns have been excluded above, so it will either compare w/string or fail.
name|Object
name|val
init|=
name|value
