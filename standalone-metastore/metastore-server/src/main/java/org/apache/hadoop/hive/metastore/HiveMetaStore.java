...
return|;
block|}
comment|/**      * Deletes the data in a table's location, if it fails logs an error      *      * @param tablePath      * @param ifPurge completely purge the table (skipping trash) while removing      *                data from warehouse      * @param db database the table belongs to      */
specifier|private
name|void
name|deleteTableData
parameter_list|(
...
block|}
block|}
comment|/**     * Give a list of partitions' locations, tries to delete each one     * and for each that fails logs an error.     *     * @param partPaths     * @param ifPurge completely purge the partition (skipping trash) while     *                removing data from warehouse     * @param db database the partition belongs to     */
specifier|private
name|void
name|deletePartitionData
parameter_list|(
