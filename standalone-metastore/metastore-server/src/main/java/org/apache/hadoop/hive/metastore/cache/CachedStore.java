...
begin_comment
comment|// TODO Only works with Hive engine for column statistics
end_comment
...
name|RuntimeException
argument_list|(
literal|"CachedStore can only be enabled for Hive engine"
argument_list|)
throw|;
block|}
name|ColumnStatistics
...
block|}
block|}
comment|/**    * This method is only used for testing. Test method will init a new cache and use the new handle to query the cache    * to get content in the cache. In production, no code would/should call this method, because SharedCache should be    * a singleton.    */
annotation|@
name|VisibleForTesting
specifier|static
name|void
...
name|debug
argument_list|(
literal|"CachedStore: updated cached aggregate partition col stats objects for catalog:"
operator|+
literal|" {}, database: {}, table: {}"
argument_list|,
name|catName
argument_list|,
name|dbName
