...
return|;
block|}
comment|// TODO: if writeIdList is not null, check isolation level compliance for SVS,
comment|// possibly with getTableFromCache() with table snapshot in cache.
annotation|@
name|Override
specifier|public
name|Table
...
return|;
block|}
comment|// TODO: the same as getTable()
annotation|@
name|Override
specifier|public
name|Partition
...
return|return;
block|}
comment|// TODO: modify the following method for the case when writeIdList != null.
name|sharedCache
operator|.
...
annotation|@
name|Override
comment|// TODO: the same as getTable() for transactional stats.
specifier|public
name|AggrStats
name|get_aggr_stats_for
parameter_list|(
