...
name|NoSuchObjectException
block|{
comment|// TODO: why have updatePartitionColumnStatistics cache if this is a bypass?
comment|// Note: when implemented, this needs to call adjustColStatForGet, like other get methods.
return|return
name|rawStore
operator|.
name|getPartitionColumnStatistics
...
comment|//TODO : need to calculate aggregate locally in cached store
if|if
condition|(
operator|!
name|shouldCacheTable
