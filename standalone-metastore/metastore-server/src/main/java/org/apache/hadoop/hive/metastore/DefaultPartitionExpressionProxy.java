...
begin_comment
comment|/**  * Default implementation of PartitionExpressionProxy.  Eventually this should use the SARGs in  * Hive's storage-api.  For now it just throws UnsupportedOperationException.  */
end_comment
