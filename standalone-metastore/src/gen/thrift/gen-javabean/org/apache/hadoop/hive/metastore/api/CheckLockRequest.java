...
argument_list|,
operator|new
name|CheckLockRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|CheckLockRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field elapsed_ms is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetElapsed_ms
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|{
specifier|public
name|CheckLockRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|CheckLockRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
