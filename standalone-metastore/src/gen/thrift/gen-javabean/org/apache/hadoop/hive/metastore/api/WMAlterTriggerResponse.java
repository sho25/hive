...
name|TStruct
argument_list|(
literal|"WMAlterTriggerResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMAlterTriggerResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMAlterTriggerResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMAlterTriggerResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMAlterTriggerResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
