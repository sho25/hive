...
specifier|public
class|class
name|UniqueConstraintsResponse
...
name|TStruct
argument_list|(
literal|"UniqueConstraintsResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|UniqueConstraintsResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|UniqueConstraintsResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'uniqueConstraints' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|UniqueConstraintsResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|UniqueConstraintsResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
