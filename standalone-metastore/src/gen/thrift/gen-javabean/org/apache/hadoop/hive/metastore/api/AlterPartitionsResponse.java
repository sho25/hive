...
name|TStruct
argument_list|(
literal|"AlterPartitionsResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|AlterPartitionsResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|AlterPartitionsResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|AlterPartitionsResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|AlterPartitionsResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
