...
name|TStruct
argument_list|(
literal|"WMAlterResourcePlanResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMAlterResourcePlanResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMAlterResourcePlanResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMAlterResourcePlanResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMAlterResourcePlanResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
