...
name|TStruct
argument_list|(
literal|"DefaultConstraintsResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|DefaultConstraintsResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|DefaultConstraintsResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'defaultConstraints' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|DefaultConstraintsResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|DefaultConstraintsResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
