...
operator|.
name|TField
name|BUCKETING_VERSION_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
operator|.
name|TField
name|LOAD_IN_BUCKETED_TABLE_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
literal|18
case|:
comment|// LOAD_IN_BUCKETED_TABLE
return|return
name|LOAD_IN_BUCKETED_TABLE
return|;
default|default:
...
specifier|final
name|int
name|__LOADINBUCKETEDTABLE_ISSET_ID
init|=
literal|5
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/** Returns true if field bucketingVersion is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetBucketingVersion
parameter_list|()
...
name|loadInBucketedTable
expr_stmt|;
name|setLoadInBucketedTableIsSet
argument_list|(
literal|true
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/** Returns true if field loadInBucketedTable is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetLoadInBucketedTable
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|}
name|boolean
name|this_present_bucketingVersion
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_bucketingVersion
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_loadInBucketedTable
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_loadInBucketedTable
init|=
literal|true
operator|&&
name|that
...
expr_stmt|;
name|boolean
name|present_loadInBucketedTable
init|=
literal|true
operator|&&
operator|(
