...
name|TStruct
argument_list|(
literal|"NotificationEventsCountRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|NotificationEventsCountRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|NotificationEventsCountRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field fromEventId is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetFromEventId
parameter_list|()
block|{
return|return
name|EncodingUtils
...
return|;
name|boolean
name|this_present_fromEventId
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_fromEventId
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'fromEventId' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|NotificationEventsCountRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|NotificationEventsCountRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
