...
specifier|public
class|class
name|WMCreateResourcePlanResponse
...
name|TStruct
argument_list|(
literal|"WMCreateResourcePlanResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMCreateResourcePlanResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMCreateResourcePlanResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMCreateResourcePlanResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMCreateResourcePlanResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
