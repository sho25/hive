...
argument_list|,
operator|new
name|RuntimeStatStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|RuntimeStatTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field weight is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetWeight
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field payload is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetPayload
parameter_list|()
...
block|}
name|boolean
name|this_present_weight
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_weight
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'weight' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
name|TProtocolException
argument_list|(
literal|"Required field 'payload' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|RuntimeStatStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
