...
name|TStruct
argument_list|(
literal|"CheckConstraintsRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|CheckConstraintsRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|CheckConstraintsRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|CheckConstraintsRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|CheckConstraintsRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
