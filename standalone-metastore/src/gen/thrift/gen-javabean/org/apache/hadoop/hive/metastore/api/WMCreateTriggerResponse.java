...
name|TStruct
argument_list|(
literal|"WMCreateTriggerResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|WMCreateTriggerResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|WMCreateTriggerResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|WMCreateTriggerResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|WMCreateTriggerResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
