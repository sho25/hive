...
argument_list|,
operator|new
name|PartitionWithoutSDStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|PartitionWithoutSDTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field relativePath is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetRelativePath
parameter_list|()
...
block|}
name|boolean
name|this_present_relativePath
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_relativePath
init|=
literal|true
operator|&&
name|that
...
block|{
specifier|public
name|PartitionWithoutSDStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|PartitionWithoutSDTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
