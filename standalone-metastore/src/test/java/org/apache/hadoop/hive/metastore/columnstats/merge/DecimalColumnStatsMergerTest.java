...
expr_stmt|;
block|}
comment|/*    * it should pass, but fails because of HIVE-19131, get back to this later!    *    * @Test public void testCompareUnscaledValue() { Assert.assertEquals(DECIMAL_20,    * merger.compareValues(DECIMAL_3, DECIMAL_20)); }    */
annotation|@
name|Test
specifier|public
name|void
