...
block|}
block|}
comment|/**    * This test creates and queries a function and then drops it. Good for testing the happy path.    */
annotation|@
name|Test
specifier|public
name|void
...
specifier|public
name|void
name|getFunctionsNoSuchCatalog
parameter_list|()
throws|throws
name|TException
block|{
