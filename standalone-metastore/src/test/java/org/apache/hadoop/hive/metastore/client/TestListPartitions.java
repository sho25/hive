...
block|}
block|}
comment|/**    * Testing listPartitions(String,String,short) ->    *         get_partitions(String,String,short).    */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**    * Testing listPartitions(String,String,List(String),short) ->    *         get_partitions(String,String,List(String),short).    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Testing listPartitionSpecs(String,String,int) ->    *         get_partitions_pspec(String,String,int).    */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**    * Testing listPartitionsWithAuthInfo(String,String,short,String,List(String)) ->    *         get_partitions_with_auth(String,String,short,String,List(String)).    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Testing listPartitionsWithAuthInfo(String,String,List(String),short,String,List(String)) ->    *         get_partitions_ps_with_auth(String,String,List(String),short,String,List(String)).    */
annotation|@
name|Test
specifier|public
name|void
...
name|tableName
argument_list|,
literal|"yYyY=\"2017\" AND mOnTh=\"may\""
argument_list|,
operator|(
name|short
operator|)
...
name|tableName
argument_list|,
literal|"yyyy=\"2017\" AND month!=\"mArCh\""
argument_list|,
operator|(
name|short
operator|)
...
expr_stmt|;
block|}
comment|/**    * Testing listPartitionNames(String,String,short) ->    *         get_partition_names(String,String,short).    */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**    * Testing listPartitionNames(String,String,List(String),short) ->    *         get_partition_names_ps(String,String,List(String),short).    */
annotation|@
name|Test
specifier|public
name|void
...
name|catName
init|=
literal|"list_partition_catalog"
decl_stmt|;
name|Catalog
name|cat
init|=
...
specifier|public
name|void
name|listPartitionsBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionsWithPartialValuesBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionsSpecsBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionsByFilterBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionSpecsByFilterBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|getNumPartitionsByFilterBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionNamesBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionNamesPartialValsBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
...
specifier|public
name|void
name|listPartitionValuesBogusCatalog
parameter_list|()
throws|throws
name|TException
block|{
