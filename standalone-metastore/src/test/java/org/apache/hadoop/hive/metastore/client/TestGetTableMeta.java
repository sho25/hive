...
expr_stmt|;
block|}
comment|/**    * Testing getTableMeta(String,String,List(String)) ->    *         get_table_meta(String,String,List(String)).    */
annotation|@
name|Test
specifier|public
name|void
...
name|catName
init|=
literal|"get_table_meta_catalog"
decl_stmt|;
name|Catalog
name|cat
init|=
