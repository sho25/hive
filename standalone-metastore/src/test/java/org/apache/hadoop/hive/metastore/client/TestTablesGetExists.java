...
block|}
block|}
comment|// Tests for getTable in other catalogs are covered in TestTablesCreateDropAlterTruncate.
annotation|@
name|Test
specifier|public
name|void
...
name|catName
init|=
literal|"get_exists_tables_in_other_catalogs"
decl_stmt|;
name|Catalog
name|cat
init|=
