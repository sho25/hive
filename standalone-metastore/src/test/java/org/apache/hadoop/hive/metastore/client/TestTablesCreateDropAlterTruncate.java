...
block|}
block|}
comment|/**    * This test creates and queries a table and then drops it. Good for testing the happy path    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
argument_list|()
decl_stmt|;
comment|// Set parameters set outside
name|table
operator|.
...
operator|.
name|MURMUR_BUCKETING
argument_list|)
expr_stmt|;
name|table
operator|.
name|setLoadInBucketedTable
argument_list|(
literal|false
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Set the optional bucketingVersion and expertMode with default values
name|newTable
operator|.
name|setBucketingVersion
argument_list|(
