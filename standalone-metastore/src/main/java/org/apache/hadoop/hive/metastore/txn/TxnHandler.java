...
operator|+
literal|"ctc_table, ctc_partition) select tc_txnid, tc_database, tc_table, "
operator|+
...
name|s
operator|=
literal|"select ctc_database, ctc_table, ctc_id, ctc_timestamp from COMPLETED_TXN_COMPONENTS where ctc_txnid = "
operator|+
name|txnid
expr_stmt|;
name|rs
...
name|s
init|=
literal|"select ctc_id, ctc_timestamp, ctc_txnid, ctc_database, ctc_table "
operator|+
