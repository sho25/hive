...
name|TException
function_decl|;
comment|/**    * Get the last completed transaction for the given tables. Although transactions in Hive    * might happen concurrently, the order is based on the actual commit to the metastore    * table holding the completed transactions.    */
annotation|@
name|InterfaceAudience
operator|.
name|LimitedPrivate
...
name|TException
function_decl|;
comment|/**    * Get the last completed transaction for the given table. Although transactions in Hive    * might happen concurrently, the order is based on the actual commit to the metastore    * table holding the completed transactions.    */
annotation|@
name|InterfaceAudience
operator|.
name|LimitedPrivate
