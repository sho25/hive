...
return|;
block|}
comment|/**    * Get table name in cat.db.table format.    * @param catName catalog name    * @param dbName database name    * @param tableName table name    * @return fully qualified name.    */
specifier|public
specifier|static
name|String
name|getCatalogQualifiedTableName
