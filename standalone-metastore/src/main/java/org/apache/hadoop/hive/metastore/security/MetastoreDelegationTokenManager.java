...
argument_list|)
decl_stmt|;
comment|// The second half of this if is to catch cases where users are passing in a HiveConf for
comment|// configuration.  It will have set the default value of
comment|// "hive.cluster.delegation.token.store .class" to
comment|// "org.apache.hadoop.hive.thrift.MemoryTokenStore" as part of its construction.  But this is
comment|// the hive-shims version of the memory store.  We want to convert this to our default value.
if|if
condition|(
name|StringUtils
operator|.
