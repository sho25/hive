...
operator|)
assert|;
comment|// Note: we don't do txn stats validation here; this can only delete stats?
if|if
condition|(
name|cascade
condition|)
...
argument_list|)
decl_stmt|;
comment|// Note: doesn't take txn stats into account. This method can only remove stats.
name|List
argument_list|<
name|ColumnStatistics
argument_list|>
