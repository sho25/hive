...
return|;
block|}
comment|/**    * Given an array of bytes it will convert the bytes to a hex string    * representation of the bytes.    * @param bytes Input bytes    * @param start start index, inclusively    * @param end end index, exclusively    * @return hex string representation of the byte array    */
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**    * Checks if the input string/char sequence is empty    * @param cs Input char sequence    * @return true if empty and false if not    */
specifier|public
specifier|static
name|boolean
name|isEmpty
