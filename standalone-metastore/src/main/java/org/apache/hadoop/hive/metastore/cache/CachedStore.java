...
annotation|@
name|VisibleForTesting
comment|/**    * This initializes the caches in SharedCache by getting the objects from Metastore DB via    * ObjectStore and populating the respective caches    *    * @param rawStore    * @throws Exception    */
specifier|static
name|void
name|prewarm
parameter_list|(
