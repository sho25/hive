...
name|MetaException
function_decl|;
comment|/**    * Get the last transaction corresponding to given databases and tables.    * @return    * @throws MetaException    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
...
name|MetaException
function_decl|;
comment|/**    * Get the last transaction corresponding to given database and table.    * @return    * @throws MetaException    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
...
name|MetaException
function_decl|;
comment|/**    * Get the first transaction corresponding to given database and table after incremental id.    * @return    * @throws MetaException    */
annotation|@
name|RetrySemantics
operator|.
name|Idempotent
