...
name|execute
argument_list|(
literal|"CREATE TABLE \"APP\".\"TBLS\" (\"TBL_ID\" BIGINT NOT NULL, "
operator|+
literal|" \"CREATE_TIME\" INTEGER NOT NULL, \"DB_ID\" BIGINT, \"LAST_ACCESS_TIME\" INTEGER NOT NULL, "
operator|+
literal|" \"OWNER\" VARCHAR(767), \"OWNER_TYPE\" VARCHAR(10), \"RETENTION\" INTEGER NOT NULL, "
operator|+
literal|" \"SD_ID\" BIGINT, \"TBL_NAME\" VARCHAR(256), \"TBL_TYPE\" VARCHAR(128), "
operator|+
...
name|info
argument_list|(
literal|"PARTITIONS table already exist, ignoring"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|execute
argument_list|(
literal|"CREATE TABLE \"APP\".\"TABLE_PARAMS\" ("
operator|+
literal|" \"TBL_ID\" BIGINT NOT NULL, \"PARAM_KEY\" VARCHAR(256) NOT NULL, "
operator|+
literal|" \"PARAM_VALUE\" CLOB, "
operator|+
literal|" PRIMARY KEY (TBL_ID, PARAM_KEY))"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|info
argument_list|(
literal|"TABLE_PARAMS table already exist, ignoring"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|execute
argument_list|(
literal|"CREATE TABLE \"APP\".\"PARTITION_PARAMS\" ("
operator|+
...
name|info
argument_list|(
literal|"PARTITION_PARAMS table already exist, ignoring"
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|(
literal|"Failed to clean up txn tables"
argument_list|)
throw|;
block|}
specifier|private
...
name|debug
argument_list|(
literal|"Successfully dropped table "
operator|+
name|name
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// Intermittent failure
name|LOG
operator|.
name|warn
argument_list|(
literal|"Intermittent drop failure, retrying, try number "
operator|+
name|i
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Failed to drop table, don't know why"
argument_list|)
expr_stmt|;
return|return
literal|false
...
block|}
block|}
comment|/**    * Return true if the transaction of the given txnId is open.    * @param conf    HiveConf    * @param txnId   transaction id to search for    * @return    * @throws Exception    */
specifier|public
specifier|static
name|boolean
