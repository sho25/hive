...
argument_list|>
argument_list|>
name|updateDeleteTableModifications
init|=
operator|new
name|ConcurrentHashMap
argument_list|<>
...
condition|)
block|{
comment|// We update first the update/delete modifications record
name|ConcurrentSkipListSet
argument_list|<
name|Long
argument_list|>
name|modificationsSet
init|=
operator|new
name|ConcurrentSkipListSet
argument_list|<>
...
continue|continue;
block|}
comment|// We create a deep copy of the materialization, as we need to set the time
comment|// and whether any update/delete operation happen on the tables that it uses
comment|// since it was created.
name|Materialization
name|materializationCopy
init|=
operator|new
name|Materialization
argument_list|(
...
argument_list|)
expr_stmt|;
name|enrichWithInvalidationInfo
argument_list|(
name|materializationCopy
argument_list|)
expr_stmt|;
...
block|{
name|String
name|materializationTxnListString
init|=
name|materialization
operator|.
name|getValidTxnList
...
expr_stmt|;
block|}
comment|// Check if there was any update/delete after creation
name|containsUpdateDelete
operator|=
name|usedUDTableModifications
operator|!=
...
name|materialization
operator|.
name|setSourceTablesUpdateDeleteModified
argument_list|(
name|containsUpdateDelete
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Checks whether the given materialization exists in the invalidation cache.    * @param dbName the database name for the materialization    * @param tblName the table name for the materialization    * @return true if we have information about the materialization in the cache,    * false otherwise    */
specifier|public
name|boolean
