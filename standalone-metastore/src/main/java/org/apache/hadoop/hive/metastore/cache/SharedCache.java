...
argument_list|)
decl_stmt|;
comment|// New key has the new table name
name|String
name|newKey
init|=
name|CacheUtils
...
return|;
block|}
comment|/**    * Given a db + table, remove all partitions for this table from the cache    * @param dbName    * @param tblName    * @return    */
specifier|public
specifier|synchronized
name|void
...
block|}
block|}
comment|// Remove cached column stats for all partitions of all tables in a db
specifier|public
specifier|synchronized
name|void
...
name|info
argument_list|(
literal|"Unable to add partition stats for: {} to SharedCache"
argument_list|,
name|colStatWithSourceInfo
operator|.
name|getPartName
...
argument_list|)
decl_stmt|;
comment|// If unable to find stats for this StatsType, return null so we can build
comment|// stats
if|if
condition|(
name|colStatObj
...
name|debug
argument_list|(
literal|"CachedStore: updating aggregate stats cache for database: {}, table: {}"
argument_list|,
name|dbName
argument_list|,
name|tblName
