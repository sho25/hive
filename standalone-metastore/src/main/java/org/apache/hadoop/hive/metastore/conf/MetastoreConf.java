...
literal|"no.such.key"
decl_stmt|;
comment|// Used in config definitions when
comment|// there is no matching Hive or
comment|// metastore key for a value
specifier|private
specifier|static
name|URL
name|hiveDefaultURL
...
literal|null
decl_stmt|;
comment|/*   private static Map<String, String> metaToHiveKeys;   private static Map<String, String> hiveToMetaKeys;   */
specifier|private
specifier|static
name|Map
argument_list|<
...
return|;
block|}
comment|/**    * Return the configuration value as a String.  This does not work on time based values as it    * doesn't have a time unit.    * @param conf configuration to read    * @param var variable to read    * @return value as an object    */
specifier|public
specifier|static
name|String
name|getAsString
...
name|RuntimeException
argument_list|(
literal|"Invalid type for getObject "
operator|+
name|var
operator|.
name|defaultVal
