...
return|;
block|}
comment|/**    * Return the configuration value as a String.  For time based values it will be returned in    * the default time unit appended with an appropriate abbreviation (eg s for seconds, ...)    * @param conf configuration to read    * @param var variable to read    * @return value as an object    */
specifier|public
specifier|static
name|String
name|getAsString
