...
block|}
block|}
comment|// TODO: add global triggers to pTPT map depending on how they are stored, with a special key?
for|for
control|(
name|MWMTrigger
name|mTrigger
...
decl_stmt|;
name|int
name|totalChildrenQueryParallelism
init|=
literal|0
decl_stmt|;
name|double
...
expr_stmt|;
block|}
comment|// Check for valid pool.getSchedulingPolicy();
block|}
for|for
control|(
name|Entry
...
name|add
argument_list|(
literal|"Sum of children pools' alloc fraction should be equal 1.0 got: "
operator|+
name|poolData
operator|.
name|totalChildrenAllocFraction
...
name|add
argument_list|(
literal|"Sum of children pools' query parallelism: "
operator|+
name|poolData
operator|.
name|totalChildrenQueryParallelism
operator|+
literal|" is not equal to pool parallelism: "
operator|+
name|poolData
operator|.
name|queryParallelism
...
block|}
block|}
comment|// TODO: validate trigger and action expressions. mResourcePlan.getTriggers()
return|return
name|errors
return|;
block|}
