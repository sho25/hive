...
parameter_list|)
block|{
comment|// Note: this doesn't do recursion because we will do that on create/alter.
name|boolean
name|commited
init|=
literal|false
...
name|class
argument_list|,
literal|"path == pname and resourcePlan == rp"
argument_list|)
expr_stmt|;
name|query
operator|.
name|declareParameters
argument_list|(
literal|"java.lang.String pname, MWMResourcePlan rp"
argument_list|)
expr_stmt|;
name|query
operator|.
