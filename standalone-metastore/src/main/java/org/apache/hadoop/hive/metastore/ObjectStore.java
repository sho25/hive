...
name|put
argument_list|(
literal|"datanucleus.ConnectionFactory"
argument_list|,
name|ds
argument_list|)
expr_stmt|;
...
name|NoSuchObjectException
argument_list|(
literal|"Cannot find resource plan: "
operator|+
name|name
argument_list|)
throw|;
...
name|InvalidOperationException
argument_list|(
literal|"Resource plan should be unique"
argument_list|)
throw|;
block|}
name|ex
...
name|name
operator|+
literal|" is active, activate another plan first."
argument_list|)
throw|;
block|}
if|if
...
condition|)
block|{
comment|// enabled plan can be disabled and disabled plan enabled.
name|mResourcePlan
operator|.
name|setStatus
argument_list|(
...
condition|)
block|{
comment|// We can activate an enabled resource plan.
if|if
condition|(
operator|!
name|isResourcePlanValid
argument_list|(
name|mResourcePlan
argument_list|)
condition|)
...
name|InvalidOperationException
argument_list|(
literal|"Cannot activate resource plan: "
operator|+
name|name
operator|+
literal|" first enable it"
argument_list|)
throw|;
block|}
else|else
block|{
comment|// This should not happen just there in case we add more status.
throw|throw
operator|new
name|InvalidOperationException
argument_list|(
literal|"Cannot move resource plan: "
operator|+
name|name
operator|+
literal|" from "
...
name|class
argument_list|,
literal|"name == resourcePlanName&& status != \"ACTIVE\""
argument_list|)
expr_stmt|;
name|query
operator|.
name|declareParameters
argument_list|(
literal|"java.lang.String resourcePlanName"
argument_list|)
expr_stmt|;
if|if
condition|(
