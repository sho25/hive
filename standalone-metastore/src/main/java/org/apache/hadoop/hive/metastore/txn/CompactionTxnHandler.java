...
argument_list|)
expr_stmt|;
comment|// Delete COLUMN_STATS_ACCURATE.BASIC_STATS rows from TABLE_PARAMS for the txnids.
name|List
argument_list|<
name|StringBuilder
argument_list|>
...
argument_list|()
expr_stmt|;
comment|// Delete COLUMN_STATS_ACCURATE.BASIC_STATS rows from PARTITIONS_PARAMS for the txnids.
name|prefix
operator|.
name|append
argument_list|(
