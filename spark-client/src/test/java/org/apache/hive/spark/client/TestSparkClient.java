...
argument_list|)
argument_list|,
literal|"TestSparkClient-local-dir"
argument_list|)
operator|.
name|toString
argument_list|()
...
specifier|public
name|void
name|testErrorJobNotSerializable
parameter_list|()
throws|throws
name|Exception
block|{
...
name|IllegalStateException
argument_list|(
literal|"SparkContext did not shutdown in time"
argument_list|)
throw|;
block|}
block|}
