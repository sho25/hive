...
name|debug
argument_list|(
literal|"Error while connecting to port "
operator|+
name|expectedPort
operator|+
literal|" retrying: "
...
name|assertNotNull
argument_list|(
literal|"Unable to create RpcServer with any attempted port"
argument_list|,
name|server2
argument_list|)
expr_stmt|;
...
specifier|static
class|class
name|MockYarnApplicationStateFinder
extends|extends
name|RpcServer
operator|.
...
block|}
block|}
comment|/**    * Tests that we don't timeout with a short timeout but the spark application isn't running.    */
annotation|@
name|Test
specifier|public
name|void
name|testExtendClientTimeout
parameter_list|()
throws|throws
name|Exception
block|{
