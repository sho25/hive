...
decl_stmt|;
comment|// TODO: replace with service registry
specifier|private
specifier|final
name|YarnClient
name|yc
...
name|info
argument_list|(
literal|"Evaluating host usage criteria for service nodes"
argument_list|)
expr_stmt|;
try|try
block|{
...
condition|)
block|{
comment|// TODO: fix this with YARN registry
name|serviceHosts
operator|.
name|add
argument_list|(
