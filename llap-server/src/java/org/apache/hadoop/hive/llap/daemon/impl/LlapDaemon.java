...
expr_stmt|;
name|long
name|xmxHeadRoomBytes
init|=
name|determineXmxHeadroom
argument_list|(
name|daemonConf
argument_list|,
name|executorMemoryBytes
...
literal|100
argument_list|,
literal|"Headroom percentage should be in [0, 100) range; found "
operator|+
name|headroomStr
argument_list|)
expr_stmt|;
...
name|RuntimeException
argument_list|(
literal|"Invalid headroom configuration "
operator|+
name|headroomStr
argument_list|)
throw|;
...
name|executorMemoryBytes
argument_list|,
literal|"LLAP daemon headroom size should be less than daemon max memory size. headRoomBytes: "
operator|+
name|xmxHeadRoomBytes
operator|+
...
argument_list|)
expr_stmt|;
comment|// Unlikely, but log the actual values in case one of the two was empty/null
name|LOG
operator|.
name|warn
argument_list|(
literal|"NodeManager host/port not found in environment. Values retrieved: host={}, port={}"
argument_list|,
name|nmHost
argument_list|,
name|nmPort
