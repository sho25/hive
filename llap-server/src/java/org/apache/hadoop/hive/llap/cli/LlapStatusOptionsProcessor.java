...
argument_list|)
block|,
name|WATCH_UNTIL_STATUS_CHANGE
argument_list|(
literal|"watchUntil"
argument_list|,
literal|'w'
argument_list|,
literal|"Watch until LLAP application status changes to the specified "
operator|+
literal|"desired state before printing to console. Accepted values are "
operator|+
name|Arrays
operator|.
name|toString
