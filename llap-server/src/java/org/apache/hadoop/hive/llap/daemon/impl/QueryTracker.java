...
argument_list|)
decl_stmt|;
comment|/// Shared singleton MetricsSource instance for all DAG locks
specifier|private
specifier|static
specifier|final
name|MetricsSource
...
name|register
argument_list|(
literal|"QueryTrackerDAGLockMetrics"
argument_list|,
literal|"Lock metrics for QueryTracher DAG instances"
argument_list|,
name|LOCK_METRICS
argument_list|)
expr_stmt|;
