...
name|threadNameSuffix
operator|=
name|constructThreadNameSuffix
argument_list|(
name|taskSpec
operator|.
name|getTaskAttemptID
...
argument_list|()
operator|.
name|getUmbilicalUgi
argument_list|()
expr_stmt|;
block|}
else|else
block|{
comment|// Temporary, till the external interface makes use of a single connection per
comment|// instance.
name|taskOwner
operator|=
name|UserGroupInformation
...
parameter_list|()
block|{
comment|// TODO: support for binary spec? presumably we'd parse it somewhere earlier
return|return
name|vertex
return|;
block|}
