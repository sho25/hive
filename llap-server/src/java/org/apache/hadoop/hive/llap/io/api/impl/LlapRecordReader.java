...
specifier|private
name|boolean
name|hasSchemaEvolutionStringFamilyTruncateIssue
parameter_list|(
name|SchemaEvolution
name|evolution
parameter_list|)
block|{
return|return
name|hasStringFamilyTruncateTypeIssue
argument_list|(
name|evolution
argument_list|,
name|evolution
...
return|;
block|}
comment|// We recurse through the types.
specifier|private
name|boolean
name|hasStringFamilyTruncateTypeIssue
parameter_list|(
...
name|DECIMAL
case|:
comment|// We are only looking for the CHAR/VARCHAR truncate issue.
return|return
literal|false
return|;
case|case
...
argument_list|()
decl_stmt|;
comment|/*      * FUTURE: When SchemaEvolution.isOnlyImplicitConversion becomes available:      *  1) Replace the hasSchemaEvolutionStringFamilyTruncateIssue call with      *     !isOnlyImplicitConversion.      *  2) Delete hasSchemaEvolutionStringFamilyTruncateIssue code.      */
if|if
condition|(
name|evolution
operator|.
