...
block|}
block|}
comment|// This parameter is read in package.py - and nowhere else. Does not need to be part of
comment|// HiveConf - that's just confusing.
specifier|final
name|long
name|minAlloc
init|=
...
name|info
argument_list|(
literal|"Memory settings: container memory: {} executor memory: {} cache memory: {} headroom memory: {}"
argument_list|,
name|LlapUtil
operator|.
name|humanReadableByteCount
