...
comment|// We will estimate collection as an object.
name|addToProcessing
argument_list|(
name|byType
argument_list|,
...
block|}
block|}
comment|// We will estimate map as an object.
name|addToProcessing
argument_list|(
name|byType
argument_list|,
...
parameter_list|)
block|{
comment|// TODO: track unique objects?
...
parameter_list|)
block|{
comment|// TODO: this is bad design, it does shallow estimate and caller checks type... we should do better
if|if
condition|(
name|obj
operator|instanceof
