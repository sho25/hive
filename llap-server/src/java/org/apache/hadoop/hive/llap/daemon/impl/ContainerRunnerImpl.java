...
condition|)
block|{
comment|// when kerberos is enabled always use FQDN
name|llapHost
operator|=
name|localAddress
operator|.
...
condition|)
block|{
comment|// when FQDN is explicitly requested (default)
name|llapHost
operator|=
name|localAddress
operator|.
...
block|{
comment|// when FQDN is not requested, use ip address
name|llapHost
operator|=
name|localAddress
operator|.
...
name|info
argument_list|(
literal|"Using llap host: {} for execution context. hostName: {} hostAddress: {}"
argument_list|,
name|llapHost
argument_list|,
name|localAddress
