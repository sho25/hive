...
expr_stmt|;
block|}
comment|// Implementing TCS is needed for StatsRecordingThreadPool.
specifier|private
class|class
name|CpuRecordingCallable
implements|implements
name|Callable
argument_list|<
name|Void
...
parameter_list|)
block|{
comment|//In case a writer has a lock on any of the vectors we don't return it to the pool.
for|for
control|(
name|ColumnVector
name|cv
