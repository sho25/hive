...
decl_stmt|;
comment|// The same id as reported by TaskRunnerCallable.getRequestId
specifier|private
specifier|final
name|String
name|fragmentRequestId
decl_stmt|;
specifier|private
specifier|final
name|ListeningExecutorService
...
name|debug
argument_list|(
literal|"Invoking OOB heartbeat for successful attempt: {}, isTaskDone={}"
argument_list|,
name|taskAttemptID
argument_list|,
name|task
...
name|debug
argument_list|(
literal|"Invoking OOB heartbeat for failed/killed attempt: {}, isTaskDone={}, isKilled={}"
argument_list|,
name|taskAttemptID
argument_list|,
name|task
