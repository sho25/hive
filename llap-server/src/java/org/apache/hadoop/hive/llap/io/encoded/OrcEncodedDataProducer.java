...
comment|// with global column list and then separately pass stripe-specific includes below, to
comment|// allow it create the batches to return based on the former but only read the latter.
for|for
control|(
name|int
name|stripeIxMod
