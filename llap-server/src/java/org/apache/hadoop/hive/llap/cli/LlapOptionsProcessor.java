...
name|withDescription
argument_list|(
literal|"Time window in seconds (after initial delay) for which LLAP application is allowed to be in "
operator|+
literal|"unhealthy state before being killed (Default: 300)"
argument_list|)
operator|.
name|create
argument_list|()
