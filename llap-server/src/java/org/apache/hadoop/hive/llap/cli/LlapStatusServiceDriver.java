...
block|}
block|}
comment|/**    * @param appStatusBuilder    * @return an ExitCode. An ExitCode other than ExitCode.SUCCESS implies future progress not possible    * @throws LlapStatusCliException    */
specifier|private
name|ExitCode
name|populateAppStatusFromLlapRegistry
parameter_list|(
