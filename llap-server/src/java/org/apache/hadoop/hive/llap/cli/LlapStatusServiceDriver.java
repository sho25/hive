...
specifier|final
name|State
name|watchUntilState
init|=
name|options
operator|.
name|getWatchUntilState
argument_list|()
decl_stmt|;
specifier|final
name|long
...
block|}
block|}
comment|// desired state attained. print and break out of loop
name|statusServiceDriver
operator|.
name|outputJson
argument_list|(
...
name|info
argument_list|(
literal|"Watch timeout {}s exhausted before desired state {} is attained."
argument_list|,
name|TimeUnit
operator|.
name|SECONDS
