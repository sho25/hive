...
expr_stmt|;
block|}
comment|// TODO#: Given how ORC reads data, it should return this and not separate columns.
specifier|static
class|class
...
comment|/* [ERROR] reason: actual argument  org.apache.hadoop.hive.llap.io.decode.ColumnVectorProducer<BatchKey>.EncodedDataConsumer cannot be converted to  org.apache.hadoop.hive.llap.Consumer<   org.apache.hadoop.hive.llap.io.api.EncodedColumn<     org.apache.hadoop.hive.llap.io.api.orc.OrcBatchKey>> by method invocation conversion     * */
name|EncodedDataReader
argument_list|<
name|BatchKey
argument_list|>
