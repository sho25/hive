...
name|STRING
case|:
comment|//          columnStreams[i] = new StringColumnStream(file, colIx, present, data, dictionary, lengths,
comment|//              columnEncoding, codec, bufferSize, rowIndex);
break|break;
default|default:
throw|throw
operator|new
