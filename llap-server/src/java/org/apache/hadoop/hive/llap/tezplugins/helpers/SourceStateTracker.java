...
block|}
block|}
comment|/**    * Constructs FragmentRuntimeInfo for scheduling within LLAP daemons.    * Also caches state based on state updates.    * @param dagName    * @param vertexName    * @param fragmentNumber    * @param priority    * @return    */
specifier|public
specifier|synchronized
name|FragmentRuntimeInfo
