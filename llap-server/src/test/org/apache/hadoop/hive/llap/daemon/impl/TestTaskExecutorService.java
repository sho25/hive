...
argument_list|)
expr_stmt|;
comment|// this request should be rejected
name|scheduler
operator|.
name|schedule
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// these should invoke preemption
name|scheduler
operator|.
name|schedule
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait till pre-emption to kick-in and complete
name|Thread
operator|.
name|sleep
argument_list|(
