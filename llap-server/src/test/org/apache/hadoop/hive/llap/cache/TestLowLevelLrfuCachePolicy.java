...
name|info
argument_list|(
literal|"Testing force-eviction out of order"
argument_list|)
expr_stmt|;
name|Configuration
name|conf
...
expr_stmt|;
block|}
comment|// Now we should have two in the heap and two in the list, which is an implementation detail.
comment|// Evict only big blocks.
name|et
operator|.
name|evicted
operator|.
...
argument_list|()
expr_stmt|;
comment|// Evict small blocks when no big ones are available.
name|assertEquals
argument_list|(
literal|2
argument_list|,
