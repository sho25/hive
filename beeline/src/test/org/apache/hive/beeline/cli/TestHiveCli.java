...
operator|+
literal|"create table if not exists test.testTbl(a string, b string);\n"
decl_stmt|;
specifier|private
name|HiveCli
name|cli
...
block|}
block|}
comment|/**    * This method is used for verifying CMD to see whether the output contains the keywords provided.    */
specifier|private
name|void
name|verifyCMD
parameter_list|(
...
parameter_list|()
block|{
comment|// something changed scratch dir permissions, so test can't execute
name|HiveConf
name|hiveConf
init|=
operator|new
