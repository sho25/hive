...
specifier|public
name|void
name|testEmptyHiveConfVariable
parameter_list|()
throws|throws
name|Exception
block|{
...
name|write
argument_list|(
literal|"beeline.hiveconfvariables={}"
argument_list|)
expr_stmt|;
name|writer
operator|.
...
expr_stmt|;
block|}
comment|/**    * Test the file parameter option    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Test the report parameter option.    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
