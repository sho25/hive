...
block|}
block|}
comment|/**    * Only initial files specified by i option will be executed. The hiverc file will be processed by session manager.    *    * @param files    * @throws IOException    */
specifier|public
name|void
name|processInitFiles
parameter_list|(
...
block|}
block|}
comment|/**    * Update the configurations for the CLI mode in the client side    *    * @param line    */
specifier|private
name|boolean
name|isConfNeedsUpdate
parameter_list|(
