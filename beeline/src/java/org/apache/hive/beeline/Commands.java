...
argument_list|()
decl_stmt|;
comment|// Marker to track if there is a special section open
name|SectionType
name|sectionType
init|=
literal|null
...
condition|)
block|{
comment|// Opening non-escaped single quote
name|sectionType
operator|=
name|SectionType
operator|.
...
condition|)
block|{
comment|// Closing non-escaped single quote
name|sectionType
operator|=
literal|null
expr_stmt|;
...
condition|)
block|{
comment|// Opening non-escaped double quote
name|sectionType
operator|=
name|SectionType
operator|.
...
condition|)
block|{
comment|// Closing non-escaped double quote
name|sectionType
operator|=
literal|null
expr_stmt|;
...
condition|)
block|{
comment|// Opening line comment with (non-escapable?) double-dash
name|sectionType
operator|=
name|SectionType
operator|.
...
condition|)
block|{
comment|// Closing line comment with (non-escapable?) newline
name|sectionType
operator|=
literal|null
expr_stmt|;
...
condition|)
block|{
comment|// Opening block comment with (non-escapable?) /*
name|sectionType
operator|=
name|SectionType
operator|.
...
condition|)
block|{
comment|// Escape character seen (anywhere)
name|wasPrevEscape
operator|=
operator|!
name|wasPrevEscape
...
condition|)
block|{
comment|// If the delimiter is seen, and the line isn't inside a section, then treat
