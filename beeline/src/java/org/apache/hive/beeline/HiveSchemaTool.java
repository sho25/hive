...
block|}
block|}
comment|/***    * get JDBC connection to metastore db    *    * @param printInfo print connection parameters    * @return    * @throws MetaException    */
specifier|private
name|Connection
name|getConnectionToMetastore
parameter_list|(
...
block|}
block|}
comment|// Flatten the nested upgrade script into a buffer
specifier|public
specifier|static
name|String
name|buildCommand
...
return|;
block|}
comment|// run beeline on the given metastore scrip, flatten the nested scripts into single file
specifier|private
name|void
name|runBeeLine
parameter_list|(
