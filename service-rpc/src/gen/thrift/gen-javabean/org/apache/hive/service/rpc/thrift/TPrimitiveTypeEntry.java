...
operator|.
name|TField
name|TYPE_QUALIFIERS_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|TPrimitiveTypeEntryStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TPrimitiveTypeEntryTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field typeQualifiers is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTypeQualifiers
parameter_list|()
...
block|}
name|boolean
name|this_present_typeQualifiers
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_typeQualifiers
init|=
literal|true
operator|&&
name|that
...
block|{
specifier|public
name|TPrimitiveTypeEntryStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TPrimitiveTypeEntryTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
