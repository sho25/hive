...
name|TStruct
argument_list|(
literal|"TGetOperationStatusReq"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
operator|.
name|TField
name|GET_PROGRESS_UPDATE_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|TGetOperationStatusReqStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetOperationStatusReqTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
specifier|final
name|int
name|__GETPROGRESSUPDATE_ISSET_ID
init|=
literal|0
decl_stmt|;
specifier|private
...
literal|null
expr_stmt|;
name|setGetProgressUpdateIsSet
argument_list|(
literal|false
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/** Returns true if field getProgressUpdate is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetGetProgressUpdate
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|}
name|boolean
name|this_present_getProgressUpdate
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_getProgressUpdate
init|=
literal|true
operator|&&
name|that
...
expr_stmt|;
name|boolean
name|present_getProgressUpdate
init|=
literal|true
operator|&&
operator|(
...
block|{
specifier|public
name|TGetOperationStatusReqStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TGetOperationStatusReqTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
