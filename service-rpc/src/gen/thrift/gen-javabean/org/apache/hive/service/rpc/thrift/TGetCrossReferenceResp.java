...
name|TStruct
argument_list|(
literal|"TGetCrossReferenceResp"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TGetCrossReferenceRespStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetCrossReferenceRespTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TGetCrossReferenceRespStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TGetCrossReferenceRespTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
