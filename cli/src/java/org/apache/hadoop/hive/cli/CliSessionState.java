...
name|hive
decl_stmt|;
comment|// currently only used (and init'ed) in getCurrentDbName
specifier|public
name|CliSessionState
parameter_list|()
block|{
...
return|;
block|}
comment|/**    * Return the name of the current database    * @return the name of the current database or, if an error, null    */
specifier|public
name|String
