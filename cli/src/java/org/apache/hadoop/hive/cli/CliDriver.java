...
block|{
name|boolean
name|insideSingleQuote
init|=
literal|false
decl_stmt|;
name|boolean
name|insideDoubleQuote
init|=
literal|false
decl_stmt|;
name|boolean
...
condition|)
block|{
comment|// take a look to see if it is escaped
if|if
condition|(
operator|!
name|escape
condition|)
block|{
comment|// flip the boolean variable
name|insideSingleQuote
operator|=
operator|!
name|insideSingleQuote
...
condition|)
block|{
comment|// do not split
block|}
else|else
block|{
comment|// split, do not include ; itself
name|ret
operator|.
name|add
argument_list|(
