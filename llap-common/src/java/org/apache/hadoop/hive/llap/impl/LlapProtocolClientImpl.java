...
parameter_list|)
block|{
comment|// Technically, methods run on a threadpool that is created externally with the UGI.
comment|// However, that is brittle, so we'd save the UGI explicitly here.
name|this
operator|.
name|ugi
operator|=
...
name|info
argument_list|(
literal|"Creating protocol proxy as "
operator|+
name|ugi
argument_list|)
expr_stmt|;
