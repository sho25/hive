...
name|warn
argument_list|(
literal|"Cannot determine token user from the token; using {}"
argument_list|,
name|tokenUser
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Getting host proxies for {}"
argument_list|,
name|hostId
argument_list|)
expr_stmt|;
...
name|AssertionError
argument_list|(
literal|"Invalid internal state from "
operator|+
name|this
operator|.
name|token
...
name|warn
argument_list|(
literal|"Unable to determine IP address for host: {}.. Ignoring.."
argument_list|,
name|hostname
argument_list|,
name|e
