...
name|IOException
argument_list|(
literal|"Failed initializing deserializer "
operator|+
name|storageHandler
operator|.
name|getSerDeClass
...
name|errorThreshold
decl_stmt|;
comment|// max fraction of errors allowed
name|long
name|minErrors
decl_stmt|;
comment|// throw error only after this many errors
name|InputErrorTracker
parameter_list|(
name|Configuration
name|conf
...
condition|)
block|{
comment|// incorrect use of this class
throw|throw
operator|new
name|RuntimeException
argument_list|(
literal|"Forgot to invoke incRecords()?"
argument_list|)
throw|;
block|}
if|if
...
condition|)
block|{
comment|// no errors are tolerated
throw|throw
operator|new
name|RuntimeException
argument_list|(
literal|"error while reading input records"
argument_list|,
name|cause
argument_list|)
throw|;
...
name|warn
argument_list|(
literal|"Error while reading an input record ("
operator|+
name|numErrors
operator|+
literal|" out of "
...
name|numRecords
decl_stmt|;
comment|// will always excuse the first error. We can decide if single
comment|// error crosses threshold inside close() if we want to.
if|if
condition|(
name|numErrors
operator|>=
...
name|numRecords
operator|+
literal|" crosses configured threshold ("
operator|+
name|errorThreshold
operator|+
literal|")"
...
name|RuntimeException
argument_list|(
literal|"error rate while reading input records crossed threshold"
argument_list|,
name|cause
argument_list|)
throw|;
