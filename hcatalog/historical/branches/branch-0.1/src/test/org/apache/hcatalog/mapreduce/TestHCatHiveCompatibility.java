...
throw|;
block|}
comment|// assert that the table created has no howl instrumentation, and that we're still able to read it.
name|Table
name|table
init|=
name|client
...
argument_list|)
expr_stmt|;
comment|// assert that the table created still has no howl instrumentation
name|Table
name|table2
init|=
name|client
...
argument_list|)
expr_stmt|;
comment|// assert that there is one partition present, and it had howl instrumentation inserted when it was created.
name|Partition
name|ptn
init|=
name|client
