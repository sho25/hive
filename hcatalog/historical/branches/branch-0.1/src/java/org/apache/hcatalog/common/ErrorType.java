...
begin_comment
comment|/**  * Enum type representing the various errors throws by Howl.  */
end_comment
...
name|ErrorType
block|{
comment|/* Howl Input Format related errors 1000 - 1999 */
name|ERROR_DB_INIT
argument_list|(
literal|1000
argument_list|,
...
argument_list|)
block|,
comment|/* Howl Output Format related errors 2000 - 2999 */
...
literal|2004
argument_list|,
literal|"HowlOutputFormat not initialized, setOutput has to be called"
argument_list|)
block|,
...
literal|9001
argument_list|,
literal|"Exception occurred while processing Howl request"
argument_list|)
block|;
