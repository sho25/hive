...
name|info
argument_list|(
literal|"The columns {} have been added to the table {}."
argument_list|,
name|newColumns
argument_list|,
name|table
...
block|}
block|}
comment|/**      * This method exists to ensure unit tests run with Pig 0.8 and      * 0.9 versions. The cleanupJob method is deprecated but, Pig 0.8 and      * 0.9 call cleanupJob method. Hence this method is used by both abortJob      * and cleanupJob methods.      * @param context The job context.      * @throws java.io.IOException      */
specifier|private
name|void
name|internalAbortJob
parameter_list|(
