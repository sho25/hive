...
argument_list|)
decl_stmt|;
comment|/**    * Set the input to use for the Job. This queries the metadata server with the specified partition predicates,    * gets the matching partitions, puts the information in the configuration object.    * @param job the job object    * @param inputJobInfo information on the Input to read    * @throws Exception    */
specifier|public
specifier|static
name|void
name|setInput
...
name|Exception
block|{
comment|//* Create and initialize an InputJobInfo object
comment|//* Serialize the InputJobInfo and save in the Job's Configuration object
name|job
operator|.
