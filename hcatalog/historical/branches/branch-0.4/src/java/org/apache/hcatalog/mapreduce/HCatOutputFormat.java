...
name|harRequested
decl_stmt|;
comment|/**      * Set the information about the output to write for the job. This queries the metadata server      * to find the StorageHandler to use for the table.  It throws an error if the       * partition is already published.      * @param job the job object      * @param outputJobInfo the table output information for the job      * @throws IOException the exception in communicating with the metadata server      */
annotation|@
...
block|}
block|}
comment|/**      * Set the schema for the data being written out to the partition. The      * table schema is used by default for the partition if this is not called.      * @param job the job object      * @param schema the schema for the data      * @throws IOException      */
specifier|public
specifier|static
name|void
name|setSchema
