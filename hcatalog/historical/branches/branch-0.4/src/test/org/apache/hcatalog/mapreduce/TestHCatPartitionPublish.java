...
argument_list|)
expr_stmt|;
comment|// Also make sure that the directory has been deleted in the table location.
name|Assert
operator|.
name|assertFalse
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//The write count does not matter, as the map will fail in its first call.
