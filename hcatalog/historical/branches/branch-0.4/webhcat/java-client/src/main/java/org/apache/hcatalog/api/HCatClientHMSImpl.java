...
name|HCatException
argument_list|(
literal|"InvalidPartitionException while marking partition for event."
argument_list|,
name|e
argument_list|)
throw|;
...
name|HCatException
argument_list|(
literal|"UnknownPartitionException while marking partition for event."
argument_list|,
name|e
argument_list|)
throw|;
...
name|HCatException
argument_list|(
literal|"InvalidPartitionException while checking partition for event."
argument_list|,
name|e
argument_list|)
throw|;
...
name|HCatException
argument_list|(
literal|"UnknownPartitionException while checking partition for event."
argument_list|,
name|e
argument_list|)
throw|;
