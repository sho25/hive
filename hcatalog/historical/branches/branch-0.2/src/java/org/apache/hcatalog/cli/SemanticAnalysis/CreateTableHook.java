...
comment|//            throw new SemanticException("Operation not supported. Table "+likeTableName+" should have been created through HCat. Seems like its not.");
comment|//          }
comment|//          return ast;
block|}
break|break;
...
comment|// in CreateTableLikeDesc. Currently, HCat disallows CTLT in pre-hook.
