...
decl_stmt|;
comment|/**    * Instantiates a new hcat partition info.    * @param partitionSchema the partition schema    * @param inputStorageDriverClass the input storage driver class name    * @param location the location    * @param hcatProperties hcat-specific properties at the partition    */
specifier|public
name|PartInfo
parameter_list|(
name|HCatSchema
...
return|;
block|}
comment|/**    * Gets the value of hcatProperties.    * @return the hcatProperties    */
specifier|public
name|Properties
