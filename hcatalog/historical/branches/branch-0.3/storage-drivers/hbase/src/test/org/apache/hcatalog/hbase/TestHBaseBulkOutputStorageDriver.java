...
begin_comment
comment|/**  * Tests components of HBaseBulkOutputStorageDriver using ManyMiniCluster.  * Including ImprtSequenceFile, HBaseOutputStorageDrivers and HBaseBulkOutputFormat  */
end_comment

begin_class
specifier|public
class|class
name|TestHBaseBulkOutputStorageDriver
extends|extends
...
specifier|public
name|void
name|hbaseBulkOutputStorageDriverTest
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testName
init|=
literal|"hbaseBulkOutputStorageDriverTest"
decl_stmt|;
name|Path
name|methodTestDir
init|=
...
specifier|public
name|void
name|hbaseBulkOutputStorageDriverTestWithDefaultDB
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testName
init|=
literal|"hbaseBulkOutputStorageDriverTestWithDefaultDB"
decl_stmt|;
name|Path
name|methodTestDir
init|=
