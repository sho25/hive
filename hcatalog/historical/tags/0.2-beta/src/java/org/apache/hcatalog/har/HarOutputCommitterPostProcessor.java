...
block|{
comment|//  static final private Log LOG = LogFactory.getLog(HarOutputCommitterPostProcessor.class);
name|boolean
name|isEnabled
init|=
literal|false
...
return|;
block|}
comment|/**    * Creates a har file from the contents of a given directory, using that as root.    * @param dir Directory to archive    * @param harName The HAR file to create    */
specifier|public
specifier|static
name|void
name|makeHar
