...
name|OutputCommitter
block|{
comment|//    static final private Log LOG = LogFactory.getLog(HCatOutputCommitter.class);
...
block|{
comment|// called explicitly through HCatRecordWriter.close() if dynamic
block|}
block|}
annotation|@
name|Override
...
block|{
comment|// called explicitly through HCatRecordWriter.close() if dynamic - return false by default
return|return
literal|false
return|;
block|}
...
expr_stmt|;
block|}
comment|// in dynamic usecase, called through HCatRecordWriter
block|}
annotation|@
name|Override
specifier|public
...
block|{
comment|// called explicitly through HCatRecordWriter.write() if dynamic
block|}
block|}
annotation|@
name|Override
...
return|;
block|}
comment|/**      * Move all of the files from the temp directory to the final location      * @param fs the output file system      * @param file the file to move      * @param src the source directory      * @param dest the target directory      * @param dryRun - a flag that simply tests if this move would succeed or not based       *                 on whether other files exist where we're trying to copy      * @throws IOException      */
specifier|private
name|void
name|moveTaskOutputs
parameter_list|(
