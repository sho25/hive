...
argument_list|()
expr_stmt|;
comment|// Simulate the frontend call sequence for LoadFunc, in case LoadFunc need to store something into UDFContext (as JsonLoader does)
if|if
condition|(
name|loadFunc
operator|instanceof
...
argument_list|)
decl_stmt|;
comment|// We will do conversion for bytes only for now
if|if
condition|(
name|data
operator|instanceof
