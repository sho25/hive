...
return|;
block|}
comment|/**      * This method updates the transaction data related to a znode.      *      * @param String The path to the transaction data.      * @param FamilyRevision The FamilyRevision to be updated.      * @param UpdateMode The mode to update like append, update, remove.      * @throws IOException      */
name|void
name|updateData
parameter_list|(
name|String
