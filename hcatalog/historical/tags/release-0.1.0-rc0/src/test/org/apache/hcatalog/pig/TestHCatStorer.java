...
comment|//    MiniCluster.createInputFile(cluster, fileName, new String[]{"test\t{([a#haddop,b#pig])}","data\t{([b#hive,a#howl])}"});
comment|//
...
index|[]
block|{
literal|"zookeeper\t(2)\t{(pig)}\t{(pnuts,hdfs)}\t{(hadoop),(howl)}"
block|,
literal|"chubby\t(2)\t{(sawzall)}\t{(bigtable,gfs)}\t{(mapreduce),(howl)}"
block|}
argument_list|)
expr_stmt|;
name|PigServer
...
name|assertEquals
argument_list|(
literal|"zookeeper\t{\"a1\":2}\t[\"pig\"]\t[{\"s1\":\"pnuts\",\"s2\":\"hdfs\"}]\t[{\"s3\":\"hadoop\"},{\"s3\":\"howl\"}]"
argument_list|,
name|itr
operator|.
name|next
...
name|assertEquals
argument_list|(
literal|"chubby\t{\"a1\":2}\t[\"sawzall\"]\t[{\"s1\":\"bigtable\",\"s2\":\"gfs\"}]\t[{\"s3\":\"mapreduce\"},{\"s3\":\"howl\"}]"
argument_list|,
name|itr
operator|.
name|next
