...
begin_comment
comment|/** The Howl wrapper for the underlying RecordReader, this ensures that the initialize on  * the underlying record reader is done with the underlying split, not with HowlSplit.  */
end_comment
...
name|storageDriver
decl_stmt|;
comment|/**      * Instantiates a new howl record reader.      * @param baseRecordReader the base record reader      */
specifier|public
name|HCatRecordReader
parameter_list|(
name|HCatInputStorageDriver
