...
block|}
comment|/**    * Returns the InputFormat to use with this Storage Driver.    * @param properties the properties containing parameters required for initialization of InputFormat    * @return the InputFormat instance    */
specifier|public
specifier|abstract
name|InputFormat
argument_list|<
...
parameter_list|)
function_decl|;
comment|/**    * Converts to HowlRecord format usable by HowlInputFormat to convert to required valuetype.    * Implementers of StorageDriver should look to overwriting this function so as to convert their    * value type to HowlRecord. Default implementation is provided for StorageDriver implementations    * on top of an underlying InputFormat that already uses HowlRecord as a tuple    * @param value the underlying value to convert to HowlRecord    */
specifier|public
specifier|abstract
name|HCatRecord
...
expr_stmt|;
block|}
comment|/**    * Set the schema of the data as originally published in Howl. The storage driver might validate that this matches with    * the schema it has (like Zebra) or it will use this to create a HowlRecord matching the output schema.    * @param jobContext the job context object    * @param howlSchema the schema published in Howl for this data    * @param instantiationState    * @throws IOException Signals that an I/O exception has occurred.    */
specifier|public
specifier|abstract
name|void
