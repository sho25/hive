...
argument_list|)
decl_stmt|;
comment|//Test passing in same jobConf or same OutputJobInfo multiple times and verify 1 transaction is created
comment|//Same jobConf
name|HCatOutputFormat
operator|.
name|setOutput
argument_list|(
