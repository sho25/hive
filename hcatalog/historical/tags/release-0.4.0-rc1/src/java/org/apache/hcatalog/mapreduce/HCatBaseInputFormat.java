...
argument_list|)
decl_stmt|;
comment|//Call getSplit on the InputFormat, create an
comment|//HCatSplit for each underlying split
comment|//NumSplits is 0 for our purposes
name|org
operator|.
name|apache
operator|.
...
argument_list|)
expr_stmt|;
comment|//    HCatUtil.logEntrySet(LOG, "props to serde", properties.entrySet());
name|Configuration
name|conf
init|=
name|storageHandler
...
name|IOException
argument_list|(
literal|"Unable to create objectInspector "
operator|+
literal|"for serde class "
operator|+
name|storageHandler
operator|.
name|getSerDeClass
