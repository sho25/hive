...
begin_comment
comment|/**  * Test for HowlOutputFormat. Writes a partition using HowlOutputFormat and reads  * it back using HCatInputFormat, checks the column values and counts.  */
end_comment
...
name|tableName
init|=
literal|"testHowlMapReduceTable"
decl_stmt|;
specifier|protected
name|String
name|inputFormat
...
name|conf
argument_list|,
literal|"howl mapreduce write test"
argument_list|)
decl_stmt|;
name|job
operator|.
...
argument_list|()
argument_list|,
literal|"mapred/testHowlMapReduceInput"
argument_list|)
decl_stmt|;
name|createInputFile
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//new HowlOutputCommitter(null).setupJob(job);
name|job
operator|.
...
name|conf
argument_list|,
literal|"howl mapreduce read test"
argument_list|)
decl_stmt|;
name|job
operator|.
...
argument_list|()
argument_list|,
literal|"mapred/testHowlMapReduceOutput"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|conf
argument_list|,
literal|"howl mapreduce read schema test"
argument_list|)
decl_stmt|;
name|job
operator|.
