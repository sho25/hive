...
return|;
block|}
comment|/**    * Set the input to use for the Job. This queries the metadata server with the specified partition predicates,    * gets the matching partitions, puts the information in the configuration object.    * @param job the job object    * @param inputInfo the howl table input info    * @throws Exception    */
specifier|public
specifier|static
name|void
name|setInput
