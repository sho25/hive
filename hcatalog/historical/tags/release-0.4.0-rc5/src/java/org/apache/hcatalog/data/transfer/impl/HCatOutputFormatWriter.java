...
parameter_list|)
block|{
comment|// Following two config keys are required by FileOutputFormat to work correctly.
comment|// In usual case of Hadoop, JobTracker will set these before launching tasks.
