...
comment|//
comment|//    PigServer server = new PigServer(ExecType.LOCAL);
...
name|createTable
init|=
literal|"create table junit_unparted(a int, b float, c double, d bigint, e string, f binary) stored as RCFILE"
decl_stmt|;
name|int
name|retCode
init|=
