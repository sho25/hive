...
name|serverUri
decl_stmt|;
comment|/** If the howl server is configured to work with hadoop security, this    * variable will hold the principal name of the server - this will be used    * in the authentication to the howl server using kerberos    */
specifier|private
specifier|final
name|String
