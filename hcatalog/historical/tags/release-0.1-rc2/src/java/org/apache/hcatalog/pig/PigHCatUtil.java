...
comment|// communicate the information to HowlInputFormat
name|String
index|[]
...
return|;
block|}
comment|/**    * @param hfs schema of the column    * @return corresponding pig type    * @throws IOException    */
specifier|static
specifier|public
name|byte
name|getPigType
