...
begin_comment
comment|/** The HowlSplit wrapper around the InputSplit returned by the underlying InputFormat */
end_comment
...
name|baseSplit
decl_stmt|;
comment|/** The schema for the HowlTable */
specifier|private
name|HCatSchema
name|tableSchema
decl_stmt|;
comment|/**      * Instantiates a new howl split.      */
specifier|public
name|HCatSplit
parameter_list|()
block|{     }
comment|/**      * Instantiates a new howl split.      *      * @param partitionInfo the partition info      * @param baseSplit the base split      * @param tableSchema the table level schema      */
specifier|public
name|HCatSplit
parameter_list|(
name|PartInfo
