...
block|}
block|}
comment|/**    * Gets the output storage driver instance, with allowing specification     * of partvals from which it picks the dynamic partvals    * @param context the job context    * @param jobInfo the output job info    * @return the output driver instance    * @throws IOException    */
specifier|protected
specifier|static
name|HCatOutputStorageDriver
name|getOutputDriverInstance
