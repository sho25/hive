...
begin_comment
comment|/**  * Test HBaseDirectOuputStorageDriver and HBaseDirectOUtputFormat using a MiniCluster  */
end_comment

begin_class
specifier|public
class|class
name|TestHBaseDirectOutputStorageDriver
extends|extends
...
specifier|public
name|void
name|directOutputStorageDriverTest
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testName
init|=
literal|"directOutputStorageDriverTest"
decl_stmt|;
name|Path
name|methodTestDir
init|=
...
specifier|public
name|void
name|directOutputStorageDriverTestWithRevision
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testName
init|=
literal|"directOutputStorageDriverTestWithRevision"
decl_stmt|;
name|Path
name|methodTestDir
init|=
