...
expr_stmt|;
block|}
comment|/**      * @param schema table schema      * @param outputSchema schema of projected output      * @param hcatProperties table properties      * @param outputVersion value to write in timestamp field      * @throws IOException thrown if hive's HBaseSerDe couldn't be initialized      */
name|HBaseSerDeResultConverter
parameter_list|(
name|HCatSchema
name|schema
