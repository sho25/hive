...
name|IOException
function_decl|;
comment|/**      * Start the write transaction.      *      * @param table      * @param families      * @return      * @throws IOException      */
specifier|public
name|Transaction
...
name|IOException
function_decl|;
comment|/**      * Start the write transaction.      *      * @param table      * @param families      * @param keepAlive      * @return      * @throws IOException      */
specifier|public
name|Transaction
name|beginWriteTransaction
parameter_list|(
...
name|IOException
function_decl|;
comment|/**      * Create the latest snapshot of the table.      *      * @param tableName      * @return      * @throws IOException      */
specifier|public
name|TableSnapshot
name|createSnapshot
parameter_list|(
...
name|IOException
function_decl|;
comment|/**      * Create the snapshot of the table using the revision number.      *      * @param tableName      * @param revision      * @return      * @throws IOException      */
specifier|public
name|TableSnapshot
name|createSnapshot
parameter_list|(
