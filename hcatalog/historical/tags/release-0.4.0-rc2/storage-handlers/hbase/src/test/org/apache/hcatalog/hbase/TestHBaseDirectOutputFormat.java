...
begin_comment
comment|/**  * Test HBaseDirectOUtputFormat and HBaseHCatStorageHandler using a MiniCluster  */
end_comment
...
name|testName
init|=
literal|"directOutputFormatTest"
decl_stmt|;
name|Path
name|methodTestDir
init|=
...
block|,
literal|"2,english:ONE,spanish:DOS"
block|,
literal|"3,english:ONE,spanish:TRES"
block|}
decl_stmt|;
...
specifier|public
name|void
name|directHCatOutputFormatTest
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testName
init|=
literal|"directHCatOutputFormatTest"
decl_stmt|;
name|Path
name|methodTestDir
init|=
...
argument_list|)
decl_stmt|;
comment|//Table name as specified by hbase.table.name property
name|String
name|hbaseTableName
init|=
name|tableName
...
name|familyName
operator|+
literal|":spanish','hbase.table.name'='"
operator|+
name|hbaseTableName
operator|+
literal|"')"
...
expr_stmt|;
block|}
comment|// verify that hbase has the records of the successful maps.
name|HTable
name|table
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// verify that the inputformat returns empty results.
name|Path
name|outputDir
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|//Test passing in same OutputJobInfo multiple times and verify 1 transaction is created
name|String
name|jobString
init|=
name|job
...
name|IOException
argument_list|(
literal|"Failing map to test abort"
argument_list|)
throw|;
block|}
for|for
...
name|IOException
argument_list|(
literal|"There should have been no records"
argument_list|)
throw|;
block|}
name|cleanup
