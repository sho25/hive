...
return|;
block|}
comment|/**    * Gets the output storage driver instance.    * @param jobContext the job context    * @return the output driver instance    * @throws IOException    */
annotation|@
...
expr_stmt|;
block|}
comment|/**    * Gets the output storage driver instance, with allowing specification of missing dynamic partvals    * @param jobContext the job context    * @return the output driver instance    * @throws IOException    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
block|}
block|}
comment|/**    * Gets the output storage driver instance, with allowing specification     * of partvals from which it picks the dynamic partvals    * @param context the job context    * @param jobInfo the output job info    * @throws IOException    */
specifier|protected
specifier|static
name|void
name|configureOutputStorageHandler
