...
return|;
block|}
comment|/**       * Sets up the table, column family znodes in zookeeper.       *       * @param tableName the hbase table name       * @param columnFamilies the column families in hbase       * @throws IOException Signals that an I/O exception has occurred.       */
specifier|public
name|void
name|setUpZNodes
parameter_list|(
...
expr_stmt|;
block|}
comment|/**       * Delete the table znodes from zookeeper.       *       * @param tableName the table name       * @throws IOException Signals that an I/O exception has occurred.       */
specifier|public
name|void
name|deleteZNodes
parameter_list|(
