...
argument_list|)
expr_stmt|;
comment|// Check that serDe settings stick.
name|String
name|tableFour
init|=
literal|"table4"
decl_stmt|;
name|String
name|nonDefaultSerDe
init|=
literal|"com.my.custom.SerDe"
decl_stmt|;
name|HCatCreateTableDesc
name|tableDesc4
init|=
...
name|assertEquals
argument_list|(
literal|"SerDe libraries don't match!"
argument_list|,
name|nonDefaultSerDe
argument_list|,
name|table4
...
argument_list|)
expr_stmt|;
comment|// Check that serDe settings don't stick when a storageHandler is used.
name|tableDesc4
operator|=
name|HCatCreateTableDesc
operator|.
...
name|assertNotSame
argument_list|(
literal|"SerDe libraries shouldn't have matched!"
argument_list|,
name|nonDefaultSerDe
argument_list|,
name|table4
