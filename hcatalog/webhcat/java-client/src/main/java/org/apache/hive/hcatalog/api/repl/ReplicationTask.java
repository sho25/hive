...
function_decl|;
block|}
comment|/**    * Dummy NoopFactory for testing, returns a NoopReplicationTask for all recognized events.    * Warning : this will eventually go away or move to the test section - it's intended only    * for integration testing purposes.    */
specifier|public
specifier|static
class|class
name|NoopFactory
...
condition|)
block|{
comment|// TODO: Eventually, we'll have a bit here that looks at a config param to instantiate
comment|// the appropriate factory, with EXIMFactory being the default - that allows
comment|// others to implement their own ReplicationTask.Factory for other replication
comment|// implementations.
comment|// That addition will be brought in by the EXIMFactory patch.
name|factoryInstance
operator|=
operator|new
name|NoopFactory
