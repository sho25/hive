...
decl_stmt|;
comment|/**    * is a comma separated list of name=value pairs;    * In case some value is itself a comma-separated list, the comma needs to    * be escaped with {@link org.apache.hadoop.util.StringUtils#ESCAPE_CHAR}    */
specifier|public
specifier|static
specifier|final
name|String
