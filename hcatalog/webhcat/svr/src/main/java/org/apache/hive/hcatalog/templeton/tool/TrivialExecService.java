...
block|}
block|}
comment|/**    * Print files and directories in current directory. Will list files in the sub-directory (only 1 level deep)    * time honored tradition in WebHCat of borrowing from Oozie    */
specifier|private
specifier|static
name|void
name|printContentsOfDir
