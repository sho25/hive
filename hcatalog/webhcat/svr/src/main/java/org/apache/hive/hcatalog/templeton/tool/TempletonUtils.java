...
name|origPathStr
decl_stmt|;
comment|// shortcut for s3/asv
comment|// If path contains scheme, user should mean an absolute path,
comment|// However, path.isAbsolute tell us otherwise.
comment|// So we skip conversion for non-hdfs.
if|if
condition|(
operator|!
operator|(
