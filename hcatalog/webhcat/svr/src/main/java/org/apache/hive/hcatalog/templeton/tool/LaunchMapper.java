...
name|JobSubmissionConstants
operator|.
name|HIVE_QUERY_TAG_ARG_PLACEHOLDER
argument_list|,
name|JobSubmissionConstants
operator|.
name|HIVE_QUERY_TAG
...
block|}
block|}
comment|/**    * Replace the placeholder tags with our MR jobid so that all child jobs or hive queries are    * get tagged with it. This is used on launcher task restart to prevent from having    * same jobs running in parallel.    */
specifier|private
specifier|static
name|void
name|replaceJobTag
