...
begin_comment
comment|// TODO, once HIVE-9175 is committed
end_comment

begin_comment
comment|// import org.apache.hive.hcatalog.messaging.AlterTableMessage;
end_comment
...
block|}
comment|// TODO Once HIVE-9175 is committed
comment|/*   @Override   public AlterTableMessage buildAlterTableMessage(Table before, Table after) {     return new JSONAlterTableMessage(HCAT_SERVER_URL, HCAT_SERVICE_PRINCIPAL, before.getDbName(),         before.getTableName(), now());   }   */
annotation|@
name|Override
specifier|public
name|DropTableMessage
