...
argument_list|)
decl_stmt|;
comment|//todo: DataOperationType is set conservatively here, we'd really want to distinguish update/delete
comment|//and insert/select and if resource (that is written to) is ACID or not
if|if
condition|(
name|sinks
operator|.
