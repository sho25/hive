...
decl_stmt|;
comment|/**    * List of SerDe classes that the HCatalog core tests will not be run against.    */
specifier|public
specifier|static
specifier|final
name|Set
...
return|;
block|}
comment|/**    * Test constructor that sets the storage format class names provided by the test parameter.    */
specifier|public
name|HCatMapReduceTest
parameter_list|(
name|String
...
argument_list|)
expr_stmt|;
comment|// in case of external table, drop the table contents as well
if|if
condition|(
name|isTableExternal
argument_list|()
...
name|Exception
block|{
comment|// Use Junit's Assume to skip running this fixture against any storage formats whose
comment|// SerDe is in the disabled serdes list.
name|Assume
operator|.
name|assumeTrue
argument_list|(
