...
name|IOException
argument_list|(
literal|"No InputJobInfo was set in job config"
argument_list|)
throw|;
block|}
name|InputJobInfo
...
condition|)
block|{
comment|// if external table and custom root specified, update the parent path
if|if
condition|(
name|Boolean
operator|.
...
condition|)
block|{
comment|// dynamic partitioning with custom path; resolve the custom path
comment|// using partition column values
name|outputLocation
operator|=
name|HCatFileUtil
operator|.
