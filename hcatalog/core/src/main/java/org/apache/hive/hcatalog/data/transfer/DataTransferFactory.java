...
return|;
block|}
comment|/**    * This should only be called once from every slave node to obtain an instance    * of {@link HCatReader}.    *    * @param context    *          reader context obtained at the master node    * @param slaveNumber    *          which slave this is, determines which part of the read is done    * @return {@link HCatReader}    */
specifier|public
specifier|static
name|HCatReader
name|getHCatReader
...
return|;
block|}
comment|/**    * This should only be called once from every slave node to obtain an instance    * of {@link HCatReader}. This should be called if an external system has some    * state to provide to HCatalog.    *    * @param context    *          reader context obtained at the master node    * @param slaveNumber    *          which slave this is, determines which part of the read is done    * @param sp    *          {@link StateProvider}    * @return {@link HCatReader}    */
specifier|public
specifier|static
name|HCatReader
name|getHCatReader
