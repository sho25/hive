...
block|}
block|}
comment|// Do not need to set the status on the partition directory. We will do it later recursively.
comment|// See: end of the registerPartitions method
name|fs
operator|.
name|mkdirs
argument_list|(
