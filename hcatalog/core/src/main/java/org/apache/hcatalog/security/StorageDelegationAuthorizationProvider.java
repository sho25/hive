...
begin_comment
comment|/**  * A HiveAuthorizationProvider which delegates the authorization requests to   * the underlying AuthorizationProviders obtained from the StorageHandler.  * @deprecated   */
end_comment
