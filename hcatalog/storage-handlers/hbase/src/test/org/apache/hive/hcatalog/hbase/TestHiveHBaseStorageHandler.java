...
specifier|public
class|class
name|TestHiveHBaseStorageHandler
extends|extends
...
operator|+
literal|" WITH SERDEPROPERTIES ('hbase.columns.mapping'=':key,cf1:val')"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//HBase table gets created with the specific case
name|HBaseAdmin
name|hAdmin
init|=
operator|new
...
literal|" WITH SERDEPROPERTIES ('hbase.columns.mapping'=':key,cf1:val')"
operator|+
literal|" TBLPROPERTIES ('hbase.table.name'='CaseSensitiveTable')"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"'org.apache.hadoop.hive.hbase.HBaseStorageHandler'"
operator|+
literal|" WITH SERDEPROPERTIES ('hbase.columns.mapping'=':key,familyone:val,familytwo:val') "
operator|+
literal|" TBLPROPERTIES ('hbase.table.name'='testTable')"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
