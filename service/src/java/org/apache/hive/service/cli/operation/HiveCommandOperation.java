...
argument_list|)
decl_stmt|;
comment|// cannot do delimited split for some commands like "dfs -cat" that prints the contents of file which may have
comment|// different delimiter. so we will split only when the resultSchema has more than 1 column
if|if
condition|(
name|resultSchema
operator|!=
