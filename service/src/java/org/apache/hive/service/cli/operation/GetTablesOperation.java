...
name|info
argument_list|(
literal|"Starting GetTablesOperation with the following parameters: "
operator|+
literal|"catalogName={}, schemaName={}, tableName={}, tableTypes={}"
argument_list|,
name|catalogName
argument_list|,
name|schemaName
...
name|info
argument_list|(
literal|"Fetching table metadata"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|info
argument_list|(
literal|"Fetching table metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
