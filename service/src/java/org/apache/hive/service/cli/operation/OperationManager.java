...
argument_list|()
decl_stmt|;
comment|//for displaying historical queries on WebUI
specifier|private
name|Queue
argument_list|<
...
return|;
block|}
comment|//Cache a number of historical operation info, at max number of
comment|//hive.server2.webui.max.historic.queries.
specifier|private
name|void
name|cacheOldOperationInfo
parameter_list|(
...
block|}
block|}
comment|/**    * @return a number of historical SQLOperation info, at max number of    * hive.server2.webui.max.historic.queries    */
specifier|public
name|List
argument_list|<
name|SQLOperationInfo
argument_list|>
name|getHistoricalSQLOpInfo
parameter_list|()
block|{
name|List
argument_list|<
