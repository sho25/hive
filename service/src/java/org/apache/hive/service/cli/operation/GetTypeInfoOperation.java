...
name|info
argument_list|(
literal|"Starting GetTypeInfoOperation"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|info
argument_list|(
literal|"Fetching type info metadata"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"No type info metadata has been returned."
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching type info metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
