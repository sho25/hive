...
argument_list|)
decl_stmt|;
comment|// Shared between threads.
specifier|private
name|UserGroupInformation
name|sessionUgi
init|=
...
literal|null
decl_stmt|;
comment|// Has to be private per thread due to thread safety issues.
specifier|private
specifier|static
class|class
name|ThreadLocalState
block|{
specifier|public
name|Hive
name|sessionHive
...
parameter_list|()
block|{
comment|// For HS2 only, create Hive on demand if missing in this thread.
name|ThreadLocalState
name|state
init|=
name|threadLocalState
