...
name|info
argument_list|(
literal|"Starting GetFunctionsOperation with the following parameters: catalogName={}, schemaName={}, functionName={}"
argument_list|,
name|catalogName
argument_list|,
name|schemaName
...
name|info
argument_list|(
literal|"Fetching function metadata"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"No function metadata has been returned"
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching function metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
