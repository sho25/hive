...
name|info
argument_list|(
literal|"The running operation could not be cancelled, typically because it has already completed normally: "
operator|+
name|queryId
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Cancelling the query execution: "
operator|+
name|queryId
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Successfully cancelled the query: "
operator|+
name|queryId
argument_list|)
expr_stmt|;
