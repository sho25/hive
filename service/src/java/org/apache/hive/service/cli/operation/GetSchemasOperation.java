...
name|info
argument_list|(
literal|"Starting GetSchemasOperation with the following parameters: catalogName={}, schemaName={}"
argument_list|,
name|catalogName
argument_list|,
name|schemaName
...
name|info
argument_list|(
literal|"Fetching schema metadata"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"No schema metadata has been returned."
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching schema metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
