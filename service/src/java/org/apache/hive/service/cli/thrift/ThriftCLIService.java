...
argument_list|()
decl_stmt|;
comment|// Set the updated fetch size from the server into the configuration map for the client
name|HiveConf
name|sessionConf
init|=
name|cliService
...
name|TException
block|{
comment|// TODO: We don't do anything for now, just log this for debugging.
comment|//       We may be able to make use of this later, e.g. for workload management.
name|TSetClientInfoResp
name|resp
init|=
literal|null
...
name|StringBuilder
argument_list|(
literal|"Client information for "
argument_list|)
operator|.
name|append
argument_list|(
...
name|warn
argument_list|(
literal|"Error setting application name"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
