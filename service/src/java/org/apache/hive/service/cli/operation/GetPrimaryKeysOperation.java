...
name|info
argument_list|(
literal|"Starting GetPrimaryKeysOperation with the following parameters: catalogName={}, schemaName={}, tableName={}"
argument_list|,
name|catalogName
argument_list|,
name|schemaName
...
name|info
argument_list|(
literal|"Fetching primary key metadata"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|debug
argument_list|(
literal|"No primary key metadata has been returned."
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching primary key metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
