...
name|info
argument_list|(
literal|"Starting GetTableTypesOperation"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|info
argument_list|(
literal|"Fetching table type metadata"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"No table type metadata has been returned."
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching table type metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
