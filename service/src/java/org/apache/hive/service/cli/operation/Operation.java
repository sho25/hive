...
return|;
block|}
comment|/**    * Wait until the operation terminates and returns false if timeout.    * @param timeOutMs - timeout in milli-seconds    * @return true if operation is terminated or false if timed-out    * @throws InterruptedException    */
specifier|public
name|boolean
name|waitToTerminate
parameter_list|(
name|long
name|timeOutMs
parameter_list|)
...
name|info
argument_list|(
literal|"[opType={}, queryId={}, startTime={}, sessionId={}, createTime={}, userName={}, ipAddress={}]"
argument_list|,
name|opHandle
operator|.
name|getOperationType
...
condition|)
block|{
comment|// Unlock the execution thread as operation is already terminated.
name|opTerminateMonitorLatch
operator|.
name|countDown
argument_list|()
