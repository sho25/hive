...
name|info
argument_list|(
literal|"Starting GetColumnsOperation with the following parameters: "
operator|+
literal|"catalogName={}, schemaName={}, tableName={}, columnName={}"
argument_list|,
name|catalogName
argument_list|,
name|schemaName
...
name|info
argument_list|(
literal|"Fetching column metadata"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|debug
argument_list|(
literal|"No column metadata has been returned."
argument_list|)
expr_stmt|;
block|}
name|setState
...
name|info
argument_list|(
literal|"Fetching column metadata has been successfully finished"
argument_list|)
expr_stmt|;
block|}
catch|catch
