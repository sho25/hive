...
throw|;
block|}
name|initializeWorkloadManagement
argument_list|(
name|hiveConf
argument_list|,
name|sessionHive
...
name|info
argument_list|(
literal|"Workload management is not enabled and there's no resource plan"
argument_list|)
expr_stmt|;
return|return;
comment|// TODO: we could activate it anyway, similar to the below; in case someone
comment|//       wants to activate a resource plan for Tez triggers only w/o restart.
block|}
name|LOG
operator|.
name|warn
argument_list|(
literal|"Workload management is enabled but there's no resource plan"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|info
argument_list|(
literal|"Started tez session pool manager.."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|error
argument_list|(
literal|"Error starting tez session pool manager: "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Started workload manager.."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|error
argument_list|(
literal|"Error starting workload manager"
argument_list|,
name|e
argument_list|)
expr_stmt|;
