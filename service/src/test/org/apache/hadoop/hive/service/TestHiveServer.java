...
specifier|public
name|void
name|testAddJarShouldFailIfJarNotExist
parameter_list|()
throws|throws
name|Exception
block|{
name|boolean
name|queryExecutionFailed
init|=
literal|false
decl_stmt|;
try|try
...
name|fail
argument_list|(
literal|"It should throw exception since jar does not exist"
argument_list|)
expr_stmt|;
block|}
block|}
specifier|public
name|void
name|testAddFileShouldFailIfFileNotExist
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"It should throw exception since file does not exist"
argument_list|)
expr_stmt|;
block|}
block|}
specifier|public
name|void
name|testAddArchiveShouldFailIfFileNotExist
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"It should trow exception since archive does not exist"
argument_list|)
expr_stmt|;
block|}
block|}
specifier|public
name|void
name|testScratchDirShouldNotClearWhileStartup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Scratch dir is not available after startup"
argument_list|,
name|fs
operator|.
name|exists
...
specifier|public
name|void
name|testScratchDirShouldClearWhileStartup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertFalse
argument_list|(
literal|"Scratch dir is available after startup"
argument_list|,
name|fs
operator|.
name|exists
