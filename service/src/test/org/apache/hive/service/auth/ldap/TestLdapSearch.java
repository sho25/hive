...
specifier|public
name|void
name|testFindGroupDNTooManyResults
parameter_list|()
throws|throws
name|NamingException
block|{
...
specifier|public
name|void
name|testFindGroupDNWhenExceptionInSearch
parameter_list|()
throws|throws
name|NamingException
block|{
...
literal|"CN=%s,OU=org1,DC=foo,DC=bar"
argument_list|,
literal|"CN=%s,OU=org2,DC=foo,DC=bar"
argument_list|)
argument_list|)
expr_stmt|;
name|NamingEnumeration
...
specifier|public
name|void
name|testIsUserMemberOfGroupWhenUserId
parameter_list|()
throws|throws
name|NamingException
block|{
...
specifier|public
name|void
name|testIsUserMemberOfGroupWhenUserDn
parameter_list|()
throws|throws
name|NamingException
block|{
...
name|isUserMemberOfGroup
argument_list|(
literal|"CN=User2,OU=org1,DC=foo,DC=bar"
argument_list|,
literal|"grp2"
argument_list|)
argument_list|)
