...
literal|"unique_user"
argument_list|,
literal|"cn=MyGroup,ou=Groups,dc=mycompany,dc=com"
argument_list|)
decl_stmt|;
name|String
name|expected
...
operator|+
literal|"(partOf=cn=MyGroup,ou=Groups,dc=mycompany,dc=com)(guid=unique_user))"
decl_stmt|;
name|String
name|actual
init|=
...
specifier|public
name|void
name|testIsUserMemberOfGroupWhenMisconfigured
parameter_list|()
block|{
name|QueryFactory
name|misconfiguredQueryFactory
init|=
operator|new
name|QueryFactory
argument_list|(
