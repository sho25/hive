...
name|TStruct
argument_list|(
literal|"TRenewDelegationTokenReq"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TRenewDelegationTokenReqStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TRenewDelegationTokenReqTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TRenewDelegationTokenReqStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TRenewDelegationTokenReqTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
