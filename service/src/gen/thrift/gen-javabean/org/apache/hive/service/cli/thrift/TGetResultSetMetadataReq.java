...
name|TStruct
argument_list|(
literal|"TGetResultSetMetadataReq"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TGetResultSetMetadataReqStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetResultSetMetadataReqTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TGetResultSetMetadataReqStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TGetResultSetMetadataReqTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
