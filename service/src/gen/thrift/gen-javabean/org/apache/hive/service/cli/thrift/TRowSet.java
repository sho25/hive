...
operator|.
name|TField
name|START_ROW_OFFSET_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|TRowSetStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TRowSetTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
specifier|final
name|int
name|__STARTROWOFFSET_ISSET_ID
init|=
literal|0
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/** Returns true if field startRowOffset is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetStartRowOffset
parameter_list|()
block|{
return|return
name|EncodingUtils
...
return|;
name|boolean
name|this_present_startRowOffset
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_startRowOffset
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'startRowOffset' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
