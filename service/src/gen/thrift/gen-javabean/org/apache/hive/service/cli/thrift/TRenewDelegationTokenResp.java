...
name|TStruct
argument_list|(
literal|"TRenewDelegationTokenResp"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TRenewDelegationTokenRespStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TRenewDelegationTokenRespTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TRenewDelegationTokenRespStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TRenewDelegationTokenRespTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
