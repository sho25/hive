...
name|TStruct
argument_list|(
literal|"TGetResultSetMetadataResp"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TGetResultSetMetadataRespStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetResultSetMetadataRespTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TGetResultSetMetadataRespStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TGetResultSetMetadataRespTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
