...
argument_list|,
operator|new
name|TGetInfoReqStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetInfoReqTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field infoType is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetInfoType
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'infoType' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|TGetInfoReqStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
