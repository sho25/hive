...
name|TStruct
argument_list|(
literal|"TGetDelegationTokenResp"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|TGetDelegationTokenRespStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TGetDelegationTokenRespTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TGetDelegationTokenRespStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TGetDelegationTokenRespTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
