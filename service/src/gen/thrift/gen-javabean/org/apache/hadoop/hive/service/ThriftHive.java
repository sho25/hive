...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"fetchOne failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"fetchN failed: out of sequence response"
argument_list|)
throw|;
block|}
name|fetchN_result
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"fetchAll failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"getSchema failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"getThriftSchema failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"getClusterStatus failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"getQueryPlan failed: out of sequence response"
argument_list|)
throw|;
block|}
...
name|BAD_SEQUENCE_ID
argument_list|,
literal|"clean failed: out of sequence response"
argument_list|)
throw|;
block|}
name|clean_result
...
name|error
argument_list|(
literal|"Internal error processing getThriftSchema"
argument_list|,
name|th
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Internal error processing getQueryPlan"
argument_list|,
name|th
argument_list|)
expr_stmt|;
