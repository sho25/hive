...
parameter_list|()
block|{}
comment|/**    * @param tableName    * @param database    * @param sd    * @param owner    * @param createTime    * @param lastAccessTime    * @param retention    * @param partitionKeys    * @param parameters    * @param viewOriginalText    * @param viewExpandedText    * @param tableType    * @param linkTarget    * @param linkTables    */
specifier|public
name|MTable
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * @param linkTarget  the table to which this link table points.    */
specifier|public
name|void
name|setLinkTarget
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * @return the ID of the table to which this link table points.    */
specifier|public
name|MTable
name|getLinkTarget
parameter_list|()
...
return|;
block|}
comment|/**    * @param linkTables the set of all Link Tables pointing to this table.    */
specifier|public
name|void
name|setLinkTables
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * @return the set of all Link Tables pointing to this table.    */
specifier|public
name|Set
argument_list|<
name|MTable
