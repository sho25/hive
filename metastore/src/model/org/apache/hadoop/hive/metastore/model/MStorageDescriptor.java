...
parameter_list|()
block|{}
comment|/**    * @param cd    * @param location    * @param inputFormat    * @param outputFormat    * @param isCompressed    * @param numBuckets    * @param serDeInfo    * @param bucketCols    * @param sortOrder    * @param parameters    * @param primaryRegionName    * @param secondaryRegions    */
specifier|public
name|MStorageDescriptor
parameter_list|(
name|MColumnDescriptor
