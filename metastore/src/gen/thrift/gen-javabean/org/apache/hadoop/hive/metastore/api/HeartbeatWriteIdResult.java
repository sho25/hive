...
name|TStruct
argument_list|(
literal|"HeartbeatWriteIdResult"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|HeartbeatWriteIdResultStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|HeartbeatWriteIdResultTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|HeartbeatWriteIdResultStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|HeartbeatWriteIdResultTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
