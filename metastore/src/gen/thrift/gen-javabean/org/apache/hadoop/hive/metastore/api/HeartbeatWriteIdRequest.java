...
name|TStruct
argument_list|(
literal|"HeartbeatWriteIdRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|HeartbeatWriteIdRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|HeartbeatWriteIdRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|HeartbeatWriteIdRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|HeartbeatWriteIdRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
