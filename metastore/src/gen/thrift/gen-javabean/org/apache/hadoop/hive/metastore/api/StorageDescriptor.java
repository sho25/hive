...
operator|.
name|TField
name|PRIMARY_REGION_NAME_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
operator|.
name|TField
name|SECONDARY_REGIONS_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
expr_stmt|;
block|}
comment|/** Returns true if field primaryRegionName is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetPrimaryRegionName
parameter_list|()
...
specifier|public
name|void
name|setPrimaryRegionNameIsSet
parameter_list|(
name|boolean
name|value
parameter_list|)
...
name|RegionStorageDescriptor
argument_list|>
name|getSecondaryRegionsIterator
parameter_list|()
block|{
return|return
operator|(
...
expr_stmt|;
block|}
comment|/** Returns true if field secondaryRegions is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetSecondaryRegions
parameter_list|()
...
block|}
name|boolean
name|this_present_primaryRegionName
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_primaryRegionName
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_secondaryRegions
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_secondaryRegions
init|=
literal|true
operator|&&
name|that
