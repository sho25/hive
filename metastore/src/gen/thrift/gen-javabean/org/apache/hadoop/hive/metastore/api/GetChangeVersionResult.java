...
name|TStruct
argument_list|(
literal|"GetChangeVersionResult"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|GetChangeVersionResultStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|GetChangeVersionResultTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'version' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|GetChangeVersionResultStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|GetChangeVersionResultTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
