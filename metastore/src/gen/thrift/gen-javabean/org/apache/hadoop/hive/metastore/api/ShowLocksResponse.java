...
argument_list|,
operator|new
name|ShowLocksResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|ShowLocksResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field locks is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetLocks
parameter_list|()
...
block|{
specifier|public
name|ShowLocksResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|ShowLocksResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
