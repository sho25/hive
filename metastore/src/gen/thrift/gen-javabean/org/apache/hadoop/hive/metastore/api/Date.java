...
operator|.
name|TField
name|DAYS_SINCE_EPOCH_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
argument_list|,
operator|new
name|DateStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
specifier|final
name|int
name|__DAYSSINCEEPOCH_ISSET_ID
init|=
literal|0
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/** Returns true if field daysSinceEpoch is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetDaysSinceEpoch
parameter_list|()
block|{
return|return
name|EncodingUtils
...
return|;
name|boolean
name|this_present_daysSinceEpoch
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_daysSinceEpoch
init|=
literal|true
decl_stmt|;
if|if
...
name|TProtocolException
argument_list|(
literal|"Required field 'daysSinceEpoch' is unset! Struct:"
operator|+
name|toString
argument_list|()
argument_list|)
