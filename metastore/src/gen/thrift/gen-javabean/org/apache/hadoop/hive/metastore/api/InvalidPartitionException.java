...
name|TStruct
argument_list|(
literal|"InvalidPartitionException"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|InvalidPartitionExceptionStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|InvalidPartitionExceptionTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|InvalidPartitionExceptionStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|InvalidPartitionExceptionTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
