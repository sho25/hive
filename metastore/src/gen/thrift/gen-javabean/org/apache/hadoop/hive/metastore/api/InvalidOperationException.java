...
name|TStruct
argument_list|(
literal|"InvalidOperationException"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|InvalidOperationExceptionStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|InvalidOperationExceptionTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|InvalidOperationExceptionStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|InvalidOperationExceptionTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
