...
name|TStruct
argument_list|(
literal|"ClearFileMetadataResult"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|ClearFileMetadataResultStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|ClearFileMetadataResultTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|ClearFileMetadataResultStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|ClearFileMetadataResultTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
