...
operator|.
name|TField
name|MM_NEXT_WRITE_ID_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
operator|.
name|TField
name|MM_WATERMARK_WRITE_ID_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
specifier|final
name|int
name|__MMWATERMARKWRITEID_ISSET_ID
init|=
literal|6
decl_stmt|;
specifier|private
...
literal|0
expr_stmt|;
name|setMmWatermarkWriteIdIsSet
argument_list|(
literal|false
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/** Returns true if field mmNextWriteId is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
...
expr_stmt|;
block|}
comment|/** Returns true if field mmWatermarkWriteId is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
...
block|}
name|boolean
name|this_present_mmNextWriteId
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_mmNextWriteId
init|=
literal|true
operator|&&
name|that
...
block|}
name|boolean
name|this_present_mmWatermarkWriteId
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_mmWatermarkWriteId
init|=
literal|true
operator|&&
name|that
...
expr_stmt|;
name|boolean
name|present_mmWatermarkWriteId
init|=
literal|true
operator|&&
operator|(
