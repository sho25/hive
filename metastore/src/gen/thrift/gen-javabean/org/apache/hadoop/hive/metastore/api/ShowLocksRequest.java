...
argument_list|,
operator|new
name|ShowLocksRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|ShowLocksRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field isExtended is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetIsExtended
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|{
specifier|public
name|ShowLocksRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|ShowLocksRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
