...
name|TStruct
argument_list|(
literal|"IndexAlreadyExistsException"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|IndexAlreadyExistsExceptionStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|IndexAlreadyExistsExceptionTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|IndexAlreadyExistsExceptionStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|IndexAlreadyExistsExceptionTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
