...
name|TStruct
argument_list|(
literal|"GrantRevokePrivilegeResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|GrantRevokePrivilegeResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|GrantRevokePrivilegeResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|GrantRevokePrivilegeResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|GrantRevokePrivilegeResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
