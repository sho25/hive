...
name|TStruct
argument_list|(
literal|"GrantRevokeRoleResponse"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|GrantRevokeRoleResponseStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|GrantRevokeRoleResponseTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|GrantRevokeRoleResponseStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|GrantRevokeRoleResponseTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
