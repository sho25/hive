...
name|TStruct
argument_list|(
literal|"UnknownPartitionException"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|UnknownPartitionExceptionStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|UnknownPartitionExceptionTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|UnknownPartitionExceptionStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|UnknownPartitionExceptionTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
