...
name|TStruct
argument_list|(
literal|"CurrentNotificationEventId"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|CurrentNotificationEventIdStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|CurrentNotificationEventIdTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|CurrentNotificationEventIdStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|CurrentNotificationEventIdTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
