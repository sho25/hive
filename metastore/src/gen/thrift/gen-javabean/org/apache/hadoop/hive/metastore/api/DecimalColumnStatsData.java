...
name|TStruct
argument_list|(
literal|"DecimalColumnStatsData"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|DecimalColumnStatsDataStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|DecimalColumnStatsDataTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field bitVectors is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetBitVectors
parameter_list|()
...
block|{
specifier|public
name|DecimalColumnStatsDataStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|DecimalColumnStatsDataTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
