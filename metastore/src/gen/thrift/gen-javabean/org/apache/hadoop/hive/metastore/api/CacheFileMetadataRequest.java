...
name|TStruct
argument_list|(
literal|"CacheFileMetadataRequest"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
argument_list|,
operator|new
name|CacheFileMetadataRequestStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|CacheFileMetadataRequestTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field isAllParts is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetIsAllParts
parameter_list|()
block|{
return|return
name|EncodingUtils
...
block|{
specifier|public
name|CacheFileMetadataRequestStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|CacheFileMetadataRequestTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
