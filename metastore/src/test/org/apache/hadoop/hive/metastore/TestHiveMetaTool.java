...
name|newLocationUri
init|=
literal|"hdfs://nn-ha-uri/user/hive/warehouse"
decl_stmt|;
name|String
index|[]
name|args
...
name|println
argument_list|(
literal|"updateFSRootLocation successful"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|println
argument_list|(
literal|"updateFSRootLocation failed"
argument_list|)
expr_stmt|;
block|}
comment|// restore the original HDFS root if needed
if|if
condition|(
name|b
condition|)
