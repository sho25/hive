...
argument_list|)
expr_stmt|;
comment|// Case 3.1 - Max in list members: 1000, Max query string length: 1KB, and exact 1000 members in a single IN clause
name|conf
operator|.
name|setIntVar
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Case 3.2 - Max in list members: 1000, Max query string length: 10KB, and exact 1000 members in a single IN clause
name|conf
operator|.
name|setIntVar
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Case 3.3 - Now with 2000 entries, try the above settings
for|for
control|(
name|long
name|i
...
argument_list|)
expr_stmt|;
comment|// Case 4 - Max in list members: 1000; Max query string length: 10KB
name|queries
operator|.
name|clear
argument_list|()
...
literal|"Wrong stmt"
argument_list|,
literal|"insert into colors(name, category) values('yellow', 1)"
argument_list|,
name|sql
operator|.
name|get
...
literal|"Wrong stmt"
argument_list|,
literal|"insert all into colors(name, category) values('yellow', 1) into colors(name, category) values('red', 2) into colors(name, category) values('orange', 3) select * from dual"
argument_list|,
name|sql
operator|.
name|get
...
literal|"Wrong stmt"
argument_list|,
literal|"insert all into colors(name, category) values('G',997) into colors(name, category) values('G',998) into colors(name, category) values('G',999) select * from dual"
argument_list|,
name|sql
operator|.
name|get
...
literal|"Wrong stmt"
argument_list|,
literal|"insert into colors(name, category) values('yellow', 1),('red', 2),('orange', 3)"
argument_list|,
name|sql
operator|.
name|get
...
literal|"Wrong stmt"
argument_list|,
literal|"insert into colors(name, category) values('G',997),('G',998),('G',999)"
argument_list|,
name|sql
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"select nl_next from NEXT_LOCK_ID with (updlock)"
argument_list|,
name|modSql
argument_list|)
expr_stmt|;
...
name|addForUpdateClause
argument_list|(
literal|"select MT_COMMENT from AUX_TABLE where MT_KEY1='CheckLock' and MT_KEY2=0"
argument_list|)
expr_stmt|;
name|Assert
operator|.
name|assertEquals
argument_list|(
literal|"select MT_COMMENT from AUX_TABLE with (updlock) where MT_KEY1='CheckLock' and MT_KEY2=0"
argument_list|,
name|modSql
argument_list|)
expr_stmt|;
