...
argument_list|)
expr_stmt|;
comment|// Add partition stats for: BOOLEAN_COL and partition: {PART_KEY, BOOLEAN_VAL} to DB
comment|// Because of the way our mock implementation works we actually need to not create the table
comment|// before we set statistics on it.
name|ColumnStatistics
name|stats
...
argument_list|)
expr_stmt|;
comment|// Add partition stats for: BINARY_COL and partition: {PART_KEY, BINARY_VAL} to DB
comment|// Because of the way our mock implementation works we actually need to not create the table
comment|// before we set statistics on it.
name|ColumnStatistics
name|stats
...
specifier|public
name|void
name|createTableWithPrimaryKey
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|createTableWithForeignKey
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Test that we can add a primary key with multiple columns
annotation|@
name|Test
specifier|public
name|void
name|addMultiColPrimaryKey
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|// Test that we can create a foreign key with multiple columns
annotation|@
name|Test
specifier|public
name|void
name|addMultiColForeignKey
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|// Test that we can add 2 foreign keys at once
annotation|@
name|Test
specifier|public
name|void
name|addMultiForeignKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// Test that we can add a foreign key when one already exists
annotation|@
name|Test
specifier|public
name|void
name|addSecondForeignKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Check that passing null gets all the foreign keys
name|fk
operator|=
name|store
operator|.
...
expr_stmt|;
block|}
comment|// Try adding a primary key when one already exists
annotation|@
name|Test
argument_list|(
name|expected
...
specifier|public
name|void
name|createTableWithUniqueConstraint
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Drop the unique constraint
name|store
operator|.
name|dropConstraint
argument_list|(
...
specifier|public
name|void
name|addMultiUniqueConstraints
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|addMultiNotNullConstraints
parameter_list|()
throws|throws
name|Exception
block|{
