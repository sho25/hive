...
name|destPath
operator|=
name|constructRenamedPartitionPath
argument_list|(
name|destPath
argument_list|,
name|new_part
...
return|;
block|}
comment|/**    * Uses the scheme and authority of the partition's current location, and the path constructed    * using the partition's new name to construct a path for the partition's new location.    */
specifier|private
name|Path
name|constructRenamedPartitionPath
parameter_list|(
