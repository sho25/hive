...
name|NoSuchObjectException
block|{
comment|// TODO - Needs to wait for ability to push filters into HBase
throw|throw
operator|new
name|UnsupportedOperationException
argument_list|()
...
return|;
block|}
comment|// TODO - we need to rework these listAll methods so they don't leak the M classes.  Those are
comment|// an artifact of the ObjectStore and don't belong in the RawStore interface.
annotation|@
name|Override
specifier|public
name|List
...
control|)
block|{
comment|// TODO - change GrantInfoWritable to contain create time and owner of granted role
name|maps
operator|.
name|add
argument_list|(
