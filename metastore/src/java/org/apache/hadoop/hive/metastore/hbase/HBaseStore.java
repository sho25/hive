...
name|error
argument_list|(
literal|"Unable to get primary key"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Unable to get foreign key"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Unable to get unique constraint"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Unable to get not null constraint"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|NoSuchObjectException
block|{
comment|// This is something of pain, since we have to search both primary key and foreign key to see
comment|// which they want to drop.
name|boolean
name|commit
init|=
literal|false
...
argument_list|)
decl_stmt|;
comment|// Make a new list of keys that excludes all columns from the constraint we're dropping.
for|for
control|(
name|SQLForeignKey
name|fkcol
...
expr_stmt|;
block|}
comment|// If we've dropped only one foreign key out of many keys, than update so that we still
comment|// have the existing keys.  Otherwise drop the foreign keys all together.
if|if
condition|(
name|newKeyList
operator|.
...
name|NoSuchObjectException
argument_list|(
literal|"Unable to find constraint named "
operator|+
name|constraintName
operator|+
literal|" on table "
...
name|error
argument_list|(
literal|"Error fetching primary key for table "
operator|+
name|tableNameForErrorMsg
argument_list|(
name|dbName
...
name|error
argument_list|(
literal|"Error writing primary key"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
try|try
block|{
comment|// Fetch the existing keys (if any) and add in these new ones
name|List
argument_list|<
name|SQLForeignKey
argument_list|>
...
name|error
argument_list|(
literal|"Error writing foreign keys"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Error writing unique constraints"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Error writing not null constraints"
argument_list|,
name|e
argument_list|)
expr_stmt|;
