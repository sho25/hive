...
argument_list|)
decl_stmt|;
comment|// The change version functionality uses the sequences table, but we don't want to give the
comment|// caller complete control over the sequence name as they might inadvertently clash with one of
...
decl_stmt|;
comment|/**    * Set the configuration for all HBaseReadWrite instances.    * @param configuration Configuration object    */
specifier|public
specifier|static
...
name|info
argument_list|(
literal|"Attempt to set conf when it has already been set."
argument_list|)
expr_stmt|;
block|}
block|}
comment|/**    * Get the instance of HBaseReadWrite for the current thread.  This can only be called after    * {@link #setConf} has been called. Woe betide you if that's not the case.    * @return thread's instance of HBaseReadWrite    */
specifier|static
name|HBaseReadWrite
name|getInstance
parameter_list|()
...
name|RuntimeException
argument_list|(
literal|"Must set conf object before getting an instance"
argument_list|)
throw|;
block|}
return|return
...
expr_stmt|;
block|}
comment|/**    * Print out the database. Intended for use by {@link org.apache.hadoop.hive.metastore.hbase.HBaseSchemaTool}    * @param name name of database to print    * @return string printout of database    */
name|String
name|printDatabase
parameter_list|(
name|String
...
return|return
name|dumpThriftObject
argument_list|(
name|db
argument_list|)
return|;
block|}
comment|/**    * Print out databases.    * @param regex regular to use to search for databases    * @return databases as a string, one each    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|/**    * Print out a function    * @param key key to get the function, must include dbname.    * @return string of the function    * @throws IOException    * @throws TException    */
name|String
name|printFunction
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * Print out functions    * @param regex regular expression to use in matching functions    * @return list of strings, one function each    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|/**    * Print out the global privileges.    * @return string containing the global privileges    * @throws IOException    * @throws TException    */
name|String
...
name|NoSuchObjectException
block|{
name|PartitionScanInfo
name|psi
init|=
name|scanPartitionsInternal
argument_list|(
name|dbName
argument_list|,
name|tableName
...
expr_stmt|;
block|}
comment|/**    * Print out a partition.    * @param partKey The key for the partition.  This must include dbname.tablename._partkeys_    *                where _partkeys_ is a dot separated list of partition values in the proper    *                order.    * @return string containing the partition    * @throws IOException    * @throws TException    */
name|String
name|printPartition
parameter_list|(
name|String
...
name|TException
block|{
comment|// First figure out the table and fetch it
name|String
index|[]
name|partKeyParts
init|=
...
return|;
return|return
name|printOnePartition
argument_list|(
name|result
argument_list|)
return|;
block|}
comment|/**    * Print partitions    * @param partKey a partial partition key.  This must match the beginings of the partition key.    *                It can be just dbname.tablename, or dbname.table.pval... where pval are the    *                partition values in order.  They must be in the correct order and they must    *                be literal values (no regular expressions)    * @return partitions as strings    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
block|{
comment|// First figure out the table and fetch it
comment|// Split on dot here rather than the standard separator because this will be passed in as a
comment|// regex, even though we aren't fully supporting regex's.
name|String
index|[]
name|partKeyParts
init|=
...
return|;
block|}
comment|/**    * Print out a role    * @param name name of role to print    * @return string printout of role    */
name|String
name|printRole
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * Print out roles.    * @param regex regular to use to search for roles    * @return string printout of roles    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|/**    * Print out a table.    * @param name The name for the table.  This must include dbname.tablename    * @return string containing the table    * @throws IOException    * @throws TException    */
name|String
name|printTable
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * Print tables    * @param regex to use to find the tables.  Remember that dbname is in each    *              table name.    * @return tables as strings    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
return|;
block|}
comment|/**********************************************************************************************    * Index related methods    *********************************************************************************************/
comment|/**    * Put an index object.  This should only be called when the index is new (create index) as it    * will blindly add/increment the storage descriptor.  If you are altering an existing index    * call {@link #replaceIndex} instead.    * @param index index object    * @throws IOException    */
name|void
name|putIndex
parameter_list|(
name|Index
...
expr_stmt|;
block|}
comment|/**    * Fetch an index object    * @param dbName database the table is in    * @param origTableName original table name    * @param indexName index name    * @return Index object, or null if no such table    * @throws IOException    */
name|Index
name|getIndex
parameter_list|(
name|String
...
name|sdParts
operator|.
name|containingIndex
return|;
block|}
comment|/**    * Delete a table    * @param dbName name of database table is in    * @param origTableName table the index is built on    * @param indexName index name    * @throws IOException    */
name|void
name|deleteIndex
parameter_list|(
name|String
...
name|IOException
block|{
comment|// Find the index so I can get the storage descriptor and drop it
if|if
condition|(
name|decrementRefCnt
condition|)
...
expr_stmt|;
block|}
comment|/**    * Get a list of tables.    * @param dbName Database these tables are in    * @param origTableName original table name    * @param maxResults max indexes to fetch.  If negative all indexes will be returned.    * @return list of indexes of the table    * @throws IOException    */
name|List
argument_list|<
name|Index
argument_list|>
...
return|;
block|}
comment|/**    * Replace an existing index.  This will also compare the storage descriptors and see if the    * reference count needs to be adjusted    * @param oldIndex old version of the index    * @param newIndex new version of the index    */
name|void
name|replaceIndex
parameter_list|(
name|Index
...
return|;
block|}
comment|/**    * Print out a storage descriptor.    * @param hash hash that is the key of the storage descriptor    * @return string version of the storage descriptor    */
name|String
...
return|;
block|}
comment|/**    * Print all of the storage descriptors.  This doesn't take a regular expression since the key    * is an md5 hash and it's hard to see how a regex on this would be useful.    * @return list of all storage descriptors as strings    * @throws IOException    * @throws TException    */
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// If this is a table key, parse it as one
name|List
argument_list|<
name|String
argument_list|>
...
condition|)
block|{
comment|// Build the part name, for which we need the table
name|Table
name|table
init|=
name|getTable
...
argument_list|)
operator|+
literal|" even though I have a partition for it!"
argument_list|)
throw|;
block|}
name|csd
...
expr_stmt|;
block|}
comment|/**    * One method to print all rows in the security table.  It's not expected to be large.    * @return each row as one string    * @throws IOException    */
name|List
argument_list|<
name|String
argument_list|>
...
name|RuntimeException
argument_list|(
literal|"Huh?  No master key, no delegation token!"
argument_list|)
throw|;
name|lines
operator|.
...
return|;
block|}
comment|/**    * One method to print all entries in the sequence table.  It's not expected to be large.    * @return each sequence as one string    * @throws IOException    */
name|List
argument_list|<
name|String
argument_list|>
...
return|;
block|}
comment|/**********************************************************************************************    * Constraints related methods    *********************************************************************************************/
comment|/**    * Fetch a primary key    * @param dbName database the table is in    * @param tableName table name    * @return List of primary key objects, which together make up one key    * @throws IOException if there's a read error    */
name|List
argument_list|<
name|SQLPrimaryKey
argument_list|>
...
return|;
block|}
comment|/**    * Fetch a the foreign keys for a table    * @param dbName database the table is in    * @param tableName table name    * @return All of the foreign key columns thrown together in one list.  Have fun sorting them out.    * @throws IOException if there's a read error    */
name|List
argument_list|<
name|SQLForeignKey
argument_list|>
...
return|;
block|}
comment|/**    * Fetch a unique constraint    * @param dbName database the table is in    * @param tableName table name    * @return List of unique constraints objects    * @throws IOException if there's a read error    */
name|List
argument_list|<
name|SQLUniqueConstraint
argument_list|>
...
name|HBaseUtils
operator|.
name|deserializeUniqueConstraint
argument_list|(
name|dbName
argument_list|,
name|tableName
...
return|;
block|}
comment|/**    * Fetch a not null constraint    * @param dbName database the table is in    * @param tableName table name    * @return List of not null constraints objects    * @throws IOException if there's a read error    */
name|List
argument_list|<
name|SQLNotNullConstraint
argument_list|>
...
name|HBaseUtils
operator|.
name|deserializeNotNullConstraint
argument_list|(
name|dbName
argument_list|,
name|tableName
...
return|;
block|}
comment|/**    * Create a primary key on a table.    * @param pk Primary key for this table    * @throws IOException if unable to write the data to the store.    */
name|void
name|putPrimaryKey
parameter_list|(
name|List
...
expr_stmt|;
block|}
comment|/**    * Create one or more unique constraints on a table.    * @param uks Unique constraints for this table    * @throws IOException if unable to write the data to the store.    */
name|void
...
name|HBaseUtils
operator|.
name|serializeUniqueConstraints
argument_list|(
name|uks
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Create one or more not null constraints on a table.    * @param nns Not null constraints for this table    * @throws IOException if unable to write the data to the store.    */
name|void
...
name|HBaseUtils
operator|.
name|serializeNotNullConstraints
argument_list|(
name|nns
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Drop the primary key from a table.    * @param dbName database the table is in    * @param tableName table name    * @throws IOException if unable to delete from the store    */
name|void
...
expr_stmt|;
block|}
comment|/**    * Drop all foreign keys from a table.  Note that this will drop all keys blindly.  You should    * only call this if you're sure you want to drop them all.  If you just want to drop one you    * should instead all {@link #getForeignKeys(String, String)}, modify the list it returns, and    * then call {@link #putForeignKeys(List)}.    * @param dbName database the table is in    * @param tableName table name    * @throws IOException if unable to delete from the store    */
name|void
...
expr_stmt|;
block|}
comment|/**    * Drop the unique constraint from a table.    * @param dbName database the table is in    * @param tableName table name    * @throws IOException if unable to delete from the store    */
name|void
...
expr_stmt|;
block|}
comment|/**    * Drop the not null constraint from a table.    * @param dbName database the table is in    * @param tableName table name    * @throws IOException if unable to delete from the store    */
name|void
