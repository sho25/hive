...
return|;
block|}
comment|/**    * Gets partitions by using direct SQL queries.    * @param table The table.    * @param parser The parsed filter from which the SQL filter will be generated.    * @return List of partitions.    */
specifier|public
name|List
argument_list|<
name|Partition
