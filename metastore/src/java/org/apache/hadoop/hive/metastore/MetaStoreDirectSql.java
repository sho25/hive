...
return|;
block|}
comment|// Get aggregated column stats for a table per partition for all columns in the partition
comment|// This is primarily used to populate stats object when using CachedStore (Check CachedStore#prewarm)
specifier|public
name|Map
argument_list|<
name|String
