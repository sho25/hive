...
argument_list|)
expr_stmt|;
comment|// See if the table has any constraints, and if so copy those as well
name|List
argument_list|<
name|SQLPrimaryKey
argument_list|>
...
name|debug
argument_list|(
literal|"Found primary keys, adding them"
argument_list|)
expr_stmt|;
name|hbaseStore
operator|.
...
expr_stmt|;
block|}
comment|// Passing null as the target table name results in all of the foreign keys being
comment|// retrieved.
name|List
argument_list|<
name|SQLForeignKey
...
name|debug
argument_list|(
literal|"Found foreign keys, adding them"
argument_list|)
expr_stmt|;
name|hbaseStore
operator|.
...
name|screen
argument_list|(
literal|"Copying indexes"
argument_list|)
expr_stmt|;
comment|// Start the parallel threads that will copy the indexes
name|Thread
index|[]
name|copiers
init|=
...
expr_stmt|;
block|}
comment|// Put indexes from the databases we copied into the queue
for|for
control|(
name|Database
name|db
...
name|screen
argument_list|(
literal|"Coyping indexes in database "
operator|+
name|db
operator|.
name|getName
