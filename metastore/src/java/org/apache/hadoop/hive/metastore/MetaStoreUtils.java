...
return|;
block|}
comment|// TODO: CTAS for MM may currently be broken. It used to work. See the old code and why isCtas isn't used?
specifier|public
specifier|static
name|boolean
name|isInsertOnlyTable
...
return|;
block|}
comment|/** The method for altering table props; may set the table to MM, non-MM, or not affect MM. */
specifier|public
specifier|static
name|Boolean
...
return|;
block|}
comment|/**    * Verify if the user is allowed to make DB notification related calls.    * Only the superusers defined in the Hadoop proxy user settings have the permission.    *    * @param user the short user name    * @param config that contains the proxy user settings    * @return if the user has the permission    */
specifier|public
specifier|static
name|boolean
