...
return|;
block|}
comment|/**    * Temporary check that if the primary region name was set in the storage descriptor, it is    * equal to the default region name.  If the primary region name was not set it sets it to the    * default region name.    * @param sd    * @param conf    * @throws MetaException    */
specifier|public
specifier|static
name|void
...
block|{
comment|// either the primary region name was null or already equal to defaultRegionName
name|sd
operator|.
