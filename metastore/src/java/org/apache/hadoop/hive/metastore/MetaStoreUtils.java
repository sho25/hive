...
return|;
block|}
comment|/**    * Get partition level schema from table level schema.    * @param sd    * @param tblsd    * @param parameters    * @param databaseName    * @param tableName    * @param partitionKeys    * @param tblSchema    * @return    */
specifier|public
specifier|static
name|Properties
...
parameter_list|)
block|{
comment|// inherent most properties from table level schema
name|Properties
name|schema
init|=
operator|(
