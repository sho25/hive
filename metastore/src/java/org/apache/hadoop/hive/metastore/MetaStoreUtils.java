...
condition|)
block|{
comment|// TODO: Add a MetaStore flag indicating accuracy of these stats and update it here.
block|}
block|}
name|tbl
operator|.
...
condition|)
block|{
comment|// The accuracy of these "collectable" stats at this point is suspect unless we know that
comment|// StatsTask was just run before this MetaStore call and populated them.
comment|// TODO: Add a MetaStore flag indicating accuracy of these stats and update it here.
block|}
block|}
name|part
