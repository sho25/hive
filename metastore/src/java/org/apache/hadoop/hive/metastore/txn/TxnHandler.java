...
operator|+
literal|"(tc_txnid, tc_database, tc_table, tc_partition, tc_operation_type) "
operator|+
literal|"values ("
operator|+
name|txnid
...
name|s
init|=
literal|"insert into TXN_COMPONENTS (tc_txnid, tc_database, tc_table, tc_partition, tc_operation_type) values ("
operator|+
name|rqst
operator|.
name|getTxnid
