...
name|TException
function_decl|;
comment|/**    * Request that the metastore fire an event.  Currently this is only supported for DML    * operations, since the metastore knows when DDL operations happen.    * @param request    * @throws TException    */
name|void
