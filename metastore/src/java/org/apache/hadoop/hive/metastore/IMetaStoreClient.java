...
parameter_list|)
function_decl|;
comment|/**      * Get at the underlying OpenTxn structure.  This is useful if the user      * wishes to get a list of all open transactions for more efficient      * filtering.      * @return open transactions      */
specifier|public
name|GetOpenTxnsResponse
name|getOpenTxns
parameter_list|()
function_decl|;
comment|/**      * Write this validTxnList into a string.  Obviously all implementations will already      * implement this, but it is being called out specifically here to make clear that the      * implementation needs to override the default implementation.  This should produce a string      * that can be used by {@link #fromString(String)} to populate a validTxnsList.      */
annotation|@
name|Override
specifier|public
name|String
...
parameter_list|()
function_decl|;
comment|/**      * Populate this validTxnList from the string.  It is assumed that the string was created via      * {@link #toString()}.      * @param src source string.      */
specifier|public
name|void
name|fromString
parameter_list|(
