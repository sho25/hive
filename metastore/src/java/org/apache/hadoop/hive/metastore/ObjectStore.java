...
argument_list|)
expr_stmt|;
comment|//Add metric for number of active JDO transactions.
name|Metrics
name|metrics
init|=
name|MetricsFactory
...
literal|null
return|;
comment|// Not supported for now; callers have to handle this accordingly.
block|}
annotation|@
name|Override
specifier|public
