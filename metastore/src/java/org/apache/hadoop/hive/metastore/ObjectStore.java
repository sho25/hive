...
operator|+
literal|"(childTable != null&& childTable.tableName == ctblname&& childTable.database.name == cdbname)"
argument_list|)
expr_stmt|;
name|query
operator|.
...
block|{
return|return
name|getNumPartitionsByFilterInternal
argument_list|(
name|dbName
argument_list|,
name|tblName
...
control|)
block|{
comment|// We have to get partition again because DataNucleus
name|MPartition
name|mPartition
init|=
name|getMPartition
...
expr_stmt|;
block|}
comment|// Set the partition properties
comment|// No need to check again if it exists.
name|MPartition
name|mPartition
init|=
...
argument_list|)
expr_stmt|;
comment|// TODO: this could also be passed from upper layer; or this method should filter the list.
name|MTable
name|mtbl
init|=
name|getMTable
...
literal|"select partitionName from org.apache.hadoop.hive.metastore.model.MPartition "
operator|+
literal|"where table.tableName == t1&& table.database.name == t2&& partitionName == t3"
argument_list|)
expr_stmt|;
name|query
operator|.
...
argument_list|)
expr_stmt|;
name|incrementChangeVersionNoTx
argument_list|(
...
name|declareParameters
argument_list|(
literal|"java.lang.String topicName"
argument_list|)
expr_stmt|;
name|query
operator|.
