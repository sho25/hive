...
name|error
argument_list|(
literal|"Direct SQL failed, falling back to ORM"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
name|convertToParts
argument_list|(
name|listMPartitionsByFilterNoTxn
argument_list|(
name|mtable
argument_list|,
name|dbName
...
argument_list|()
operator|+
literal|" partitions retrieved using "
operator|+
operator|(
name|doUseDirectSql
condition|?
...
name|debug
argument_list|(
literal|"Executing listMPartitionsByFilterNoTxn"
argument_list|)
expr_stmt|;
name|Map
argument_list|<
...
name|debug
argument_list|(
literal|"Done executing query for listMPartitionsByFilterNoTxn"
argument_list|)
expr_stmt|;
name|pm
operator|.
