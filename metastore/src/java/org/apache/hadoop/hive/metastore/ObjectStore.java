...
argument_list|>
block|{
comment|/**      * GetHelper for returning db info using directSql/JDO.      * Since this is a db-level call, tblName is ignored, and null is passed irrespective of what is passed in.      * @param dbName The Database Name      * @param tblName Placeholder param to match signature, always ignored.      * @param allowSql Whether or not we allow DirectSQL to perform this query.      * @param allowJdo Whether or not we allow ORM to perform this query.      * @throws MetaException      */
specifier|public
name|GetDbHelper
parameter_list|(
name|String
...
literal|"java.lang.String t1, java.lang.String t2, java.lang.Long t3, "
operator|+
literal|"java.lang.Long t4, java.lang.String t5"
argument_list|)
expr_stmt|;
name|query
operator|.
