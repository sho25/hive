...
name|newQuery
argument_list|(
literal|"select indexName from org.apache.hadoop.hive.metastore.model.MIndex where origTable.database.name == t1&& origTable.tableName == t2 order by indexName asc"
argument_list|)
decl_stmt|;
name|q
operator|.
