...
name|debug
argument_list|(
literal|"Admin users already added."
argument_list|)
expr_stmt|;
return|return;
block|}
...
condition|)
block|{
comment|//convert each MRoleMap object into a thrift RolePrincipalGrant object
for|for
control|(
name|MRoleMap
name|roleMap
...
name|mapRoleName
operator|+
literal|" does not match role name arg "
operator|+
name|role_name
argument_list|)
throw|;
