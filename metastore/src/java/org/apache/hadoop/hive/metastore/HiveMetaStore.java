...
block|}
block|}
comment|/**    * An ugly interface because everything about this file is ugly. RawStore is threadlocal so this    * thread-local disease propagates everywhere, and FileMetadataManager cannot just get a RawStore    * or handlers to use; it will need to have this method to make thread-local handlers and a    * thread-local RawStore.    */
specifier|public
interface|interface
...
name|forName
argument_list|(
literal|"org.apache.hadoop.hive.ql.txn.AcidCompactionHistoryService"
argument_list|)
argument_list|)
expr_stmt|;
name|startHouseKeeperService
...
name|forName
argument_list|(
literal|"org.apache.hadoop.hive.ql.txn.AcidWriteSetService"
argument_list|)
argument_list|)
expr_stmt|;
name|ThreadPool
