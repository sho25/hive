...
throw|;
block|}
comment|/**          * Trash may be skipped iff:          * 1. deleteData == true, obviously.          * 2. tbl is external.          * 3. Either          *  3.1. User has specified PURGE from the commandline, and if not,          *  3.2. User has set the table to auto-purge.          */
name|ifPurge
operator|=
operator|(
operator|(
...
name|MetaException
argument_list|(
literal|"Unable to drop table because it is in an encryption zone"
operator|+
