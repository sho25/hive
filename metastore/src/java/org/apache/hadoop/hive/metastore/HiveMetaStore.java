...
return|;
block|}
comment|/**      * An implementation of add_partition_core that does not commit      * transaction or rollback transaction as part of its operation      * - it is assumed that will be tended to from outside this call      * @param ms      * @param part      * @return      * @throws InvalidObjectException      * @throws AlreadyExistsException      * @throws MetaException      */
specifier|private
name|Entry
argument_list|<
name|Partition
