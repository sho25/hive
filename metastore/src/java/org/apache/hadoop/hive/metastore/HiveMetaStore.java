...
name|info
argument_list|(
literal|"Opening raw store ... impl class:"
operator|+
name|rawStoreClassName
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// create default database if it doesn't exist
try|try
block|{
name|ms
operator|.
...
name|info
argument_list|(
literal|"Starting the new metaserver on port ["
operator|+
name|port
operator|+
literal|"]..."
