...
name|error
argument_list|(
literal|"Updating CachedStore: error happen when refresh"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Error shutting down RawStore"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// Stop and fall back to underlying RawStore
name|colStats
operator|=
literal|null
expr_stmt|;
...
condition|)
block|{
comment|// we don't have stats for all the partitions
comment|// logic for extrapolation hasn't been added to CacheStore
comment|// So stop now, and lets fallback to underlying RawStore
return|return
literal|null
return|;
block|}
