...
literal|null
condition|?
name|getTableColStatsJoinedTables
argument_list|(
name|quote
argument_list|)
else|:
name|getPartitionColStatsJoinedTables
argument_list|(
name|quote
argument_list|)
operator|)
...
parameter_list|)
block|{
comment|//actually we do not have to get the quote from database since double quoted identifier
comment|//should work on all favors of db so far Hive supports.
return|return
operator|(
operator|new
name|StringBuffer
