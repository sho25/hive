...
expr_stmt|;
block|}
comment|/**    * Verifies that the expected result returned after 2 unsuccessful retries    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testRetryGetTransport
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Verifies exception is thrown after 3 unsuccessful retries    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testRetryGetTransport2
parameter_list|()
throws|throws
name|Exception
block|{
