...
specifier|final
name|String
name|COMMON_DRUID_JVM_PROPERTIES
init|=
literal|"-Duser.timezone=UTC -Dfile.encoding=UTF-8 -Djava.util.logging.manager=org.apache.logging.log4j.jul.LogManager "
operator|+
literal|"-Ddruid.emitter=logging -Ddruid.emitter.logging.logLevel=info"
decl_stmt|;
specifier|private
specifier|static
specifier|final
