...
name|llap
argument_list|,
literal|"useLocalFs can currently only be set for tez or llap"
argument_list|)
expr_stmt|;
block|}
if|if
...
block|{
comment|// Setup local file system
name|fs
operator|=
name|FileSystem
operator|.
...
name|llap
argument_list|,
literal|"localMode can currently only be set for tez or llap"
argument_list|)
expr_stmt|;
block|}
name|String
