...
argument_list|)
argument_list|,
literal|"POSTHOOK: Lineage: ###Masked###"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
specifier|final
name|Pattern
name|PATTERN_MASK_DATA_SIZE
init|=
name|Pattern
operator|.
name|compile
argument_list|(
literal|"-- MASK_DATA_SIZE"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Pattern
name|PATTERN_MASK_LINEAGE
init|=
name|Pattern
operator|.
name|compile
argument_list|(
literal|"-- MASK_LINEAGE"
argument_list|)
decl_stmt|;
specifier|private
name|FsType
...
argument_list|>
argument_list|>
name|initPatternWithMaskComments
parameter_list|()
block|{
return|return
operator|new
