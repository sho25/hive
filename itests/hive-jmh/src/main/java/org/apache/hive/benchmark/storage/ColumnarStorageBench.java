...
block|{
return|return
name|getVectorizedRecordReader
argument_list|(
name|inputPath
argument_list|)
return|;
...
argument_list|)
expr_stmt|;
comment|// TODO: VectorizedParquetRecordReader doesn't support map, array now, the value of
comment|// ColumnProjectionUtils.READ_COLUMN_IDS_CONF_STR should be updated after support these data
comment|// types.
name|conf
operator|.
name|setBoolean
