...
block|}
block|}
comment|/***    * Test isValid() method    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/***    * Negative test isValid() method    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
name|assertEquals
argument_list|(
literal|"Unexpected type of exception class thrown"
argument_list|,
name|HiveSQLException
operator|.
name|class
