...
argument_list|,
literal|"FAILED: Execution Error, return code 1 from org.apache.hadoop.hive.ql.ddl.DDLTask"
argument_list|,
literal|"08S01"
argument_list|,
literal|1
...
expr_stmt|;
block|}
comment|/**    * Test getting query log method in Jdbc for REPL commands    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testGetQueryLogForReplCommands
parameter_list|()
throws|throws
name|Exception
block|{
...
name|execute
argument_list|(
literal|"set hive.metastore.transactional.event.listeners ="
operator|+
...
name|primaryDb
operator|+
literal|" with dbproperties('repl.source.for'='1,2,3')"
argument_list|)
expr_stmt|;
name|stmt
operator|.
...
argument_list|()
expr_stmt|;
comment|// Test query logs for bootstrap dump and load
name|String
index|[]
name|expectedBootstrapDumpLogs
init|=
block|{
literal|"REPL::START"
block|,
literal|"REPL::TABLE_DUMP"
block|,
literal|"REPL::END"
block|}
decl_stmt|;
comment|// Bootstrap dump
name|stmt
operator|=
operator|(
name|HiveStatement
...
name|info
argument_list|(
literal|"Query_Log for Bootstrap Dump"
argument_list|)
expr_stmt|;
name|verifyFetchedLog
argument_list|(
...
name|String
index|[]
name|expectedBootstrapLoadLogs
init|=
block|{
literal|"REPL::START"
block|,
literal|"REPL::TABLE_LOAD"
block|,
literal|"REPL::END"
block|}
decl_stmt|;
...
name|info
argument_list|(
literal|"Query_Log for Bootstrap Load"
argument_list|)
expr_stmt|;
name|verifyFetchedLog
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Perform operation for incremental replication
name|stmt
operator|=
operator|(
name|HiveStatement
...
argument_list|()
expr_stmt|;
comment|// Test query logs for incremental dump and load
name|String
index|[]
name|expectedIncrementalDumpLogs
init|=
block|{
literal|"REPL::START"
block|,
literal|"REPL::EVENT_DUMP"
block|,
literal|"REPL::END"
block|}
decl_stmt|;
...
name|info
argument_list|(
literal|"Query_Log for Incremental Dump"
argument_list|)
expr_stmt|;
name|verifyFetchedLog
argument_list|(
...
name|String
index|[]
name|expectedIncrementalLoadLogs
init|=
block|{
literal|"REPL::START"
block|,
literal|"REPL::EVENT_LOAD"
block|,
literal|"REPL::END"
block|}
decl_stmt|;
comment|// Incremental load
name|stmt
operator|=
operator|(
name|HiveStatement
...
name|info
argument_list|(
literal|"Query_Log for Incremental Load"
argument_list|)
expr_stmt|;
name|verifyFetchedLog
argument_list|(
...
name|execute
argument_list|(
literal|"set hive.exec.parallel = false"
argument_list|)
expr_stmt|;
name|stmt
operator|.
...
name|execute
argument_list|(
literal|"set hive.metastore.dml.events = false"
argument_list|)
expr_stmt|;
name|stmt
operator|.
...
specifier|public
name|void
name|testUnionUniqueColumnNames
parameter_list|()
throws|throws
name|Exception
block|{
...
name|execute
argument_list|(
literal|"SET hive.resultset.use.unique.column.names=true"
argument_list|)
expr_stmt|;
name|ResultSet
name|rs
...
name|executeQuery
argument_list|(
literal|"select 1 UNION ALL select 2"
argument_list|)
decl_stmt|;
name|ResultSetMetaData
name|metaData
...
name|assertTrue
argument_list|(
literal|"There's no . for the UNION column name"
argument_list|,
operator|!
name|metaData
operator|.
...
name|execute
argument_list|(
literal|"create table tbl (fld int) tblproperties("
operator|+
...
name|execute
argument_list|(
literal|"insert into tbl values (1)"
argument_list|)
expr_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"insert into tbl values (2)"
argument_list|)
expr_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"insert into tbl values (3)"
argument_list|)
expr_stmt|;
name|ResultSet
name|res
