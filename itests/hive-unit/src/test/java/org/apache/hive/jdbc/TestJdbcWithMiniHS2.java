...
name|Ignore
argument_list|(
literal|"Flaky test. Should be re-enabled in HIVE-19706"
argument_list|)
annotation|@
name|Test
specifier|public
...
name|execute
argument_list|(
literal|"CREATE TABLE emp_table (id int, name string, salary int)"
argument_list|)
expr_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"insert into emp_table values(1,'aaaaa',20000)"
argument_list|)
expr_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"CREATE VIEW emp_view AS SELECT * FROM emp_table WHERE salary>10000"
argument_list|)
expr_stmt|;
name|String
name|customPath
...
literal|"/custom"
decl_stmt|;
comment|//Test External CTLV
name|String
name|extPath
init|=
name|customPath
operator|+
literal|"/emp_ext_table"
decl_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"CREATE EXTERNAL TABLE emp_ext_table like emp_view STORED AS PARQUET LOCATION '"
operator|+
name|extPath
operator|+
literal|"'"
...
argument_list|)
expr_stmt|;
comment|//Test Managed CTLV
name|String
name|mndPath
init|=
name|customPath
operator|+
literal|"/emp_mm_table"
decl_stmt|;
name|stmt
operator|.
name|execute
argument_list|(
literal|"CREATE TABLE emp_mm_table like emp_view STORED AS ORC LOCATION '"
operator|+
name|mndPath
operator|+
literal|"'"
