...
begin_comment
comment|/**  * This class is cloned from TestJdbcWithMiniMR, except use Namenode HA.  */
end_comment

begin_class
specifier|public
class|class
name|TestJdbcWithMiniHA
block|{
specifier|public
specifier|static
specifier|final
...
name|TEST_TAG_VALUE
init|=
literal|"miniHS2.miniHA.value"
decl_stmt|;
specifier|public
specifier|static
class|class
name|HATestSessionHook
...
block|}
block|}
comment|/**    * Verify that the connection to MiniHS2 is successful    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
