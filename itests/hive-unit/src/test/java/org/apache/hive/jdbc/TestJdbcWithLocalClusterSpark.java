...
begin_comment
comment|/**  * This class is cloned from TestJdbcWithMiniMR, except use Spark as the execution engine.  */
end_comment

begin_class
specifier|public
class|class
name|TestJdbcWithLocalClusterSpark
block|{
specifier|public
specifier|static
specifier|final
...
argument_list|)
argument_list|,
literal|"TestJdbcWithLocalClusterSpark-local-dir"
argument_list|)
operator|.
name|toString
argument_list|()
