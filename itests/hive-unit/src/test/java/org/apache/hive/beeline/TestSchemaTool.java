...
expr_stmt|;
block|}
comment|/*    * Test the validation of incorrect NULL values in the tables    * @throws Exception    */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**   * Test validation for schema versions   * @throws Exception   */
specifier|public
name|void
...
block|,
literal|"insert into DBS values(4, 'my db2', 'hdfs://myhost.com:8020', 'zDB', 'public', 'role')"
block|,
literal|"insert into DBS values(6, 'db with bad port', 'hdfs://myhost.com:8020:', 'aDB', 'public', 'role')"
block|,
...
block|,
literal|"insert into TBLS(TBL_ID,CREATE_TIME,DB_ID,LAST_ACCESS_TIME,OWNER,RETENTION,SD_ID,TBL_NAME,TBL_TYPE,VIEW_EXPANDED_TEXT,VIEW_ORIGINAL_TEXT,IS_REWRITE_ENABLED) values (4012 ,1435255431,4,0 ,'hive',0,4002,'mytal4012','MANAGED_TABLE',NULL,NULL,'n')"
block|,
...
return|;
block|}
comment|/**    * Insert the records in DB to simulate a hive table    * @throws IOException    */
specifier|private
name|void
name|createTestHiveTableSchemas
parameter_list|()
