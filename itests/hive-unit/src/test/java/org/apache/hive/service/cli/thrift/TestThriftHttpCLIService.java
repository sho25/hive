...
name|Exception
block|{
comment|// Stop and restart HiveServer2 in given incorrect auth mode
...
argument_list|()
expr_stmt|;
comment|// HiveServer2 in Http mode will not start using KERBEROS/LDAP/CUSTOM auth types
name|startHiveServer2WithConf
argument_list|(
name|hiveConf
argument_list|)
expr_stmt|;
comment|// This will throw an expected exception since Http server is not running
name|testOpenSessionExpectedException
argument_list|()
expr_stmt|;
comment|// Stop and restart back with the original config
name|stopHiveServer2
argument_list|()
expr_stmt|;
name|hiveConf
