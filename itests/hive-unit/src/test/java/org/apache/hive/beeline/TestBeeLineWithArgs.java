...
expr_stmt|;
block|}
comment|/**    * Test Beeline -hivevar option. User can specify --hivevar name=value on Beeline command line.    * This test defines multiple variables using repeated --hivevar flags.    * @throws Throwable    */
annotation|@
name|Test
specifier|public
name|void
...
name|SCRIPT_TEXT
init|=
literal|"${COMMAND} ${OBJECT} ${TABLE_NAME} (d int);\nshow tables;\n"
decl_stmt|;
specifier|final
name|String
name|EXPECTED_PATTERN
