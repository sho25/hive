...
specifier|public
name|void
name|replicationWithTableNameContainsKeywords
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|run
argument_list|(
literal|"create external table t1_functions (id int)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t1_functions values (1)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t1_functions values (2)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"create external table t2_constraints (place string) partitioned by (country string)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t2_constraints partition(country='india') values ('bangalore')"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t2_constraints partition(country='us') values ('austin')"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t2_constraints partition(country='france') values ('paris')"
argument_list|)
operator|.
name|dump
argument_list|(
...
name|run
argument_list|(
literal|"show tables like 't1_functions'"
argument_list|)
operator|.
name|verifyResults
argument_list|(
...
index|[]
block|{
literal|"t1_functions"
block|}
argument_list|)
operator|.
name|run
argument_list|(
literal|"show tables like 't2_constraints'"
argument_list|)
operator|.
name|verifyResults
argument_list|(
...
index|[]
block|{
literal|"t2_constraints"
block|}
argument_list|)
operator|.
name|run
argument_list|(
literal|"select id from t1_functions"
argument_list|)
operator|.
name|verifyResults
argument_list|(
...
name|run
argument_list|(
literal|"create external table t3_bootstrap (id int)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t3_bootstrap values (10)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t3_bootstrap values (20)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"create table t4_tables (id int)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t4_tables values (10)"
argument_list|)
operator|.
name|run
argument_list|(
literal|"insert into table t4_tables values (20)"
argument_list|)
operator|.
name|dump
argument_list|(
...
name|run
argument_list|(
literal|"show tables like 't3_bootstrap'"
argument_list|)
operator|.
name|verifyResults
argument_list|(
...
index|[]
block|{
literal|"t3_bootstrap"
block|}
argument_list|)
operator|.
name|run
argument_list|(
literal|"show tables like 't4_tables'"
argument_list|)
operator|.
name|verifyResults
argument_list|(
