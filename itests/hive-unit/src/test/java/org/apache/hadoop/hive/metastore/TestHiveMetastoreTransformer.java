...
specifier|public
name|void
name|testTransformerAlterTable
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// should be converted to external table
comment|// retrieve the table
name|Table
name|tbl2
init|=
...
name|fail
argument_list|(
literal|"alter_table expected to fail due to location:"
operator|+
name|newLocation
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"alter_table failed with exception, as expected"
argument_list|)
expr_stmt|;
block|}
comment|// retrieve the table and check that the location was not altered
name|tbl2
operator|=
name|client
operator|.
...
name|assertEquals
argument_list|(
literal|"Table location expected to be in external warehouse"
argument_list|,
name|tableLocation
argument_list|,
name|tbl2
...
name|info
argument_list|(
literal|"alter_table with new location succeeded as expected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"alter_table expected to succeed with new location:"
operator|+
name|newLocation
argument_list|)
expr_stmt|;
block|}
comment|// retrieve the table and check that the location was altered
name|tbl2
operator|=
name|client
operator|.
...
name|tblName
operator|=
literal|"test_create_insert_table"
expr_stmt|;
name|type
operator|=
name|TableType
...
name|assertEquals
argument_list|(
literal|"Table type expected to be MANAGED"
argument_list|,
...
name|fail
argument_list|(
literal|"alter_table expected to fail but succeeded with new location:"
operator|+
name|newLocation
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// retrieve the table and ensure location has not been changed.
name|tbl2
operator|=
name|client
operator|.
...
name|assertEquals
argument_list|(
literal|"Table location expected to remain unaltered"
argument_list|,
name|tableLocation
argument_list|,
name|tbl2
...
name|info
argument_list|(
literal|"alter_table succeeded with new location as expected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"alter_table expected to succeed but failed with new location:"
operator|+
name|newLocation
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"Table location expected to be new location"
argument_list|,
name|newLocation
argument_list|,
name|tbl2
...
name|tblName
operator|=
literal|"test_create_acid_table"
expr_stmt|;
name|type
operator|=
name|TableType
...
specifier|public
name|void
name|testTransformerAlterTableWithoutLocationChangeDoesntValidateLocation
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testTransformerWithNonHiveCatalogs
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setHMSClient
argument_list|(
literal|"TestCreateTableNonHive#1"
argument_list|,
operator|(
name|String
index|[]
...
name|info
argument_list|(
literal|"Create non-hive table is expected to succeed and has succeeded"
argument_list|)
expr_stmt|;
comment|// no transformation for views
block|}
...
name|fail
argument_list|(
literal|"Create non-hive table expected to succeed but has failed.<"
operator|+
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"TableName expected to be "
operator|+
name|tblName
argument_list|,
name|tblName
...
name|assertEquals
argument_list|(
literal|"TableType expected to be EXTERNAL"
argument_list|,
name|TableType
operator|.
name|EXTERNAL_TABLE
...
name|assertNull
argument_list|(
literal|"Table's ReadCapabilities is expected to be null"
argument_list|,
name|tbl2
operator|.
name|getRequiredReadCapabilities
...
name|assertNull
argument_list|(
literal|"Table's WriteCapabilities is expected to be null"
argument_list|,
name|tbl2
operator|.
name|getRequiredWriteCapabilities
...
name|setHMSClient
argument_list|(
literal|"TestAlterTableNonHive#1"
argument_list|,
operator|(
name|String
index|[]
...
name|info
argument_list|(
literal|"alter_table succeeded with new location in managed warehouse as expected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|setHMSClient
argument_list|(
literal|"TestCreateTableNonHive#2"
argument_list|,
operator|(
name|String
index|[]
...
name|info
argument_list|(
literal|"Create non-hive MGD table is expected to succeed and has succeeded"
argument_list|)
expr_stmt|;
comment|// no transformation for views
block|}
...
name|fail
argument_list|(
literal|"Create non-hive MGD table expected to succeed but has failed.<"
operator|+
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"TableType expected to be MANAGED"
argument_list|,
name|TableType
operator|.
name|MANAGED_TABLE
...
argument_list|)
expr_stmt|;
comment|// TESTS to ensure AlterTable does not go thru translation for non-hive catalog objects
name|setHMSClient
argument_list|(
literal|"TestAlterTableNonHive#2"
argument_list|,
operator|(
name|String
index|[]
...
name|info
argument_list|(
literal|"alter_table succeeded with new location in external warehouse as expected"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertEquals
argument_list|(
literal|"Table location expected to be in managed warehouse"
argument_list|,
name|newLocation
argument_list|,
name|tbl2
...
argument_list|)
expr_stmt|;
comment|// Test getTablesExt with many tables.
name|sparkDbName
operator|=
literal|"sparkdbext"
expr_stmt|;
...
name|info
argument_list|(
literal|"Catalog does not exist, creating a new one"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|error
argument_list|(
literal|"Creation of a new catalog failed, aborting test"
argument_list|)
expr_stmt|;
throw|throw
name|e
