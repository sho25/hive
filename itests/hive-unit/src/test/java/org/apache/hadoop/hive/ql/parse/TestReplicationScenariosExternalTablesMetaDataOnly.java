...
begin_comment
comment|/**  * TestMetadataReplicationScenariosExternalTables - Test metadata only replication.  * for external tables.  */
end_comment

begin_class
specifier|public
class|class
name|TestReplicationScenariosExternalTablesMetaDataOnly
extends|extends
...
argument_list|)
expr_stmt|;
comment|// the _external_tables_file data only should be created if external tables are to be replicated not otherwise
name|assertFalse
argument_list|(
name|primary
operator|.
...
argument_list|)
decl_stmt|;
comment|// verify that the external table info is not written as metadata only replication
name|assertFalseExternalFileInfo
argument_list|(
operator|new
name|Path
argument_list|(
