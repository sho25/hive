...
name|contains
argument_list|(
literal|"org.apache.hadoop.hive.ql.metadata.hiveException: "
operator|+
...
name|contains
argument_list|(
literal|"org.apache.hadoop.hive.ql.parse.semanticException:"
operator|+
...
argument_list|)
expr_stmt|;
comment|// Verify if no create table/function calls. Only add partitions.
name|BehaviourInjection
argument_list|<
name|CallerArguments
argument_list|,
