...
specifier|public
name|void
name|testIncrementalCreateFunctionWithFunctionBinaryJarsOnHDFS
parameter_list|()
throws|throws
name|Throwable
block|{
...
comment|// do a empty incremental load to allow dump of replicatedDbName
name|WarehouseInstance
operator|.
name|Tuple
name|temp
...
argument_list|)
expr_stmt|;
comment|// first successful incremental load.
