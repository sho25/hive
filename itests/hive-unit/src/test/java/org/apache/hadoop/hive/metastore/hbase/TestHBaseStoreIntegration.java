...
expr_stmt|;
block|}
comment|// We only test getPartitionsByFilter since it calls same code as getPartitionsByExpr anyway.
comment|// Test the case where we completely specify the partition
name|List
argument_list|<
name|Partition
...
name|parts
argument_list|,
literal|"[20010102, north america]"
argument_list|,
literal|"[20010102, europe]"
argument_list|,
literal|"[20010103, north america]"
argument_list|)
expr_stmt|;
name|parts
operator|=
...
name|tableName
argument_list|,
literal|"ds>= '20010102' and region = 'europe' "
argument_list|,
operator|(
name|short
operator|)
...
argument_list|)
expr_stmt|;
comment|// filtering on first partition is only implemented as of now, so it will
comment|// not filter on region
name|checkPartVals
argument_list|(
name|parts
argument_list|,
...
name|tableName
argument_list|,
literal|"ds>= '20010101' and ds< '20010102'"
argument_list|,
operator|(
name|short
operator|)
...
name|parts
argument_list|,
literal|"[20010101, north america]"
argument_list|,
literal|"[20010101, europe]"
argument_list|)
expr_stmt|;
name|parts
operator|=
...
name|tableName
argument_list|,
literal|"ds = '20010102' or ds< '20010103'"
argument_list|,
operator|(
name|short
operator|)
...
argument_list|)
expr_stmt|;
comment|// test conversion to DNF
name|parts
operator|=
name|store
operator|.
...
name|tableName
argument_list|,
literal|"ds = '20010102' and (ds = '20010102' or region = 'europe')"
argument_list|,
operator|(
name|short
operator|)
...
argument_list|)
expr_stmt|;
comment|// filtering on first partition is only implemented as of now, so it will not filter on region
name|checkPartVals
argument_list|(
name|parts
argument_list|,
...
expr_stmt|;
block|}
comment|/**    * Check if the given partitions have same values as given partitions value strings    * @param parts given partitions    * @param expectedPartVals    */
specifier|private
name|void
name|checkPartVals
parameter_list|(
