...
argument_list|)
expr_stmt|;
comment|// Insert another round of test data
name|dataProvider
operator|.
name|insertTestData
argument_list|(
...
specifier|public
name|void
name|testMinorCompactionAfterMajor
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Delta directories do not match after major compaction"
argument_list|,
name|Collections
operator|.
name|singletonList
argument_list|(
literal|"delta_0000001_0000010_v0000020"
argument_list|)
argument_list|,
name|CompactorTestUtil
operator|.
...
expr_stmt|;
block|}
comment|/**    * Tests whether hive.llap.io.etl.skip.format config is handled properly whenever QueryCompactor#runCompactionQueries    * is invoked.    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testLlapCacheOffDuringCompaction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|VALID_TXNS_KEY
argument_list|,
literal|"8:9223372036854775807::"
argument_list|)
expr_stmt|;
comment|// Check for default case.
name|qc
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check for case where  hive.llap.io.etl.skip.format is explicitly set to none - as to always use cache.
name|hiveConf
operator|.
name|setVar
argument_list|(
