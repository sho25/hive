...
argument_list|)
decl_stmt|;
comment|// Check if MetaException has one of InvalidObjectException or NoSuchObjectExcetion or any exception thrown from ObjectStore , which means that the
comment|// authorization checks passed.
if|if
condition|(
name|exStackString
...
name|contains
argument_list|(
literal|"org.apache.hadoop.hive.metastore.api.NoSuchObjectException"
argument_list|)
operator|||
name|exStackString
operator|.
name|contains
argument_list|(
literal|"org.apache.hadoop.hive.metastore.api.InvalidObjectException"
argument_list|)
condition|)
block|{
name|assertFalse
argument_list|(
literal|"No Authz exception thrown in embedded mode"
argument_list|,
name|isRemoteMetastoreMode
argument_list|)
expr_stmt|;
