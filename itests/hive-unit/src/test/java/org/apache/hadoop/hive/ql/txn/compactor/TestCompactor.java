...
argument_list|()
decl_stmt|;
comment|// Start a third batch, abortTransaction everything, don't properly close it
name|connection2
operator|.
name|beginTransaction
argument_list|()
...
name|equals
argument_list|(
literal|"delete_delta_0000001_0000002_v0000005"
argument_list|)
condition|)
block|{
name|minorCompactedDeleteDelta
...
name|equals
argument_list|(
literal|"delete_delta_0000001_0000004_v0000009"
argument_list|)
condition|)
block|{
name|minorCompactedDeleteDelta
