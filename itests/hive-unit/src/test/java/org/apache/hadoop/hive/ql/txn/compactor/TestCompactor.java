...
begin_comment
comment|/**  * Compaction related unit tests.  */
end_comment
...
specifier|public
name|void
name|testStatsAfterCompactionPartTblNew
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equals
argument_list|(
literal|"delta_0000001_0000004_v0000009"
argument_list|)
condition|)
block|{
name|resultFile
...
specifier|public
name|void
name|minorCompactAfterAbortNew
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|majorCompactAfterAbortNew
parameter_list|()
throws|throws
name|Exception
block|{
...
name|tblName
operator|+
literal|"(a INT, b STRING) STORED AS ORC"
operator|+
...
argument_list|)
expr_stmt|;
comment|// Check that we have two deltas.
name|FileSystem
name|fs
init|=
name|FileSystem
...
name|fs
argument_list|,
literal|"base_0000002_v0000006"
argument_list|)
expr_stmt|;
comment|// Make sure we don't compact if we don't need to compact.
name|runMajorCompaction
argument_list|(
name|dbName
argument_list|,
...
specifier|public
name|void
name|mmTableOriginalsOrc
parameter_list|()
throws|throws
name|Exception
block|{
name|mmTableOriginals
argument_list|(
literal|"ORC"
argument_list|)
expr_stmt|;
...
name|Exception
block|{
comment|// Originals split won't work due to MAPREDUCE-7086 issue in FileInputFormat.
name|boolean
name|isBrokenUntilMapreduce7086
init|=
literal|"TEXTFILE"
operator|.
name|equals
...
name|tblName
operator|+
literal|"(a INT, b STRING) STORED AS "
operator|+
name|format
operator|+
...
name|fs
argument_list|,
literal|"base_0000001_v0000009"
argument_list|)
expr_stmt|;
comment|// Try with an extra delta.
name|executeStatementOnDriver
argument_list|(
literal|"drop table if exists "
operator|+
...
argument_list|)
expr_stmt|;
comment|// Neither select nor compaction (which is a select) wil work after this.
if|if
condition|(
name|isBrokenUntilMapreduce7086
condition|)
...
name|tblName
operator|+
literal|"(a INT, b STRING) CLUSTERED BY (a) "
operator|+
literal|"INTO 64 BUCKETS STORED AS ORC TBLPROPERTIES ('transactional'='true', "
operator|+
...
name|tblName
operator|+
literal|"(a INT, b STRING) STORED AS TEXTFILE"
operator|+
literal|" TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')"
argument_list|,
name|driver
...
argument_list|)
expr_stmt|;
comment|// Just check to make sure base_5 below is not new.
name|executeStatementOnDriver
argument_list|(
literal|"INSERT INTO "
operator|+
...
argument_list|)
expr_stmt|;
comment|// Don't compact 4 and 5; 3 is opened.
name|FileSystem
name|fs
init|=
name|FileSystem
...
literal|"(a INT, b STRING) "
operator|+
literal|" PARTITIONED BY(ds int) STORED AS TEXTFILE"
operator|+
literal|" TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')"
argument_list|,
name|driver
...
name|tblName
operator|+
literal|" partition (ds) VALUES(1, 'foo', 1)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" partition (ds) VALUES(2, 'bar', 1)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" partition (ds) VALUES(1, 'foo', 2)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" partition (ds) VALUES(2, 'bar', 2)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" partition (ds) VALUES(2, 'bar', 3)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Make sure we don't compact if we don't need to compact; but do if we do.
name|verifyFooBarResult
argument_list|(
name|tblName
argument_list|,
...
specifier|public
name|void
name|majorCompactWhileStreamingForSplitUpdateNew
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equals
argument_list|(
literal|"delete_delta_0000001_0000003_v0000006"
argument_list|)
condition|)
block|{
name|minorCompactedDeleteDelta
...
name|equals
argument_list|(
literal|"delta_0000001_0000002_v0000005"
argument_list|)
condition|)
block|{
name|minorCompactedDelta
...
specifier|public
name|void
name|minorCompactWhileStreamingWithSplitUpdateNew
parameter_list|()
throws|throws
name|Exception
block|{
...
operator|+
literal|" TBLPROPERTIES ('transactional'='true', 'orc.compress.size'='2700')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/**      * we just did a major compaction on ttp1.  Open any file produced by it and check buffer size.      * It should be the default.      */
name|List
argument_list|<
name|String
argument_list|>
...
name|execSelectAndDumpData
argument_list|(
literal|"select distinct INPUT__FILE__NAME from "
operator|+
name|tblName1
argument_list|,
name|driver
argument_list|,
literal|"Find Orc File bufer default"
argument_list|)
decl_stmt|;
name|Assert
operator|.
...
name|assertEquals
argument_list|(
literal|"Expected default compression size"
argument_list|,
literal|2700
argument_list|,
name|orcReader
...
argument_list|)
expr_stmt|;
comment|//make sure 2700 is not the default so that we are testing if tblproperties indeed propagate
name|Assert
operator|.
name|assertNotEquals
argument_list|(
literal|"Unexpected default compression size"
argument_list|,
literal|2700
argument_list|,
name|OrcConf
...
argument_list|)
expr_stmt|;
comment|//make sure we are checking the right (latest) compaction entry
name|Assert
operator|.
name|assertEquals
argument_list|(
...
comment|//we just ran Major compaction so we should have a base_x in tblName2 that has the new files
comment|// Get the name of a file and look at its properties to see if orc.compress.size was respected.
name|rs
operator|=
name|execSelectAndDumpData
argument_list|(
...
name|driver
argument_list|,
literal|"Find Compacted Orc File"
argument_list|)
expr_stmt|;
name|Assert
operator|.
...
name|assertEquals
argument_list|(
literal|"File written with wrong buffer size"
argument_list|,
literal|3141
argument_list|,
name|orcReader
...
name|assertTrue
argument_list|(
literal|"The object must be equal"
argument_list|,
name|compactionInfo
operator|.
name|equals
...
name|assertFalse
argument_list|(
literal|"The object must be not equal"
argument_list|,
name|compactionInfo
operator|.
name|equals
...
specifier|public
name|void
name|testCompactionInfoHashCode
parameter_list|()
block|{
name|CompactionInfo
name|compactionInfo
...
name|assertEquals
argument_list|(
literal|"The hash codes must be equal"
argument_list|,
name|compactionInfo
operator|.
name|hashCode
...
specifier|public
name|void
name|testDisableCompactionDuringReplLoad
parameter_list|()
throws|throws
name|Exception
block|{
...
name|tblName
operator|+
literal|" SET TBLPROPERTIES ( 'hive.repl.first.inc.pending' = 'true')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|database
operator|+
literal|" set dbproperties ('hive.repl.first.inc.pending' = 'true')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|tblName
operator|+
literal|" SET TBLPROPERTIES ( 'hive.repl.first.inc.pending' = 'false')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
name|database
operator|+
literal|" set dbproperties ('hive.repl.first.inc.pending' = 'false')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Tests compaction of tables that were populated by LOAD DATA INPATH statements.    *    * In this scenario original ORC files are a structured in the following way:    * comp3    * |--delta_0000001_0000001_0000    *    |--000000_0    * |--delta_0000002_0000002_0000    *    |--000000_0    *    |--000001_0    *    * ..where comp3 table is not bucketed.    *    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testCompactionOnDataLoadedInPath
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Setup of LOAD INPATH scenario.
name|executeStatementOnDriver
argument_list|(
literal|"drop table if exists comp0"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"drop table if exists comp1"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"drop table if exists comp3"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"create external table comp0 (a string)"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"insert into comp0 values ('1111111111111')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"insert into comp0 values ('2222222222222')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"insert into comp0 values ('3333333333333')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"create external table comp1 stored as orc as select * from comp0"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
name|executeStatementOnDriver
argument_list|(
literal|"create table comp3 (a string) stored as orc "
operator|+
...
argument_list|)
expr_stmt|;
comment|// Check compacted content and file structure.
name|table
operator|=
name|hmsClient
operator|.
...
argument_list|()
expr_stmt|;
comment|// Another insert into the newly compacted table.
name|executeStatementOnDriver
argument_list|(
literal|"insert into comp3 values ('4444444444444')"
argument_list|,
name|driver
argument_list|)
expr_stmt|;
comment|// Compact with extra row too.
name|txnHandler
operator|.
name|compact
argument_list|(
