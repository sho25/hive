...
return|;
block|}
comment|/**    * Get statistics for given set of columns of a given table in the given database    * @param dbName - the database where the table resides    * @param tableName - tablename whose statistics are to be retrieved    * @param colNames - columns whose statistics is to be retrieved.    * @return - list of ColumnStatisticsObj objects in the order of the specified columns    */
specifier|public
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/**    * Get statistics for given set of columns for all the partitions of a given table in the given    * database.    * @param dbName - the database where the table resides    * @param tableName - name of the partitioned table in the database    * @param colNames - columns whose statistics is to be retrieved    * @return Map of partition name and list of ColumnStatisticsObj. The objects in the list are    * ordered according to the given list of columns.    * @throws Exception    */
name|Map
argument_list|<
name|String
argument_list|,
