...
argument_list|)
expr_stmt|;
comment|// this is required since the same filesystem is used in both source and target
return|return
name|Arrays
operator|.
name|asList
...
name|assertEquals
argument_list|(
literal|"The file should have tableName,base64encoded(data_location)"
argument_list|,
literal|2
argument_list|,
name|components
