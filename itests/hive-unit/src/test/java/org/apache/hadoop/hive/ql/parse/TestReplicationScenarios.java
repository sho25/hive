...
expr_stmt|;
block|}
comment|// TODO: This test should be removed once ACID tables replication is supported.
annotation|@
name|Test
specifier|public
name|void
...
name|dbName
operator|+
literal|".acid_table (key int, value int) PARTITIONED BY (load_date date) "
operator|+
...
argument_list|)
expr_stmt|;
comment|// Dummy create table command to mark proper last repl ID after dump
name|run
argument_list|(
literal|"CREATE TABLE "
operator|+
...
argument_list|)
expr_stmt|;
comment|// Dummy insert into command to mark proper last repl ID after dump
name|run
argument_list|(
literal|"INSERT INTO "
operator|+
