...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":3}\t9\t10"
block|,
name|AbstractFileMergeOperator
operator|.
name|UNION_SUDBIR_PREFIX
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":4}\t7\t8"
block|,
name|AbstractFileMergeOperator
operator|.
name|UNION_SUDBIR_PREFIX
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":5}\t5\t6"
block|,
name|AbstractFileMergeOperator
operator|.
name|UNION_SUDBIR_PREFIX
...
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t70\t80"
block|,
...
block|,
literal|"delete_delta_0000002_0000002_0000"
block|}
decl_stmt|;
for|for
control|(
...
name|endsWith
argument_list|(
literal|"base_0000002/bucket_00000"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|{
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":0}\t100\t110\t1"
block|,
literal|"nonacidpart/p=1/000000_0"
block|}
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":1}\t1\t2\t1"
block|,
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":2}\t3\t4\t1"
block|,
literal|"nonacidpart/p=1/"
operator|+
name|AbstractFileMergeOperator
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":3}\t9\t10\t1"
block|,
literal|"nonacidpart/p=1/"
operator|+
name|AbstractFileMergeOperator
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":4}\t7\t8\t1"
block|,
literal|"nonacidpart/p=1/"
operator|+
name|AbstractFileMergeOperator
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":5}\t5\t6\t1"
block|,
literal|"nonacidpart/p=1/"
operator|+
name|AbstractFileMergeOperator
...
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870914,\"rowid\":0}\t9\t10"
block|,
literal|"/delta_0000001_0000001_0002/bucket_00000"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870914,\"rowid\":1}\t7\t8"
block|,
literal|"/delta_0000001_0000001_0002/bucket_00000"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870914,\"rowid\":2}\t5\t6"
block|,
literal|"/delta_0000001_0000001_0002/bucket_00000"
block|}
block|,     }
...
block|,
block|{
literal|"{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t70\t80"
block|,
...
name|endsWith
argument_list|(
literal|"base_0000003/bucket_00000"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|,
literal|"warehouse/t/base_-9223372036854775808_v0000024/bucket_00000"
block|}
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":1}\t3\t4"
...
block|,
block|{
literal|"{\"writeid\":0,\"bucketid\":536870912,\"rowid\":3}\t7\t8"
block|,
literal|"warehouse/t/base_-9223372036854775808_v0000024/bucket_00000"
block|}
block|,
...
block|,
literal|"warehouse/t/delta_0000001_0000001_0001/bucket_00000_0"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870913,\"rowid\":1}\t3\t4"
...
block|,
literal|"warehouse/t/delta_0000001_0000001_0002/bucket_00000_0"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870914,\"rowid\":1}\t7\t8"
...
block|,
literal|"warehouse/t/delta_0000001_0000001_0003/bucket_00000_0"
block|}
block|}
decl_stmt|;
name|Assert
...
block|,
literal|"warehouse/t/delta_0000001_0000001_0000/bucket_00001_0"
block|}
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t2\t4"
block|,
literal|"warehouse/t/delta_0000001_0000001_0000/bucket_00000_0"
block|}
block|,
block|{
...
block|,
block|{
literal|"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t6\t8"
block|,
literal|"warehouse/t/delta_0000001_0000001_0000/bucket_00000_0"
block|}
block|,
...
specifier|public
name|void
name|testGetSplitsLocksWithMaterializedView
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// The get_splits call should have resulted in a lock on ACIDTBL and materialized view mv_acidTbl
name|ShowLocksResponse
name|slr
init|=
name|txnHandler
...
name|runStatementOnDriver
argument_list|(
literal|"drop materialized view if exists "
operator|+
name|mvName
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * HIVE-20699    *    * see TestTxnCommands3.testCompactor    */
annotation|@
name|Test
specifier|public
name|void
name|testCrudMajorCompactionSplitGrouper
parameter_list|()
throws|throws
name|Exception
block|{
...
name|tblName
operator|+
literal|" order by ROW__ID.bucketid, ROW__ID"
argument_list|,
name|confForTez
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// No order by needed: this should use the compactor split grouping to return the rows in correct order
name|List
argument_list|<
name|String
argument_list|>
...
expr_stmt|;
block|}
comment|/**    * Tests the OrcInputFormat.isOrignal method for files in ACID and Non-ACID tables.    * @throws IOException If there is a file reading error    */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Checks if the file format is original or ACID file based on OrcInputFormat static methods.    * @param path The file to check    * @param expected The expected result of the isOriginal    * @throws IOException Error when reading the file    */
specifier|private
name|void
name|assertIsOriginal
parameter_list|(
...
name|assertEquals
argument_list|(
literal|"Reader based original check"
argument_list|,
name|expected
argument_list|,
name|OrcInputFormat
...
name|assertEquals
argument_list|(
literal|"Footer based original check"
argument_list|,
name|expected
argument_list|,
name|OrcInputFormat
...
name|assertTrue
argument_list|(
literal|"Checking if any file found to check"
argument_list|,
name|foundAnyFile
argument_list|)
expr_stmt|;
