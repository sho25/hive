...
specifier|public
name|void
name|testInputSomeColumnsUsedView
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInputSomeColumnsUsedJoin
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"number of output objects"
argument_list|,
literal|2
argument_list|,
name|outputs
...
argument_list|)
expr_stmt|;
comment|// actually create the permanent function
name|CommandProcessorResponse
name|cresponse
init|=
name|driver
...
argument_list|)
expr_stmt|;
comment|// Verify privilege objects
name|reset
argument_list|(
name|mockedAuthorizer
argument_list|)
...
name|assertEquals
argument_list|(
literal|"number of input objects"
argument_list|,
literal|2
argument_list|,
name|inputs
...
argument_list|)
expr_stmt|;
comment|// create 2nd permanent function
name|String
name|funcName2
init|=
literal|"funcName2"
...
name|funcName2
operator|+
literal|" as 'org.apache.hadoop.hive.ql.udf.UDFRand'"
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// try using 2nd permanent function and verify its only 2nd one that shows up
comment|// for auth
name|reset
argument_list|(
name|mockedAuthorizer
...
argument_list|)
expr_stmt|;
comment|// try using both permanent functions
name|reset
argument_list|(
name|mockedAuthorizer
argument_list|)
...
name|separator
operator|+
literal|"THSAC_testTableTable"
decl_stmt|;
specifier|final
name|String
name|tableName
init|=
literal|"testTempTable"
decl_stmt|;
block|{
...
argument_list|()
decl_stmt|;
comment|// only the URI should be passed for authorization check
name|assertEquals
argument_list|(
literal|"input count"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// only the dbname should be passed authorization check
name|assertEquals
argument_list|(
literal|"output count"
argument_list|,
literal|1
argument_list|,
name|outputs
...
block|}
block|{
comment|// select from the temp table
name|reset
argument_list|(
name|mockedAuthorizer
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// temp tables should be skipped from authorization
name|List
argument_list|<
name|HivePrivilegeObject
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// HiveAuthorizer.filterListCmdObjects should not filter any object
name|when
argument_list|(
name|mockedAuthorizer
operator|.
