...
argument_list|)
decl_stmt|;
comment|// Create scratchdir with 777, so that user impersonation has no issues.
name|FileSystem
operator|.
name|mkdirs
argument_list|(
...
return|;
block|}
comment|/**    * return connection URL for this server instance    * @param dbName - DB name to be included in the URL    * @param sessionConfExt - Addional string to be appended to sessionConf part of url    * @return    */
specifier|public
name|String
name|getJdbcURL
parameter_list|(
...
return|;
block|}
comment|/**    * return connection URL for this server instance    * @param dbName - DB name to be included in the URL    * @param sessionConfExt - Addional string to be appended to sessionConf part of url    * @param hiveConfExt - Additional string to be appended to HiveConf part of url (excluding the ?)    * @return    */
specifier|public
name|String
name|getJdbcURL
parameter_list|(
...
name|hiveConfExt
operator|=
literal|"hive.server2.transport.mode=http;hive.server2.thrift.http.path=cliservice;"
operator|+
name|hiveConfExt
expr_stmt|;
block|}
