...
operator|+
literal|"\"servicePrincipal\":\"\",\"db\":\"myhcatdb\",\"timestamp\":[0-9]+}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
operator|+
literal|"\"servicePrincipal\":\"\",\"db\":\"hcatdropdb\",\"timestamp\":[0-9]+}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
operator|+
literal|"\"servicePrincipal\":\"\",\"db\":\"default\",\"table\":\"hcatcreatetable\",\"timestamp\":[0-9]+}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
operator|+
literal|"\"hcatdroptable\",\"timestamp\":[0-9]+}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"\"servicePrincipal\":\"\",\"db\":\"default\",\"table\":"
operator|+
literal|"\"hcataddparttable\",\"timestamp\":[0-9]+,\"partitions\":\\[\\{\"pc\":\"testpart\"}]}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"\"servicePrincipal\":\"\",\"db\":\"default\",\"table\":"
operator|+
literal|"\"hcatdropparttable\",\"timestamp\":[0-9]+,\"partitions\":\\[\\{\"pc\":\"testpart\"}]}"
argument_list|)
argument_list|)
expr_stmt|;
block|}
