...
block|}
block|,
comment|// Arithmetic on two TimestampColumnVector base classes.
block|{
literal|"TimestampArithmeticTimestampBase"
block|,
literal|"Add"
block|,
literal|"Col"
...
block|}
block|,
comment|// Arithmetic on a TimestampColumnVector and date base classes.
block|{
literal|"DateArithmeticTimestampBase"
block|,
literal|"Add"
block|,
literal|"Col"
...
block|,
block|{
literal|"TimestampArithmeticDateBase"
block|,
literal|"Add"
block|,
literal|"Col"
...
block|}
block|,
comment|// Arithmetic with a type date (LongColumnVector storing epoch days) and type interval_day_time (TimestampColumnVector storing
comment|// nanosecond interval in 2 longs) produces a type timestamp (TimestampColumnVector).
block|{
...
block|}
block|,
comment|// Subtraction with a type date (LongColumnVector storing epoch days) and type timestamp produces a type timestamp (TimestampColumnVector).
block|{
literal|"DateArithmeticTimestamp"
block|,
literal|"Subtract"
...
block|}
block|,
comment|// Base compare timestamp to timestamp used by Timestamp and IntervalDayTime.
block|{
literal|"TimestampCompareTimestampBase"
block|,
literal|"Equal"
block|,
literal|"=="
...
block|}
block|,
comment|// Base filter timestamp against timestamp used by Timestamp and IntervalDayTime.
block|{
literal|"FilterTimestampCompareTimestampBase"
block|,
literal|"Equal"
block|,
literal|"=="
...
condition|)
block|{
name|generateTimestampCompareTimestampBase
argument_list|(
name|tdesc
argument_list|)
expr_stmt|;
...
condition|)
block|{
name|generateFilterTimestampCompareTimestampBase
argument_list|(
name|tdesc
argument_list|)
expr_stmt|;
...
condition|)
block|{
name|generateTimestampArithmeticTimestampBase
argument_list|(
name|tdesc
argument_list|)
expr_stmt|;
...
condition|)
block|{
name|generateDateArithmeticTimestampBase
argument_list|(
name|tdesc
argument_list|)
expr_stmt|;
...
condition|)
block|{
name|generateTimestampArithmeticDateBase
argument_list|(
name|tdesc
argument_list|)
expr_stmt|;
...
block|{
return|return
literal|"getTimestampSecondsWithFractionalNanos"
return|;
block|}
else|else
block|{
...
return|;
block|}
comment|// TimestampColumnArithmeticTimestampColumnBase.txt
comment|// TimestampScalarArithmeticTimestampColumnBase.txt
comment|// TimestampColumnArithmeticTimestampScalarBase.txt
comment|//
specifier|private
name|void
name|generateTimestampArithmeticTimestampBase
...
block|}
comment|// DateColumnArithmeticTimestampColumnBase.txt
comment|// DateScalarArithmeticTimestampColumnBase.txt
comment|// DateColumnArithmeticTimestampScalarBase.txt
comment|//
specifier|private
name|void
name|generateDateArithmeticTimestampBase
...
comment|/* UNDONE: Col Col, vs Scalar Col vs Col Scalar     testCodeGen.addColumnColumnOperationTestCases(           className,           inputColumnVectorType1,           inputColumnVectorType2,           "long");     */
block|}
comment|// TimestampColumnArithmeticDateColumnBase.txt
comment|// TimestampScalarArithmeticDateColumnBase.txt
comment|// TimestampColumnArithmeticDateScalarBase.txt
comment|//
specifier|private
name|void
name|generateTimestampArithmeticDateBase
