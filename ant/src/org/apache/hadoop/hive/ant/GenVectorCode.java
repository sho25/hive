...
block|}
block|,
comment|// Note: floor(long) is a no-op so code generation should remove it or use
comment|// an IdentityExpression
block|{
literal|"ColumnUnaryFunc"
block|,
literal|"FuncCeil"
...
block|}
block|,
comment|// Similarly, ceil(long) is a no-op, so not generating code for it here
block|{
literal|"ColumnUnaryFunc"
block|,
literal|"FuncExp"
