...
argument_list|)
decl_stmt|;
comment|// If prefix length is< 3, File.createTempFile() will throw an IllegalArgumentException.
comment|// We need to avoid this case.
if|if
condition|(
name|fileNameWithoutExtension
operator|.
...
name|println
argument_list|(
literal|"Log file already exists: "
operator|+
name|lf
operator|.
name|getCanonicalPath
...
name|println
argument_list|(
literal|"Query file names containing file already exists: "
operator|+
name|qFileNamesFile
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"Could not delete query file names containing file "
operator|+
name|qFileNames
operator|.
name|getCanonicalPath
...
name|println
argument_list|(
literal|"Could not create query file names containing file "
operator|+
name|qFileNamesFile
argument_list|)
expr_stmt|;
...
name|BuildException
argument_list|(
literal|"hiveConfDir is not dir "
operator|+
operator|new
name|File
argument_list|(
