...
begin_comment
comment|/**  * Druid Record Writer, implementing a file sink operator.  */
end_comment
...
name|format
argument_list|(
literal|"partitionNumber and maxPartitionSize should be mutually exclusive "
operator|+
literal|"got partitionNum [%s] and maxPartitionSize [%s]"
argument_list|,
name|partitionNumber
argument_list|,
name|maxPartitionSize
