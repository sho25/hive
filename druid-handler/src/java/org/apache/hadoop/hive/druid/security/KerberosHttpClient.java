...
argument_list|)
decl_stmt|;
comment|/* Handle response as Futures instead of inline code to avoid boiler plate repeated code. */
name|Futures
operator|.
name|addCallback
argument_list|(
...
name|debug
argument_list|(
literal|"Not retrying and returning future response"
argument_list|)
expr_stmt|;
name|future
operator|.
