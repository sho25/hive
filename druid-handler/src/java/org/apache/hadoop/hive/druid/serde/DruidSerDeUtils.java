...
block|}
block|}
comment|/* Extract type from dimension spec. It returns TIMESTAMP if it is a FLOOR,    * INTEGER if it is a EXTRACT, or STRING otherwise. */
specifier|public
specifier|static
name|PrimitiveTypeInfo
...
condition|)
block|{
comment|// Timestamp (null or default used by FLOOR)
return|return
name|TypeInfoFactory
operator|.
...
block|{
comment|// EXTRACT from timestamp
return|return
name|TypeInfoFactory
operator|.
name|intTypeInfo
