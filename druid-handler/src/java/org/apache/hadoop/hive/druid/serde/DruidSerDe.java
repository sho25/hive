...
parameter_list|)
block|{
comment|// we may not be able to parse the date if it already comes in Hive format,
comment|// we retry and otherwise fail
name|numberOfMillis
operator|=
name|Timestamp
operator|.
