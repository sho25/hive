...
index|]
decl_stmt|;
comment|// Grouping dimensions can have different types if we are grouping using an
...
condition|)
block|{
comment|// NULL value for dimension
name|value
operator|.
name|getValue
argument_list|()
...
name|TIMESTAMP
case|:
comment|// FLOOR extraction function
name|val
operator|=
name|ISODateTimeFormat
operator|.
...
name|INT
case|:
comment|// EXTRACT extraction function
name|val
operator|=
name|Integer
operator|.
