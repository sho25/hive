...
name|format
argument_list|(
literal|"checking load status from coordinator [%s]"
argument_list|,
name|coordinatorAddress
argument_list|)
argument_list|)
expr_stmt|;
comment|// check if the coordinator is up
name|httpClient
operator|=
name|makeHttpClient
argument_list|(
...
name|format
argument_list|(
literal|"Checking segment [%s] response is [%s]"
argument_list|,
name|input
argument_list|,
name|result
...
name|format
argument_list|(
literal|"commit insert overwrite into table [%s]"
argument_list|,
name|table
operator|.
name|getTableName
...
name|MetaException
argument_list|(
literal|"Insert into is not supported yet"
argument_list|)
throw|;
block|}
block|}
...
name|MetaException
argument_list|(
literal|"INSERT INTO statement is not allowed by druid storage handler"
argument_list|)
throw|;
block|}
block|}
