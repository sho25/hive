...
name|format
argument_list|(
literal|"Committing hive table {} druid data source {} to the druid metadata store"
argument_list|,
name|table
operator|.
name|getTableName
...
name|format
argument_list|(
literal|"Will move [%s] druid segments from [%s] to [%s]"
argument_list|,
name|segmentList
operator|.
name|size
...
name|error
argument_list|(
literal|"Failed to publish segments"
argument_list|)
expr_stmt|;
if|if
condition|(
