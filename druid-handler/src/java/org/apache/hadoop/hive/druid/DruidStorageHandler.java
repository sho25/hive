...
name|postgresql
operator|.
name|PostgreSQLConnectorConfig
import|;
end_import
...
parameter_list|)
block|{
comment|// Reading password from configuration for backwards compatibility.
name|LOG
operator|.
name|warn
argument_list|(
literal|"Unable to retrieve password from credential providers. Trying to read it from config.."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Exception while deserializing druid query. Explain plan may not have final druid query"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// Case when we do not have any additional info to add.
return|return
name|initialProps
return|;
block|}
