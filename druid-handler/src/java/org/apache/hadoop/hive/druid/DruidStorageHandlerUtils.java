...
name|format
argument_list|(
literal|"Druid does not support decimal column type."
operator|+
literal|"Either cast column [%s] to double or Enable Approximate Result for Druid by setting property [%s] to true"
argument_list|,
name|columnNames
operator|.
name|get
