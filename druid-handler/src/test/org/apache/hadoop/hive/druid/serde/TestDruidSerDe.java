...
init|=
literal|"timestamp with local time zone,smallint,double,float"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
init|=
literal|"timestamp with local time zone,string,bigint,double,float"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
init|=
literal|"timestamp with local time zone,string,string,int,double,float"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|COLUMN_TYPES
init|=
literal|"timestamp with local time zone,string,char(6),varchar(8),double,float,decimal(38,18),bigint,int,smallint,tinyint"
decl_stmt|;
specifier|private
specifier|static
specifier|final
