...
name|byte
index|[]
name|topNQueryResults
decl_stmt|;
specifier|private
name|byte
index|[]
name|groupByQueryResults
decl_stmt|;
specifier|private
name|byte
index|[]
name|groupByTimeExtractQueryResults
decl_stmt|;
specifier|private
name|byte
index|[]
...
block|}
decl_stmt|;
comment|// Timeseries query results as records (types defined by metastore)
specifier|private
specifier|static
specifier|final
name|String
name|TIMESERIES_COLUMN_NAMES
init|=
literal|"timestamp,sample_name1,sample_name2,sample_divide"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|TIMESERIES_COLUMN_TYPES
init|=
literal|"timestamp with local time zone,bigint,float,float"
decl_stmt|;
comment|// TopN query
specifier|private
specifier|static
...
block|}
decl_stmt|;
comment|// TopN query results as records (types defined by metastore)
specifier|private
specifier|static
specifier|final
name|String
name|TOPN_COLUMN_NAMES
init|=
literal|"timestamp,sample_dim,count,some_metric,sample_divide"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|TOPN_COLUMN_TYPES
init|=
literal|"timestamp with local time zone,string,bigint,float,float"
decl_stmt|;
...
specifier|final
name|String
name|GB_TIME_EXTRACTIONS
init|=
literal|"{\"queryType\":\"groupBy\",\"dataSource\":\"sample_datasource\","
operator|+
literal|"\"granularity\":\"all\",\"dimensions\":"
operator|+
literal|"[{\"type\":\"extraction\",\"dimension\":\"__time\",\"outputName\":\"extract\",\"extractionFn\":"
operator|+
literal|"{\"type\":\"timeFormat\",\"format\":\"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'\",\"timeZone\":\"UTC\"}}],"
operator|+
literal|"\"limitSpec\":{\"type\":\"default\"},"
operator|+
literal|"\"aggregations\":[{\"type\":\"count\",\"name\":\"$f1\"}],"
operator|+
...
specifier|final
name|String
name|GB_TIME_EXTRACTIONS_RESULTS
init|=
literal|"[  "
operator|+
literal|" {  "
...
literal|"  \"event\" : {   "
operator|+
literal|"   \"extract\" : \"2012-01-01T00:00:00.000Z\",   "
operator|+
literal|"   \"$f1\" : 200"
operator|+
literal|"  } "
...
literal|"  \"event\" : {   "
operator|+
literal|"   \"extract\" : \"2012-01-01T00:00:12.000Z\",   "
operator|+
literal|"   \"$f1\" : 400"
operator|+
literal|"  }  "
...
specifier|final
name|String
name|GB_MONTH_EXTRACTIONS_RESULTS
init|=
literal|"[  "
operator|+
literal|" {  "
...
literal|"\"granularity\":\"all\","
operator|+
literal|"\"dimensions\":[{\"type\":\"extraction\",\"dimension\":\"__time\",\"outputName\":\"extract_month\","
operator|+
literal|"\"extractionFn\":{\"type\":\"timeFormat\",\"format\":\"M\",\"timeZone\":\"UTC\",\"locale\":\"en-US\"}}],"
operator|+
literal|"\"limitSpec\":{\"type\":\"default\"},\"aggregations\":[{\"type\":\"count\",\"name\":\"$f1\"}],"
operator|+
literal|"\"intervals\":[\"1900-01-01T00:00:00.000/3000-01-01T00:00:00.000\"]}"
decl_stmt|;
...
index|[]
index|[]
name|GROUP_BY_QUERY_EXTRACTION_RESULTS_RECORDS
init|=
operator|new
name|Object
index|[]
...
index|[]
index|[]
name|GB_MONTH_EXTRACTION_RESULTS_RECORDS
init|=
operator|new
name|Object
index|[]
...
block|}
decl_stmt|;
comment|// GroupBy query results as records (types defined by metastore)
specifier|private
specifier|static
specifier|final
name|String
name|GROUP_BY_COLUMN_NAMES
init|=
literal|"timestamp,country,device,total_usage,data_transfer,avg_usage"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|GROUP_BY_COLUMN_TYPES
init|=
literal|"timestamp with local time zone,string,string,bigint,double,float"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|GB_TIME_EXTRACTIONS_COLUMN_NAMES
init|=
literal|"timestamp,extract,$f1"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|GB_TIME_EXTRACTIONS_COLUMN_TYPES
init|=
literal|"timestamp with local time zone,timestamp with local time zone,bigint"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|GB_MONTH_EXTRACTIONS_COLUMN_NAMES
init|=
literal|"timestamp,extract_month,$f1"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|GB_MONTH_EXTRACTIONS_COLUMN_TYPES
init|=
literal|"timestamp with local time zone,int,bigint"
decl_stmt|;
...
literal|"   } ]  }} ]"
decl_stmt|;
comment|// Select query results as records (types defined by metastore)
specifier|private
specifier|static
specifier|final
name|String
...
init|=
literal|"__time,robot,namespace,anonymous,unpatrolled,page,language,newpage,user,count,added,delta,variation,deleted"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|COLUMN_NAMES
init|=
literal|"__time,c0,c1,c2,c3,c4,c5,c6,c7,c8"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|COLUMN_TYPES
init|=
literal|"timestamp with local time zone,string,char(6),varchar(8),double,float,bigint,int,smallint,tinyint"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
specifier|public
name|void
name|testDruidObjectSerializer
parameter_list|()
throws|throws
name|SerDeException
throws|,
...
specifier|public
name|void
name|testDruidObjectSerializerwithNullTimestamp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expectMessage
argument_list|(
literal|"Timestamp column cannot have null value"
argument_list|)
expr_stmt|;
comment|// should fail as timestamp is null
name|serializeObject
argument_list|(
name|tbl
argument_list|,
...
specifier|public
name|void
name|testDruidObjectDeserializer
parameter_list|()
throws|throws
name|SerDeException
throws|,
