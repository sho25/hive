...
argument_list|)
decl_stmt|;
comment|/*     final descriptor path is in the form tablePath/taskId_Attempt_ID/segmentDescriptorDir/segmentIdentifier.json     UUID.randomUUID() will fake the taskId_attemptID     */
name|Path
name|taskDirPath
init|=
operator|new
