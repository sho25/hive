...
argument_list|()
decl_stmt|;
comment|// TODO: security for output channel
name|Socket
name|socket
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// TODO: this is bogus. What does LLAP use this for?
name|ContainerId
name|containerId
init|=
name|ContainerId
...
parameter_list|)
block|{
comment|// TODO: why is this ignored?
name|TezTaskAttemptID
name|taskAttemptId
init|=
name|request
