...
return|;
block|}
comment|/*    * This particular instance is for Hadoop 1.0 which creates an archive    * with only the relative path of the archived directory stored within    * the archive as compared to the full path in case of earlier versions.    * See this api in Hadoop20Shims for comparison.    */
specifier|public
name|URI
name|getHarUri
parameter_list|(
...
return|;
block|}
comment|/**    * Create a delegation token object for the given token string and service.    * Add the token to given UGI    */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Add a given service to delegation token string.    */
annotation|@
name|Override
specifier|public
name|String
...
name|IOException
block|{
comment|//get delegation token for user
name|String
name|uname
init|=
name|UserGroupInformation
...
expr_stmt|;
block|}
comment|/**    * CombineFileInputFormat sometimes returns directories as splits, need to prune them.    */
specifier|private
specifier|static
name|Set
argument_list|<
