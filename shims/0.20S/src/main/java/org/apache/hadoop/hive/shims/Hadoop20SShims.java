...
name|IOException
argument_list|(
literal|"Cannot run Spark on YARN on current Hadoop, Version: "
operator|+
name|VersionInfo
operator|.
name|getVersion
...
name|forName
argument_list|(
literal|"org.apache.hadoop.tools.distcp2"
argument_list|)
decl_stmt|;
name|Constructor
name|c
...
name|IOException
block|{
comment|// Inefficient for direct buffers; only here for compat.
name|int
name|pos
init|=
name|dest
