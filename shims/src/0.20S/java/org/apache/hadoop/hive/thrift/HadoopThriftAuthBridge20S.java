...
argument_list|()
decl_stmt|;
comment|//A hack (127.0.1.1 is used as the remote address in case remoteAddr is null)
comment|//to make a testcase TestHadoop20SAuthBridge.testMetastoreProxyUser
comment|//pass. Once we have updated hive to have a thrift release with
comment|//THIFT-1053 in, we can remove the check for remoteAddr being null, and this
comment|//hack
name|ProxyUsers
operator|.
name|authorize
...
return|;
block|}
comment|//declare the field public so that testcases can set it to an explicit value
specifier|public
specifier|final
specifier|static
name|ThreadLocal
