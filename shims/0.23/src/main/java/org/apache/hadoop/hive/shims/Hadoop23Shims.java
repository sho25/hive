...
name|setInt
argument_list|(
literal|"tez.am.inline.task.execution.max-tasks"
argument_list|,
literal|6
argument_list|)
expr_stmt|;
...
name|setInt
argument_list|(
literal|"tez.runtime.io.sort.mb"
argument_list|,
literal|10
argument_list|)
expr_stmt|;
...
name|setInt
argument_list|(
literal|"tez.runtime.unordered.output.buffer.size-mb"
argument_list|,
literal|20
argument_list|)
expr_stmt|;
...
name|setFloat
argument_list|(
literal|"tez.runtime.shuffle.fetch.buffer.percent"
argument_list|,
literal|0.2f
argument_list|)
expr_stmt|;
...
name|setFloat
argument_list|(
literal|"tez.runtime.shuffle.memory.limit.percent"
argument_list|,
literal|0.2f
argument_list|)
expr_stmt|;
...
name|setFloat
argument_list|(
literal|"tez.runtime.task.input.post-merge.buffer.percent"
argument_list|,
literal|0f
argument_list|)
expr_stmt|;
...
name|forName
argument_list|(
literal|"org.apache.hadoop.tools.DistCp"
argument_list|)
decl_stmt|;
name|Constructor
name|c
...
name|IOException
argument_list|(
literal|"Cannot find DistCp class package: "
operator|+
name|e
operator|.
name|getMessage
...
name|IOException
argument_list|(
literal|"Cannot get DistCp constructor: "
operator|+
name|e
operator|.
name|getMessage
