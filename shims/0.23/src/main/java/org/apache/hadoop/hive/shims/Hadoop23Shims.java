...
name|UnsupportedOperationException
argument_list|(
literal|"No JobTracker port for local mode"
argument_list|)
throw|;
block|}
annotation|@
...
name|TezConfiguration
operator|.
name|TEZ_IGNORE_LIB_URIS
argument_list|,
literal|true
argument_list|)
expr_stmt|;
comment|// TODO Force fs to file://, setup staging dir?
comment|//      conf.set("fs.defaultFS", "file:///");
comment|//      conf.set(TezConfiguration.TEZ_AM_STAGING_DIR, "/tmp");
if|if
condition|(
operator|!
name|isLlap
...
argument_list|)
expr_stmt|;
comment|// Overrides values from the hive/tez-site.
name|conf
operator|.
name|setInt
argument_list|(
...
name|TezConfiguration
operator|.
name|TEZ_TASK_RESOURCE_MEMORY_MB
argument_list|,
literal|128
argument_list|)
expr_stmt|;
...
name|TezRuntimeConfiguration
operator|.
name|TEZ_RUNTIME_UNORDERED_OUTPUT_BUFFER_SIZE_MB
argument_list|,
literal|10
argument_list|)
expr_stmt|;
...
name|TezRuntimeConfiguration
operator|.
name|TEZ_RUNTIME_SHUFFLE_FETCH_BUFFER_PERCENT
argument_list|,
literal|0.4f
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// -update and -delete are mandatory options for directory copy to work.
comment|// -pbx is default preserve options if user doesn't pass any.
name|List
argument_list|<
name|String
argument_list|>
...
block|{
return|return
name|equivalentEncryptionZones
argument_list|(
name|getEncryptionZoneForPath
argument_list|(
name|path1
...
name|warn
argument_list|(
literal|"EncryptionShim for path2 ("
operator|+
name|path2
operator|+
literal|") is of unexpected type: "
operator|+
name|encryptionShim2
operator|.
name|getClass
argument_list|()
operator|+
literal|". Assuming path2 is on the same EncryptionZone as path1("
operator|+
name|path1
operator|+
literal|")."
...
return|;
block|}
comment|/**      * Compares two encryption key strengths.      *      * @param path1 First  path to compare      * @param path2 Second path to compare      * @return 1 if path1 is stronger; 0 if paths are equals; -1 if path1 is weaker.      * @throws IOException If an error occurred attempting to get key metadata      */
annotation|@
name|Override
specifier|public
name|int
...
block|}
block|}
comment|/**      * Compares two encryption key strengths.      *      * @param zone1 First  EncryptionZone to compare      * @param zone2 Second EncryptionZone to compare      * @return 1 if zone1 is stronger; 0 if zones are equal; -1 if zone1 is weaker.      * @throws IOException If an error occurred attempting to get key metadata      */
specifier|private
name|int
name|compareKeyStrength
parameter_list|(
...
name|IOException
block|{
comment|// zone1, zone2 should already have been checked for nulls.
assert|assert
name|zone1
operator|!=
literal|null
...
literal|null
operator|:
literal|"Neither EncryptionZone under comparison can be null."
assert|;
name|CipherSuite
name|suite1
init|=
...
specifier|static
name|Boolean
name|hdfsErasureCodingSupport
decl_stmt|;
comment|/**    * @return true if the runtime version of hdfs supports erasure coding    */
specifier|private
specifier|static
specifier|synchronized
name|boolean
name|isHdfsErasureCodingSupported
parameter_list|()
block|{
if|if
condition|(
...
parameter_list|)
block|{
comment|// This version of Hadoop does not support HdfsAdmin.getErasureCodingPolicies().
comment|// Hadoop 3.0.0 introduces this new method.
block|}
name|hdfsErasureCodingSupport
operator|=
operator|(
...
name|HadoopShims
operator|.
name|NoopHdfsErasureCodingShim
argument_list|()
return|;
block|}
comment|/**    * Information about an Erasure Coding Policy.    */
specifier|private
specifier|static
class|class
name|HdfsFileErasureCodingPolicyImpl
implements|implements
...
block|}
block|}
comment|/**    * This class encapsulates methods used to get Erasure Coding information from    * HDFS paths in order to to provide commands similar to those provided by the hdfs ec command.    * https://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-hdfs/HDFSErasureCoding.html    */
specifier|public
specifier|static
class|class
name|HdfsErasureCodingShim
...
expr_stmt|;
block|}
comment|/**      * Lists all (enabled, disabled and removed) erasure coding policies registered in HDFS.      * @return a list of erasure coding policies      */
annotation|@
name|Override
specifier|public
name|List
...
return|;
block|}
comment|/**      * Enable an erasure coding policy.      * @param ecPolicyName the name of the erasure coding policy      */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Sets an erasure coding policy on a directory at the specified path.      * @param path a directory in HDFS      * @param ecPolicyName the name of the erasure coding policy      */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Get details of the erasure coding policy of a file or directory at the specified path.      * @param path an hdfs file or directory      * @return an erasure coding policy      */
annotation|@
name|Override
specifier|public
name|HdfsFileErasureCodingPolicy
...
return|;
block|}
comment|/**      * Unset an erasure coding policy set by a previous call to setPolicy on a directory.      * @param path a directory in HDFS      */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Remove an erasure coding policy.      * @param ecPolicyName the name of the erasure coding policy      */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Disable an erasure coding policy.      * @param ecPolicyName the name of the erasure coding policy      */
annotation|@
name|Override
specifier|public
name|void
...
parameter_list|()
block|{
comment|// Look for FileSystemCounter.BYTES_READ_EC, this is present in hadoop 3.2
name|Field
name|field
init|=
literal|null
...
parameter_list|)
block|{
comment|// This version of Hadoop does not support EC stats for MR
block|}
return|return
operator|(
name|field
