...
block|,
name|TestColumnScalarOperationVectorExpressionCheckedEvaluation
block|,
name|TestColumnScalarFilterVectorExpressionEvaluation
block|,
name|TestColumnColumnOperationVectorExpressionEvaluation
block|,
name|TestColumnColumnOperationVectorExpressionCheckedEvaluation
block|,
...
argument_list|)
operator|+
name|createOutputTypeInfoFragment
argument_list|(
literal|"Ret"
argument_list|,
name|outputTypeInfo
...
argument_list|(
literal|"Received null input for the identifier"
argument_list|)
throw|;
block|}
switch|switch
...
name|RuntimeException
argument_list|(
literal|"Unsupported input typeInfo "
operator|+
name|outputTypeInfo
argument_list|)
throw|;
