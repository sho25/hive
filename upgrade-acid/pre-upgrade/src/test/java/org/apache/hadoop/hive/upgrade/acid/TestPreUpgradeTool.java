...
name|is
argument_list|(
literal|"ALTER TABLE default.tacid COMPACT 'major';"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|is
argument_list|(
literal|"ALTER TABLE default.tacidpart PARTITION(p=10Y) COMPACT 'major';"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// Check whether compaction was successful in the first run
name|File
name|secondRunDataDir
init|=
operator|new
name|File
argument_list|(
...
specifier|public
name|void
name|testOnlyFilteredDatabasesAreUpgradedWhenRegexIsGiven
parameter_list|()
throws|throws
name|Exception
block|{
...
operator|+
name|INCLUDE_TABLE_NAME
operator|+
literal|" (a int, b int) clustered by (b) "
operator|+
literal|"into 2 buckets stored as orc TBLPROPERTIES ('transactional'='true')"
argument_list|)
expr_stmt|;
name|runStatementOnDriver
argument_list|(
...
name|is
argument_list|(
literal|"ALTER TABLE dinclude.tinclude COMPACT 'major';"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|public
name|void
name|testOnlyFilteredTablesAreUpgradedWhenRegexIsGiven
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|" (a int, b int) "
operator|+
literal|"clustered by (b) "
operator|+
literal|"into 10 buckets "
operator|+
