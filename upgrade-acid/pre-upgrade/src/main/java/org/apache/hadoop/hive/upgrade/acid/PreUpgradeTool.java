...
literal|"d"
argument_list|,
literal|"Regular expression to match database names on which this tool will be run. Default: all databases"
argument_list|)
decl_stmt|;
name|dbRegexOption
operator|.
...
literal|"t"
argument_list|,
literal|"Regular expression to match table names on which this tool will be run. Default: all tables"
argument_list|)
decl_stmt|;
name|tableRegexOption
operator|.
...
name|format
argument_list|(
literal|"Table type to match tables on which this tool will be run. Possible values: %s "
operator|+
literal|"Default: all tables"
argument_list|,
name|Arrays
operator|.
name|stream
...
name|info
argument_list|(
literal|"acid is off, there can't be any acid tables - nothing to compact"
argument_list|)
expr_stmt|;
return|return;
block|}
