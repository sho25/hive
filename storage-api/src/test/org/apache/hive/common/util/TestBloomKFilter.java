...
argument_list|)
decl_stmt|;
comment|// bloom-1 is known to have higher fpp, to make tests pass give room for another 3%
specifier|private
specifier|final
name|double
name|deltaError
...
specifier|public
name|void
name|testMergeBloomKFilterBytes
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testMergeBloomKFilterBytesFailureCases
parameter_list|()
throws|throws
name|Exception
block|{
