...
expr_stmt|;
block|}
comment|/**    * Set a field from a HiveIntervalDayTime.    *    * This is a FAST version that assumes the caller has checked to make sure the sourceBuf    * is not null and elementNum is correctly adjusted for isRepeating.  And, that the isNull entry    * has been set.  Only the output entry fields will be set by this method.    *    * @param elementNum    * @param intervalDayTime    */
specifier|public
name|void
name|set
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Set a field from the current value in the scratch interval day time.    *    * This is a FAST version that assumes the caller has checked to make sure the scratch interval    * day time is valid and elementNum is correctly adjusted for isRepeating.  And, that the isNull    * entry has been set.  Only the output entry fields will be set by this method.    *    * @param elementNum    */
specifier|public
name|void
