...
name|debug
argument_list|(
literal|"Error while retrieving literalList, returning null"
argument_list|,
name|err
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// Give it a pass. Optionally, have LiteralDelegate provide a getLiteralClass() to check.
operator|(
operator|(
name|LiteralDelegate
operator|)
...
parameter_list|)
block|{
comment|// The leaves could be shared in the tree. Use Set to remove the duplicates.
name|Set
argument_list|<
name|ExpressionTree
argument_list|>
...
block|}
block|}
comment|// Update the leaf in place
for|for
control|(
name|ExpressionTree
name|leaf
