...
return|;
block|}
comment|/**    * Return a string representation of the number with the number of decimal digits as    * the given scale. Please note that this is different from toString().    * @param scale the number of digits after the decimal point    * @return the string representation of exact number of decimal digits    */
annotation|@
name|HiveDecimalVersionV1
specifier|public
name|String
...
return|;
block|}
comment|/**      * Specially handling the case that bd=0, and we are converting it to a type where precision=scale,      * such as decimal(1, 1).      */
if|if
condition|(
name|bd
operator|.
