...
begin_comment
comment|/**  * An implementation of {@link ValidWriteIdList} for use by readers.  * This class will view a write id as valid only if it maps to committed transaction.  * Write ids of both open and aborted transactions will be seen as invalid.  */
end_comment
...
name|tableName
decl_stmt|;
comment|// Full table name of format<db_name>.<table_name>
specifier|protected
name|long
index|[]
name|exceptions
...
name|abortedBits
decl_stmt|;
comment|// BitSet for flagging aborted write ids. Bit is true if aborted, false if open
comment|//default value means there are no open write ids in the snapshot
specifier|private
name|long
name|minOpenWriteId
init|=
...
expr_stmt|;
block|}
comment|/**    * Used if there are no open write ids in the snapshot.    */
specifier|public
name|ValidReaderWriteIdList
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * We cannot use a base file if its range contains an open write id.    * @param writeId from base_xxxx    */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|// Format is<table_name>:<hwm>:<minOpenWriteId>:<open_writeids>:<abort_writeids>
annotation|@
name|Override
specifier|public
name|String
...
argument_list|)
expr_stmt|;
comment|// separator for open write ids
name|buf
operator|.
name|append
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// separator for aborted write ids
block|}
else|else
block|{
name|StringBuilder
