...
name|ROUND_HALF_UP
decl_stmt|;
comment|/**    * ROUND_HALF_EVEN:    *   Round towards the "nearest neighbor" unless both neighbors are equidistant, then round    *   towards the even neighbor.    *<p>    *   The Hive function is BROUND.    *<p>    *   Known as Banker’s Rounding.    *<p>    *   When you add values rounded with ROUND_HALF_UP you have a bias that grows as you add more    *   numbers.  Banker's Rounding is a way to minimize that bias.  It rounds toward the nearest    *   even number when the fraction is 0.5 exactly.  In table below, notice that 2.5 goes DOWN to    *   2 (even) but 3.5 goes UP to 4 (even), etc.    *<p>    *   So, the sign is irrelevant.    *<p>    *       (Example here rounds at scale 0)    *       Value        BROUND                  Value        BROUND    *        0.49          0                     -0.49          0    *        0.5           0                     -0.5           0    *        0.51          1                     -0.51         -1    *        1.5           2                     -1.5          -2    *        2.5           2                     -2.5          -2    *        2.51          3                     -2.51         -3    *        3.5           4                     -3.5          -4    *        4.5           4                     -4.5          -4    *        4.51          5                     -4.51         -5    *    */
annotation|@
name|HiveDecimalVersionV1
specifier|public
specifier|static
