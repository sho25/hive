...
parameter_list|)
function_decl|;
comment|/**    * Releases the buffer returned by getFileData/provided to putFileData back to cache.    * See respective javadocs for details.    */
name|void
name|releaseBuffer
parameter_list|(
name|MemoryBuffer
...
parameter_list|)
function_decl|;
comment|/**    * Notifies the cache that the buffer returned from getFileData/provided to putFileData will    * be used by another consumer and therefore released multiple times (one more time per call).    */
name|void
name|reuseBuffer
parameter_list|(
name|MemoryBuffer
...
parameter_list|)
function_decl|;
comment|/**    * Gets the allocator associated with this DataCache.    */
name|Allocator
name|getAllocator
parameter_list|()
function_decl|;
