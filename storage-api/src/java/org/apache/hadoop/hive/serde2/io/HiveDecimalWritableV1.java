...
return|;
block|}
comment|/**    * Get a OldHiveDecimal instance from the writable and constraint it with maximum precision/scale.    *    * @param maxPrecision maximum precision    * @param maxScale maximum scale    * @return OldHiveDecimal instance    */
annotation|@
name|HiveDecimalWritableVersionV1
specifier|public
name|HiveDecimalV1
