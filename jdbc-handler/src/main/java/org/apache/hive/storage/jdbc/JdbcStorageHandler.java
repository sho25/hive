...
name|debug
argument_list|(
literal|"Adding properties to input job conf"
argument_list|)
expr_stmt|;
name|Properties
name|properties
...
name|debug
argument_list|(
literal|"Adding secrets to input job conf"
argument_list|)
expr_stmt|;
name|Properties
name|properties
...
argument_list|)
expr_stmt|;
comment|// Adding mysql jdbc driver if exists
try|try
block|{
name|classesToLoad
operator|.
...
parameter_list|)
block|{     }
comment|// Adding postgres jdbc driver if exists
try|try
block|{
name|classesToLoad
operator|.
...
parameter_list|)
block|{     }
comment|// Adding oracle jdbc driver if exists
try|try
block|{
name|classesToLoad
operator|.
...
parameter_list|)
block|{     }
comment|// Adding mssql jdbc driver if exists
try|try
block|{
name|classesToLoad
operator|.
...
name|error
argument_list|(
literal|"Could not add necessary JDBC storage handler dependencies to classpath"
argument_list|,
name|e
argument_list|)
expr_stmt|;
