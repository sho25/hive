...
argument_list|(
literal|"Table name should be defined"
argument_list|)
throw|;
block|}
name|Connection
...
block|}
block|}
comment|/**    * Constructs the query used as the prepared statement to insert data.    *    * @param table    *          the table to insert into    * @param columnNames    *          the columns to insert into    */
specifier|protected
name|String
name|constructQuery
parameter_list|(
