...
argument_list|)
decl_stmt|;
comment|// Extract information from properties
name|String
index|[]
name|jdbcColumnNamesArray
decl_stmt|;
name|List
argument_list|<
name|TypeInfo
argument_list|>
name|hiveColumnTypesArray
decl_stmt|;
if|if
condition|(
name|properties
...
block|{
comment|// The query was hardcoded by user or we are creating the table.
comment|// We obtain the column names with the db accessor.
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// These are the column names for the table defined with the JDBC storage handler.
name|jdbcColumnNamesArray
operator|=
name|parseProperty
argument_list|(
...
name|length
operator|+
literal|" hiveColumnNames. Table definition has "
operator|+
name|jdbcColumnNamesArray
operator|.
name|length
operator|+
literal|" hiveColumnNames"
argument_list|)
throw|;
block|}
name|hiveColumnTypesArray
