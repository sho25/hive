...
condition|)
block|{
comment|// The query has been specified by user, extract column names
name|hiveColumnNames
operator|=
name|properties
operator|.
...
block|{
comment|// Table is specified, we need to get the column names from the accessor due to capitalization
name|hiveColumnNames
operator|=
name|dbAccessor
operator|.
...
argument_list|)
expr_stmt|;
comment|// Number should be equal to list of columns
if|if
condition|(
name|hiveColumnNames
operator|.
...
name|SerDeException
argument_list|(
literal|"Column numbers do not match. "
operator|+
literal|"Remote table columns are "
operator|+
name|Arrays
operator|.
name|toString
...
argument_list|)
operator|+
literal|" and declared table columns in Hive "
operator|+
literal|"external table are "
operator|+
name|Arrays
operator|.
name|toString
...
name|trace
argument_list|(
literal|"Serializing from SerDe"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|format
argument_list|(
literal|"Required %d columns, received %d."
argument_list|,
name|numColumns
argument_list|,
operator|(
