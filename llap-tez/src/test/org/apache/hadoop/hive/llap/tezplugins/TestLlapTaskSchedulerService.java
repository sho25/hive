...
specifier|public
name|void
name|testFallbackAllocationOrderedNext
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
expr_stmt|;
comment|// 1st task provided unknown host location, it should be assigned first host
name|assertEquals
argument_list|(
name|hostsKnown
index|[
...
argument_list|)
expr_stmt|;
comment|// 2nd task provided host1 as location preference, it should be assigned host1 as it has capacity
name|assertEquals
argument_list|(
name|hostsKnown
index|[
...
argument_list|)
expr_stmt|;
comment|// 3rd task provided no location preference, it is tried with host1 but it is full, so gets assigned host2
name|assertEquals
argument_list|(
name|hostsKnown
index|[
