...
name|LLAP_DAEMON_PREFIX
operator|+
literal|"yarn.container.mb"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|int
name|LLAP_DAEMON_YARN_CONTAINER_MB_DEFAULT
init|=
operator|-
literal|1
decl_stmt|;
...
name|LLAP_DAEMON_PREFIX
operator|+
literal|"am.liveness.heartbeat.interval-ms"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|long
name|LLAP_DAEMON_AM_LIVENESS_HEARTBEAT_INTERVAL_MS_DEFAULT
init|=
literal|10000l
decl_stmt|;
comment|/**    * Amount of time to wait on connection failures to the AM from an LLAP daemon before considering    * the AM to be dead    */
specifier|public
specifier|static
specifier|final
name|String
name|LLAP_DAEMON_AM_LIVENESS_CONNECTION_TIMEOUT_MILLIS
init|=
name|LLAP_PREFIX
operator|+
literal|"am.liveness.connection.timeout-millis"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|long
name|LLAP_DAEMON_AM_LIVENESS_CONNECTION_TIMEOUT_MILLIS_DEFAULT
init|=
literal|10000l
decl_stmt|;
comment|// Not used yet - since the Writable RPC engine does not support this policy.
comment|/**    * Sleep duration while waiting to retry connection failures to the AM from the daemon for the    * general keep-alive thread    */
specifier|public
specifier|static
specifier|final
name|String
name|LLAP_DAEMON_AM_LIVENESS_CONNECTION_SLEEP_BETWEEN_RETRIES_MILLIS
init|=
name|LLAP_PREFIX
operator|+
literal|"am.liveness.connection.sleep-between-retries-millis"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|long
name|LLAP_DAEMON_AM_LIVENESS_CONNECTION_SLEEP_BETWEEN_RETRIES_MILLIS_DEFAULT
init|=
literal|2000l
decl_stmt|;
...
specifier|final
name|String
name|LLAP_DAEMON_WAIT_QUEUE_SCHEDULER_CLASS_NAME
init|=
name|LLAP_DAEMON_PREFIX
operator|+
literal|"wait.queue.comparator.class.name"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|LLAP_DAEMON_WAIT_QUEUE_SCHEDULER_CLASS_NAME_DEFAULT
init|=
