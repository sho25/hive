...
specifier|final
name|String
name|LLAP_DAEMON_TASK_SCHEDULER_WAIT_QUEUE_FAIR_ORDERING
init|=
name|LLAP_DAEMON_PREFIX
operator|+
literal|"task.scheduler.wait.queue.fair.ordering"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|boolean
name|LLAP_DAEMON_TASK_SCHEDULER_WAIT_QUEUE_FAIR_ORDERING_DEFAULT
init|=
literal|false
decl_stmt|;
specifier|public
