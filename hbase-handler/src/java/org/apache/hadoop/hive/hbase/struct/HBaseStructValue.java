...
begin_comment
comment|/**  * This is an extension of LazyStruct. All value structs should extend this class and override the  * {@link LazyStruct#getField(int)} method where fieldID corresponds to the ID of a value in the  * value structure.  *<br>  * For example, for a value structure<i>"/part1/part2/part3"</i>,<i>part1</i> will have an id  *<i>0</i>,<i>part2</i> will have an id<i>1</i> and<i>part3</i> will have an id<i>2</i>. Custom  * implementations of getField(fieldID) should return the value corresponding to that fieldID. So,  * for the above example, the value returned for<i>getField(0)</i> should be<i>part1</i>,  *<i>getField(1)</i> should be<i>part2</i> and<i>getField(2)</i> should be<i>part3</i>.  *  *<br>  * All implementation are expected to have a constructor of the form<br>  *  *<pre>  * MyCustomStructObject(LazySimpleStructObjectInspector oi, Properties props, Configuration conf, ColumnMapping colMap)  *</pre>  *   * */
end_comment
