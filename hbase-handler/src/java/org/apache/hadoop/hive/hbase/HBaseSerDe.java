...
argument_list|)
expr_stmt|;
comment|// initialize the byte [] corresponding to each column name
name|hbaseColumnNamesBytes
operator|=
name|initColumnNamesBytes
argument_list|(
...
comment|// we just can make sure that "column-family:" is mapped to MAP<String,?>
for|for
control|(
name|int
name|i
...
return|;
block|}
comment|/**    * Serialize the row into a ByteStream.    *    * @param obj           The object for the current field.    * @param objInspector  The ObjectInspector for the current Object.    * @param level         The current level of separator.    * @throws IOException    * @return true, if serialize is a not-null object; otherwise false.    */
specifier|private
name|boolean
name|serialize
parameter_list|(
