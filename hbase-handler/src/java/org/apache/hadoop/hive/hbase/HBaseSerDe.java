...
argument_list|)
decl_stmt|;
comment|// Parse the HBase columns mapping and initialize the col family& qualifiers
name|hbaseColumnFamilies
operator|=
operator|new
name|ArrayList
...
comment|// check that the "column-family:" is mapped to MAP<String,?>
for|for
control|(
name|int
name|i
