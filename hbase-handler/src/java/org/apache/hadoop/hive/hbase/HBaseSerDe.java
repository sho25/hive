...
argument_list|)
decl_stmt|;
comment|// Initialize the hbase column list
name|hbaseColumnNames
operator|=
name|parseColumnMapping
argument_list|(
...
condition|)
block|{
comment|// a special column becomes a STRING
name|sb
operator|.
name|append
argument_list|(
