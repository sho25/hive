...
return|;
block|}
comment|// Hive doesn't have a Fixed type, so we're going to treat them as arrays of
comment|// bytes
comment|// TODO: Make note in documentation that Hive sends these out as signed bytes.
specifier|private
specifier|static
specifier|final
name|TypeInfo
name|FIXED_AND_BYTES_EQUIV
init|=
name|TypeInfoFactory
operator|.
name|getListTypeInfo
...
return|;
block|}
comment|// Avro considers bytes to be a primitive type, but Hive doesn't.  We'll
comment|// convert them to a list of bytes, just like Fixed.  Sigh.
specifier|private
specifier|static
name|TypeInfo
name|generateBytesTypeInfo
