...
literal|0
expr_stmt|;
comment|// Set "global" separator member to next level.
name|currentLevel
operator|++
expr_stmt|;
block|}
...
argument_list|()
expr_stmt|;
comment|// MAP requires 2 levels: key separator and key-pair separator.
name|currentLevel
operator|++
expr_stmt|;
block|}
...
parameter_list|()
block|{
comment|// Remove MAP extra level.
name|currentLevel
operator|--
expr_stmt|;
name|finishComplex
