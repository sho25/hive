...
expr_stmt|;
block|}
comment|/* (non-Javadoc)    * This provides a LazyFloat like class which can be initialized from data stored in a    * binary format.    *    * @see org.apache.hadoop.hive.serde2.lazy.LazyObject#init    *        (org.apache.hadoop.hive.serde2.lazy.ByteArrayRef, int, int)    */
annotation|@
name|Override
specifier|public
name|void
