...
return|;
block|}
comment|/**    * This enum controls how we copy primitive objects.    *     * KEEP means keeping the original format of the primitive object. This is usually the most efficient.     * JAVA means converting all primitive objects to java primitive objects.    * WRITABLE means converting all primitive objects to writable objects.     *    */
specifier|public
enum|enum
