...
block|}
block|}
comment|/**    * Write out the text representation of a Primitive Object to a UTF8 byte stream.     * @param out  The UTF8 byte OutputStream    * @param o    The primitive Object    */
specifier|public
specifier|static
name|void
...
break|break;
block|}
comment|// TODO: We should enable this piece of code, once we pass ObjectInspector in the Operator.init()
comment|// instead of Operator.forward().  Until then, JoinOperator will assume the output columns are
comment|// all strings but they may not be.
