...
return|;
block|}
comment|// parse the struct using multi-char delimiter
specifier|public
name|void
...
expr_stmt|;
block|}
comment|// the indexes of the delimiters
name|int
index|[]
name|delimitIndexes
init|=
...
expr_stmt|;
block|}
comment|// find all the indexes of the sub byte[]
specifier|private
name|int
index|[]
name|findIndexes
