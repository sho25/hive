...
return|;
block|}
comment|// invariant: rightLength = leftLength
comment|// rightOffset is within the buffers
name|byte
index|[]
name|rightBuffer
init|=
...
comment|// bounds check first, to trigger bugs whether the first byte matches or not
if|if
condition|(
name|left
index|[
...
return|;
block|}
comment|/**    * Compares the current readPosition of the buffer with the external byte array.    * Does not modify readPoint.    */
specifier|public
name|boolean
name|isEqual
parameter_list|(
