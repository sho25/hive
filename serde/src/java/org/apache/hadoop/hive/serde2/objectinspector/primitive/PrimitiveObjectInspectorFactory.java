...
specifier|static
specifier|final
name|JavaTimestampLocalTZObjectInspector
...
return|return
operator|new
name|WritableConstantTimestampLocalTZObjectInspector
argument_list|(
operator|(
name|TimestampLocalTZTypeInfo
operator|)
...
return|return
operator|new
name|WritableConstantHiveIntervalYearMonthObjectInspector
argument_list|(
operator|(
name|HiveIntervalYearMonthWritable
operator|)
...
return|return
operator|new
name|WritableConstantHiveIntervalDayTimeObjectInspector
argument_list|(
operator|(
name|HiveIntervalDayTimeWritable
operator|)
