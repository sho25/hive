...
return|;
block|}
comment|/**    * If the union schema is a nullable union, get the schema for the non-nullable type.    * This method does no checking that the provided Schema is nullable. If the provided    * union schema is non-nullable, it simply returns the union schema    */
specifier|public
specifier|static
name|Schema
...
block|}
block|}
comment|/**    * Called on specific alter table events, removes schema url and schema literal from given tblproperties    * After the change, HMS solely will be responsible for handling the schema    *    * @param conf    * @param serializationLib    * @param parameters    */
specifier|public
specifier|static
name|void
...
name|RuntimeException
argument_list|(
literal|"Not allowed to alter schema of Avro stored table having external schema."
operator|+
