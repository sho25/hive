...
block|}
block|}
comment|/**    * Parses a boolean from string    *    * Accepts "false","off","no","0" and "" as FALSE    * All other values are interpreted as true.    */
specifier|public
specifier|static
name|boolean
name|parseBoolean
...
argument_list|)
expr_stmt|;
comment|// Handle simpler cases directly avoiding exceptions
try|try
block|{
if|if
condition|(
...
return|;
block|}
comment|// If a timestamp does not have a space, then it is likely zoned time.
if|if
condition|(
name|s
operator|.
