...
init|=
literal|"hive.io.file.readNestedColumn.paths"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
specifier|final
name|String
name|READ_NESTED_COLUMN_PATH_CONF_STR_DEFAULT
init|=
literal|""
decl_stmt|;
specifier|private
...
return|;
block|}
comment|/**    * Sets the<em>READ_ALL_COLUMNS</em> flag to false and overwrites column ids    * with the provided list.    */
specifier|public
specifier|static
name|void
name|setReadColumns
...
expr_stmt|;
block|}
comment|/**    * Appends read nested column's paths. Once a read nested column path    * is included in the list, a underlying record reader of a columnar file format    * (e.g. Parquet and ORC) can know what columns are needed.    */
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
name|setReadNestedColumnPathConf
argument_list|(
name|conf
argument_list|,
name|newConfStr
