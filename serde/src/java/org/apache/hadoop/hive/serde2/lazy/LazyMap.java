...
name|warn
argument_list|(
literal|"skipped empty entry or entry with empty key in the representation of column with MAP type."
argument_list|)
expr_stmt|;
comment|//reset keyInited[mapSize] flag, since it may be set to true in the case of previous empty entry
name|keyInited
index|[
name|mapSize
index|]
