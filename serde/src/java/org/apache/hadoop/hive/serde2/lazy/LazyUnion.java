...
literal|false
decl_stmt|;
comment|/**    * Whether the tag has been set or not    * */
specifier|private
name|boolean
name|tagSet
init|=
...
return|;
block|}
comment|/**    * Set the field of the union    *    * @param field the field to be set    * */
specifier|public
name|void
name|setField
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Set the tag for the union    *    * @param tag the tag to be set    * */
specifier|public
name|void
name|setTag
parameter_list|(
