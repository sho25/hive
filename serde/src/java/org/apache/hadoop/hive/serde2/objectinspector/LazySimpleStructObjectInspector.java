...
begin_comment
comment|/**  * LazySimpleStructObjectInspector works on struct data that is stored in LazyStruct.  * It only supports primitive types as its fields for simplicity and efficiency.   *   * The names of the struct fields and the internal structure of the struct fields  * are specified in the ctor of the LazySimpleStructObjectInspector.  *   * Always use the ObjectInspectorFactory to create new ObjectInspector objects, instead  * of directly creating an instance of this class.  */
end_comment
