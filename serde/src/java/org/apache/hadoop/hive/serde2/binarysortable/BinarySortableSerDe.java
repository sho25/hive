...
case|:
block|{
comment|// decimals are encoded in three pieces:
comment|// sign: 1, 2 or 3 for smaller, equal or larger than 0 respectively
comment|// factor: Number that indicates the amount of digits you have to move
comment|// the decimal point left or right until the resulting number is smaller
comment|// than zero but has something other than 0 as the first digit.
comment|// digits: which is a string of all the digits in the decimal. If the number
comment|// is negative the binary string will be inverted to get the correct ordering.
comment|// Example: 0.00123
comment|// Sign is 3 (bigger than 0)
comment|// Factor is -2 (move decimal point 2 positions right)
comment|// Digits are: 123
name|HiveDecimalObjectInspector
name|boi
init|=
operator|(
