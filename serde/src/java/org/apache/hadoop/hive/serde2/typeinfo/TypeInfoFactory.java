...
argument_list|)
decl_stmt|;
comment|// Create params if there are any
if|if
condition|(
name|parts
operator|.
...
condition|)
block|{
comment|// The type string came with parameters.  Parse and add to TypeInfo
try|try
block|{
name|BaseTypeParams
name|typeParams
...
name|RuntimeException
argument_list|(
literal|"Error creating type parameters for "
operator|+
name|typeName
operator|+
literal|": "
...
argument_list|)
decl_stmt|;
comment|// Disallow usage of varchar without length specifier.
comment|//public static final TypeInfo varcharTypeInfo = getPrimitiveTypeInfo(serdeConstants.VARCHAR_TYPE_NAME);
specifier|public
specifier|static
specifier|final
name|TypeInfo
