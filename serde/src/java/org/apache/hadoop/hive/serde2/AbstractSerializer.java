...
begin_comment
comment|/**  * Abstract class for implementing Serializer. The abstract class has been created, so that  * new methods can be added in the underlying interface, Serializer, and only implementations  * that need those methods overwrite it.  */
end_comment
