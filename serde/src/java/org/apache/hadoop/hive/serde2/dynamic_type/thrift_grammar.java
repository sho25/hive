...
comment|// separately because one cannot use a table (ie service.method) as a Struct like type.
specifier|protected
name|Map
argument_list|<
name|String
...
block|}
decl_stmt|;
comment|// need three params to differentiate between this and 2 param method auto generated since
comment|// some calls in the autogenerated code use null param for 2nd param and thus ambiguous.
specifier|protected
name|thrift_grammar
parameter_list|(
name|InputStream
...
block|}
block|}
comment|// nothing special - just use the DynamicSerDeFieldList's children methods to access the fields
specifier|final
specifier|public
...
block|}
block|}
comment|// lookup the specified type and set this nodes type to it. Precludes forward and self references for now.
name|jjtn000
operator|.
name|jjtAddChild
argument_list|(
