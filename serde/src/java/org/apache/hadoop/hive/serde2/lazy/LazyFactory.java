...
return|;
block|}
comment|/**    * Create a hierarchical ObjectInspector for ColumnarStruct with the given    * columnNames and columnTypeInfos.    *     * @see LazyFactory#createLazyObjectInspector(TypeInfo, byte[], int, Text)    */
specifier|public
specifier|static
name|ObjectInspector
