...
expr_stmt|;
block|}
comment|/**    * Serialize a struct object without writing the byte size. This function is    * shared by both row serialization and struct serialization.    *    * @param byteStream    *          the byte stream storing the serialization data    * @param obj    *          the struct object to serialize    * @param objInspector    *          the struct object inspector    * @param warnedOnceNullMapKey a boolean indicating whether a warning    *          has been issued once already when encountering null map keys    * @return a boolean indicating whether a warning for null map keys has been issued    *          once already    * @throws SerDeException     */
specifier|private
specifier|static
name|boolean
name|serializeStruct
