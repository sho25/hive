...
expr_stmt|;
block|}
comment|/**    *    * Allocate scratchLongs with HiveDecimal.SCRATCH_LONGS_LEN longs.    * And, allocate scratch buffer with HiveDecimal.SCRATCH_BUFFER_LEN_BIG_INTEGER_BYTES bytes.    *    * @param byteStream    * @param dec    * @param scratchLongs    * @param scratchBytes    * @param scratchLongBytes    */
specifier|public
specifier|static
name|void
name|writeToByteStream
