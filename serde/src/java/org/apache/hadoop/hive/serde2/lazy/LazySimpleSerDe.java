...
name|serdeParams
operator|+
literal|", cachedObjectInspector="
operator|+
name|cachedObjectInspector
operator|+
literal|", serializedSize="
operator|+
name|serializedSize
operator|+
literal|", stats="
...
name|stats
operator|+
literal|", lastOperationSerialize="
operator|+
name|lastOperationSerialize
operator|+
literal|", lastOperationDeserialize="
operator|+
name|lastOperationDeserialize
argument_list|)
expr_stmt|;
...
name|SerDeException
block|{   }
comment|/**    * Initialize the SerDe given the parameters. serialization.format: separator    * char or byte code (only supports byte-value up to 127) columns:    * ","-separated column names columns.types: ",", ":", or ";"-separated column    * types    *    * @see  org.apache.hadoop.hive.serde2.AbstractSerDe#initialize(Configuration, Properties)    */
annotation|@
name|Override
specifier|public
name|void
...
name|byteArrayRef
decl_stmt|;
comment|/**    * Deserialize a row from the Writable to a LazyObject.    *    * @param field    *          the Writable that contains the data    * @return The deserialized row Object.    * @see  org.apache.hadoop.hive.serde2.AbstractSerDe#deserialize(Writable)    */
annotation|@
name|Override
specifier|public
name|Object
...
return|;
block|}
comment|/**    * Returns the Writable Class after serialization.    *    * @see org.apache.hadoop.hive.serde2.AbstractSerDe#getSerializedClass()    */
annotation|@
name|Override
specifier|public
name|Class
...
argument_list|()
decl_stmt|;
comment|/**    * Serialize a row of data.    *    * @param obj    *          The row object    * @param objInspector    *          The ObjectInspector for the row object    * @return The serialized Writable object    * @throws SerDeException    * @see org.apache.hadoop.hive.serde2.AbstractSerDe#serialize(Object, ObjectInspector)    */
annotation|@
name|Override
specifier|public
name|Writable
