...
return|;
block|}
comment|/**    * Common functionality for all SerDe libraries to handle list and primitive    * string serialization to json strings    */
specifier|public
specifier|static
name|String
name|toJSONString
...
name|SerDeException
argument_list|(
literal|"SerDeUtils.toJSONString only does lists"
argument_list|)
throw|;
block|}
block|}
