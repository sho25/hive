...
argument_list|,
operator|new
name|InnerStructStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|InnerStructTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field field0 is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetField0
parameter_list|()
...
block|{
specifier|public
name|InnerStructStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
