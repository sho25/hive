...
name|Text
argument_list|(
literal|"100.001000000000000000"
argument_list|)
argument_list|,
name|textConverter
operator|.
...
argument_list|)
decl_stmt|;
comment|// Value should be truncated to varchar length 5
name|varcharConverter
operator|=
name|ObjectInspectorConverters
operator|.
...
argument_list|)
decl_stmt|;
comment|// Value should be truncated to char length 5
name|charConverter
operator|=
name|ObjectInspectorConverters
operator|.
...
argument_list|)
expr_stmt|;
comment|// Char value should be have space padding to full char length
name|charConverter
operator|=
name|ObjectInspectorConverters
operator|.
