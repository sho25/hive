...
name|assertEquals
argument_list|(
literal|"Test for char's avro schema failed"
argument_list|,
name|expectedSchema
argument_list|,
name|getAvroSchemaString
...
name|assertEquals
argument_list|(
literal|"Test for varchar's avro schema failed"
argument_list|,
name|expectedSchema
argument_list|,
name|getAvroSchemaString
...
name|assertEquals
argument_list|(
literal|"Test for date in avro schema failed"
argument_list|,
name|expectedSchema
argument_list|,
name|getAvroSchemaString
...
specifier|public
name|void
name|createAvroTimestampSchema
parameter_list|()
block|{
specifier|final
name|String
...
literal|"\"type\":\"long\","
operator|+
literal|"\"logicalType\":\"timestamp-millis\"}"
decl_stmt|;
name|String
name|expectedSchema
init|=
...
name|assertEquals
argument_list|(
literal|"Test for timestamp in avro schema failed"
argument_list|,
name|expectedSchema
argument_list|,
name|getAvroSchemaString
