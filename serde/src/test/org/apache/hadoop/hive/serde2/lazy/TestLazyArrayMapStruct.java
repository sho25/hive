...
name|assertEquals
argument_list|(
literal|"{'a':123,'b':['a','b','c'],'c':{'f':'g','d':'e'},'d':'hi'}"
operator|.
name|replace
argument_list|(
literal|"'"
...
name|assertEquals
argument_list|(
literal|"{'a':123,'b':null,'c':{'f':'g','d':'e'},'d':null}"
operator|.
name|replace
argument_list|(
literal|"'"
...
name|assertEquals
argument_list|(
literal|"{'a':null,'b':['a'],'c':{'f':'g','d':null,'h':null},'d':'no'}"
operator|.
name|replace
argument_list|(
literal|"'"
...
name|assertEquals
argument_list|(
literal|"{'a':null,'b':['a'],'c':{'f':'g','d':null,'h':null},'d':'has tail'}"
operator|.
name|replace
argument_list|(
literal|"'"
