...
name|fail
argument_list|(
literal|"SerDe deserialized value does not match (expected "
operator|+
name|expected
operator|.
name|getClass
...
name|String
argument_list|>
name|serializeWriteExpectedFields
init|=
operator|new
name|ArrayList
argument_list|<
...
name|fail
argument_list|(
literal|"SerializeWrite and SerDe serialization does not match at positions "
operator|+
name|differentPositions
operator|.
name|toString
...
argument_list|()
decl_stmt|;
comment|// UNDONE: Until Fast BinarySortable supports complex types -- disable.
name|source
operator|.
name|init
argument_list|(
