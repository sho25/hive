...
specifier|public
name|void
name|canSerializeCyclesInSchema
parameter_list|()
throws|throws
name|SerDeException
throws|,
name|IOException
block|{
comment|// Create parent-child avro-record and avro-schema
name|AvroCycleParent
name|parent
init|=
operator|new
name|AvroCycleParent
...
argument_list|()
decl_stmt|;
comment|// Check serialization and deserialization
name|AvroGenericRecordWritable
name|agrw
init|=
name|Utils
