...
specifier|public
name|void
name|canDeserializeRecordsInternal
parameter_list|(
name|Schema
name|s
parameter_list|,
...
specifier|public
name|void
name|canDeserializeNullableRecords
parameter_list|()
throws|throws
name|SerDeException
throws|,
...
expr_stmt|;
block|}
comment|/**    * Test whether Avro timestamps can be deserialized according to new behavior (storage in UTC but    * LocalDateTime semantics as timestamps are converted back to the writer time zone) as well as    * old behavior (Instant semantics).    */
annotation|@
name|Test
specifier|public
name|void
name|canDeserializeTimestamps
parameter_list|()
throws|throws
name|SerDeException
throws|,
...
argument_list|)
decl_stmt|;
comment|// 2019-01-02 00:00:00 GMT is 1546387200000 milliseconds after epoch
name|GenericData
operator|.
name|Record
name|record
...
argument_list|)
decl_stmt|;
comment|// 2019-01-02 00:00:00 GMT is 2019-01-01 19:00:00 GMT-0500 (America/New_York / EST)
name|assertEquals
argument_list|(
name|Timestamp
operator|.
name|valueOf
argument_list|(
literal|"2019-01-01 19:00:00.999"
argument_list|)
argument_list|,
name|resultTimestamp
argument_list|)
expr_stmt|;
comment|// Do the same without specifying writer time zone. This tests deserialization of older records
comment|// which should be interpreted in Instant semantics
name|AvroGenericRecordWritable
name|agrw2
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// 2019-01-02 00:00:00 GMT is 2019-01-01 16:00:00 in zone GMT-0800 (PST)
comment|// This is the time zone for VM in test.
name|assertEquals
argument_list|(
name|Timestamp
operator|.
name|valueOf
argument_list|(
literal|"2019-01-01 16:00:00.999"
argument_list|)
argument_list|,
name|resultTimestamp
argument_list|)
...
specifier|public
name|void
name|canDeserializeEvolvedUnions1
parameter_list|()
throws|throws
name|SerDeException
throws|,
...
specifier|public
name|void
name|canDeserializeEvolvedUnions2
parameter_list|()
throws|throws
name|SerDeException
throws|,
...
specifier|public
name|void
name|canDeserializeMapsWithJavaLangStringKeys
parameter_list|()
throws|throws
name|IOException
throws|,
name|SerDeException
block|{
comment|// Ensures maps can be deserialized when avro.java.string=String.
comment|// See http://stackoverflow.com/a/19868919/312944 for why that might be used.
name|String
name|schemaString
init|=
literal|"{\n"
...
operator|+
literal|"      \"avro.java.string\":\"String\",\n"
operator|+
literal|"      \"values\":\"long\"}\n"
operator|+
literal|"\t}\n"
...
argument_list|)
expr_stmt|;
comment|// Read the record with the same record reader ID
name|row
operator|=
operator|(
name|ArrayList
...
argument_list|)
expr_stmt|;
comment|//Expecting not to change the size of internal structures
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//Read the record with **different** record reader ID
name|garw
operator|.
name|setRecordReaderID
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//Expecting to change the size of internal structures
name|assertEquals
argument_list|(
literal|2
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//Read the record with **different** record reader ID and **evolved** schema
name|Schema
name|evolvedSchema
init|=
name|AvroSerdeUtils
...
argument_list|)
expr_stmt|;
comment|//Read the record with existing record reader ID and same **evolved** schema
name|garw
operator|.
name|setRecordReaderID
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//Reuse record reader ID
name|row
operator|=
operator|(
name|ArrayList
