...
name|info
argument_list|(
literal|"Adding perf metrics for "
operator|+
name|phase
operator|.
name|getClass
...
specifier|final
name|String
name|SERVER_ENV_PROPERTIES
init|=
literal|"hive.ptest.server.env.properties"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
literal|true
argument_list|,
literal|"optional properties file with environment properties"
argument_list|)
expr_stmt|;
name|options
operator|.
...
decl_stmt|;
name|String
name|environmentConfigurationFile
init|=
name|commandLine
operator|.
name|getOptionValue
