...
return|;
block|}
comment|/**    * Build a context with the properties read from an input stream.    * @param inputStream    * @return context    * @throws IOException    */
specifier|public
specifier|static
name|Context
...
return|;
block|}
comment|/**    * Build a context with the properties read from a file    * @param file    * @return    * @throws IOException    */
specifier|public
specifier|static
name|Context
name|fromFile
...
block|}
block|}
comment|/**    * Builder that can aggregate properties from several files    * when building a context. If the same key is present in more    * than one file, the last one will be used.    */
specifier|public
specifier|static
class|class
name|ContextBuilder
...
argument_list|()
decl_stmt|;
comment|/**      * Add properties from a file to the context      * @param file      * @return      * @throws IOException      */
specifier|public
name|ContextBuilder
...
return|;
block|}
comment|/**      * Build the context using the aggregated properties      * @return      * @throws IOException      */
specifier|public
name|Context
name|build
parameter_list|()
