...
argument_list|(
literal|"Can't parse category at "
operator|+
name|source
argument_list|)
throw|;
...
return|;
block|}
comment|/**    * Parse TypeDescription from the Hive type names. This is the inverse    * of TypeDescription.toString()    * @param typeName the name of the type    * @return a new TypeDescription or null if typeName was null    * @throws IllegalArgumentException if the string is badly formed    */
specifier|public
specifier|static
name|TypeDescription
name|fromString
...
return|;
block|}
comment|/**    * Locate a subtype by its id.    * @param goal the column id to look for    * @return the subtype    */
specifier|public
name|TypeDescription
name|findSubtype
parameter_list|(
...
parameter_list|)
block|{
comment|// call getId method to make sure the ids are assigned
name|int
name|id
init|=
name|getId
