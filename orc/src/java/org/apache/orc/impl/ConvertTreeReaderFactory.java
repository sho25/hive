...
argument_list|()
decl_stmt|;
comment|// Check to see if the decimal will fit in the Hive integer data type.
comment|// If not, set the element to null.
name|boolean
name|isInRange
decl_stmt|;
switch|switch
...
index|]
decl_stmt|;
comment|// Convert decimal into bytes instead of a String for better performance.
specifier|final
name|int
name|byteIndex
init|=
