...
name|evolution
decl_stmt|;
comment|// the file included columns indexed by the file's column ids.
specifier|private
specifier|final
name|boolean
index|[]
...
name|dataReader
decl_stmt|;
comment|/**    * Given a list of column names, find the given column and return the index.    *    * @param evolution the mapping from reader to file schema    * @param columnName  the column name to look for    * @return the file column id or -1 if the column wasn't found    */
specifier|static
name|int
name|findColumns
parameter_list|(
...
return|;
block|}
comment|/**    * Find the mapping from predicate leaves to columns.    * @param sargLeaves the search argument that we need to map    * @param evolution the mapping from reader to file schema    * @return an array mapping the sarg leaves to file column ids    */
specifier|public
specifier|static
name|int
index|[]
