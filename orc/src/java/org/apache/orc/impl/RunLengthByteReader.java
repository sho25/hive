...
block|}
block|}
comment|/**    * Read the next size bytes into the data array, skipping over any slots    * where isNull is true.    * @param isNull if non-null, skip any rows where isNull[r] is true    * @param data the array to read into    * @param size the number of elements to read    * @throws IOException    */
specifier|public
name|void
name|nextVector
parameter_list|(
