...
name|orcTail
decl_stmt|;
comment|// TODO: We can generalize FileMetada interface. Make OrcTail implement FileMetadata interface
comment|// and remove this class altogether. Both footer caching and llap caching just needs OrcTail.
comment|// For now keeping this around to avoid complex surgery
specifier|private
name|FileMetadata
name|fileMetadata
decl_stmt|;
