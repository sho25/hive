...
begin_comment
comment|/**  * Data independed base class which implements the common part of  * all hive resultsets.  */
end_comment
...
name|columnIndex
operator|+
literal|" to BigDecimal. Found data of type: "
operator|+
name|obj
operator|.
name|getClass
...
name|SQLException
block|{
comment|// TODO method required by JDK 1.7
throw|throw
operator|new
name|SQLException
argument_list|(
