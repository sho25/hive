...
comment|// when isHasResultSet is set, the query transitioned from running -> complete and is not expected go back to
comment|// running state when fetching results (implicit state transition)
if|if
condition|(
operator|(
name|statement
