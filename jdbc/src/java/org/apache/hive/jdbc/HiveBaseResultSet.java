...
name|SQLException
argument_list|(
literal|"Illegal conversion to binary stream from column "
operator|+
name|columnIndex
operator|+
literal|" - Unsupported encoding exception"
argument_list|)
throw|;
block|}
return|return
...
throw|;
block|}
comment|// If we fell through to here this is not a valid type conversion
throw|throw
operator|new
name|SQLException
argument_list|(
...
name|columnIndex
operator|+
literal|" to date: Illegal conversion"
argument_list|)
throw|;
block|}
specifier|public
