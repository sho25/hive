...
name|warn
argument_list|(
literal|"Cannot get token from environment variable $HADOOP_TOKEN_FILE_LOCATION="
operator|+
name|System
operator|.
name|getenv
...
name|warn
argument_list|(
literal|"Delegation token with key: [hive] cannot be found."
argument_list|)
expr_stmt|;
return|return
literal|null
...
name|debug
argument_list|(
literal|"Fetching delegation token from session."
argument_list|)
expr_stmt|;
return|return
name|SessionUtils
