...
specifier|final
name|int
name|partitionedIntColumnValue
init|=
literal|777
decl_stmt|;
specifier|private
...
name|assertEquals
argument_list|(
literal|"Incorrect catalog count"
argument_list|,
literal|1
argument_list|,
name|cnt
...
specifier|public
name|void
name|testPartitionedResultSetMetaData
parameter_list|()
throws|throws
name|SQLException
block|{
...
name|executeQuery
argument_list|(
literal|"select under_col, value, partcolabc, partcolint "
operator|+
literal|"from "
operator|+
name|partitionedTableName
