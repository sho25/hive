...
argument_list|)
expr_stmt|;
comment|//todo: why does it need transactional_properties?
name|queryTable
argument_list|(
name|driver
argument_list|,
literal|"create table default.streamingnobuckets (a string, b string) stored as orc TBLPROPERTIES('transactional'='true', 'transactional_properties'='default')"
argument_list|)
expr_stmt|;
name|queryTable
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * this is a clone from TestTxnStatement2....    */
specifier|public
specifier|static
name|void
name|runWorker
...
specifier|public
name|void
name|testTransactionBatchCommit_Regex
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testTransactionBatchCommit_RegexUGI
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"Column 1: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 2: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 3: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 4: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 5: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 7: count: 0 hasNull: false"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 8: count: 0 hasNull: false sum: 0"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|contains
argument_list|(
literal|"Column 9: count: 0 hasNull: false"
argument_list|)
argument_list|)
expr_stmt|;
