...
name|endsWith
argument_list|(
literal|"streamingnobuckets/base_0000005_v0000025/bucket_00000"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
name|endsWith
argument_list|(
literal|"streamingnobuckets/base_0000009_v0000029/bucket_00000"
argument_list|)
argument_list|)
expr_stmt|;
name|Assert
...
specifier|public
name|void
name|testTransactionBatchSizeValidation
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// the output stream of this FS doesn't support hflush, so the below test will fail
name|conf
operator|.
name|setVar
argument_list|(
...
name|assertTrue
argument_list|(
literal|"Expected connection error due to batch sizes"
argument_list|,
name|e
operator|.
name|getMessage
...
name|contains
argument_list|(
literal|"only supports transaction batch"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|Exception
block|{
comment|// Bad file system object, ClassCastException should occur during record writer init
name|conf
operator|.
name|set
argument_list|(
