...
argument_list|)
decl_stmt|;
comment|// Set UGI to use Kerberos
comment|// Have to use the string constant to support hadoop 1
name|conf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Set the current UGI to a fake user
name|UserGroupInformation
name|user1
init|=
name|UserGroupInformation
...
argument_list|)
decl_stmt|;
comment|// Use that as the "current user"
name|Mockito
operator|.
name|when
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Turn off passwords, enable sasl and set a keytab
name|conf
operator|.
name|unset
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Call the real method instead of the mock
name|Mockito
operator|.
name|doCallRealMethod
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Stub OutputFormat actions
name|Mockito
operator|.
name|when
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The AccumuloInputFormat methods
name|Mockito
operator|.
name|verify
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Other methods we expect
name|Mockito
operator|.
name|verify
argument_list|(
