...
parameter_list|)
block|{
comment|// re-throw the ISE so the caller can work around the silly impl that throws this in the
comment|// first place.
throw|throw
name|e
throw|;
...
block|}
block|}
comment|/**    * Wrap the setZooKeeperInstance reflected-call into its own method for testing    *    * @param jobConf    *          The JobConf    * @param inputOrOutputFormatClass    *          The InputFormat or OutputFormat class    * @param zookeepers    *          ZooKeeper hosts    * @param instanceName    *          Accumulo instance name    * @param useSasl    *          Is SASL enabled    * @throws IOException    *           When invocation of the method fails    */
name|void
name|setZooKeeperInstanceWithReflection
parameter_list|(
name|JobConf
