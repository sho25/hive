...
expr_stmt|;
block|}
comment|/**    * Compile and run PL/HQL script     */
specifier|public
name|Integer
name|run
parameter_list|(
...
return|;
block|}
comment|/**    * Run already compiled PL/HQL script (also used from Hive UDF)    */
specifier|public
name|Var
name|run
parameter_list|()
...
expr_stmt|;
block|}
comment|/**    * Start executing PL/HQL script    */
annotation|@
name|Override
specifier|public
name|Integer
