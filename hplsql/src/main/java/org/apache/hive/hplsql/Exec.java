...
name|dir
operator|+
literal|"antlr4-runtime-4.5.jar"
argument_list|)
expr_stmt|;
if|if
condition|(
...
specifier|public
name|Integer
name|visitInsert_directory_stmt
parameter_list|(
name|HplsqlParser
operator|.
...
specifier|public
name|Integer
name|visitCreate_table_options_td_item
parameter_list|(
name|HplsqlParser
operator|.
name|Create_table_options_td_itemContext
name|ctx
parameter_list|)
block|{
return|return
...
specifier|public
name|Integer
name|visitCreate_table_options_db2_item
parameter_list|(
name|HplsqlParser
operator|.
name|Create_table_options_db2_itemContext
name|ctx
parameter_list|)
block|{
return|return
...
specifier|public
name|Integer
name|visitCreate_table_options_mysql_item
parameter_list|(
name|HplsqlParser
operator|.
...
return|;
block|}
comment|/**    * ALTER TABLE statement    */
annotation|@
name|Override
specifier|public
name|Integer
name|visitAlter_table_stmt
parameter_list|(
name|HplsqlParser
operator|.
...
specifier|public
name|Integer
name|visitCreate_database_stmt
parameter_list|(
name|HplsqlParser
operator|.
...
return|;
block|}
comment|/**    * Static SELECT statement (i.e. unquoted) or expression    */
annotation|@
name|Override
specifier|public
name|Integer
name|visitExpr_select
parameter_list|(
name|HplsqlParser
operator|.
name|Expr_selectContext
name|ctx
parameter_list|)
block|{
if|if
...
return|;
block|}
comment|/**    * File path (unquoted) or expression    */
annotation|@
name|Override
specifier|public
name|Integer
...
return|;
block|}
comment|/**    * Interval expression (INTERVAL '1' DAY i.e)    */
annotation|@
name|Override
specifier|public
name|Integer
name|visitExpr_interval
parameter_list|(
name|HplsqlParser
operator|.
name|Expr_intervalContext
name|ctx
parameter_list|)
block|{
name|int
...
return|;
block|}
comment|/**    * Append the text preserving the formatting (space symbols) between tokens    */
name|void
name|append
parameter_list|(
name|StringBuilder
...
expr_stmt|;
block|}
comment|/**    * Get the first non-null node    */
name|TerminalNode
name|nvl
parameter_list|(
name|TerminalNode
